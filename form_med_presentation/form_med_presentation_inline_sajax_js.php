  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_med_presentation_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_med_presentation_inline_form();
	}
...
?>
  ...
  function do_ajax_form_med_presentation_inline_validate_mpres_desc_()
  {
    var nomeCampo_mpres_desc_ = "mpres_desc_";
    var var_mpres_desc_ = scAjaxGetFieldText(nomeCampo_mpres_desc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_med_presentation_inline_validate_mpres_desc_(var_mpres_desc_, var_script_case_init, do_ajax_form_med_presentation_inline_validate_mpres_desc__cb);
  } // do_ajax_form_med_presentation_inline_validate_mpres_desc_

  function do_ajax_form_med_presentation_inline_validate_mpres_desc__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_med_presentation_inline_validate_mpres_desc__cb

  // ---------- Validate mpres_doses_
  function do_ajax_form_med_presentation_inline_validate_mpres_doses_()
  {
    var nomeCampo_mpres_doses_ = "mpres_doses_";
    var var_mpres_doses_ = scAjaxGetFieldText(nomeCampo_mpres_doses_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_med_presentation_inline_validate_mpres_doses_(var_mpres_doses_, var_script_case_init, do_ajax_form_med_presentation_inline_validate_mpres_doses__cb);
  } // do_ajax_form_med_presentation_inline_validate_mpres_doses_

  function do_ajax_form_med_presentation_inline_validate_mpres_doses__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_med_presentation_inline_validate_mpres_doses__cb

  // ---------- Validate mpres_exits_
  function do_ajax_form_med_presentation_inline_validate_mpres_exits_()
  {
    var nomeCampo_mpres_exits_ = "mpres_exits_";
    var var_mpres_exits_ = scAjaxGetFieldText(nomeCampo_mpres_exits_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_med_presentation_inline_validate_mpres_exits_(var_mpres_exits_, var_script_case_init, do_ajax_form_med_presentation_inline_validate_mpres_exits__cb);
  } // do_ajax_form_med_presentation_inline_validate_mpres_exits_

  function do_ajax_form_med_presentation_inline_validate_mpres_exits__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_med_presentation_inline_validate_mpres_exits__cb

  // ---------- Validate mpres_id_
  function do_ajax_form_med_presentation_inline_validate_mpres_id_()
  {
    var nomeCampo_mpres_id_ = "mpres_id_";
    var var_mpres_id_ = scAjaxGetFieldText(nomeCampo_mpres_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_med_presentation_inline_validate_mpres_id_(var_mpres_id_, var_script_case_init, do_ajax_form_med_presentation_inline_validate_mpres_id__cb);
  } // do_ajax_form_med_presentation_inline_validate_mpres_id_

  function do_ajax_form_med_presentation_inline_validate_mpres_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_med_presentation_inline_validate_mpres_id__cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_med_presentation_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_med_presentation_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_mpres_desc_ = scAjaxGetFieldText("mpres_desc_");
    var var_mpres_doses_ = scAjaxGetFieldText("mpres_doses_");
    var var_mpres_exits_ = scAjaxGetFieldText("mpres_exits_");
    var var_mpres_id_ = scAjaxGetFieldText("mpres_id_");
    ...
    scAjaxProcOn();
    x_ajax_form_med_presentation_inline_submit_form(var_mpres_desc_, var_mpres_doses_, var_mpres_exits_, var_mpres_id_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_med_presentation_inline_submit_form_cb);
  } // do_ajax_form_med_presentation_inline_submit_form

  function do_ajax_form_med_presentation_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("mpres_desc_");
      scAjaxHideErrorDisplay("mpres_doses_");
      scAjaxHideErrorDisplay("mpres_exits_");
      scAjaxHideErrorDisplay("mpres_id_");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_med_presentation_inline_submit_form_cb_after_alert);
  } // do_ajax_form_med_presentation_inline_submit_form_cb
  function do_ajax_form_med_presentation_inline_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_med_presentation_inline_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_med_presentation_inline_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_med_presentation_inline_navigate_form, function() {});
    } else {
      perform_ajax_form_med_presentation_inline_navigate_form();
    }
  }

  function perform_ajax_form_med_presentation_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_med_presentation_inline_navigate_form(var_mpres_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_med_presentation_inline_navigate_form_cb);
  } // do_ajax_form_med_presentation_inline_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_med_presentation_inline']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_med_presentation_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_med_presentation_inline_navigate_form_cb_after_alert);
  } // do_ajax_form_med_presentation_inline_navigate_form_cb
  function do_ajax_form_med_presentation_inline_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_med_presentation_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_med_presentation_inline_navigate_form_cb_after_alert

  function sc_hide_form_med_presentation_inline_form()
  {
  ...
  ajax_field_list[0] = "mpres_desc_";
  ajax_field_list[1] = "mpres_doses_";
  ajax_field_list[2] = "mpres_exits_";
  ajax_field_list[3] = "mpres_id_";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "mpres_desc_": {"label": "Presentación", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mpres_doses_": {"label": "Dosis", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mpres_exits_": {"label": "Existencia", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mpres_id_": {"label": "Código", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["mpres_desc_"][1] = "mpres_desc_";
  ajax_field_mult["mpres_doses_"][1] = "mpres_doses_";
  ajax_field_mult["mpres_exits_"][1] = "mpres_exits_";
  ajax_field_mult["mpres_id_"][1] = "mpres_id_";

  var ajax_field_id = {
    "mpres_desc_": new Array("hidden_field_label_mpres_desc_", "hidden_field_data_mpres_desc_"),
    "mpres_doses_": new Array("hidden_field_label_mpres_doses_", "hidden_field_data_mpres_doses_"),
    "mpres_exits_": new Array("hidden_field_label_mpres_exits_", "hidden_field_data_mpres_exits_")
  };
