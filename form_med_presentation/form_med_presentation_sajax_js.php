  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_med_presentation" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_med_presentation_form();
	}
...
?>
  ...
  // ---------- Validate mpres_desc_
  function do_ajax_form_med_presentation_validate_mpres_desc_(iNumLinha)
  {
    var nomeCampo_mpres_desc_ = "mpres_desc_" + iNumLinha;
    var var_mpres_desc_ = scAjaxGetFieldText(nomeCampo_mpres_desc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_med_presentation_validate_mpres_desc_(var_mpres_desc_, iNumLinha, var_script_case_init, do_ajax_form_med_presentation_validate_mpres_desc__cb);
  } // do_ajax_form_med_presentation_validate_mpres_desc_

  function do_ajax_form_med_presentation_validate_mpres_desc__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "mpres_desc_" + iLineNumber;
    }
    else
    {
      sFieldValid = "mpres_desc_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "mpres_desc_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "mpres_desc_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_med_presentation_validate_mpres_desc__cb

  // ---------- Validate mpres_doses_
  function do_ajax_form_med_presentation_validate_mpres_doses_(iNumLinha)
  {
    var nomeCampo_mpres_doses_ = "mpres_doses_" + iNumLinha;
    var var_mpres_doses_ = scAjaxGetFieldText(nomeCampo_mpres_doses_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_med_presentation_validate_mpres_doses_(var_mpres_doses_, iNumLinha, var_script_case_init, do_ajax_form_med_presentation_validate_mpres_doses__cb);
  } // do_ajax_form_med_presentation_validate_mpres_doses_

  function do_ajax_form_med_presentation_validate_mpres_doses__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "mpres_doses_" + iLineNumber;
    }
    else
    {
      sFieldValid = "mpres_doses_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "mpres_doses_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "mpres_doses_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_med_presentation_validate_mpres_doses__cb

  // ---------- Validate mpres_exits_
  function do_ajax_form_med_presentation_validate_mpres_exits_(iNumLinha)
  {
    var nomeCampo_mpres_exits_ = "mpres_exits_" + iNumLinha;
    var var_mpres_exits_ = scAjaxGetFieldText(nomeCampo_mpres_exits_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_med_presentation_validate_mpres_exits_(var_mpres_exits_, iNumLinha, var_script_case_init, do_ajax_form_med_presentation_validate_mpres_exits__cb);
  } // do_ajax_form_med_presentation_validate_mpres_exits_

  function do_ajax_form_med_presentation_validate_mpres_exits__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "mpres_exits_" + iLineNumber;
    }
    else
    {
      sFieldValid = "mpres_exits_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "mpres_exits_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "mpres_exits_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_med_presentation_validate_mpres_exits__cb

  // ---------- Validate mpres_id_
  function do_ajax_form_med_presentation_validate_mpres_id_(iNumLinha)
  {
    var nomeCampo_mpres_id_ = "mpres_id_" + iNumLinha;
    var var_mpres_id_ = scAjaxGetFieldHidden(nomeCampo_mpres_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_med_presentation_validate_mpres_id_(var_mpres_id_, iNumLinha, var_script_case_init, do_ajax_form_med_presentation_validate_mpres_id__cb);
  } // do_ajax_form_med_presentation_validate_mpres_id_

  function do_ajax_form_med_presentation_validate_mpres_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_med_presentation_validate_mpres_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_med_presentation_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_med_presentation_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_med_presentation_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_med_presentation_add_new_line_cb);
  } // do_ajax_form_med_presentation_add_new_line

  function do_ajax_form_med_presentation_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_med_presentation_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_med_presentation_backup_line(iNumLinha)
  {
    var var_mpres_id_ = scAjaxGetFieldHidden("mpres_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_med_presentation_backup_line(var_mpres_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_med_presentation_backup_line_cb);
  } // do_ajax_form_med_presentation_backup_line

  function do_ajax_form_med_presentation_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_med_presentation_backup_line_cb

  function do_ajax_form_med_presentation_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_med_presentation_cancel_insert

  function do_ajax_form_med_presentation_cancel_update(iSeqVert)
  {
    do_ajax_form_med_presentation_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_med_presentation_cancel_update

  function do_ajax_form_med_presentation_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_med_presentation_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_med_presentation_table_refresh()
  {
    var var_mpres_id_ = document.F2.mpres_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_med_presentation_table_refresh(var_mpres_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_med_presentation_table_refresh_cb);
  } //  do_ajax_form_med_presentation_table_refresh

  function do_ajax_form_med_presentation_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.mpres_id_.value = scAjaxGetKeyValue("mpres_id_");
    ...
    scAjaxAlert(do_ajax_form_med_presentation_table_refresh_cb_after_alert);
  } // do_ajax_form_med_presentation_table_refresh_cb
  function do_ajax_form_med_presentation_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_med_presentation_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_med_presentation_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_med_presentation_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_mpres_desc_ = scAjaxGetFieldText("mpres_desc_" + iNumLinha);
    var var_mpres_doses_ = scAjaxGetFieldText("mpres_doses_" + iNumLinha);
    var var_mpres_exits_ = scAjaxGetFieldText("mpres_exits_" + iNumLinha);
    var var_mpres_id_ = scAjaxGetFieldHidden("mpres_id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_med_presentation_submit_form(var_mpres_desc_, var_mpres_doses_, var_mpres_exits_, var_mpres_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_med_presentation_submit_form_cb);
  } // do_ajax_form_med_presentation_submit_form

  function do_ajax_form_med_presentation_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("mpres_desc_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("mpres_doses_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("mpres_exits_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_med_presentation_submit_form_cb_after_alert);
  } // do_ajax_form_med_presentation_submit_form_cb
  function do_ajax_form_med_presentation_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_med_presentation_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_med_presentation_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_med_presentation_navigate_form, function() {});
    } else {
      perform_ajax_form_med_presentation_navigate_form();
    }
  }

  function perform_ajax_form_med_presentation_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_med_presentation_cancel_insert(sc_form_med_presentation_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("mpres_desc_" + iNavForm);
      scAjaxHideErrorDisplay("mpres_doses_" + iNavForm);
      scAjaxHideErrorDisplay("mpres_exits_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_med_presentation_navigate_form(var_mpres_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_med_presentation_navigate_form_cb);
  } // do_ajax_form_med_presentation_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_med_presentation']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_med_presentation_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.mpres_id_.value = scAjaxGetKeyValue("mpres_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_med_presentation_navigate_form_cb_after_alert);
  } // do_ajax_form_med_presentation_navigate_form_cb
  function do_ajax_form_med_presentation_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_med_presentation_navigate_form_cb_after_alert

    function sc_form_med_presentation_get_last_line_number()
    {
    ...
    } //sc_form_med_presentation_get_last_line_number

  function sc_hide_form_med_presentation_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "mpres_desc_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "mpres_doses_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "mpres_exits_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "mpres_id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["mpres_desc_" + iNumLinha] = {"label": "Presentación<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["mpres_doses_" + iNumLinha] = {"label": "Dosis<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["mpres_exits_" + iNumLinha] = {"label": "Existencia<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["mpres_id_" + iNumLinha] = {"label": "Código<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["mpres_desc_"][iNumLinha] = "mpres_desc_" + iNumLinha;
    ajax_field_mult["mpres_doses_"][iNumLinha] = "mpres_doses_" + iNumLinha;
    ajax_field_mult["mpres_exits_"][iNumLinha] = "mpres_exits_" + iNumLinha;
    ajax_field_mult["mpres_id_"][iNumLinha] = "mpres_id_" + iNumLinha;
    ajax_field_id["mpres_desc_" + iNumLinha] = new Array("hidden_field_label_mpres_desc_", "hidden_field_data_mpres_desc_" + iNumLinha);
    ajax_field_id["mpres_doses_" + iNumLinha] = new Array("hidden_field_label_mpres_doses_", "hidden_field_data_mpres_doses_" + iNumLinha);
    ajax_field_id["mpres_exits_" + iNumLinha] = new Array("hidden_field_label_mpres_exits_", "hidden_field_data_mpres_exits_" + iNumLinha);
    ajax_error_count["mpres_desc_" + iNumLinha] = "off";
    ajax_error_count["mpres_doses_" + iNumLinha] = "off";
    ajax_error_count["mpres_exits_" + iNumLinha] = "off";
    ajax_error_count["mpres_id_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["mpres_desc_" + iNumLinha] = "off";
    ajax_read_only["mpres_doses_" + iNumLinha] = "off";
    ajax_read_only["mpres_exits_" + iNumLinha] = "on";
...
{
?>
    ajax_read_only["mpres_desc_" + iNumLinha] = "on";
    ajax_read_only["mpres_doses_" + iNumLinha] = "on";
    ajax_read_only["mpres_exits_" + iNumLinha] = "on";
    ajax_read_only["mpres_id_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["mpres_desc_" + iNumLinha] = null;
    ajax_error_list["mpres_doses_" + iNumLinha] = null;
    ajax_error_list["mpres_exits_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    "mpres_desc_": new Array(),
    "mpres_doses_": new Array(),
    "mpres_exits_": new Array(),
    "mpres_id_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["mpres_desc_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["mpres_desc_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["mpres_desc_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["mpres_desc_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["mpres_desc_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["mpres_doses_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["mpres_doses_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["mpres_doses_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["mpres_doses_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["mpres_doses_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["mpres_exits_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["mpres_exits_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["mpres_exits_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["mpres_exits_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["mpres_exits_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['mpres_desc_'])) ? $this->nmgp_cmp_readonly['mpres_desc_'] : 'off';
?>
    scAjaxFieldRead("mpres_desc_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['mpres_doses_'])) ? $this->nmgp_cmp_readonly['mpres_doses_'] : 'off';
?>
    scAjaxFieldRead("mpres_doses_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['mpres_exits_'])) ? $this->nmgp_cmp_readonly['mpres_exits_'] : 'on';
?>
    scAjaxFieldRead("mpres_exits_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['mpres_id_'])) ? $this->nmgp_cmp_readonly['mpres_id_'] : 'on';
?>
  ...
  {
    scAjaxFieldRead("mpres_desc_" + iSeq, "on");
    scAjaxFieldRead("mpres_doses_" + iSeq, "on");
    scAjaxFieldRead("mpres_exits_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["mpres_desc_" + iRow] || "on" == ajax_error_count["mpres_doses_" + iRow] || "on" == ajax_error_count["mpres_exits_" + iRow] || "on" == ajax_error_count["mpres_id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_mpres_desc_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_mpres_doses_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_mpres_exits_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["mpres_desc_" + iRow] && "off" == ajax_error_count["mpres_doses_" + iRow] && "off" == ajax_error_count["mpres_exits_" + iRow] && "off" == ajax_error_count["mpres_id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["mpres_desc_" + iRow] = "off";
        ajax_error_count["mpres_doses_" + iRow] = "off";
        ajax_error_count["mpres_exits_" + iRow] = "off";
      ...
      $("#hidden_field_data_mpres_desc_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_mpres_doses_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_mpres_exits_" + iRow).removeClass("scFormErrorLine");
