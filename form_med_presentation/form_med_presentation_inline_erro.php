...
$old_error_handler = set_error_handler("form_med_presentation_inline_scriptcase_error_handler");

function form_med_presentation_inline_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['form_med_presentation_inline']['contr_erro']) && $_SESSION['scriptcase']['form_med_presentation_inline']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_med_presentation_inline->contr_form_med_presentation_inline->Apl_com_erro = true;
            if ($inicial_form_med_presentation_inline->contr_form_med_presentation_inline->NM_ajax_flag)
            {
                $inicial_form_med_presentation_inline->contr_form_med_presentation_inline->NM_ajax_info['errList']['geral_form_med_presentation_inline'][] = $msg;
                return;
            }
            form_med_presentation_inline_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_med_presentation_inline_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_med_presentation_inline'])  && '' != $_SESSION['scriptcase']['error_icon']['form_med_presentation_inline'])  ? $_SESSION['scriptcase']['error_icon']['form_med_presentation_inline']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_med_presentation_inline']) && '' != $_SESSION['scriptcase']['error_span_title']['form_med_presentation_inline']) ? $_SESSION['scriptcase']['error_span_title']['form_med_presentation_inline'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_med_presentation_inline']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_med_presentation_inline']) ? $_SESSION['scriptcase']['error_icon_title']['form_med_presentation_inline'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_med_presentation']['error_buffer'] .= ob_get_flush();
}
