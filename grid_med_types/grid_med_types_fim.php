...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["EnfermeriaUNAE_____grid_med_types"]))
   {
      unset($_SESSION['session_sec_aplicacao']["EnfermeriaUNAE_____grid_med_types"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_med_types'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_med_types']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_med_types']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_med_types']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_med_types']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_med_types']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_med_types']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_med_types']['embutida_filho'] as $ind => $sc_init)
          {
