  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_patients_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_patients_mob_form();
	}
...
?>
  ...
  // ---------- Validate pati_docnum
  function do_ajax_form_patients_mob_validate_pati_docnum()
  {
    var nomeCampo_pati_docnum = "pati_docnum";
    var var_pati_docnum = scAjaxGetFieldText(nomeCampo_pati_docnum);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_mob_validate_pati_docnum(var_pati_docnum, var_script_case_init, do_ajax_form_patients_mob_validate_pati_docnum_cb);
  } // do_ajax_form_patients_mob_validate_pati_docnum

  function do_ajax_form_patients_mob_validate_pati_docnum_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pati_docnum";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_mob_validate_pati_docnum_cb

  // ---------- Validate pati_name
  function do_ajax_form_patients_mob_validate_pati_name()
  {
    var nomeCampo_pati_name = "pati_name";
    var var_pati_name = scAjaxGetFieldText(nomeCampo_pati_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_mob_validate_pati_name(var_pati_name, var_script_case_init, do_ajax_form_patients_mob_validate_pati_name_cb);
  } // do_ajax_form_patients_mob_validate_pati_name

  function do_ajax_form_patients_mob_validate_pati_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pati_name";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_mob_validate_pati_name_cb

  // ---------- Validate pati_lname
  function do_ajax_form_patients_mob_validate_pati_lname()
  {
    var nomeCampo_pati_lname = "pati_lname";
    var var_pati_lname = scAjaxGetFieldText(nomeCampo_pati_lname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_mob_validate_pati_lname(var_pati_lname, var_script_case_init, do_ajax_form_patients_mob_validate_pati_lname_cb);
  } // do_ajax_form_patients_mob_validate_pati_lname

  function do_ajax_form_patients_mob_validate_pati_lname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pati_lname";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_mob_validate_pati_lname_cb

  // ---------- Validate pati_bod
  function do_ajax_form_patients_mob_validate_pati_bod()
  {
    var nomeCampo_pati_bod = "pati_bod";
    var var_pati_bod = scAjaxGetFieldText(nomeCampo_pati_bod);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_pati_bod = scAjaxGetFieldText(nomeCampo_pati_bod);
      x_ajax_form_patients_mob_validate_pati_bod(var_pati_bod, var_script_case_init, do_ajax_form_patients_mob_validate_pati_bod_cb);
    }, 200);
  } // do_ajax_form_patients_mob_validate_pati_bod

  function do_ajax_form_patients_mob_validate_pati_bod_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pati_bod";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_mob_validate_pati_bod_cb

  // ---------- Validate pati_phone
  function do_ajax_form_patients_mob_validate_pati_phone()
  {
    var nomeCampo_pati_phone = "pati_phone";
    var var_pati_phone = scAjaxGetFieldText(nomeCampo_pati_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_mob_validate_pati_phone(var_pati_phone, var_script_case_init, do_ajax_form_patients_mob_validate_pati_phone_cb);
  } // do_ajax_form_patients_mob_validate_pati_phone

  function do_ajax_form_patients_mob_validate_pati_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pati_phone";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_mob_validate_pati_phone_cb

  // ---------- Validate pati_career
  function do_ajax_form_patients_mob_validate_pati_career()
  {
    var nomeCampo_pati_career = "pati_career";
    var var_pati_career = scAjaxGetFieldText(nomeCampo_pati_career);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_mob_validate_pati_career(var_pati_career, var_script_case_init, do_ajax_form_patients_mob_validate_pati_career_cb);
  } // do_ajax_form_patients_mob_validate_pati_career

  function do_ajax_form_patients_mob_validate_pati_career_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pati_career";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_mob_validate_pati_career_cb

  // ---------- Validate pati_caryerar
  function do_ajax_form_patients_mob_validate_pati_caryerar()
  {
    var nomeCampo_pati_caryerar = "pati_caryerar";
    var var_pati_caryerar = scAjaxGetFieldText(nomeCampo_pati_caryerar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_mob_validate_pati_caryerar(var_pati_caryerar, var_script_case_init, do_ajax_form_patients_mob_validate_pati_caryerar_cb);
  } // do_ajax_form_patients_mob_validate_pati_caryerar

  function do_ajax_form_patients_mob_validate_pati_caryerar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pati_caryerar";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_mob_validate_pati_caryerar_cb

  // ---------- Validate pati_carsem
  function do_ajax_form_patients_mob_validate_pati_carsem()
  {
    var nomeCampo_pati_carsem = "pati_carsem";
    var var_pati_carsem = scAjaxGetFieldText(nomeCampo_pati_carsem);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_mob_validate_pati_carsem(var_pati_carsem, var_script_case_init, do_ajax_form_patients_mob_validate_pati_carsem_cb);
  } // do_ajax_form_patients_mob_validate_pati_carsem

  function do_ajax_form_patients_mob_validate_pati_carsem_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pati_carsem";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_mob_validate_pati_carsem_cb

  // ---------- Validate btyp_id
  function do_ajax_form_patients_mob_validate_btyp_id()
  {
    var nomeCampo_btyp_id = "btyp_id";
    var var_btyp_id = scAjaxGetFieldSelect(nomeCampo_btyp_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_mob_validate_btyp_id(var_btyp_id, var_script_case_init, do_ajax_form_patients_mob_validate_btyp_id_cb);
  } // do_ajax_form_patients_mob_validate_btyp_id

  function do_ajax_form_patients_mob_validate_btyp_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "btyp_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_mob_validate_btyp_id_cb

  // ---------- Validate gerens_id
  function do_ajax_form_patients_mob_validate_gerens_id()
  {
    var nomeCampo_gerens_id = "gerens_id";
    var var_gerens_id = scAjaxGetFieldRadio(nomeCampo_gerens_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_mob_validate_gerens_id(var_gerens_id, var_script_case_init, do_ajax_form_patients_mob_validate_gerens_id_cb);
  } // do_ajax_form_patients_mob_validate_gerens_id

  function do_ajax_form_patients_mob_validate_gerens_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_mob_validate_gerens_id_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_patients_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_patients_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_pati_docnum = scAjaxGetFieldText("pati_docnum");
    var var_pati_name = scAjaxGetFieldText("pati_name");
    var var_pati_lname = scAjaxGetFieldText("pati_lname");
    var var_pati_bod = scAjaxGetFieldText("pati_bod");
    var var_pati_phone = scAjaxGetFieldText("pati_phone");
    var var_pati_career = scAjaxGetFieldText("pati_career");
    var var_pati_caryerar = scAjaxGetFieldText("pati_caryerar");
    var var_pati_carsem = scAjaxGetFieldText("pati_carsem");
    var var_btyp_id = scAjaxGetFieldSelect("btyp_id");
    var var_gerens_id = scAjaxGetFieldRadio("gerens_id");
    var var_pati_id = scAjaxGetFieldText("pati_id");
    ...
    scAjaxProcOn();
    x_ajax_form_patients_mob_submit_form(var_pati_docnum, var_pati_name, var_pati_lname, var_pati_bod, var_pati_phone, var_pati_career, var_pati_caryerar, var_pati_carsem, var_btyp_id, var_gerens_id, var_pati_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_patients_mob_submit_form_cb);
  } // do_ajax_form_patients_mob_submit_form

  function do_ajax_form_patients_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("pati_docnum");
      scAjaxHideErrorDisplay("pati_name");
      scAjaxHideErrorDisplay("pati_lname");
      scAjaxHideErrorDisplay("pati_bod");
      scAjaxHideErrorDisplay("pati_phone");
      scAjaxHideErrorDisplay("pati_career");
      scAjaxHideErrorDisplay("pati_caryerar");
      scAjaxHideErrorDisplay("pati_carsem");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_patients_mob_submit_form_cb_after_alert);
  } // do_ajax_form_patients_mob_submit_form_cb
  function do_ajax_form_patients_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_patients_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_patients_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_patients_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_patients_mob_navigate_form();
    }
  }

  function perform_ajax_form_patients_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("btyp_id");
    scAjaxHideErrorDisplay("gerens_id");
    var var_pati_id = document.F2.pati_id.value;
    ...
    scAjaxProcOn();
    x_ajax_form_patients_mob_navigate_form(var_pati_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_patients_mob_navigate_form_cb);
  } // do_ajax_form_patients_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_patients_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.pati_id.value = scAjaxGetKeyValue("pati_id");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_patients_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_patients_mob_navigate_form_cb
  function do_ajax_form_patients_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_patients_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_patients_mob_navigate_form_cb_after_alert

  function sc_hide_form_patients_mob_form()
  {
  ...
  ajax_field_list[0] = "pati_docnum";
  ajax_field_list[1] = "pati_name";
  ajax_field_list[2] = "pati_lname";
  ajax_field_list[3] = "pati_bod";
  ajax_field_list[4] = "pati_phone";
  ajax_field_list[5] = "pati_career";
  ajax_field_list[6] = "pati_caryerar";
  ajax_field_list[7] = "pati_carsem";
  ...
  var ajax_error_list = {
    "pati_docnum": {"label": "Nro. Documento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pati_name": {"label": "Paciente Nombre", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pati_lname": {"label": "Paciente Apellido", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pati_bod": {"label": "Fecha de Nacimiento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pati_phone": {"label": "Teléfono", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pati_career": {"label": "Carrera", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pati_caryerar": {"label": "Curso", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pati_carsem": {"label": "Semestre", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "btyp_id": {"label": "Grupo Sanguineo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "pati_docnum": new Array(),
    "pati_name": new Array(),
    "pati_lname": new Array(),
    "pati_bod": new Array(),
    "pati_phone": new Array(),
    "pati_career": new Array(),
    "pati_caryerar": new Array(),
    "pati_carsem": new Array(),
    "btyp_id": new Array(),
    "gerens_id": new Array()
  };
  ajax_field_mult["pati_docnum"][1] = "pati_docnum";
  ajax_field_mult["pati_name"][1] = "pati_name";
  ajax_field_mult["pati_lname"][1] = "pati_lname";
  ajax_field_mult["pati_bod"][1] = "pati_bod";
  ajax_field_mult["pati_phone"][1] = "pati_phone";
  ajax_field_mult["pati_career"][1] = "pati_career";
  ajax_field_mult["pati_caryerar"][1] = "pati_caryerar";
  ajax_field_mult["pati_carsem"][1] = "pati_carsem";
  ajax_field_mult["btyp_id"][1] = "btyp_id";
  ajax_field_mult["gerens_id"][1] = "gerens_id";

  var ajax_field_id = {
    "pati_docnum": new Array("hidden_field_label_pati_docnum", "hidden_field_data_pati_docnum"),
    "pati_name": new Array("hidden_field_label_pati_name", "hidden_field_data_pati_name"),
    "pati_lname": new Array("hidden_field_label_pati_lname", "hidden_field_data_pati_lname"),
    "pati_bod": new Array("hidden_field_label_pati_bod", "hidden_field_data_pati_bod"),
    "pati_phone": new Array("hidden_field_label_pati_phone", "hidden_field_data_pati_phone"),
    "pati_career": new Array("hidden_field_label_pati_career", "hidden_field_data_pati_career"),
    "pati_caryerar": new Array("hidden_field_label_pati_caryerar", "hidden_field_data_pati_caryerar"),
    "pati_carsem": new Array("hidden_field_label_pati_carsem", "hidden_field_data_pati_carsem"),
