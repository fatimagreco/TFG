  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_patients" == sTestField)
        {
...
?>
  ...
  function do_ajax_form_patients_validate_pati_docnum()
  {
    var nomeCampo_pati_docnum = "pati_docnum";
    var var_pati_docnum = scAjaxGetFieldText(nomeCampo_pati_docnum);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_validate_pati_docnum(var_pati_docnum, var_script_case_init, do_ajax_form_patients_validate_pati_docnum_cb);
  } // do_ajax_form_patients_validate_pati_docnum

  function do_ajax_form_patients_validate_pati_docnum_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_validate_pati_docnum_cb

  // ---------- Validate pati_name
  function do_ajax_form_patients_validate_pati_name()
  {
    var nomeCampo_pati_name = "pati_name";
    var var_pati_name = scAjaxGetFieldText(nomeCampo_pati_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_validate_pati_name(var_pati_name, var_script_case_init, do_ajax_form_patients_validate_pati_name_cb);
  } // do_ajax_form_patients_validate_pati_name

  function do_ajax_form_patients_validate_pati_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_validate_pati_name_cb

  // ---------- Validate pati_lname
  function do_ajax_form_patients_validate_pati_lname()
  {
    var nomeCampo_pati_lname = "pati_lname";
    var var_pati_lname = scAjaxGetFieldText(nomeCampo_pati_lname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_validate_pati_lname(var_pati_lname, var_script_case_init, do_ajax_form_patients_validate_pati_lname_cb);
  } // do_ajax_form_patients_validate_pati_lname

  function do_ajax_form_patients_validate_pati_lname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_validate_pati_lname_cb

  // ---------- Validate pati_bod
  function do_ajax_form_patients_validate_pati_bod()
  {
    ...
    setTimeout(function() {
      var var_pati_bod = scAjaxGetFieldText(nomeCampo_pati_bod);
      x_ajax_form_patients_validate_pati_bod(var_pati_bod, var_script_case_init, do_ajax_form_patients_validate_pati_bod_cb);
    }, 200);
  } // do_ajax_form_patients_validate_pati_bod

  function do_ajax_form_patients_validate_pati_bod_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_validate_pati_bod_cb

  // ---------- Validate pati_phone
  function do_ajax_form_patients_validate_pati_phone()
  {
    var nomeCampo_pati_phone = "pati_phone";
    var var_pati_phone = scAjaxGetFieldText(nomeCampo_pati_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_validate_pati_phone(var_pati_phone, var_script_case_init, do_ajax_form_patients_validate_pati_phone_cb);
  } // do_ajax_form_patients_validate_pati_phone

  function do_ajax_form_patients_validate_pati_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_validate_pati_phone_cb

  // ---------- Validate pati_career
  function do_ajax_form_patients_validate_pati_career()
  {
    var nomeCampo_pati_career = "pati_career";
    var var_pati_career = scAjaxGetFieldText(nomeCampo_pati_career);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_validate_pati_career(var_pati_career, var_script_case_init, do_ajax_form_patients_validate_pati_career_cb);
  } // do_ajax_form_patients_validate_pati_career

  function do_ajax_form_patients_validate_pati_career_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_validate_pati_career_cb

  // ---------- Validate pati_caryerar
  function do_ajax_form_patients_validate_pati_caryerar()
  {
    var nomeCampo_pati_caryerar = "pati_caryerar";
    var var_pati_caryerar = scAjaxGetFieldText(nomeCampo_pati_caryerar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_validate_pati_caryerar(var_pati_caryerar, var_script_case_init, do_ajax_form_patients_validate_pati_caryerar_cb);
  } // do_ajax_form_patients_validate_pati_caryerar

  function do_ajax_form_patients_validate_pati_caryerar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_validate_pati_caryerar_cb

  // ---------- Validate pati_carsem
  function do_ajax_form_patients_validate_pati_carsem()
  {
    var nomeCampo_pati_carsem = "pati_carsem";
    var var_pati_carsem = scAjaxGetFieldText(nomeCampo_pati_carsem);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_validate_pati_carsem(var_pati_carsem, var_script_case_init, do_ajax_form_patients_validate_pati_carsem_cb);
  } // do_ajax_form_patients_validate_pati_carsem

  function do_ajax_form_patients_validate_pati_carsem_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_validate_pati_carsem_cb

  // ---------- Validate btyp_id
  function do_ajax_form_patients_validate_btyp_id()
  {
    var nomeCampo_btyp_id = "btyp_id";
    var var_btyp_id = scAjaxGetFieldSelect(nomeCampo_btyp_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_validate_btyp_id(var_btyp_id, var_script_case_init, do_ajax_form_patients_validate_btyp_id_cb);
  } // do_ajax_form_patients_validate_btyp_id

  function do_ajax_form_patients_validate_btyp_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "btyp_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_validate_btyp_id_cb

  // ---------- Validate gerens_id
  function do_ajax_form_patients_validate_gerens_id()
  {
    var nomeCampo_gerens_id = "gerens_id";
    var var_gerens_id = scAjaxGetFieldRadio(nomeCampo_gerens_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_validate_gerens_id(var_gerens_id, var_script_case_init, do_ajax_form_patients_validate_gerens_id_cb);
  } // do_ajax_form_patients_validate_gerens_id

  function do_ajax_form_patients_validate_gerens_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_validate_gerens_id_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_patients_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_patients_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_patients_submit_form(var_pati_docnum, var_pati_name, var_pati_lname, var_pati_bod, var_pati_phone, var_pati_career, var_pati_caryerar, var_pati_carsem, var_btyp_id, var_gerens_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_patients_submit_form_cb);
  } // do_ajax_form_patients_submit_form

  function do_ajax_form_patients_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_patients_submit_form_cb_after_alert);
  } // do_ajax_form_patients_submit_form_cb
  function do_ajax_form_patients_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_patients_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_patients_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_patients_navigate_form, function() {});
    } else {
      perform_ajax_form_patients_navigate_form();
    }
  }

  function perform_ajax_form_patients_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_patients_navigate_form(var_pati_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_patients_navigate_form_cb);
  } // do_ajax_form_patients_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_patients_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_patients_navigate_form_cb_after_alert);
  } // do_ajax_form_patients_navigate_form_cb
  function do_ajax_form_patients_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_patients_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_patients_navigate_form_cb_after_alert

  function sc_hide_form_patients_form()
  {
