...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["EnfermeriaUNAE_____sec_grid_sec_users_groups"]))
   {
      unset($_SESSION['session_sec_aplicacao']["EnfermeriaUNAE_____sec_grid_sec_users_groups"]);
   }
