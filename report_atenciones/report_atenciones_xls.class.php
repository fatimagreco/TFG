...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "report_atenciones/report_atenciones_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new report_atenciones_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_report_atenciones.zip";
          $this->Arquivo   .= "_report_atenciones" . $this->Xls_tp;
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['report_atenciones']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_atenciones']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['report_atenciones']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
...
$_SESSION['scriptcase']['report_atenciones']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_atenciones']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_atenciones']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_atenciones']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['report_atenciones']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['report_atenciones']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['report_atenciones']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['report_atenciones']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['report_atenciones']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_anam_carsem()
   {
         ...
         if (is_numeric($this->anam_carsem))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->anam_carsem);
         $this->Xls_col++;
   }
   //----- anam_reason
   ...
   function NM_export_anam_aller()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->anam_aller, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->anam_aller, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- anam_temp
   function NM_export_anam_temp()
   {
         ...
         if (is_numeric($this->anam_temp))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->anam_temp);
         $this->Xls_col++;
   }
   //----- anam_hbeat
   function NM_export_anam_hbeat()
   {
         ...
         if (is_numeric($this->anam_hbeat))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->anam_hbeat);
         $this->Xls_col++;
   }
   //----- anam_bpsys
   ...
   function NM_export_anam_oxy()
   {
         ...
         if (is_numeric($this->anam_oxy))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->anam_oxy);
         $this->Xls_col++;
   }
   //----- anam_gluco
   function NM_export_anam_gluco()
   {
         ...
         if (is_numeric($this->anam_gluco))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->anam_gluco);
         $this->Xls_col++;
   }
   //----- anam_diag
   function NM_export_anam_diag()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->anam_diag, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->anam_diag, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- pati_name
   ...
   function NM_export_pati_caryerar()
   {
         ...
         if (is_numeric($this->pati_caryerar))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->pati_caryerar);
         $this->Xls_col++;
   }
   //----- pati_carsem
   function NM_export_pati_carsem()
   {
         ...
         if (is_numeric($this->pati_carsem))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->pati_carsem);
         $this->Xls_col++;
   }
   //----- pati_famphone
   function NM_export_pati_famphone()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pati_famphone, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pati_famphone, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- pati_famname
   function NM_export_pati_famname()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pati_famname, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pati_famname, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- user_name
   ...
   function NM_export_user_lname()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->user_lname, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->user_lname, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- user_docnum
   function NM_export_user_docnum()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->user_docnum, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->user_docnum, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- btyp_name
   ...
   function NM_export_treat_restdays()
   {
         ...
         if (is_numeric($this->treat_restdays))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->treat_restdays);
         $this->Xls_col++;
   }
   //----- treat_rest
   function NM_export_treat_rest()
   {
         ...
         if (is_numeric($this->treat_rest))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->treat_rest);
         $this->Xls_col++;
   }
   //----- pat_nombre
   function NM_export_pat_nombre()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pat_nombre, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pat_nombre, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- pat_nombrefirma
   function NM_export_pat_nombrefirma()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pat_nombrefirma, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pat_nombrefirma, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- pati_edad
   function NM_export_pati_edad()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pati_edad, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pati_edad, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- treat_record
   function NM_export_treat_record()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->treat_record, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->treat_record, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- user_nombre
   function NM_export_user_nombre()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->user_nombre, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->user_nombre, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- pati_docunum
   function NM_export_pati_docunum()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pati_docunum, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pati_docunum, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- pat_gerens
   function NM_export_pat_gerens()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pat_gerens, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pat_gerens, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- pat_btyp
   function NM_export_pat_btyp()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pat_btyp, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pat_btyp, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- anam_id
   ...
   //----- anam_carsem
   function NM_sub_cons_anam_carsem()
   {
         $this->anam_carsem = NM_charset_to_utf8($this->anam_carsem);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->anam_carsem;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- anam_aller
   function NM_sub_cons_anam_aller()
   {
         $this->anam_aller = html_entity_decode($this->anam_aller, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->anam_aller = strip_tags($this->anam_aller);
         $this->anam_aller = NM_charset_to_utf8($this->anam_aller);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->anam_aller;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- anam_temp
   function NM_sub_cons_anam_temp()
   {
         $this->anam_temp = NM_charset_to_utf8($this->anam_temp);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->anam_temp;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- anam_hbeat
   function NM_sub_cons_anam_hbeat()
   {
         $this->anam_hbeat = NM_charset_to_utf8($this->anam_hbeat);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->anam_hbeat;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- anam_oxy
   function NM_sub_cons_anam_oxy()
   {
         $this->anam_oxy = NM_charset_to_utf8($this->anam_oxy);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->anam_oxy;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- anam_gluco
   function NM_sub_cons_anam_gluco()
   {
         $this->anam_gluco = NM_charset_to_utf8($this->anam_gluco);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->anam_gluco;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- anam_diag
   function NM_sub_cons_anam_diag()
   {
         $this->anam_diag = html_entity_decode($this->anam_diag, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->anam_diag = strip_tags($this->anam_diag);
         $this->anam_diag = NM_charset_to_utf8($this->anam_diag);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->anam_diag;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- pati_caryerar
   function NM_sub_cons_pati_caryerar()
   {
         $this->pati_caryerar = NM_charset_to_utf8($this->pati_caryerar);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->pati_caryerar;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- pati_carsem
   function NM_sub_cons_pati_carsem()
   {
         $this->pati_carsem = NM_charset_to_utf8($this->pati_carsem);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->pati_carsem;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- pati_famphone
   function NM_sub_cons_pati_famphone()
   {
         $this->pati_famphone = html_entity_decode($this->pati_famphone, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->pati_famphone = strip_tags($this->pati_famphone);
         $this->pati_famphone = NM_charset_to_utf8($this->pati_famphone);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->pati_famphone;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- pati_famname
   function NM_sub_cons_pati_famname()
   {
         $this->pati_famname = html_entity_decode($this->pati_famname, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->pati_famname = strip_tags($this->pati_famname);
         $this->pati_famname = NM_charset_to_utf8($this->pati_famname);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->pati_famname;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- user_lname
   function NM_sub_cons_user_lname()
   {
         $this->user_lname = html_entity_decode($this->user_lname, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->user_lname = strip_tags($this->user_lname);
         $this->user_lname = NM_charset_to_utf8($this->user_lname);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->user_lname;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- treat_restdays
   function NM_sub_cons_treat_restdays()
   {
         $this->treat_restdays = NM_charset_to_utf8($this->treat_restdays);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->treat_restdays;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- treat_rest
   function NM_sub_cons_treat_rest()
   {
         $this->treat_rest = NM_charset_to_utf8($this->treat_rest);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->treat_rest;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- pat_nombre
   function NM_sub_cons_pat_nombre()
   {
         $this->pat_nombre = html_entity_decode($this->pat_nombre, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->pat_nombre = strip_tags($this->pat_nombre);
         $this->pat_nombre = NM_charset_to_utf8($this->pat_nombre);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->pat_nombre;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- pat_nombrefirma
   function NM_sub_cons_pat_nombrefirma()
   {
         $this->pat_nombrefirma = html_entity_decode($this->pat_nombrefirma, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->pat_nombrefirma = strip_tags($this->pat_nombrefirma);
         $this->pat_nombrefirma = NM_charset_to_utf8($this->pat_nombrefirma);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->pat_nombrefirma;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- pati_edad
   function NM_sub_cons_pati_edad()
   {
         $this->pati_edad = html_entity_decode($this->pati_edad, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->pati_edad = strip_tags($this->pati_edad);
         $this->pati_edad = NM_charset_to_utf8($this->pati_edad);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->pati_edad;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- treat_record
   function NM_sub_cons_treat_record()
   {
         $this->treat_record = html_entity_decode($this->treat_record, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->treat_record = strip_tags($this->treat_record);
         $this->treat_record = NM_charset_to_utf8($this->treat_record);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->treat_record;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- user_nombre
   function NM_sub_cons_user_nombre()
   {
         $this->user_nombre = html_entity_decode($this->user_nombre, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->user_nombre = strip_tags($this->user_nombre);
         $this->user_nombre = NM_charset_to_utf8($this->user_nombre);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->user_nombre;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- pati_docunum
   function NM_sub_cons_pati_docunum()
   {
         $this->pati_docunum = NM_charset_to_utf8($this->pati_docunum);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->pati_docunum;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- pat_gerens
   function NM_sub_cons_pat_gerens()
   {
         $this->pat_gerens = NM_charset_to_utf8($this->pat_gerens);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->pat_gerens;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- pat_btyp
   function NM_sub_cons_pat_btyp()
   {
         $this->pat_btyp = NM_charset_to_utf8($this->pat_btyp);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->pat_btyp;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_atenciones']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['report_atenciones']['nolabel'])
       {
