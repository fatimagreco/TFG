<?php
@session_start() ;
$_SESSION['scriptcase']['report_atenciones']['sc_process_barr'] = true;
require_once('../report_atenciones/index.php');
unset($_SESSION['scriptcase']['report_atenciones']['sc_process_barr']);
$ExportCtrl = new report_atenciones_export_control;
$ExportCtrl->Export_barr();

class report_atenciones_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_title'] ?> vw_anamnesis</TITLE>
