<?php
@session_start() ;
$_SESSION['scriptcase']['grid_med_entry']['sc_process_barr'] = true;
require_once('../grid_med_entry/index.php');
unset($_SESSION['scriptcase']['grid_med_entry']['sc_process_barr']);
$ExportCtrl = new grid_med_entry_export_control;
$ExportCtrl->Export_barr();

class grid_med_entry_export_control
{
