...
<?php
   ...
   $Ord_Cmp = new grid_med_entry_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_med_entry_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_med_entry']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_med_entry']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['ment_id'] = "ment_id";
   $tab_labels["ment_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_med_entry']['labels']["ment_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_med_entry']['labels']["ment_id"] : "N°";
   $tab_ger_campos['ment_date'] = "on";
   $tab_def_campos['ment_date'] = "ment_date";
   $tab_labels["ment_date"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_med_entry']['labels']["ment_date"])) ? $_SESSION['sc_session'][$sc_init]['grid_med_entry']['labels']["ment_date"] : "Fecha";
   $tab_ger_campos['sup_id'] = "on";
   $tab_def_campos['sup_id'] = "sup_id";
   $tab_labels["sup_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_med_entry']['labels']["sup_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_med_entry']['labels']["sup_id"] : "Proveedor";
   $tab_ger_campos['user_id'] = "on";
   $tab_def_campos['user_id'] = "user_id";
   $tab_labels["user_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_med_entry']['labels']["user_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_med_entry']['labels']["user_id"] : "Usuario";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_med_entry']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_med_entry']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_med_entry']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_med_entry']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_med_entry']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_med_entry']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_med_entry']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_med_entry']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_med_entry']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_med_entry']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_med_entry']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_med_entry']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_med_entry_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_med_entry']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_med_entry']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_med_entry']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_med_entry']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_med_entry']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
