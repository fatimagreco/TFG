  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_med_entry" == sTestField)
        {
...
?>
  ...
  // ---------- Validate ment_date
  function do_ajax_form_med_entry_validate_ment_date()
  {
    var nomeCampo_ment_date = "ment_date";
    var var_ment_date = scAjaxGetFieldText(nomeCampo_ment_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_med_entry_validate_ment_date(var_ment_date, var_script_case_init, do_ajax_form_med_entry_validate_ment_date_cb);
  } // do_ajax_form_med_entry_validate_ment_date

  function do_ajax_form_med_entry_validate_ment_date_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_med_entry_validate_ment_date_cb

  // ---------- Validate sup_id
  function do_ajax_form_med_entry_validate_sup_id()
  {
    var nomeCampo_sup_id = "sup_id";
    var var_sup_id = scAjaxGetFieldSelect(nomeCampo_sup_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_med_entry_validate_sup_id(var_sup_id, var_script_case_init, do_ajax_form_med_entry_validate_sup_id_cb);
  } // do_ajax_form_med_entry_validate_sup_id

  function do_ajax_form_med_entry_validate_sup_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sup_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_med_entry_validate_sup_id_cb

  // ---------- Validate user_id
  function do_ajax_form_med_entry_validate_user_id()
  {
    var nomeCampo_user_id = "user_id";
    var var_user_id = scAjaxGetFieldSelect(nomeCampo_user_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_med_entry_validate_user_id(var_user_id, var_script_case_init, do_ajax_form_med_entry_validate_user_id_cb);
  } // do_ajax_form_med_entry_validate_user_id

  function do_ajax_form_med_entry_validate_user_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_med_entry_validate_user_id_cb

  // ---------- Validate medicamentos
  function do_ajax_form_med_entry_validate_medicamentos()
  {
    var nomeCampo_medicamentos = "medicamentos";
    var var_medicamentos = scAjaxGetFieldText(nomeCampo_medicamentos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_med_entry_validate_medicamentos(var_medicamentos, var_script_case_init, do_ajax_form_med_entry_validate_medicamentos_cb);
  } // do_ajax_form_med_entry_validate_medicamentos

  function do_ajax_form_med_entry_validate_medicamentos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_med_entry_validate_medicamentos_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_med_entry_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_med_entry_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_med_entry_submit_form(var_ment_date, var_sup_id, var_user_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_med_entry_submit_form_cb);
  } // do_ajax_form_med_entry_submit_form

  function do_ajax_form_med_entry_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_med_entry_submit_form_cb_after_alert);
  } // do_ajax_form_med_entry_submit_form_cb
  function do_ajax_form_med_entry_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_med_entry_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_med_entrydet"] = "off";

  function do_ajax_form_med_entry_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_med_entry_navigate_form, function() {});
    } else {
      perform_ajax_form_med_entry_navigate_form();
    }
  }

  function perform_ajax_form_med_entry_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_med_entrydet"] = "on";
    x_ajax_form_med_entry_navigate_form(var_ment_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_med_entry_navigate_form_cb);
  } // do_ajax_form_med_entry_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_med_entry']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_med_entry_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_med_entrydet"] && "nmsc_iframe_liga_form_med_entrydet" != scMasterDetailIframe["nmsc_iframe_liga_form_med_entrydet"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_med_entrydet"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_med_entrydet').contentWindow.nm_move('apl_detalhe', true, '500px');
        document.getElementById('nmsc_iframe_liga_form_med_entrydet').style.height = "500px";
        document.getElementById('nmsc_iframe_liga_form_med_entrydet').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_med_entry_navigate_form_cb_after_alert);
  } // do_ajax_form_med_entry_navigate_form_cb
  function do_ajax_form_med_entry_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_med_entry_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_med_entry_navigate_form_cb_after_alert

  function sc_hide_form_med_entry_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_med_entrydet"])
    {
      return true;
    }
    return false;
