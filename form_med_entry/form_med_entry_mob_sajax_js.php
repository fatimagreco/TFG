  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_med_entry_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_med_entry_mob_form();
	}
...
?>
  ...
  // ---------- Validate ment_date
  function do_ajax_form_med_entry_mob_validate_ment_date()
  {
    var nomeCampo_ment_date = "ment_date";
    var var_ment_date = scAjaxGetFieldText(nomeCampo_ment_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_med_entry_mob_validate_ment_date(var_ment_date, var_script_case_init, do_ajax_form_med_entry_mob_validate_ment_date_cb);
  } // do_ajax_form_med_entry_mob_validate_ment_date

  function do_ajax_form_med_entry_mob_validate_ment_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ment_date";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_med_entry_mob_validate_ment_date_cb

  // ---------- Validate sup_id
  function do_ajax_form_med_entry_mob_validate_sup_id()
  {
    var nomeCampo_sup_id = "sup_id";
    var var_sup_id = scAjaxGetFieldSelect(nomeCampo_sup_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_med_entry_mob_validate_sup_id(var_sup_id, var_script_case_init, do_ajax_form_med_entry_mob_validate_sup_id_cb);
  } // do_ajax_form_med_entry_mob_validate_sup_id

  function do_ajax_form_med_entry_mob_validate_sup_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sup_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_med_entry_mob_validate_sup_id_cb

  // ---------- Validate user_id
  function do_ajax_form_med_entry_mob_validate_user_id()
  {
    var nomeCampo_user_id = "user_id";
    var var_user_id = scAjaxGetFieldSelect(nomeCampo_user_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_med_entry_mob_validate_user_id(var_user_id, var_script_case_init, do_ajax_form_med_entry_mob_validate_user_id_cb);
  } // do_ajax_form_med_entry_mob_validate_user_id

  function do_ajax_form_med_entry_mob_validate_user_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_med_entry_mob_validate_user_id_cb

  // ---------- Validate medicamentos
  function do_ajax_form_med_entry_mob_validate_medicamentos()
  {
    var nomeCampo_medicamentos = "medicamentos";
    var var_medicamentos = scAjaxGetFieldText(nomeCampo_medicamentos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_med_entry_mob_validate_medicamentos(var_medicamentos, var_script_case_init, do_ajax_form_med_entry_mob_validate_medicamentos_cb);
  } // do_ajax_form_med_entry_mob_validate_medicamentos

  function do_ajax_form_med_entry_mob_validate_medicamentos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "medicamentos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_med_entry_mob_validate_medicamentos_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_med_entry_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_med_entry_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_ment_date = scAjaxGetFieldText("ment_date");
    var var_sup_id = scAjaxGetFieldSelect("sup_id");
    var var_user_id = scAjaxGetFieldSelect("user_id");
    var var_ment_id = scAjaxGetFieldText("ment_id");
    ...
    scAjaxProcOn();
    x_ajax_form_med_entry_mob_submit_form(var_ment_date, var_sup_id, var_user_id, var_ment_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_med_entry_mob_submit_form_cb);
  } // do_ajax_form_med_entry_mob_submit_form

  function do_ajax_form_med_entry_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("ment_date");
      scAjaxHideErrorDisplay("sup_id");
      scAjaxHideErrorDisplay("user_id");
      scAjaxHideErrorDisplay("medicamentos");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_med_entry_mob_submit_form_cb_after_alert);
  } // do_ajax_form_med_entry_mob_submit_form_cb
  function do_ajax_form_med_entry_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_med_entry_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_med_entrydet_mob"] = "off";

  function do_ajax_form_med_entry_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_med_entry_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_med_entry_mob_navigate_form();
    }
  }

  function perform_ajax_form_med_entry_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("user_id");
    scAjaxHideErrorDisplay("medicamentos");
    var var_ment_id = document.F2.ment_id.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_med_entrydet_mob"] = "on";
    x_ajax_form_med_entry_mob_navigate_form(var_ment_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_med_entry_mob_navigate_form_cb);
  } // do_ajax_form_med_entry_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_med_entry_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_med_entry_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.ment_id.value = scAjaxGetKeyValue("ment_id");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_med_entrydet_mob"] && "nmsc_iframe_liga_form_med_entrydet_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_med_entrydet_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_med_entrydet_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_med_entrydet_mob').contentWindow.nm_move('apl_detalhe', true, '500px');
        document.getElementById('nmsc_iframe_liga_form_med_entrydet_mob').style.height = "500px";
        document.getElementById('nmsc_iframe_liga_form_med_entrydet_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_med_entry_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_med_entry_mob_navigate_form_cb
  function do_ajax_form_med_entry_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_med_entry_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_med_entry_mob_navigate_form_cb_after_alert

  function sc_hide_form_med_entry_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_med_entrydet_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "ment_date";
  ajax_field_list[1] = "sup_id";
  ajax_field_list[2] = "user_id";
  ajax_field_list[3] = "medicamentos";
  ...
  var ajax_error_list = {
    "ment_date": {"label": "Fecha", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sup_id": {"label": "Proveedor", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "user_id": {"label": "Usuario", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "medicamentos": {"label": "Medicamentos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["ment_date"][1] = "ment_date";
  ajax_field_mult["sup_id"][1] = "sup_id";
  ajax_field_mult["user_id"][1] = "user_id";
  ajax_field_mult["medicamentos"][1] = "medicamentos";

  var ajax_field_id = {
    "ment_date": new Array("hidden_field_label_ment_date", "hidden_field_data_ment_date"),
    "sup_id": new Array("hidden_field_label_sup_id", "hidden_field_data_sup_id"),
    "user_id": new Array("hidden_field_label_user_id", "hidden_field_data_user_id"),
    "medicamentos": new Array("hidden_field_label_medicamentos", "hidden_field_data_medicamentos")
  };
