...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["EnfermeriaUNAE_____grid_consultations"]))
   {
      unset($_SESSION['session_sec_aplicacao']["EnfermeriaUNAE_____grid_consultations"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_consultations'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_consultations']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_consultations']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_consultations']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_consultations']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_consultations']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_consultations</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_consultations']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_consultations']['embutida_filho'] as $ind => $sc_init)
          {
