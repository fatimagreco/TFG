...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "con.consul_Date";$Nm_datas[] = "con_consul_Date";$Nm_datas[] = "con.consul_strtime";$Nm_datas[] = "con_consul_strtime";$Nm_datas[] = "con.consul_endtime";$Nm_datas[] = "con_consul_endtime";$Nm_numeric[] = "con_consul_id";$Nm_numeric[] = "con_pati_id";$Nm_numeric[] = "con_user_id";$Nm_numeric[] = "con_consil_sesnum";$Nm_numeric[] = "con_consul_state";$Nm_numeric[] = "p_pati_docnum";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_consul_reason_cond" name="consul_reason_cond" onChange="nm_campos_between(document.getElementById('id_vis_consul_reason'), this, 'consul_reason')">
      ...
      <br><span id="id_hide_consul_reason"  <?php echo $str_hide_consul_reason?>><INPUT  type="text" id="SC_consul_reason" name="consul_reason" value="<?php echo NM_encode_input($consul_reason) ?>" size="50" maxlength="32767" class="scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_p_pati_docnum_cond" name="p_pati_docnum_cond" onChange="nm_campos_between(document.getElementById('id_vis_p_pati_docnum'), this, 'p_pati_docnum')">
      ...
      <br><span id="id_hide_p_pati_docnum"  <?php echo $str_hide_p_pati_docnum?>><INPUT  type="text" id="SC_p_pati_docnum" name="p_pati_docnum" value="<?php echo NM_encode_input($p_pati_docnum) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_pname_cond" name="pname_cond" onChange="nm_campos_between(document.getElementById('id_vis_pname'), this, 'pname')">
      ...
      <br><span id="id_hide_pname"  <?php echo $str_hide_pname?>><INPUT  type="text" id="SC_pname" name="pname" value="<?php echo NM_encode_input($pname) ?>"  size=50 alt="{datatype: 'text', maxLength: 276, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_consul_date_cond" name="consul_date_cond" onChange="nm_campos_between(document.getElementById('id_vis_consul_date'), this, 'consul_date')">
      ...
      <br><span id="id_hide_consul_date"  <?php echo $str_hide_consul_date?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
 ...
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_consul_date"  <?php echo $str_display_consul_date; ?> class="scFilterFieldFontEven">
