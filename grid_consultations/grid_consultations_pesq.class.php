...
class grid_consultations_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_consultations_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_consultations_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_consultations_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "con.consul_Date";$Nm_datas[] = "con_consul_Date";$Nm_datas[] = "con.consul_strtime";$Nm_datas[] = "con_consul_strtime";$Nm_datas[] = "con.consul_endtime";$Nm_datas[] = "con_consul_endtime";
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Atenciones Unidad de Bienestar Universitario</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_consultations/grid_consultations_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_consultations_ajax_search.js"></script>
 <script type="text/javascript" src="grid_consultations_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_consultations_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_consultations']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_consultations']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_consul_reason_cond#NMF#' + search_get_sel_txt('SC_consul_reason_cond') + '@NMF@';
  str_out += 'SC_consul_reason#NMF#' + search_get_text('SC_consul_reason') + '@NMF@';
  str_out += 'SC_p_pati_docnum_cond#NMF#' + search_get_sel_txt('SC_p_pati_docnum_cond') + '@NMF@';
  str_out += 'SC_p_pati_docnum#NMF#' + search_get_text('SC_p_pati_docnum') + '@NMF@';
  str_out += 'SC_pname_cond#NMF#' + search_get_sel_txt('SC_pname_cond') + '@NMF@';
  str_out += 'SC_pname#NMF#' + search_get_text('SC_pname') + '@NMF@';
  str_out += 'SC_consul_date_cond#NMF#' + search_get_sel_txt('SC_consul_date_cond') + '@NMF@';
  str_out += 'SC_consul_date_dia#NMF#' + search_get_sel_txt('SC_consul_date_dia') + '@NMF@';
  str_out += 'SC_consul_date_mes#NMF#' + search_get_sel_txt('SC_consul_date_mes') + '@NMF@';
  str_out += 'SC_consul_date_ano#NMF#' + search_get_sel_txt('SC_consul_date_ano') + '@NMF@';
  str_out += 'SC_consul_date_input_2_dia#NMF#' + search_get_sel_txt('SC_consul_date_input_2_dia') + '@NMF@';
  str_out += 'SC_consul_date_input_2_mes#NMF#' + search_get_sel_txt('SC_consul_date_input_2_mes') + '@NMF@';
  str_out += 'SC_consul_date_input_2_ano#NMF#' + search_get_sel_txt('SC_consul_date_input_2_ano') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">Atenciones Unidad de Bienestar Universitario</div>
...
<?php
   ...
   {
      global 
             $p_pati_docnum_cond, $p_pati_docnum,
             $pname_cond, $pname,
             $consul_date_cond, $consul_date, $consul_date_dia, $consul_date_mes, $consul_date_ano, $consul_date_input_2_dia, $consul_date_input_2_mes, $consul_date_input_2_ano,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $p_pati_docnum = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']['p_pati_docnum']; 
          $p_pati_docnum_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']['p_pati_docnum_cond']; 
          $pname = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']['pname']; 
          $pname_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']['pname_cond']; 
          $consul_date_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']['consul_date_dia']; 
          $consul_date_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']['consul_date_mes']; 
          $consul_date_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']['consul_date_ano']; 
          $consul_date_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']['consul_date_input_2_dia']; 
          $consul_date_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']['consul_date_input_2_mes']; 
          $consul_date_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']['consul_date_input_2_ano']; 
          $consul_date_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']['consul_date_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']['NM_operador']; 
          if (strtoupper($p_pati_docnum_cond) != "II" && strtoupper($p_pati_docnum_cond) != "QP" && strtoupper($p_pati_docnum_cond) != "NP" && strtoupper($p_pati_docnum_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($p_pati_docnum, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($consul_reason_cond) || empty($consul_reason_cond))
      {
         $consul_reason_cond = "eq";
      }
      if (!isset($p_pati_docnum_cond) || empty($p_pati_docnum_cond))
      {
         $p_pati_docnum_cond = "gt";
      }
      if (!isset($pname_cond) || empty($pname_cond))
      {
         $pname_cond = "qp";
      }
      if (!isset($consul_date_cond) || empty($consul_date_cond))
      {
         $consul_date_cond = "eq";
      }
      ...
      $str_hide_consul_reason = (in_array($consul_reason_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_p_pati_docnum = (in_array($p_pati_docnum_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_pname = (in_array($pname_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_consul_date = (in_array($consul_date_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_consul_reason = ('bw' == $consul_reason_cond) ? $display_aberto : $display_fechado;
      $str_display_p_pati_docnum = ('bw' == $p_pati_docnum_cond) ? $display_aberto : $display_fechado;
      $str_display_pname = ('bw' == $pname_cond) ? $display_aberto : $display_fechado;
      $str_display_consul_date = ('bw' == $consul_date_cond) ? $display_aberto : $display_fechado;

      if (!isset($consul_reason) || $consul_reason == "")
      {
          $consul_reason = "";
      }
      if (isset($consul_reason) && !empty($consul_reason))
      {
         $tmp_pos = (is_string($consul_reason)) ? strpos($consul_reason, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $consul_reason = substr($consul_reason, 0, $tmp_pos);
         }
      }
      if (!isset($p_pati_docnum) || $p_pati_docnum == "")
      {
          $p_pati_docnum = "";
      }
      if (isset($p_pati_docnum) && !empty($p_pati_docnum))
      {
         $tmp_pos = (is_string($p_pati_docnum)) ? strpos($p_pati_docnum, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $p_pati_docnum = substr($p_pati_docnum, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = (is_string($pname)) ? strpos($pname, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $pname = substr($pname, 0, $tmp_pos);
         }
      }
      if (!isset($consul_date) || $consul_date == "")
      {
          $consul_date = "";
      }
      if (isset($consul_date) && !empty($consul_date))
      {
         $tmp_pos = (is_string($consul_date)) ? strpos($consul_date, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $consul_date = substr($consul_date, 0, $tmp_pos);
         }
      }
?>
 <?php
...
?>
<?php
   if (is_file("grid_consultations_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_consultations']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_consultations']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_consul_reason_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['consul_reason'])) ? $this->New_label['consul_reason'] : "Motivo"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_consul_reason_cond" name="consul_reason_cond" onChange="nm_campos_between(document.getElementById('id_vis_consul_reason'), this, 'consul_reason')">
       <OPTION value="eq" <?php if ("eq" == $consul_reason_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $consul_reason_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $consul_reason_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $consul_reason_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_consul_reason" <?php echo $str_hide_consul_reason?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['consul_reason'])) ? $this->New_label['consul_reason'] : "Motivo";
 $nmgp_tab_label .= "consul_reason?#?" . $SC_Label . "?@?";
...
?>
<INPUT  type="text" id="SC_consul_reason" name="consul_reason" value="<?php echo NM_encode_input($consul_reason) ?>" size="50" maxlength="32767" class="scFilterObjectOdd">
      ...
      <TD id='SC_p_pati_docnum_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['p_pati_docnum'])) ? $this->New_label['p_pati_docnum'] : "Nro. Documento"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_p_pati_docnum_cond" name="p_pati_docnum_cond" onChange="nm_campos_between(document.getElementById('id_vis_p_pati_docnum'), this, 'p_pati_docnum')">
       <OPTION value="gt" <?php if ("gt" == $p_pati_docnum_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $p_pati_docnum_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $p_pati_docnum_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_p_pati_docnum" <?php echo $str_hide_p_pati_docnum?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['p_pati_docnum'])) ? $this->New_label['p_pati_docnum'] : "Nro. Documento";
 $nmgp_tab_label .= "p_pati_docnum?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_p_pati_docnum" name="p_pati_docnum" value="<?php echo NM_encode_input($p_pati_docnum) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_pname_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['pname'])) ? $this->New_label['pname'] : "Paciente"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_pname_cond" name="pname_cond" onChange="nm_campos_between(document.getElementById('id_vis_pname'), this, 'pname')">
       <OPTION value="qp" <?php if ("qp" == $pname_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $pname_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $pname_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $pname_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_pname" <?php echo $str_hide_pname?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['pname'])) ? $this->New_label['pname'] : "Paciente";
 $nmgp_tab_label .= "pname?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_pname" name="pname" value="<?php echo NM_encode_input($pname) ?>"  size=50 alt="{datatype: 'text', maxLength: 276, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_consul_date_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['consul_date'])) ? $this->New_label['consul_date'] : "Fecha"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_consul_date_cond" name="consul_date_cond" onChange="nm_campos_between(document.getElementById('id_vis_consul_date'), this, 'consul_date')">
       <OPTION value="eq" <?php if ("eq" == $consul_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $consul_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $consul_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $consul_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_consul_date" <?php echo $str_hide_consul_date?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['consul_date'])) ? $this->New_label['consul_date'] : "Fecha";
 $nmgp_tab_label .= "consul_date?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
  ...
  {
?>
<span id='id_date_part_consul_date_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_consul_date_dia" name="consul_date_dia" value="<?php echo NM_encode_input($consul_date_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_consul_date_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_consul_date_mes" name="consul_date_mes" value="<?php echo NM_encode_input($consul_date_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_consul_date_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_consul_date_ano" name="consul_date_ano" value="<?php echo NM_encode_input($consul_date_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
        <SPAN id="id_css_consul_date"  class="scFilterFieldFontEven">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_consul_date"  <?php echo $str_display_consul_date; ?> class="scFilterFieldFontEven">
...
<?php
  ...
  {
?>
<span id='id_date_part_consul_date_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_consul_date_input_2_dia" name="consul_date_input_2_dia" value="<?php echo NM_encode_input($consul_date_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_consul_date_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_consul_date_input_2_mes" name="consul_date_input_2_mes" value="<?php echo NM_encode_input($consul_date_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_consul_date_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_consul_date_input_2_ano" name="consul_date_input_2_ano" value="<?php echo NM_encode_input($consul_date_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if (!$_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.p_pati_docnum_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_p_pati_docnum'), document.F1.p_pati_docnum_cond, 'p_pati_docnum');
   document.F1.p_pati_docnum.value = "";
   document.F1.pname_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_pname'), document.F1.pname_cond, 'pname');
   document.F1.pname.value = "";
   document.F1.consul_date_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_consul_date'), document.F1.consul_date_cond, 'consul_date');
   document.F1.consul_date_dia.value = "";
   document.F1.consul_date_mes.value = "";
   document.F1.consul_date_ano.value = "";
   document.F1.consul_date_input_2_dia.value = "";
   document.F1.consul_date_input_2_mes.value = "";
   document.F1.consul_date_input_2_ano.value = "";
 }
 function SC_carga_evt_jquery()
 {
    $('#SC_consul_date_dia').bind('change', function() {sc_grid_consultations_valida_dia(this)});
    $('#SC_consul_date_input_2_dia').bind('change', function() {sc_grid_consultations_valida_dia(this)});
    $('#SC_consul_date_input_2_mes').bind('change', function() {sc_grid_consultations_valida_mes(this)});
    $('#SC_consul_date_mes').bind('change', function() {sc_grid_consultations_valida_mes(this)});
 }
 function sc_grid_consultations_valida_dia(obj)
 {
 ...
 function sc_grid_consultations_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_consul_reason_cond'] = 'cond';
      $tp_fields['SC_consul_reason'] = 'text';
      $tp_fields['SC_p_pati_docnum_cond'] = 'cond';
      $tp_fields['SC_p_pati_docnum'] = 'text';
      $tp_fields['SC_pname_cond'] = 'cond';
      $tp_fields['SC_pname'] = 'text';
      $tp_fields['SC_consul_date_cond'] = 'cond';
      $tp_fields['SC_consul_date_dia'] = 'text';
      $tp_fields['SC_consul_date_mes'] = 'text';
      $tp_fields['SC_consul_date_ano'] = 'text';
      $tp_fields['SC_consul_date_input_2_dia'] = 'text';
      $tp_fields['SC_consul_date_input_2_mes'] = 'text';
      $tp_fields['SC_consul_date_input_2_ano'] = 'text';
   ...
   {
      global $p_pati_docnum_cond, $p_pati_docnum,
             $pname_cond, $pname,
             $consul_date_cond, $consul_date, $consul_date_dia, $consul_date_mes, $consul_date_ano, $consul_date_input_2_dia, $consul_date_input_2_mes, $consul_date_input_2_ano, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $p_pati_docnum_cond_salva = $p_pati_docnum_cond; 
      if (!isset($p_pati_docnum_input_2) || $p_pati_docnum_input_2 == "")
      {
          $p_pati_docnum_input_2 = $p_pati_docnum;
      }
      $pname_cond_salva = $pname_cond; 
      if (!isset($pname_input_2) || $pname_input_2 == "")
      {
          $pname_input_2 = $pname;
      }
      $consul_date_cond_salva = $consul_date_cond; 
      if (!isset($consul_date_input_2_dia) || $consul_date_input_2_dia == "")
      {
          $consul_date_input_2_dia = $consul_date_dia;
      }
      if (!isset($consul_date_input_2_mes) || $consul_date_input_2_mes == "")
      {
          $consul_date_input_2_mes = $consul_date_mes;
      }
      if (!isset($consul_date_input_2_ano) || $consul_date_input_2_ano == "")
      {
          $consul_date_input_2_ano = $consul_date_ano;
      }
      if ($p_pati_docnum_cond != "in")
      {
          nm_limpa_numero($p_pati_docnum, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']['p_pati_docnum'] = $p_pati_docnum; 
      if (is_array($p_pati_docnum) && !empty($p_pati_docnum))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['Grid_search'][$I_Grid]['val'][0] = $p_pati_docnum;
      }
      elseif ($p_pati_docnum_cond_salva == "nu" || $p_pati_docnum_cond_salva == "nn" || $p_pati_docnum_cond_salva == "ep" || $p_pati_docnum_cond_salva == "ne" || !empty($p_pati_docnum))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['Grid_search'][$I_Grid]['val'][0][0] = $p_pati_docnum;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']['p_pati_docnum_cond'] = $p_pati_docnum_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['Grid_search'][$I_Grid]['cmp'] = "p_pati_docnum"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['Grid_search'][$I_Grid]['opc'] = $p_pati_docnum_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq']['p_pati_docnum'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']['pname'] = $pname; 
      if (is_array($pname) && !empty($pname))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['Grid_search'][$I_Grid]['val'][0] = $pname;
      }
      elseif ($pname_cond_salva == "nu" || $pname_cond_salva == "nn" || $pname_cond_salva == "ep" || $pname_cond_salva == "ne" || !empty($pname))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['Grid_search'][$I_Grid]['val'][0][0] = $pname;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']['pname_cond'] = $pname_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['Grid_search'][$I_Grid]['cmp'] = "pname"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['Grid_search'][$I_Grid]['opc'] = $pname_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq']['pname'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']['consul_date_dia'] = $consul_date_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']['consul_date_mes'] = $consul_date_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']['consul_date_ano'] = $consul_date_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']['consul_date_input_2_dia'] = $consul_date_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']['consul_date_input_2_mes'] = $consul_date_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']['consul_date_input_2_ano'] = $consul_date_input_2_ano; 
      if (!empty($consul_date_dia) || !empty($consul_date_mes) || !empty($consul_date_ano) || $consul_date_cond_salva == "nu" || $consul_date_cond_salva == "nn" || $consul_date_cond_salva == "ep" || $consul_date_cond_salva == "ne")
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $consul_date_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $consul_date_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $consul_date_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $consul_date_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $consul_date_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $consul_date_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']['consul_date_cond'] = $consul_date_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['Grid_search'][$I_Grid]['cmp'] = "consul_date"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['Grid_search'][$I_Grid]['opc'] = $consul_date_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq']['consul_date'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $consul_reason;
      $this->cmp_formatado['consul_reason'] = $Conteudo;
      $Conteudo = $p_pati_docnum;
      if (strtoupper($p_pati_docnum_cond) != "II" && strtoupper($p_pati_docnum_cond) != "QP" && strtoupper($p_pati_docnum_cond) != "NP" && strtoupper($p_pati_docnum_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['p_pati_docnum'] = $Conteudo;
      $Conteudo = $pname;
      $this->cmp_formatado['pname'] = $Conteudo;

      //----- $p_pati_docnum
      $this->Date_part = false;
      if (isset($p_pati_docnum) || $p_pati_docnum_cond == "nu" || $p_pati_docnum_cond == "nn" || $p_pati_docnum_cond == "ep" || $p_pati_docnum_cond == "ne")
      {
         $this->monta_condicao("p.pati_docnum", $p_pati_docnum_cond, $p_pati_docnum, "", "p_pati_docnum", "INT", false);
      }

      //----- $pname
      $this->Date_part = false;
      if (isset($pname) || $pname_cond == "nu" || $pname_cond == "nn" || $pname_cond == "ep" || $pname_cond == "ne")
      {
         $this->monta_condicao("CONCAT(p.pati_lname,\", \",p.pati_name)", $pname_cond, $pname, "", "pname", "VARCHAR", false);
      }

      //----- $consul_date
      $this->Date_part = false;
      if ($consul_date_cond != "bi_TP")
      {
          $consul_date_cond = strtoupper($consul_date_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $consul_date_ano;
          $Dtxt .= $consul_date_mes;
          $Dtxt .= $consul_date_dia;
          $val[0]['ano'] = $consul_date_ano;
          $val[0]['mes'] = $consul_date_mes;
          $val[0]['dia'] = $consul_date_dia;
          if ($consul_date_cond == "BW")
          {
              $val[1]['ano'] = $consul_date_input_2_ano;
              $val[1]['mes'] = $consul_date_input_2_mes;
              $val[1]['dia'] = $consul_date_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DT", "DATE", $consul_date_cond, "", "data");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $consul_date = $val[0];
          $this->cmp_formatado['consul_date'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']['consul_date'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['consul_date'], "YYYY-MM-DD");
          $this->cmp_formatado['consul_date'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($consul_date_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $consul_date_input_2     = $val[1];
              $this->cmp_formatado['consul_date_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']['consul_date_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['consul_date_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['consul_date_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $consul_date_cond == "NU" || $consul_date_cond == "NN"|| $consul_date_cond == "EP"|| $consul_date_cond == "NE")
          {
              $this->monta_condicao("con.consul_Date", $consul_date_cond, $consul_date, $consul_date_input_2, 'consul_date', 'DATE');
          }
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq']['consul_date']['label'] = $nmgp_tab_label['consul_date'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq']['consul_date']['descr'] = $nmgp_tab_label['consul_date'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['grid_pesq']['consul_date']['hint']  = $nmgp_tab_label['consul_date'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['where_pesq_fast'])) 
       {
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['where_pesq_fast'] . ")";
           }
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['where_pesq_interativ'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['where_pesq_interativ'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['where_pesq'] = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['where_pesq_interativ'];
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consultations']['cond_pesq'] .= $this->NM_operador;
