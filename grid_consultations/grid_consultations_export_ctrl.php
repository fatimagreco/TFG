<?php
@session_start() ;
$_SESSION['scriptcase']['grid_consultations']['sc_process_barr'] = true;
require_once('../grid_consultations/index.php');
unset($_SESSION['scriptcase']['grid_consultations']['sc_process_barr']);
$ExportCtrl = new grid_consultations_export_control;
$ExportCtrl->Export_barr();

class grid_consultations_export_control
{
