  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_med_entrydet" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_med_entrydet_form();
	}
...
?>
  ...
  // ---------- Validate mpres_id_
  function do_ajax_form_med_entrydet_validate_mpres_id_(iNumLinha)
  {
    var nomeCampo_mpres_id_ = "mpres_id_" + iNumLinha;
    var var_mpres_id_ = scAjaxGetFieldSelect(nomeCampo_mpres_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_med_entrydet_validate_mpres_id_(var_mpres_id_, iNumLinha, var_script_case_init, do_ajax_form_med_entrydet_validate_mpres_id__cb);
  } // do_ajax_form_med_entrydet_validate_mpres_id_

  function do_ajax_form_med_entrydet_validate_mpres_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "mpres_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "mpres_id_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "mpres_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "mpres_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_med_entrydet_validate_mpres_id__cb

  // ---------- Validate med_dosis_
  function do_ajax_form_med_entrydet_validate_med_dosis_(iNumLinha)
  {
  } // do_ajax_form_med_entrydet_validate_med_dosis_

  function do_ajax_form_med_entrydet_validate_med_dosis__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "med_dosis_" + iLineNumber;
    }
    else
    {
      sFieldValid = "med_dosis_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "med_dosis_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "med_dosis_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_med_entrydet_validate_med_dosis__cb

  // ---------- Validate medet_cant_
  function do_ajax_form_med_entrydet_validate_medet_cant_(iNumLinha)
  {
    var nomeCampo_medet_cant_ = "medet_cant_" + iNumLinha;
    var var_medet_cant_ = scAjaxGetFieldText(nomeCampo_medet_cant_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_med_entrydet_validate_medet_cant_(var_medet_cant_, iNumLinha, var_script_case_init, do_ajax_form_med_entrydet_validate_medet_cant__cb);
  } // do_ajax_form_med_entrydet_validate_medet_cant_

  function do_ajax_form_med_entrydet_validate_medet_cant__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "medet_cant_" + iLineNumber;
    }
    else
    {
      sFieldValid = "medet_cant_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "medet_cant_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "medet_cant_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_med_entrydet_validate_medet_cant__cb

  // ---------- Validate medet_dosis_
  function do_ajax_form_med_entrydet_validate_medet_dosis_(iNumLinha)
  {
    var nomeCampo_medet_dosis_ = "medet_dosis_" + iNumLinha;
    var var_medet_dosis_ = scAjaxGetFieldText(nomeCampo_medet_dosis_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_med_entrydet_validate_medet_dosis_(var_medet_dosis_, iNumLinha, var_script_case_init, do_ajax_form_med_entrydet_validate_medet_dosis__cb);
  } // do_ajax_form_med_entrydet_validate_medet_dosis_

  function do_ajax_form_med_entrydet_validate_medet_dosis__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "medet_dosis_" + iLineNumber;
    }
    else
    {
      sFieldValid = "medet_dosis_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "medet_dosis_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "medet_dosis_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_med_entrydet_validate_medet_dosis__cb

  // ---------- Event onchange medet_cant_
  function do_ajax_form_med_entrydet_event_medet_cant__onchange(iSeqForm)
  {
    var var_medet_dosis_ = scAjaxGetFieldText("medet_dosis_" + iSeqForm);
    var var_med_dosis_ = scAjaxGetFieldHidden("med_dosis_" + iSeqForm);
    var var_medet_cant_ = scAjaxGetFieldText("medet_cant_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_med_entrydet_event_medet_cant__onchange(var_medet_dosis_, var_med_dosis_, var_medet_cant_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_med_entrydet_event_medet_cant__onchange_cb);
  } // do_ajax_form_med_entrydet_event_medet_cant__onchange

  function do_ajax_form_med_entrydet_event_medet_cant__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_med_entrydet_event_medet_cant__onchange_cb_after_alert);
  } // do_ajax_form_med_entrydet_event_medet_cant__onchange_cb
  function do_ajax_form_med_entrydet_event_medet_cant__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_med_entrydet_event_medet_cant__onchange_cb_after_alert

  // ---------- Event onchange mpres_id_
  function do_ajax_form_med_entrydet_event_mpres_id__onchange(iSeqForm)
  {
    var var_medet_dosis_ = scAjaxGetFieldText("medet_dosis_" + iSeqForm);
    var var_med_dosis_ = scAjaxGetFieldHidden("med_dosis_" + iSeqForm);
    var var_medet_cant_ = scAjaxGetFieldText("medet_cant_" + iSeqForm);
    var var_mpres_id_ = scAjaxGetFieldSelect("mpres_id_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_med_entrydet_event_mpres_id__onchange(var_medet_dosis_, var_med_dosis_, var_medet_cant_, var_mpres_id_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_med_entrydet_event_mpres_id__onchange_cb);
  } // do_ajax_form_med_entrydet_event_mpres_id__onchange

  function do_ajax_form_med_entrydet_event_mpres_id__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_med_entrydet_event_mpres_id__onchange_cb_after_alert);
  } // do_ajax_form_med_entrydet_event_mpres_id__onchange_cb
  function do_ajax_form_med_entrydet_event_mpres_id__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_med_entrydet_event_mpres_id__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_med_entrydet_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_med_entrydet_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_med_entrydet_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_med_entrydet_add_new_line_cb);
  } // do_ajax_form_med_entrydet_add_new_line

  function do_ajax_form_med_entrydet_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_med_entrydet_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_med_entrydet_backup_line(iNumLinha)
  {
    var var_medet_id_ = scAjaxGetFieldText("medet_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_med_entrydet_backup_line(var_medet_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_med_entrydet_backup_line_cb);
  } // do_ajax_form_med_entrydet_backup_line

  function do_ajax_form_med_entrydet_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_med_entrydet_backup_line_cb

  function do_ajax_form_med_entrydet_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_med_entrydet_cancel_insert

  function do_ajax_form_med_entrydet_cancel_update(iSeqVert)
  {
    do_ajax_form_med_entrydet_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_med_entrydet_cancel_update

  function do_ajax_form_med_entrydet_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_med_entrydet_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_med_entrydet_table_refresh()
  {
    var var_medet_id_ = document.F2.medet_id_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_med_entrydet_table_refresh(var_medet_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_med_entrydet_table_refresh_cb);
  } //  do_ajax_form_med_entrydet_table_refresh

  function do_ajax_form_med_entrydet_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.medet_id_.value = scAjaxGetKeyValue("medet_id_");
    ...
    scAjaxAlert(do_ajax_form_med_entrydet_table_refresh_cb_after_alert);
  } // do_ajax_form_med_entrydet_table_refresh_cb
  function do_ajax_form_med_entrydet_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_med_entrydet_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_med_entrydet_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_med_entrydet_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_mpres_id_ = scAjaxGetFieldSelect("mpres_id_" + iNumLinha);
    var var_med_dosis_ = scAjaxGetFieldHidden("med_dosis_" + iNumLinha);
    var var_medet_cant_ = scAjaxGetFieldText("medet_cant_" + iNumLinha);
    var var_medet_dosis_ = scAjaxGetFieldText("medet_dosis_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_med_entrydet_submit_form(var_mpres_id_, var_med_dosis_, var_medet_cant_, var_medet_dosis_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_med_entrydet_submit_form_cb);
  } // do_ajax_form_med_entrydet_submit_form

  function do_ajax_form_med_entrydet_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("mpres_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("med_dosis_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("medet_cant_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("medet_dosis_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_med_entrydet_submit_form_cb_after_alert);
  } // do_ajax_form_med_entrydet_submit_form_cb
  function do_ajax_form_med_entrydet_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_med_entrydet_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_med_entrydet_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_med_entrydet_navigate_form, function() {});
    } else {
      perform_ajax_form_med_entrydet_navigate_form();
    }
  }

  function perform_ajax_form_med_entrydet_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_med_entrydet_cancel_insert(sc_form_med_entrydet_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("mpres_id_" + iNavForm);
      scAjaxHideErrorDisplay("med_dosis_" + iNavForm);
      scAjaxHideErrorDisplay("medet_cant_" + iNavForm);
      scAjaxHideErrorDisplay("medet_dosis_" + iNavForm);
    }
    var var_medet_id_ = document.F2.medet_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_med_entrydet_navigate_form(var_medet_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_med_entrydet_navigate_form_cb);
  } // do_ajax_form_med_entrydet_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_med_entrydet']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_med_entrydet_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.medet_id_.value = scAjaxGetKeyValue("medet_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_med_entrydet_navigate_form_cb_after_alert);
  } // do_ajax_form_med_entrydet_navigate_form_cb
  function do_ajax_form_med_entrydet_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_med_entrydet_navigate_form_cb_after_alert

    function sc_form_med_entrydet_get_last_line_number()
    {
    ...
    } //sc_form_med_entrydet_get_last_line_number

  function sc_hide_form_med_entrydet_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "mpres_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "med_dosis_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "medet_cant_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "medet_dosis_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["mpres_id_" + iNumLinha] = {"label": "Medicamento<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["med_dosis_" + iNumLinha] = {"label": "Dosis<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["medet_cant_" + iNumLinha] = {"label": "Cantidad<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["medet_dosis_" + iNumLinha] = {"label": "Cantidad Dosis<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["mpres_id_"][iNumLinha] = "mpres_id_" + iNumLinha;
    ajax_field_mult["med_dosis_"][iNumLinha] = "med_dosis_" + iNumLinha;
    ajax_field_mult["medet_cant_"][iNumLinha] = "medet_cant_" + iNumLinha;
    ajax_field_mult["medet_dosis_"][iNumLinha] = "medet_dosis_" + iNumLinha;
    ajax_field_id["mpres_id_" + iNumLinha] = new Array("hidden_field_label_mpres_id_", "hidden_field_data_mpres_id_" + iNumLinha);
    ajax_field_id["med_dosis_" + iNumLinha] = new Array("hidden_field_label_med_dosis_", "hidden_field_data_med_dosis_" + iNumLinha);
    ajax_field_id["medet_cant_" + iNumLinha] = new Array("hidden_field_label_medet_cant_", "hidden_field_data_medet_cant_" + iNumLinha);
    ajax_field_id["medet_dosis_" + iNumLinha] = new Array("hidden_field_label_medet_dosis_", "hidden_field_data_medet_dosis_" + iNumLinha);
    ajax_error_count["mpres_id_" + iNumLinha] = "off";
    ajax_error_count["med_dosis_" + iNumLinha] = "off";
    ajax_error_count["medet_cant_" + iNumLinha] = "off";
    ajax_error_count["medet_dosis_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["mpres_id_" + iNumLinha] = "off";
    ajax_read_only["med_dosis_" + iNumLinha] = "off";
    ajax_read_only["medet_cant_" + iNumLinha] = "on";
    ajax_read_only["medet_dosis_" + iNumLinha] = "on";
<?php
}
else
{
?>
    ajax_read_only["mpres_id_" + iNumLinha] = "on";
    ajax_read_only["med_dosis_" + iNumLinha] = "on";
    ajax_read_only["medet_cant_" + iNumLinha] = "on";
    ajax_read_only["medet_dosis_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["mpres_id_" + iNumLinha] = null;
    ajax_error_list["med_dosis_" + iNumLinha] = null;
    ajax_error_list["medet_cant_" + iNumLinha] = null;
    ajax_error_list["medet_dosis_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "mpres_id_": new Array(),
    "med_dosis_": new Array(),
    "medet_cant_": new Array(),
    "medet_dosis_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["mpres_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["mpres_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["mpres_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["mpres_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["mpres_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["med_dosis_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["med_dosis_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["med_dosis_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["med_dosis_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["med_dosis_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["medet_cant_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["medet_cant_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["medet_cant_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["medet_cant_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["medet_cant_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["medet_dosis_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["medet_dosis_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["medet_dosis_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["medet_dosis_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["medet_dosis_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['mpres_id_'])) ? $this->nmgp_cmp_readonly['mpres_id_'] : 'off';
?>
    scAjaxFieldRead("mpres_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['med_dosis_'])) ? $this->nmgp_cmp_readonly['med_dosis_'] : 'off';
?>
    scAjaxFieldRead("med_dosis_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['medet_cant_'])) ? $this->nmgp_cmp_readonly['medet_cant_'] : 'on';
?>
    scAjaxFieldRead("medet_cant_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['medet_dosis_'])) ? $this->nmgp_cmp_readonly['medet_dosis_'] : 'on';
?>
    scAjaxFieldRead("medet_dosis_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("mpres_id_" + iSeq, "on");
    scAjaxFieldRead("med_dosis_" + iSeq, "on");
    scAjaxFieldRead("medet_cant_" + iSeq, "on");
    scAjaxFieldRead("medet_dosis_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["mpres_id_" + iRow] || "on" == ajax_error_count["med_dosis_" + iRow] || "on" == ajax_error_count["medet_cant_" + iRow] || "on" == ajax_error_count["medet_dosis_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_mpres_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_med_dosis_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_medet_cant_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_medet_dosis_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["mpres_id_" + iRow] && "off" == ajax_error_count["med_dosis_" + iRow] && "off" == ajax_error_count["medet_cant_" + iRow] && "off" == ajax_error_count["medet_dosis_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["mpres_id_" + iRow] = "off";
        ajax_error_count["med_dosis_" + iRow] = "off";
        ajax_error_count["medet_cant_" + iRow] = "off";
        ajax_error_count["medet_dosis_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_mpres_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_med_dosis_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_medet_cant_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_medet_dosis_" + iRow).removeClass("scFormErrorLine");
    }
  }
