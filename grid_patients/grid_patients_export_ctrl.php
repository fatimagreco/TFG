<?php
@session_start() ;
$_SESSION['scriptcase']['grid_patients']['sc_process_barr'] = true;
require_once('../grid_patients/index.php');
unset($_SESSION['scriptcase']['grid_patients']['sc_process_barr']);
$ExportCtrl = new grid_patients_export_control;
$ExportCtrl->Export_barr();

class grid_patients_export_control
{
