...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["EnfermeriaUNAE_____lista_pacientes"]))
   {
      unset($_SESSION['session_sec_aplicacao']["EnfermeriaUNAE_____lista_pacientes"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_pacientes'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['lista_pacientes']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['lista_pacientes']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['lista_pacientes']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['lista_pacientes']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['lista_pacientes']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['lista_pacientes']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['lista_pacientes']['embutida_filho'] as $ind => $sc_init)
          {
