...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "pati_bod";$Nm_numeric[] = "pati_id";$Nm_numeric[] = "pati_docnum";$Nm_numeric[] = "pati_phone";$Nm_numeric[] = "pati_caryerar";$Nm_numeric[] = "pati_carsem";$Nm_numeric[] = "btyp_id";$Nm_numeric[] = "gerens_id";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_pati_id_cond" name="pati_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_pati_id'), this, 'pati_id')">
      ...
      <br><span id="id_hide_pati_id"  <?php echo $str_hide_pati_id?>><INPUT  type="text" id="SC_pati_id" name="pati_id" value="<?php echo NM_encode_input($pati_id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_pati_name_cond" name="pati_name_cond" onChange="nm_campos_between(document.getElementById('id_vis_pati_name'), this, 'pati_name')">
      ...
      <br><span id="id_hide_pati_name"  <?php echo $str_hide_pati_name?>><?php
      if ($pati_name != "")
      {
      $pati_name_look = (is_string($pati_name) ? substr($this->Db->qstr($pati_name), 1, -1) : $pati_name); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_pati_docnum_cond" name="pati_docnum_cond" onChange="nm_campos_between(document.getElementById('id_vis_pati_docnum'), this, 'pati_docnum')">
      ...
      <br><span id="id_hide_pati_docnum"  <?php echo $str_hide_pati_docnum?>><INPUT  type="text" id="SC_pati_docnum" name="pati_docnum" value="<?php echo NM_encode_input($pati_docnum) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_pati_bod_cond" name="pati_bod_cond" onChange="nm_campos_between(document.getElementById('id_vis_pati_bod'), this, 'pati_bod')">
      ...
      <br><span id="id_hide_pati_bod"  <?php echo $str_hide_pati_bod?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
 ...
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_pati_bod"  <?php echo $str_display_pati_bod; ?> class="scFilterFieldFontEven">
