<?php
@session_start() ;
$_SESSION['scriptcase']['lista_pacientes']['sc_process_barr'] = true;
require_once('../lista_pacientes/index.php');
unset($_SESSION['scriptcase']['lista_pacientes']['sc_process_barr']);
$ExportCtrl = new lista_pacientes_export_control;
$ExportCtrl->Export_barr();

class lista_pacientes_export_control
{
