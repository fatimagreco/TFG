...
<?php
   ...
   $Ord_Cmp = new lista_pacientes_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class lista_pacientes_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['lista_pacientes']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['lista_pacientes']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["pati_docnum"]   = (isset($_SESSION['sc_session'][$sc_init]['lista_pacientes']['labels']["pati_docnum"])) ? $_SESSION['sc_session'][$sc_init]['lista_pacientes']['labels']["pati_docnum"] : "Nro. Documento";
   $tab_ger_campos['pati_name'] = "on";
   $tab_def_campos['pati_name'] = "pati_name";
   $tab_labels["pati_name"]   = (isset($_SESSION['sc_session'][$sc_init]['lista_pacientes']['labels']["pati_name"])) ? $_SESSION['sc_session'][$sc_init]['lista_pacientes']['labels']["pati_name"] : "Paciente";
   $tab_ger_campos['pati_bod'] = "on";
   $tab_def_campos['pati_bod'] = "pati_bod";
   $tab_labels["pati_bod"]   = (isset($_SESSION['sc_session'][$sc_init]['lista_pacientes']['labels']["pati_bod"])) ? $_SESSION['sc_session'][$sc_init]['lista_pacientes']['labels']["pati_bod"] : "Fecha de Nacimiento";
   $tab_ger_campos['pati_phone'] = "on";
   $tab_def_campos['pati_phone'] = "pati_phone";
   $tab_labels["pati_phone"]   = (isset($_SESSION['sc_session'][$sc_init]['lista_pacientes']['labels']["pati_phone"])) ? $_SESSION['sc_session'][$sc_init]['lista_pacientes']['labels']["pati_phone"] : "Teléfono";
   $tab_ger_campos['btyp_id'] = "on";
   $tab_def_campos['btyp_id'] = "btyp_id";
   $tab_labels["btyp_id"]   = (isset($_SESSION['sc_session'][$sc_init]['lista_pacientes']['labels']["btyp_id"])) ? $_SESSION['sc_session'][$sc_init]['lista_pacientes']['labels']["btyp_id"] : "Btyp Id";
   $tab_ger_campos['pati_career'] = "on";
   $tab_def_campos['pati_career'] = "pati_career";
   $tab_labels["pati_career"]   = (isset($_SESSION['sc_session'][$sc_init]['lista_pacientes']['labels']["pati_career"])) ? $_SESSION['sc_session'][$sc_init]['lista_pacientes']['labels']["pati_career"] : "Carrera";
   $tab_ger_campos['gerens_id'] = "on";
   $tab_def_campos['gerens_id'] = "gerens_id";
   $tab_labels["gerens_id"]   = (isset($_SESSION['sc_session'][$sc_init]['lista_pacientes']['labels']["gerens_id"])) ? $_SESSION['sc_session'][$sc_init]['lista_pacientes']['labels']["gerens_id"] : "Genero";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['lista_pacientes']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['lista_pacientes']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['lista_pacientes']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['lista_pacientes']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['lista_pacientes']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['lista_pacientes']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['lista_pacientes']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['lista_pacientes']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['lista_pacientes']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['lista_pacientes']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['lista_pacientes']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['lista_pacientes']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "lista_pacientes_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['lista_pacientes']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['lista_pacientes']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['lista_pacientes']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['lista_pacientes']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['lista_pacientes']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
