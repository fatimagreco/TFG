...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        if (!SC_Proc_Mobile) {
            document.getElementById('nmsc_iframe_liga_A_lista_pacientes').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_E_lista_pacientes').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_D_lista_pacientes').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_B_lista_pacientes').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_A_lista_pacientes').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_E_lista_pacientes').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_D_lista_pacientes').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_B_lista_pacientes').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_A_lista_pacientes').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_E_lista_pacientes').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_D_lista_pacientes').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_B_lista_pacientes').style.width  = '0px';
        }
        if (oResp["setValue"]) {
