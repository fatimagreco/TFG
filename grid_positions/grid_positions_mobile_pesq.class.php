...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "pos_id";$Nm_numeric[] = "pos_id";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_pos_id_cond" name="pos_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_pos_id'), this, 'pos_id')">
      ...
      <br><span id="id_hide_pos_id"  <?php echo $str_hide_pos_id?>><INPUT  type="text" id="SC_pos_id" name="pos_id" value="<?php echo NM_encode_input($pos_id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_pos_name_cond" name="pos_name_cond" onChange="nm_campos_between(document.getElementById('id_vis_pos_name'), this, 'pos_name')">
      ...
      <br><span id="id_hide_pos_name"  <?php echo $str_hide_pos_name?>><?php
      if ($pos_name != "")
      {
      $pos_name_look = (is_string($pos_name) ? substr($this->Db->qstr($pos_name), 1, -1) : $pos_name); 
      $nmgp_def_dados = array(); 
