<?php
@session_start() ;
$_SESSION['scriptcase']['grid_positions']['sc_process_barr'] = true;
require_once('../grid_positions/index.php');
unset($_SESSION['scriptcase']['grid_positions']['sc_process_barr']);
$ExportCtrl = new grid_positions_export_control;
$ExportCtrl->Export_barr();

class grid_positions_export_control
{
