...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["EnfermeriaUNAE_____grid_positions"]))
   {
      unset($_SESSION['session_sec_aplicacao']["EnfermeriaUNAE_____grid_positions"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_positions'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_positions']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_positions']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_positions']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_positions']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_positions']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_positions']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_positions']['embutida_filho'] as $ind => $sc_init)
          {
