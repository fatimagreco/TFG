...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "btyp_id";$Nm_numeric[] = "btyp_id";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_btyp_id_cond" name="btyp_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_btyp_id'), this, 'btyp_id')">
      ...
      <br><span id="id_hide_btyp_id"  <?php echo $str_hide_btyp_id?>><INPUT  type="text" id="SC_btyp_id" name="btyp_id" value="<?php echo NM_encode_input($btyp_id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_btyp_name_cond" name="btyp_name_cond" onChange="nm_campos_between(document.getElementById('id_vis_btyp_name'), this, 'btyp_name')">
      ...
      <br><span id="id_hide_btyp_name"  <?php echo $str_hide_btyp_name?>><?php
      if ($btyp_name != "")
      {
      $btyp_name_look = (is_string($btyp_name) ? substr($this->Db->qstr($btyp_name), 1, -1) : $btyp_name); 
      $nmgp_def_dados = array(); 
