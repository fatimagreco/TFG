...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["EnfermeriaUNAE_____grid_bloodtypes"]))
   {
      unset($_SESSION['session_sec_aplicacao']["EnfermeriaUNAE_____grid_bloodtypes"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_bloodtypes'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_bloodtypes']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_bloodtypes']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_bloodtypes']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_bloodtypes']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_bloodtypes']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_bloodtypes']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_bloodtypes']['embutida_filho'] as $ind => $sc_init)
          {
