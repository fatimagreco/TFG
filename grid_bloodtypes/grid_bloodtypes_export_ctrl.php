<?php
@session_start() ;
$_SESSION['scriptcase']['grid_bloodtypes']['sc_process_barr'] = true;
require_once('../grid_bloodtypes/index.php');
unset($_SESSION['scriptcase']['grid_bloodtypes']['sc_process_barr']);
$ExportCtrl = new grid_bloodtypes_export_control;
$ExportCtrl->Export_barr();

class grid_bloodtypes_export_control
{
