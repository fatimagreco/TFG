  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_anamnesis_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_anamnesis_mob_form();
	}
...
?>
  ...
  // ---------- Validate anam_date
  function do_ajax_form_anamnesis_mob_validate_anam_date()
  {
    var nomeCampo_anam_date = "anam_date";
    var var_anam_date = scAjaxGetFieldText(nomeCampo_anam_date);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_anam_date = scAjaxGetFieldText(nomeCampo_anam_date);
      x_ajax_form_anamnesis_mob_validate_anam_date(var_anam_date, var_script_case_init, do_ajax_form_anamnesis_mob_validate_anam_date_cb);
    }, 200);
  } // do_ajax_form_anamnesis_mob_validate_anam_date

  function do_ajax_form_anamnesis_mob_validate_anam_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "anam_date";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_mob_validate_anam_date_cb

  // ---------- Validate anam_strtime
  function do_ajax_form_anamnesis_mob_validate_anam_strtime()
  {
    var nomeCampo_anam_strtime = "anam_strtime";
    var var_anam_strtime = scAjaxGetFieldText(nomeCampo_anam_strtime);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_mob_validate_anam_strtime(var_anam_strtime, var_script_case_init, do_ajax_form_anamnesis_mob_validate_anam_strtime_cb);
  } // do_ajax_form_anamnesis_mob_validate_anam_strtime

  function do_ajax_form_anamnesis_mob_validate_anam_strtime_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "anam_strtime";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_mob_validate_anam_strtime_cb

  // ---------- Validate anam_reason
  function do_ajax_form_anamnesis_mob_validate_anam_reason()
  {
    var nomeCampo_anam_reason = "anam_reason";
    var var_anam_reason = scAjaxGetFieldText(nomeCampo_anam_reason);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_mob_validate_anam_reason(var_anam_reason, var_script_case_init, do_ajax_form_anamnesis_mob_validate_anam_reason_cb);
  } // do_ajax_form_anamnesis_mob_validate_anam_reason

  function do_ajax_form_anamnesis_mob_validate_anam_reason_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "anam_reason";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_mob_validate_anam_reason_cb

  // ---------- Validate anam_diag
  function do_ajax_form_anamnesis_mob_validate_anam_diag()
  {
    var nomeCampo_anam_diag = "anam_diag";
    var var_anam_diag = scAjaxGetFieldText(nomeCampo_anam_diag);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_mob_validate_anam_diag(var_anam_diag, var_script_case_init, do_ajax_form_anamnesis_mob_validate_anam_diag_cb);
  } // do_ajax_form_anamnesis_mob_validate_anam_diag

  function do_ajax_form_anamnesis_mob_validate_anam_diag_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "anam_diag";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_mob_validate_anam_diag_cb

  // ---------- Validate pati_id
  function do_ajax_form_anamnesis_mob_validate_pati_id()
  {
    var nomeCampo_pati_id = "pati_id";
    var var_pati_id = scAjaxGetFieldSelect(nomeCampo_pati_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_mob_validate_pati_id(var_pati_id, var_script_case_init, do_ajax_form_anamnesis_mob_validate_pati_id_cb);
  } // do_ajax_form_anamnesis_mob_validate_pati_id

  function do_ajax_form_anamnesis_mob_validate_pati_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pati_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_mob_validate_pati_id_cb

  // ---------- Validate pat_bod
  function do_ajax_form_anamnesis_mob_validate_pat_bod()
  {
    var nomeCampo_pat_bod = "pat_bod";
    var var_pat_bod = scAjaxGetFieldText(nomeCampo_pat_bod);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_mob_validate_pat_bod(var_pat_bod, var_script_case_init, do_ajax_form_anamnesis_mob_validate_pat_bod_cb);
  } // do_ajax_form_anamnesis_mob_validate_pat_bod

  function do_ajax_form_anamnesis_mob_validate_pat_bod_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pat_bod";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_mob_validate_pat_bod_cb

  // ---------- Validate pat_name
  function do_ajax_form_anamnesis_mob_validate_pat_name()
  {
    var nomeCampo_pat_name = "pat_name";
    var var_pat_name = scAjaxGetFieldText(nomeCampo_pat_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_mob_validate_pat_name(var_pat_name, var_script_case_init, do_ajax_form_anamnesis_mob_validate_pat_name_cb);
  } // do_ajax_form_anamnesis_mob_validate_pat_name

  function do_ajax_form_anamnesis_mob_validate_pat_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pat_name";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_mob_validate_pat_name_cb

  // ---------- Validate pat_lname
  function do_ajax_form_anamnesis_mob_validate_pat_lname()
  {
    var nomeCampo_pat_lname = "pat_lname";
    var var_pat_lname = scAjaxGetFieldText(nomeCampo_pat_lname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_mob_validate_pat_lname(var_pat_lname, var_script_case_init, do_ajax_form_anamnesis_mob_validate_pat_lname_cb);
  } // do_ajax_form_anamnesis_mob_validate_pat_lname

  function do_ajax_form_anamnesis_mob_validate_pat_lname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pat_lname";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_mob_validate_pat_lname_cb

  // ---------- Validate pat_blood
  function do_ajax_form_anamnesis_mob_validate_pat_blood()
  {
    var nomeCampo_pat_blood = "pat_blood";
    var var_pat_blood = scAjaxGetFieldSelect(nomeCampo_pat_blood);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_mob_validate_pat_blood(var_pat_blood, var_script_case_init, do_ajax_form_anamnesis_mob_validate_pat_blood_cb);
  } // do_ajax_form_anamnesis_mob_validate_pat_blood

  function do_ajax_form_anamnesis_mob_validate_pat_blood_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pat_blood";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_mob_validate_pat_blood_cb

  // ---------- Validate anam_career
  function do_ajax_form_anamnesis_mob_validate_anam_career()
  {
    var nomeCampo_anam_career = "anam_career";
    var var_anam_career = scAjaxGetFieldText(nomeCampo_anam_career);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_mob_validate_anam_career(var_anam_career, var_script_case_init, do_ajax_form_anamnesis_mob_validate_anam_career_cb);
  } // do_ajax_form_anamnesis_mob_validate_anam_career

  function do_ajax_form_anamnesis_mob_validate_anam_career_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "anam_career";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_mob_validate_anam_career_cb

  // ---------- Validate pat_gerens
  function do_ajax_form_anamnesis_mob_validate_pat_gerens()
  {
    var nomeCampo_pat_gerens = "pat_gerens";
    var var_pat_gerens = scAjaxGetFieldRadio(nomeCampo_pat_gerens);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_mob_validate_pat_gerens(var_pat_gerens, var_script_case_init, do_ajax_form_anamnesis_mob_validate_pat_gerens_cb);
  } // do_ajax_form_anamnesis_mob_validate_pat_gerens

  function do_ajax_form_anamnesis_mob_validate_pat_gerens_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pat_gerens";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_mob_validate_pat_gerens_cb

  // ---------- Validate pat_phone
  function do_ajax_form_anamnesis_mob_validate_pat_phone()
  {
    var nomeCampo_pat_phone = "pat_phone";
    var var_pat_phone = scAjaxGetFieldText(nomeCampo_pat_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_mob_validate_pat_phone(var_pat_phone, var_script_case_init, do_ajax_form_anamnesis_mob_validate_pat_phone_cb);
  } // do_ajax_form_anamnesis_mob_validate_pat_phone

  function do_ajax_form_anamnesis_mob_validate_pat_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pat_phone";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_mob_validate_pat_phone_cb

  // ---------- Validate anam_carsem
  function do_ajax_form_anamnesis_mob_validate_anam_carsem()
  {
    var nomeCampo_anam_carsem = "anam_carsem";
    var var_anam_carsem = scAjaxGetFieldText(nomeCampo_anam_carsem);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_mob_validate_anam_carsem(var_anam_carsem, var_script_case_init, do_ajax_form_anamnesis_mob_validate_anam_carsem_cb);
  } // do_ajax_form_anamnesis_mob_validate_anam_carsem

  function do_ajax_form_anamnesis_mob_validate_anam_carsem_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "anam_carsem";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_mob_validate_anam_carsem_cb

  // ---------- Validate anam_bpsys
  function do_ajax_form_anamnesis_mob_validate_anam_bpsys()
  {
    var nomeCampo_anam_bpsys = "anam_bpsys";
    var var_anam_bpsys = scAjaxGetFieldText(nomeCampo_anam_bpsys);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_mob_validate_anam_bpsys(var_anam_bpsys, var_script_case_init, do_ajax_form_anamnesis_mob_validate_anam_bpsys_cb);
  } // do_ajax_form_anamnesis_mob_validate_anam_bpsys

  function do_ajax_form_anamnesis_mob_validate_anam_bpsys_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "anam_bpsys";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_mob_validate_anam_bpsys_cb

  // ---------- Validate anam_bpdia
  function do_ajax_form_anamnesis_mob_validate_anam_bpdia()
  {
    var nomeCampo_anam_bpdia = "anam_bpdia";
    var var_anam_bpdia = scAjaxGetFieldText(nomeCampo_anam_bpdia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_mob_validate_anam_bpdia(var_anam_bpdia, var_script_case_init, do_ajax_form_anamnesis_mob_validate_anam_bpdia_cb);
  } // do_ajax_form_anamnesis_mob_validate_anam_bpdia

  function do_ajax_form_anamnesis_mob_validate_anam_bpdia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "anam_bpdia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_mob_validate_anam_bpdia_cb

  // ---------- Validate anam_hbeat
  function do_ajax_form_anamnesis_mob_validate_anam_hbeat()
  {
    var nomeCampo_anam_hbeat = "anam_hbeat";
    var var_anam_hbeat = scAjaxGetFieldText(nomeCampo_anam_hbeat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_mob_validate_anam_hbeat(var_anam_hbeat, var_script_case_init, do_ajax_form_anamnesis_mob_validate_anam_hbeat_cb);
  } // do_ajax_form_anamnesis_mob_validate_anam_hbeat

  function do_ajax_form_anamnesis_mob_validate_anam_hbeat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "anam_hbeat";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_mob_validate_anam_hbeat_cb

  // ---------- Validate anam_temp
  function do_ajax_form_anamnesis_mob_validate_anam_temp()
  {
    var nomeCampo_anam_temp = "anam_temp";
    var var_anam_temp = scAjaxGetFieldText(nomeCampo_anam_temp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_mob_validate_anam_temp(var_anam_temp, var_script_case_init, do_ajax_form_anamnesis_mob_validate_anam_temp_cb);
  } // do_ajax_form_anamnesis_mob_validate_anam_temp

  function do_ajax_form_anamnesis_mob_validate_anam_temp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "anam_temp";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_mob_validate_anam_temp_cb

  // ---------- Validate anam_oxy
  function do_ajax_form_anamnesis_mob_validate_anam_oxy()
  {
    var nomeCampo_anam_oxy = "anam_oxy";
    var var_anam_oxy = scAjaxGetFieldText(nomeCampo_anam_oxy);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_mob_validate_anam_oxy(var_anam_oxy, var_script_case_init, do_ajax_form_anamnesis_mob_validate_anam_oxy_cb);
  } // do_ajax_form_anamnesis_mob_validate_anam_oxy

  function do_ajax_form_anamnesis_mob_validate_anam_oxy_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "anam_oxy";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_mob_validate_anam_oxy_cb

  // ---------- Validate anam_gluco
  function do_ajax_form_anamnesis_mob_validate_anam_gluco()
  {
    var nomeCampo_anam_gluco = "anam_gluco";
    var var_anam_gluco = scAjaxGetFieldText(nomeCampo_anam_gluco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_mob_validate_anam_gluco(var_anam_gluco, var_script_case_init, do_ajax_form_anamnesis_mob_validate_anam_gluco_cb);
  } // do_ajax_form_anamnesis_mob_validate_anam_gluco

  function do_ajax_form_anamnesis_mob_validate_anam_gluco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "anam_gluco";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_mob_validate_anam_gluco_cb

  // ---------- Validate anam_aller
  function do_ajax_form_anamnesis_mob_validate_anam_aller()
  {
    var nomeCampo_anam_aller = "anam_aller";
    var var_anam_aller = scAjaxGetFieldText(nomeCampo_anam_aller);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_mob_validate_anam_aller(var_anam_aller, var_script_case_init, do_ajax_form_anamnesis_mob_validate_anam_aller_cb);
  } // do_ajax_form_anamnesis_mob_validate_anam_aller

  function do_ajax_form_anamnesis_mob_validate_anam_aller_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "anam_aller";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_mob_validate_anam_aller_cb

  // ---------- Validate tratamiento
  function do_ajax_form_anamnesis_mob_validate_tratamiento()
  {
    var nomeCampo_tratamiento = "tratamiento";
    var var_tratamiento = scAjaxGetFieldText(nomeCampo_tratamiento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_mob_validate_tratamiento(var_tratamiento, var_script_case_init, do_ajax_form_anamnesis_mob_validate_tratamiento_cb);
  } // do_ajax_form_anamnesis_mob_validate_tratamiento

  function do_ajax_form_anamnesis_mob_validate_tratamiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tratamiento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_mob_validate_tratamiento_cb

  // ---------- Event onchange pati_id
  function do_ajax_form_anamnesis_mob_event_pati_id_onchange()
  {
    var var_pati_id = scAjaxGetFieldSelect("pati_id");
    var var_anam_career = scAjaxGetFieldText("anam_career");
    var var_anam_carsem = scAjaxGetFieldText("anam_carsem");
    var var_pat_bod = scAjaxGetFieldText("pat_bod");
    var var_pat_name = scAjaxGetFieldText("pat_name");
    var var_pat_lname = scAjaxGetFieldText("pat_lname");
    var var_pat_gerens = scAjaxGetFieldRadio("pat_gerens");
    var var_pat_phone = scAjaxGetFieldText("pat_phone");
    var var_pat_blood = scAjaxGetFieldSelect("pat_blood");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_anamnesis_mob_event_pati_id_onchange(var_pati_id, var_anam_career, var_anam_carsem, var_pat_bod, var_pat_name, var_pat_lname, var_pat_gerens, var_pat_phone, var_pat_blood, var_script_case_init, do_ajax_form_anamnesis_mob_event_pati_id_onchange_cb);
  } // do_ajax_form_anamnesis_mob_event_pati_id_onchange

  function do_ajax_form_anamnesis_mob_event_pati_id_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pati_id";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_anamnesis_mob_event_pati_id_onchange_cb_after_alert);
  } // do_ajax_form_anamnesis_mob_event_pati_id_onchange_cb
  function do_ajax_form_anamnesis_mob_event_pati_id_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_anamnesis_mob_event_pati_id_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_anamnesis_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_anamnesis_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_anam_date = scAjaxGetFieldText("anam_date");
    var var_anam_strtime = scAjaxGetFieldText("anam_strtime");
    var var_anam_reason = scAjaxGetFieldText("anam_reason");
    var var_anam_diag = scAjaxGetFieldText("anam_diag");
    var var_pati_id = scAjaxGetFieldSelect("pati_id");
    var var_pat_bod = scAjaxGetFieldText("pat_bod");
    var var_pat_name = scAjaxGetFieldText("pat_name");
    var var_pat_lname = scAjaxGetFieldText("pat_lname");
    ...
    var var_pat_phone = scAjaxGetFieldText("pat_phone");
    var var_anam_carsem = scAjaxGetFieldText("anam_carsem");
    var var_anam_bpsys = scAjaxGetFieldText("anam_bpsys");
    var var_anam_bpdia = scAjaxGetFieldText("anam_bpdia");
    var var_anam_hbeat = scAjaxGetFieldText("anam_hbeat");
    var var_anam_temp = scAjaxGetFieldText("anam_temp");
    var var_anam_oxy = scAjaxGetFieldText("anam_oxy");
    var var_anam_gluco = scAjaxGetFieldText("anam_gluco");
    var var_anam_aller = scAjaxGetFieldText("anam_aller");
    var var_anam_id = scAjaxGetFieldText("anam_id");
    ...
    scAjaxProcOn();
    x_ajax_form_anamnesis_mob_submit_form(var_anam_date, var_anam_strtime, var_anam_reason, var_anam_diag, var_pati_id, var_pat_bod, var_pat_name, var_pat_lname, var_pat_blood, var_anam_career, var_pat_gerens, var_pat_phone, var_anam_carsem, var_anam_bpsys, var_anam_bpdia, var_anam_hbeat, var_anam_temp, var_anam_oxy, var_anam_gluco, var_anam_aller, var_anam_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_anamnesis_mob_submit_form_cb);
  } // do_ajax_form_anamnesis_mob_submit_form

  function do_ajax_form_anamnesis_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("anam_date");
      scAjaxHideErrorDisplay("anam_strtime");
      scAjaxHideErrorDisplay("anam_reason");
      scAjaxHideErrorDisplay("anam_diag");
      scAjaxHideErrorDisplay("pati_id");
      scAjaxHideErrorDisplay("pat_bod");
      scAjaxHideErrorDisplay("pat_name");
      scAjaxHideErrorDisplay("pat_lname");
      scAjaxHideErrorDisplay("pat_blood");
      scAjaxHideErrorDisplay("anam_career");
      scAjaxHideErrorDisplay("pat_gerens");
      scAjaxHideErrorDisplay("pat_phone");
      scAjaxHideErrorDisplay("anam_carsem");
      scAjaxHideErrorDisplay("anam_bpsys");
      scAjaxHideErrorDisplay("anam_bpdia");
      scAjaxHideErrorDisplay("anam_hbeat");
      scAjaxHideErrorDisplay("anam_temp");
      scAjaxHideErrorDisplay("anam_oxy");
      scAjaxHideErrorDisplay("anam_gluco");
      scAjaxHideErrorDisplay("anam_aller");
      scAjaxHideErrorDisplay("tratamiento");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_anamnesis_mob_submit_form_cb_after_alert);
  } // do_ajax_form_anamnesis_mob_submit_form_cb
  function do_ajax_form_anamnesis_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_anamnesis_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_treatment_mob"] = "off";

  function do_ajax_form_anamnesis_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_anamnesis_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_anamnesis_mob_navigate_form();
    }
  }

  function perform_ajax_form_anamnesis_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("anam_aller");
    scAjaxHideErrorDisplay("tratamiento");
    var var_anam_id = document.F2.anam_id.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_treatment_mob"] = "on";
    x_ajax_form_anamnesis_mob_navigate_form(var_anam_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_anamnesis_mob_navigate_form_cb);
  } // do_ajax_form_anamnesis_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_anamnesis_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.anam_id.value = scAjaxGetKeyValue("anam_id");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_treatment_mob"] && "nmsc_iframe_liga_form_treatment_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_treatment_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_treatment_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_treatment_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_treatment_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_treatment_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_anamnesis_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_anamnesis_mob_navigate_form_cb
  function do_ajax_form_anamnesis_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_anamnesis_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_anamnesis_mob_navigate_form_cb_after_alert

  function sc_hide_form_anamnesis_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_treatment_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "anam_date";
  ajax_field_list[1] = "anam_strtime";
  ajax_field_list[2] = "anam_reason";
  ajax_field_list[3] = "anam_diag";
  ajax_field_list[4] = "pati_id";
  ajax_field_list[5] = "pat_bod";
  ajax_field_list[6] = "pat_name";
  ajax_field_list[7] = "pat_lname";
  ajax_field_list[8] = "pat_blood";
  ajax_field_list[9] = "anam_career";
  ajax_field_list[10] = "pat_gerens";
  ajax_field_list[11] = "pat_phone";
  ajax_field_list[12] = "anam_carsem";
  ajax_field_list[13] = "anam_bpsys";
  ajax_field_list[14] = "anam_bpdia";
  ajax_field_list[15] = "anam_hbeat";
  ajax_field_list[16] = "anam_temp";
  ajax_field_list[17] = "anam_oxy";
  ajax_field_list[18] = "anam_gluco";
  ajax_field_list[19] = "anam_aller";
  ajax_field_list[20] = "tratamiento";
  ...
  var ajax_error_list = {
    "anam_date": {"label": "Fecha", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "anam_strtime": {"label": "Hora Inicio", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "anam_reason": {"label": "Motivo de Conslta", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "anam_diag": {"label": "Diagnóstico", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pati_id": {"label": "Paciente", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pat_bod": {"label": "Fecha de Nacimiento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pat_name": {"label": "Nombre", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pat_lname": {"label": "Apellido", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pat_blood": {"label": "Tipo Sanguíneo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "anam_career": {"label": "Carrera", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pat_gerens": {"label": "Genero", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pat_phone": {"label": "Celular", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "anam_carsem": {"label": "Semestre", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "anam_bpsys": {"label": "Presión sistólica", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "anam_bpdia": {"label": "Presión diastólica", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "anam_hbeat": {"label": "Ritmo Cardiaco", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "anam_temp": {"label": "Temperatura", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "anam_oxy": {"label": "Oxigenación", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "anam_gluco": {"label": "Glucosa", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "anam_aller": {"label": "Alergias", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tratamiento": {"label": "Tratamiento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "anam_date": new Array(),
    "anam_strtime": new Array(),
    "anam_reason": new Array(),
    "anam_diag": new Array(),
    "pati_id": new Array(),
    "pat_bod": new Array(),
    "pat_name": new Array(),
    "pat_lname": new Array(),
    "pat_blood": new Array(),
    "anam_career": new Array(),
    "pat_gerens": new Array(),
    "pat_phone": new Array(),
    "anam_carsem": new Array(),
    "anam_bpsys": new Array(),
    "anam_bpdia": new Array(),
    "anam_hbeat": new Array(),
    "anam_temp": new Array(),
    "anam_oxy": new Array(),
    "anam_gluco": new Array(),
    "anam_aller": new Array(),
    "tratamiento": new Array()
  };
  ajax_field_mult["anam_date"][1] = "anam_date";
  ajax_field_mult["anam_strtime"][1] = "anam_strtime";
  ajax_field_mult["anam_reason"][1] = "anam_reason";
  ajax_field_mult["anam_diag"][1] = "anam_diag";
  ajax_field_mult["pati_id"][1] = "pati_id";
  ajax_field_mult["pat_bod"][1] = "pat_bod";
  ajax_field_mult["pat_name"][1] = "pat_name";
  ajax_field_mult["pat_lname"][1] = "pat_lname";
  ajax_field_mult["pat_blood"][1] = "pat_blood";
  ajax_field_mult["anam_career"][1] = "anam_career";
  ajax_field_mult["pat_gerens"][1] = "pat_gerens";
  ajax_field_mult["pat_phone"][1] = "pat_phone";
  ajax_field_mult["anam_carsem"][1] = "anam_carsem";
  ajax_field_mult["anam_bpsys"][1] = "anam_bpsys";
  ajax_field_mult["anam_bpdia"][1] = "anam_bpdia";
  ajax_field_mult["anam_hbeat"][1] = "anam_hbeat";
  ajax_field_mult["anam_temp"][1] = "anam_temp";
  ajax_field_mult["anam_oxy"][1] = "anam_oxy";
  ajax_field_mult["anam_gluco"][1] = "anam_gluco";
  ajax_field_mult["anam_aller"][1] = "anam_aller";
  ajax_field_mult["tratamiento"][1] = "tratamiento";

  var ajax_field_id = {
    "anam_date": new Array("hidden_field_label_anam_date", "hidden_field_data_anam_date"),
    "anam_strtime": new Array("hidden_field_label_anam_strtime", "hidden_field_data_anam_strtime"),
    "anam_reason": new Array("hidden_field_label_anam_reason", "hidden_field_data_anam_reason"),
    "anam_diag": new Array("hidden_field_label_anam_diag", "hidden_field_data_anam_diag"),
    "pati_id": new Array("hidden_field_label_pati_id", "hidden_field_data_pati_id"),
    "pat_bod": new Array("hidden_field_label_pat_bod", "hidden_field_data_pat_bod"),
    "pat_name": new Array("hidden_field_label_pat_name", "hidden_field_data_pat_name"),
    "pat_lname": new Array("hidden_field_label_pat_lname", "hidden_field_data_pat_lname"),
    "pat_blood": new Array("hidden_field_label_pat_blood", "hidden_field_data_pat_blood"),
    "anam_career": new Array("hidden_field_label_anam_career", "hidden_field_data_anam_career"),
    "pat_gerens": new Array("hidden_field_label_pat_gerens", "hidden_field_data_pat_gerens"),
    "pat_phone": new Array("hidden_field_label_pat_phone", "hidden_field_data_pat_phone"),
    "anam_carsem": new Array("hidden_field_label_anam_carsem", "hidden_field_data_anam_carsem"),
    "anam_bpsys": new Array("hidden_field_label_anam_bpsys", "hidden_field_data_anam_bpsys"),
    "anam_bpdia": new Array("hidden_field_label_anam_bpdia", "hidden_field_data_anam_bpdia"),
    "anam_hbeat": new Array("hidden_field_label_anam_hbeat", "hidden_field_data_anam_hbeat"),
    "anam_temp": new Array("hidden_field_label_anam_temp", "hidden_field_data_anam_temp"),
    "anam_oxy": new Array("hidden_field_label_anam_oxy", "hidden_field_data_anam_oxy"),
    "anam_gluco": new Array("hidden_field_label_anam_gluco", "hidden_field_data_anam_gluco"),
    "anam_aller": new Array("hidden_field_label_anam_aller", "hidden_field_data_anam_aller"),
    "tratamiento": new Array("hidden_field_label_tratamiento", "hidden_field_data_tratamiento")
  };
