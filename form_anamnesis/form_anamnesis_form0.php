...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2-4.0.6/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_anamnesis/form_anamnesis_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_anamnesis_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_anamnesis_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['link_info']['remove_border']) {
...
<?php
 include_once("form_anamnesis_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_anamnesis'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_anamnesis'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['run_iframe'] != "R")
{
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['fast_search'][2] : "";
...
<?php 
          ...
          $SC_Label_atu['anam_date'] = (isset($this->nm_new_label['anam_date'])) ? $this->nm_new_label['anam_date'] : 'Fecha'; 
          $SC_Label_atu['anam_strtime'] = (isset($this->nm_new_label['anam_strtime'])) ? $this->nm_new_label['anam_strtime'] : 'Hora Inicio'; 
          $SC_Label_atu['anam_reason'] = (isset($this->nm_new_label['anam_reason'])) ? $this->nm_new_label['anam_reason'] : 'Motivo de Conslta'; 
          $SC_Label_atu['anam_diag'] = (isset($this->nm_new_label['anam_diag'])) ? $this->nm_new_label['anam_diag'] : 'Diagnóstico'; 
          $SC_Label_atu['pati_id'] = (isset($this->nm_new_label['pati_id'])) ? $this->nm_new_label['pati_id'] : 'Paciente'; 
          $SC_Label_atu['anam_career'] = (isset($this->nm_new_label['anam_career'])) ? $this->nm_new_label['anam_career'] : 'Carrera'; 
          $SC_Label_atu['anam_carsem'] = (isset($this->nm_new_label['anam_carsem'])) ? $this->nm_new_label['anam_carsem'] : 'Semestre'; 
          $SC_Label_atu['anam_bpsys'] = (isset($this->nm_new_label['anam_bpsys'])) ? $this->nm_new_label['anam_bpsys'] : 'Presión sistólica'; 
          $SC_Label_atu['anam_bpdia'] = (isset($this->nm_new_label['anam_bpdia'])) ? $this->nm_new_label['anam_bpdia'] : 'Presión diastólica'; 
          $SC_Label_atu['anam_hbeat'] = (isset($this->nm_new_label['anam_hbeat'])) ? $this->nm_new_label['anam_hbeat'] : 'Ritmo Cardiaco'; 
          $SC_Label_atu['anam_temp'] = (isset($this->nm_new_label['anam_temp'])) ? $this->nm_new_label['anam_temp'] : 'Temperatura'; 
          $SC_Label_atu['anam_oxy'] = (isset($this->nm_new_label['anam_oxy'])) ? $this->nm_new_label['anam_oxy'] : 'Oxigenación'; 
          $SC_Label_atu['anam_gluco'] = (isset($this->nm_new_label['anam_gluco'])) ? $this->nm_new_label['anam_gluco'] : 'Glucosa'; 
          $SC_Label_atu['anam_aller'] = (isset($this->nm_new_label['anam_aller'])) ? $this->nm_new_label['anam_aller'] : 'Alergias'; 
          $SC_Label_atu['tratamiento'] = (isset($this->nm_new_label['tratamiento'])) ? $this->nm_new_label['tratamiento'] : 'Tratamiento'; 
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_disabled']['breload']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_disabled']['breload']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_label']['breload']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_label']['breload']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_label']['breload'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<script type="text/javascript">
var pag_ativa = "form_anamnesis_form0";
</script>
<ul class="scTabLine sc-ui-page-tab-line">
<?php
    $this->tabCssClass = array(
        'form_anamnesis_form0' => array(
            'title' => "Atención",
            'class' => empty($nmgp_num_form) || $nmgp_num_form == "form_anamnesis_form0" ? "scTabActive" : "scTabInactive",
        ),
        'form_anamnesis_form1' => array(
            'title' => "Tratamiento",
            'class' => $nmgp_num_form == "form_anamnesis_form1" ? "scTabActive" : "scTabInactive",
        ),
    );
    if (!empty($this->Ini->nm_hidden_pages)) {
        foreach ($this->Ini->nm_hidden_pages as $pageName => $pageStatus) {
            if ('Atención' == $pageName && 'off' == $pageStatus) {
                $this->tabCssClass['form_anamnesis_form0']['class'] = 'scTabInactive';
            }
            if ('Tratamiento' == $pageName && 'off' == $pageStatus) {
                $this->tabCssClass['form_anamnesis_form1']['class'] = 'scTabInactive';
            }
        }
...
?>
<?php
    $css_celula = $this->tabCssClass["form_anamnesis_form0"]['class'];
?>
   <li id="id_form_anamnesis_form0" class="<?php echo $css_celula; ?> sc-form-page sc-tab-click" data-tab-name="form_anamnesis_form0">
     Atención
   </li>
<?php
    $css_celula = $this->tabCssClass["form_anamnesis_form1"]['class'];
?>
   <li id="id_form_anamnesis_form1" class="<?php echo $css_celula; ?> sc-form-page sc-tab-click" data-tab-name="form_anamnesis_form1">
     Tratamiento
   </li>
</ul>
...
<div id="form_anamnesis_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_anam_date_label" id="hidden_field_label_anam_date" style="<?php echo $sStyleHidden_anam_date; ?>"><span id="id_label_anam_date"><?php echo $this->nm_new_label['anam_date']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['php_cmp_required']['anam_date']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['php_cmp_required']['anam_date'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_anam_date_line" id="hidden_field_data_anam_date" style="<?php echo $sStyleHidden_anam_date; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_anam_date_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_anam_strtime_label" id="hidden_field_label_anam_strtime" style="<?php echo $sStyleHidden_anam_strtime; ?>"><span id="id_label_anam_strtime"><?php echo $this->nm_new_label['anam_strtime']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['php_cmp_required']['anam_strtime']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['php_cmp_required']['anam_strtime'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_anam_strtime_line" id="hidden_field_data_anam_strtime" style="<?php echo $sStyleHidden_anam_strtime; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_anam_strtime_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_anam_reason_label" id="hidden_field_label_anam_reason" style="<?php echo $sStyleHidden_anam_reason; ?>"><span id="id_label_anam_reason"><?php echo $this->nm_new_label['anam_reason']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['php_cmp_required']['anam_reason']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['php_cmp_required']['anam_reason'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_anam_reason_line" id="hidden_field_data_anam_reason" style="<?php echo $sStyleHidden_anam_reason; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_anam_reason_line" style="vertical-align: top;padding: 0px">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_anam_diag_label" id="hidden_field_label_anam_diag" style="<?php echo $sStyleHidden_anam_diag; ?>"><span id="id_label_anam_diag"><?php echo $this->nm_new_label['anam_diag']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['php_cmp_required']['anam_diag']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['php_cmp_required']['anam_diag'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_anam_diag_line" id="hidden_field_data_anam_diag" style="<?php echo $sStyleHidden_anam_diag; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_anam_diag_line" style="vertical-align: top;padding: 0px">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pati_id_label" id="hidden_field_label_pati_id" style="<?php echo $sStyleHidden_pati_id; ?>"><span id="id_label_pati_id"><?php echo $this->nm_new_label['pati_id']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['php_cmp_required']['pati_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['php_cmp_required']['pati_id'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_pati_id_line" id="hidden_field_data_pati_id" style="<?php echo $sStyleHidden_pati_id; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pati_id_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pat_bod_line" id="hidden_field_data_pat_bod" style="<?php echo $sStyleHidden_pat_bod; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pat_bod_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pat_name_line" id="hidden_field_data_pat_name" style="<?php echo $sStyleHidden_pat_name; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pat_name_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pat_lname_line" id="hidden_field_data_pat_lname" style="<?php echo $sStyleHidden_pat_lname; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pat_lname_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pat_blood_label" id="hidden_field_label_pat_blood" style="<?php echo $sStyleHidden_pat_blood; ?>"><span id="id_label_pat_blood"><?php echo $this->nm_new_label['pat_blood']; ?></span></TD>
    <TD class="scFormDataOdd css_pat_blood_line" id="hidden_field_data_pat_blood" style="<?php echo $sStyleHidden_pat_blood; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pat_blood_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_anam_career_line" id="hidden_field_data_anam_career" style="<?php echo $sStyleHidden_anam_career; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_anam_career_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pat_gerens_line" id="hidden_field_data_pat_gerens" style="<?php echo $sStyleHidden_pat_gerens; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pat_gerens_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pat_phone_line" id="hidden_field_data_pat_phone" style="<?php echo $sStyleHidden_pat_phone; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pat_phone_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_anam_carsem_label" id="hidden_field_label_anam_carsem" style="<?php echo $sStyleHidden_anam_carsem; ?>"><span id="id_label_anam_carsem"><?php echo $this->nm_new_label['anam_carsem']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['php_cmp_required']['anam_carsem']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['php_cmp_required']['anam_carsem'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_anam_carsem_line" id="hidden_field_data_anam_carsem" style="<?php echo $sStyleHidden_anam_carsem; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_anam_carsem_line" style="vertical-align: top;padding: 0px">
