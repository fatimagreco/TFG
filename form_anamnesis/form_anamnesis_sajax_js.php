  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_anamnesis" == sTestField)
        {
...
?>
  ...
  // ---------- Validate anam_date
  function do_ajax_form_anamnesis_validate_anam_date()
  {
    ...
    setTimeout(function() {
      var var_anam_date = scAjaxGetFieldText(nomeCampo_anam_date);
      x_ajax_form_anamnesis_validate_anam_date(var_anam_date, var_script_case_init, do_ajax_form_anamnesis_validate_anam_date_cb);
    }, 200);
  } // do_ajax_form_anamnesis_validate_anam_date

  function do_ajax_form_anamnesis_validate_anam_date_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_validate_anam_date_cb

  // ---------- Validate anam_strtime
  function do_ajax_form_anamnesis_validate_anam_strtime()
  {
    var nomeCampo_anam_strtime = "anam_strtime";
    var var_anam_strtime = scAjaxGetFieldText(nomeCampo_anam_strtime);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_validate_anam_strtime(var_anam_strtime, var_script_case_init, do_ajax_form_anamnesis_validate_anam_strtime_cb);
  } // do_ajax_form_anamnesis_validate_anam_strtime

  function do_ajax_form_anamnesis_validate_anam_strtime_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_validate_anam_strtime_cb

  // ---------- Validate anam_reason
  function do_ajax_form_anamnesis_validate_anam_reason()
  {
    var nomeCampo_anam_reason = "anam_reason";
    var var_anam_reason = scAjaxGetFieldText(nomeCampo_anam_reason);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_validate_anam_reason(var_anam_reason, var_script_case_init, do_ajax_form_anamnesis_validate_anam_reason_cb);
  } // do_ajax_form_anamnesis_validate_anam_reason

  function do_ajax_form_anamnesis_validate_anam_reason_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_validate_anam_reason_cb

  // ---------- Validate anam_diag
  function do_ajax_form_anamnesis_validate_anam_diag()
  {
    var nomeCampo_anam_diag = "anam_diag";
    var var_anam_diag = scAjaxGetFieldText(nomeCampo_anam_diag);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_validate_anam_diag(var_anam_diag, var_script_case_init, do_ajax_form_anamnesis_validate_anam_diag_cb);
  } // do_ajax_form_anamnesis_validate_anam_diag

  function do_ajax_form_anamnesis_validate_anam_diag_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_validate_anam_diag_cb

  // ---------- Validate pati_id
  function do_ajax_form_anamnesis_validate_pati_id()
  {
    var nomeCampo_pati_id = "pati_id";
    var var_pati_id = scAjaxGetFieldSelect(nomeCampo_pati_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_validate_pati_id(var_pati_id, var_script_case_init, do_ajax_form_anamnesis_validate_pati_id_cb);
  } // do_ajax_form_anamnesis_validate_pati_id

  function do_ajax_form_anamnesis_validate_pati_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pati_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_validate_pati_id_cb

  // ---------- Validate pat_bod
  function do_ajax_form_anamnesis_validate_pat_bod()
  {
    var nomeCampo_pat_bod = "pat_bod";
    var var_pat_bod = scAjaxGetFieldText(nomeCampo_pat_bod);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_validate_pat_bod(var_pat_bod, var_script_case_init, do_ajax_form_anamnesis_validate_pat_bod_cb);
  } // do_ajax_form_anamnesis_validate_pat_bod

  function do_ajax_form_anamnesis_validate_pat_bod_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pat_bod";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_validate_pat_bod_cb

  // ---------- Validate pat_name
  function do_ajax_form_anamnesis_validate_pat_name()
  {
    var nomeCampo_pat_name = "pat_name";
    var var_pat_name = scAjaxGetFieldText(nomeCampo_pat_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_validate_pat_name(var_pat_name, var_script_case_init, do_ajax_form_anamnesis_validate_pat_name_cb);
  } // do_ajax_form_anamnesis_validate_pat_name

  function do_ajax_form_anamnesis_validate_pat_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_validate_pat_name_cb

  // ---------- Validate pat_lname
  function do_ajax_form_anamnesis_validate_pat_lname()
  {
    var nomeCampo_pat_lname = "pat_lname";
    var var_pat_lname = scAjaxGetFieldText(nomeCampo_pat_lname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_validate_pat_lname(var_pat_lname, var_script_case_init, do_ajax_form_anamnesis_validate_pat_lname_cb);
  } // do_ajax_form_anamnesis_validate_pat_lname

  function do_ajax_form_anamnesis_validate_pat_lname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_validate_pat_lname_cb

  // ---------- Validate pat_blood
  function do_ajax_form_anamnesis_validate_pat_blood()
  {
    var nomeCampo_pat_blood = "pat_blood";
    var var_pat_blood = scAjaxGetFieldSelect(nomeCampo_pat_blood);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_validate_pat_blood(var_pat_blood, var_script_case_init, do_ajax_form_anamnesis_validate_pat_blood_cb);
  } // do_ajax_form_anamnesis_validate_pat_blood

  function do_ajax_form_anamnesis_validate_pat_blood_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_validate_pat_blood_cb

  // ---------- Validate anam_career
  function do_ajax_form_anamnesis_validate_anam_career()
  {
    var nomeCampo_anam_career = "anam_career";
    var var_anam_career = scAjaxGetFieldText(nomeCampo_anam_career);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_validate_anam_career(var_anam_career, var_script_case_init, do_ajax_form_anamnesis_validate_anam_career_cb);
  } // do_ajax_form_anamnesis_validate_anam_career

  function do_ajax_form_anamnesis_validate_anam_career_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_validate_anam_career_cb

  // ---------- Validate pat_gerens
  function do_ajax_form_anamnesis_validate_pat_gerens()
  {
    var nomeCampo_pat_gerens = "pat_gerens";
    var var_pat_gerens = scAjaxGetFieldRadio(nomeCampo_pat_gerens);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_validate_pat_gerens(var_pat_gerens, var_script_case_init, do_ajax_form_anamnesis_validate_pat_gerens_cb);
  } // do_ajax_form_anamnesis_validate_pat_gerens

  function do_ajax_form_anamnesis_validate_pat_gerens_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_validate_pat_gerens_cb

  // ---------- Validate pat_phone
  function do_ajax_form_anamnesis_validate_pat_phone()
  {
    var nomeCampo_pat_phone = "pat_phone";
    var var_pat_phone = scAjaxGetFieldText(nomeCampo_pat_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_validate_pat_phone(var_pat_phone, var_script_case_init, do_ajax_form_anamnesis_validate_pat_phone_cb);
  } // do_ajax_form_anamnesis_validate_pat_phone

  function do_ajax_form_anamnesis_validate_pat_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_validate_pat_phone_cb

  // ---------- Validate anam_carsem
  function do_ajax_form_anamnesis_validate_anam_carsem()
  {
    var nomeCampo_anam_carsem = "anam_carsem";
    var var_anam_carsem = scAjaxGetFieldText(nomeCampo_anam_carsem);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_validate_anam_carsem(var_anam_carsem, var_script_case_init, do_ajax_form_anamnesis_validate_anam_carsem_cb);
  } // do_ajax_form_anamnesis_validate_anam_carsem

  function do_ajax_form_anamnesis_validate_anam_carsem_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_validate_anam_carsem_cb

  // ---------- Validate anam_bpsys
  function do_ajax_form_anamnesis_validate_anam_bpsys()
  {
    var nomeCampo_anam_bpsys = "anam_bpsys";
    var var_anam_bpsys = scAjaxGetFieldText(nomeCampo_anam_bpsys);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_validate_anam_bpsys(var_anam_bpsys, var_script_case_init, do_ajax_form_anamnesis_validate_anam_bpsys_cb);
  } // do_ajax_form_anamnesis_validate_anam_bpsys

  function do_ajax_form_anamnesis_validate_anam_bpsys_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_validate_anam_bpsys_cb

  // ---------- Validate anam_bpdia
  function do_ajax_form_anamnesis_validate_anam_bpdia()
  {
    var nomeCampo_anam_bpdia = "anam_bpdia";
    var var_anam_bpdia = scAjaxGetFieldText(nomeCampo_anam_bpdia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_validate_anam_bpdia(var_anam_bpdia, var_script_case_init, do_ajax_form_anamnesis_validate_anam_bpdia_cb);
  } // do_ajax_form_anamnesis_validate_anam_bpdia

  function do_ajax_form_anamnesis_validate_anam_bpdia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_validate_anam_bpdia_cb

  // ---------- Validate anam_hbeat
  function do_ajax_form_anamnesis_validate_anam_hbeat()
  {
    var nomeCampo_anam_hbeat = "anam_hbeat";
    var var_anam_hbeat = scAjaxGetFieldText(nomeCampo_anam_hbeat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_validate_anam_hbeat(var_anam_hbeat, var_script_case_init, do_ajax_form_anamnesis_validate_anam_hbeat_cb);
  } // do_ajax_form_anamnesis_validate_anam_hbeat

  function do_ajax_form_anamnesis_validate_anam_hbeat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_validate_anam_hbeat_cb

  // ---------- Validate anam_temp
  function do_ajax_form_anamnesis_validate_anam_temp()
  {
    var nomeCampo_anam_temp = "anam_temp";
    var var_anam_temp = scAjaxGetFieldText(nomeCampo_anam_temp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_validate_anam_temp(var_anam_temp, var_script_case_init, do_ajax_form_anamnesis_validate_anam_temp_cb);
  } // do_ajax_form_anamnesis_validate_anam_temp

  function do_ajax_form_anamnesis_validate_anam_temp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_validate_anam_temp_cb

  // ---------- Validate anam_oxy
  function do_ajax_form_anamnesis_validate_anam_oxy()
  {
    var nomeCampo_anam_oxy = "anam_oxy";
    var var_anam_oxy = scAjaxGetFieldText(nomeCampo_anam_oxy);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_validate_anam_oxy(var_anam_oxy, var_script_case_init, do_ajax_form_anamnesis_validate_anam_oxy_cb);
  } // do_ajax_form_anamnesis_validate_anam_oxy

  function do_ajax_form_anamnesis_validate_anam_oxy_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_validate_anam_oxy_cb

  // ---------- Validate anam_gluco
  function do_ajax_form_anamnesis_validate_anam_gluco()
  {
    var nomeCampo_anam_gluco = "anam_gluco";
    var var_anam_gluco = scAjaxGetFieldText(nomeCampo_anam_gluco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_validate_anam_gluco(var_anam_gluco, var_script_case_init, do_ajax_form_anamnesis_validate_anam_gluco_cb);
  } // do_ajax_form_anamnesis_validate_anam_gluco

  function do_ajax_form_anamnesis_validate_anam_gluco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_validate_anam_gluco_cb

  // ---------- Validate anam_aller
  function do_ajax_form_anamnesis_validate_anam_aller()
  {
    var nomeCampo_anam_aller = "anam_aller";
    var var_anam_aller = scAjaxGetFieldText(nomeCampo_anam_aller);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_validate_anam_aller(var_anam_aller, var_script_case_init, do_ajax_form_anamnesis_validate_anam_aller_cb);
  } // do_ajax_form_anamnesis_validate_anam_aller

  function do_ajax_form_anamnesis_validate_anam_aller_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_validate_anam_aller_cb

  // ---------- Validate tratamiento
  function do_ajax_form_anamnesis_validate_tratamiento()
  {
    var nomeCampo_tratamiento = "tratamiento";
    var var_tratamiento = scAjaxGetFieldText(nomeCampo_tratamiento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_anamnesis_validate_tratamiento(var_tratamiento, var_script_case_init, do_ajax_form_anamnesis_validate_tratamiento_cb);
  } // do_ajax_form_anamnesis_validate_tratamiento

  function do_ajax_form_anamnesis_validate_tratamiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_anamnesis_validate_tratamiento_cb

  // ---------- Event onchange pati_id
  function do_ajax_form_anamnesis_event_pati_id_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_anamnesis_event_pati_id_onchange(var_pati_id, var_anam_career, var_anam_carsem, var_pat_bod, var_pat_name, var_pat_lname, var_pat_gerens, var_pat_phone, var_pat_blood, var_script_case_init, do_ajax_form_anamnesis_event_pati_id_onchange_cb);
  } // do_ajax_form_anamnesis_event_pati_id_onchange

  function do_ajax_form_anamnesis_event_pati_id_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pati_id";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_anamnesis_event_pati_id_onchange_cb_after_alert);
  } // do_ajax_form_anamnesis_event_pati_id_onchange_cb
  function do_ajax_form_anamnesis_event_pati_id_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_anamnesis_event_pati_id_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_anamnesis_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_anamnesis_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_anamnesis_submit_form(var_anam_date, var_anam_strtime, var_anam_reason, var_anam_diag, var_pati_id, var_pat_bod, var_pat_name, var_pat_lname, var_pat_blood, var_anam_career, var_pat_gerens, var_pat_phone, var_anam_carsem, var_anam_bpsys, var_anam_bpdia, var_anam_hbeat, var_anam_temp, var_anam_oxy, var_anam_gluco, var_anam_aller, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_anamnesis_submit_form_cb);
  } // do_ajax_form_anamnesis_submit_form

  function do_ajax_form_anamnesis_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_anamnesis_submit_form_cb_after_alert);
  } // do_ajax_form_anamnesis_submit_form_cb
  function do_ajax_form_anamnesis_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_anamnesis_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_treatment"] = "off";

  function do_ajax_form_anamnesis_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_anamnesis_navigate_form, function() {});
    } else {
      perform_ajax_form_anamnesis_navigate_form();
    }
  }

  function perform_ajax_form_anamnesis_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_treatment"] = "on";
    x_ajax_form_anamnesis_navigate_form(var_anam_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_anamnesis_navigate_form_cb);
  } // do_ajax_form_anamnesis_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_anamnesis']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_anamnesis_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_treatment"] && "nmsc_iframe_liga_form_treatment" != scMasterDetailIframe["nmsc_iframe_liga_form_treatment"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_treatment"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_treatment').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_treatment').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_treatment').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_anamnesis_navigate_form_cb_after_alert);
  } // do_ajax_form_anamnesis_navigate_form_cb
  function do_ajax_form_anamnesis_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_anamnesis_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_anamnesis_navigate_form_cb_after_alert

  function sc_hide_form_anamnesis_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_treatment"])
    {
      return true;
    }
    return false;
