...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'anam_gluco':
      case 'anam_aller':
        sc_exib_ocult_pag('form_anamnesis_form0');
        break;
      case 'tratamiento':
        sc_exib_ocult_pag('form_anamnesis_form1');
        break;
    }
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_anam_id' + iSeqRow).bind('change', function() { sc_form_anamnesis_anam_id_onchange(this, iSeqRow) });
  ...
  $('#id_sc_field_user_id' + iSeqRow).bind('change', function() { sc_form_anamnesis_user_id_onchange(this, iSeqRow) });
  $('#id_sc_field_anam_date' + iSeqRow).bind('blur', function() { sc_form_anamnesis_anam_date_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_anamnesis_anam_date_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_anam_strtime' + iSeqRow).bind('blur', function() { sc_form_anamnesis_anam_strtime_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_anamnesis_anam_strtime_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_anamnesis_anam_strtime_onfocus(this, iSeqRow) });
  $('#id_sc_field_anam_endtime' + iSeqRow).bind('change', function() { sc_form_anamnesis_anam_endtime_onchange(this, iSeqRow) });
  $('#id_sc_field_anam_career' + iSeqRow).bind('blur', function() { sc_form_anamnesis_anam_career_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_anamnesis_anam_career_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_anamnesis_anam_career_onfocus(this, iSeqRow) });
  $('#id_sc_field_anam_caryear' + iSeqRow).bind('change', function() { sc_form_anamnesis_anam_caryear_onchange(this, iSeqRow) });
  $('#id_sc_field_anam_carsem' + iSeqRow).bind('blur', function() { sc_form_anamnesis_anam_carsem_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_anamnesis_anam_carsem_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_anam_reason' + iSeqRow).bind('blur', function() { sc_form_anamnesis_anam_reason_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_anamnesis_anam_reason_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_anam_aller' + iSeqRow).bind('blur', function() { sc_form_anamnesis_anam_aller_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_anamnesis_anam_aller_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_anam_temp' + iSeqRow).bind('blur', function() { sc_form_anamnesis_anam_temp_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_anamnesis_anam_temp_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_anam_hbeat' + iSeqRow).bind('blur', function() { sc_form_anamnesis_anam_hbeat_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_anamnesis_anam_hbeat_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_anam_bpsys' + iSeqRow).bind('blur', function() { sc_form_anamnesis_anam_bpsys_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_anamnesis_anam_bpsys_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_anam_bpdia' + iSeqRow).bind('blur', function() { sc_form_anamnesis_anam_bpdia_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_anamnesis_anam_bpdia_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_anam_oxy' + iSeqRow).bind('blur', function() { sc_form_anamnesis_anam_oxy_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_anamnesis_anam_oxy_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_anam_gluco' + iSeqRow).bind('blur', function() { sc_form_anamnesis_anam_gluco_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_anamnesis_anam_gluco_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_anam_diag' + iSeqRow).bind('blur', function() { sc_form_anamnesis_anam_diag_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_anamnesis_anam_diag_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tratamiento' + iSeqRow).bind('blur', function() { sc_form_anamnesis_tratamiento_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_anamnesis_tratamiento_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pat_blood' + iSeqRow).bind('blur', function() { sc_form_anamnesis_pat_blood_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_anamnesis_pat_blood_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pat_bod' + iSeqRow).bind('blur', function() { sc_form_anamnesis_pat_bod_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_anamnesis_pat_bod_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pat_gerens' + iSeqRow).bind('blur', function() { sc_form_anamnesis_pat_gerens_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_anamnesis_pat_gerens_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pat_lname' + iSeqRow).bind('blur', function() { sc_form_anamnesis_pat_lname_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_anamnesis_pat_lname_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pat_name' + iSeqRow).bind('blur', function() { sc_form_anamnesis_pat_name_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_anamnesis_pat_name_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pat_phone' + iSeqRow).bind('blur', function() { sc_form_anamnesis_pat_phone_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_anamnesis_pat_phone_onchange(this, iSeqRow) })
...
function sc_form_anamnesis_anam_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_anamnesis_user_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_anamnesis_anam_date_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_anamnesis_anam_strtime_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_anamnesis_anam_endtime_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_anamnesis_anam_career_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_anamnesis_anam_caryear_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_anamnesis_anam_carsem_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_anamnesis_anam_reason_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_anamnesis_anam_aller_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_anamnesis_anam_temp_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_anamnesis_anam_hbeat_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_anamnesis_anam_bpsys_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_anamnesis_anam_bpdia_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_anamnesis_anam_oxy_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_anamnesis_anam_gluco_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_anamnesis_anam_diag_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_anamnesis_tratamiento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_anamnesis_pat_blood_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_anamnesis_pat_bod_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_anamnesis_pat_gerens_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_anamnesis_pat_lname_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_anamnesis_pat_name_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_anamnesis_pat_phone_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function displayChange_field_tratamiento(row, status) {
    var fieldId;
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_treatment")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_treatment")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_anamnesis_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_anam_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_form_anamnesis_validate_anam_date(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_anamnesis')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
