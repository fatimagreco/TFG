...
class grid_Users_1_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_Users_1_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_Users_1_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_Users_1_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_user_name')
      {
          $user_name = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_user_name($user_name);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_Users_1/grid_Users_1_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_Users_1_ajax_search.js"></script>
 <script type="text/javascript" src="grid_Users_1_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_Users_1_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_Users_1']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_Users_1']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_user_bod_cond#NMF#' + search_get_sel_txt('SC_user_bod_cond') + '@NMF@';
  str_out += 'SC_user_bod_dia#NMF#' + search_get_sel_txt('SC_user_bod_dia') + '@NMF@';
  str_out += 'SC_user_bod_mes#NMF#' + search_get_sel_txt('SC_user_bod_mes') + '@NMF@';
  str_out += 'SC_user_bod_ano#NMF#' + search_get_sel_txt('SC_user_bod_ano') + '@NMF@';
  str_out += 'SC_user_bod_input_2_dia#NMF#' + search_get_sel_txt('SC_user_bod_input_2_dia') + '@NMF@';
  str_out += 'SC_user_bod_input_2_mes#NMF#' + search_get_sel_txt('SC_user_bod_input_2_mes') + '@NMF@';
  str_out += 'SC_user_bod_input_2_ano#NMF#' + search_get_sel_txt('SC_user_bod_input_2_ano') + '@NMF@';
  str_out += 'SC_user_id_cond#NMF#' + search_get_sel_txt('SC_user_id_cond') + '@NMF@';
  str_out += 'SC_user_id#NMF#' + search_get_text('SC_user_id') + '@NMF@';
  str_out += 'SC_user_name_cond#NMF#' + search_get_sel_txt('SC_user_name_cond') + '@NMF@';
  str_out += 'SC_user_name#NMF#' + search_get_text('SC_user_name') + '@NMF@';
  str_out += 'id_ac_user_name#NMF#' + search_get_text('id_ac_user_name') + '@NMF@';
  str_out += 'SC_user_docnum_cond#NMF#' + search_get_sel_txt('SC_user_docnum_cond') + '@NMF@';
  str_out += 'SC_user_docnum#NMF#' + search_get_text('SC_user_docnum') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_user_name").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_user_name").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_user_name",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_user_name").val(ui.item.value);
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $user_bod_cond, $user_bod, $user_bod_dia, $user_bod_mes, $user_bod_ano, $user_bod_input_2_dia, $user_bod_input_2_mes, $user_bod_input_2_ano,
             $user_id_cond, $user_id,
             $user_name_cond, $user_name, $user_name_autocomp,
             $user_docnum_cond, $user_docnum,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $user_bod_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['user_bod_dia']; 
          $user_bod_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['user_bod_mes']; 
          $user_bod_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['user_bod_ano']; 
          $user_bod_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['user_bod_input_2_dia']; 
          $user_bod_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['user_bod_input_2_mes']; 
          $user_bod_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['user_bod_input_2_ano']; 
          $user_bod_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['user_bod_cond']; 
          $user_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['user_id']; 
          $user_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['user_id_cond']; 
          $user_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['user_name']; 
          $user_name_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['user_name_cond']; 
          $user_docnum = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['user_docnum']; 
          $user_docnum_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['user_docnum_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['NM_operador']; 
          ...
          if (strtoupper($user_docnum_cond) != "II" && strtoupper($user_docnum_cond) != "QP" && strtoupper($user_docnum_cond) != "NP" && strtoupper($user_docnum_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($user_docnum, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($user_bod_cond) || empty($user_bod_cond))
      {
         $user_bod_cond = "eq";
      }
      ...
      if (!isset($user_name_cond) || empty($user_name_cond))
      {
         $user_name_cond = "qp";
      }
      if (!isset($user_docnum_cond) || empty($user_docnum_cond))
      {
         $user_docnum_cond = "gt";
      }
      ...
      $str_hide_user_bod = (in_array($user_bod_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_user_id = (in_array($user_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_user_name = (in_array($user_name_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_user_docnum = (in_array($user_docnum_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_user_bod = ('bw' == $user_bod_cond) ? $display_aberto : $display_fechado;
      $str_display_user_id = ('bw' == $user_id_cond) ? $display_aberto : $display_fechado;
      $str_display_user_name = ('bw' == $user_name_cond) ? $display_aberto : $display_fechado;
      $str_display_user_docnum = ('bw' == $user_docnum_cond) ? $display_aberto : $display_fechado;

      if (!isset($user_bod) || $user_bod == "")
      {
          $user_bod = "";
      }
      if (isset($user_bod) && !empty($user_bod))
      {
         $tmp_pos = (is_string($user_bod)) ? strpos($user_bod, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $user_bod = substr($user_bod, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = (is_string($user_name)) ? strpos($user_name, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $user_name = substr($user_name, 0, $tmp_pos);
         }
      }
      if (!isset($user_docnum) || $user_docnum == "")
      {
          $user_docnum = "";
      }
      if (isset($user_docnum) && !empty($user_docnum))
      {
         $tmp_pos = (is_string($user_docnum)) ? strpos($user_docnum, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $user_docnum = substr($user_docnum, 0, $tmp_pos);
         }
      }
?>
 <?php
...
?>
<?php
   if (is_file("grid_Users_1_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_Users_1']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_Users_1']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_user_bod_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['user_bod'])) ? $this->New_label['user_bod'] : "Fecha de Nacimiento"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_user_bod_cond" name="user_bod_cond" onChange="nm_campos_between(document.getElementById('id_vis_user_bod'), this, 'user_bod')">
       <OPTION value="eq" <?php if ("eq" == $user_bod_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $user_bod_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $user_bod_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $user_bod_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_user_bod" <?php echo $str_hide_user_bod?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['user_bod'])) ? $this->New_label['user_bod'] : "Fecha de Nacimiento";
 $nmgp_tab_label .= "user_bod?#?" . $SC_Label . "?@?";
...
<?php
  ...
  {
?>
<span id='id_date_part_user_bod_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_user_bod_dia" name="user_bod_dia" value="<?php echo NM_encode_input($user_bod_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_user_bod_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_user_bod_mes" name="user_bod_mes" value="<?php echo NM_encode_input($user_bod_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_user_bod_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_user_bod_ano" name="user_bod_ano" value="<?php echo NM_encode_input($user_bod_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
        <SPAN id="id_css_user_bod"  class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_user_bod"  <?php echo $str_display_user_bod; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<span id='id_date_part_user_bod_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_user_bod_input_2_dia" name="user_bod_input_2_dia" value="<?php echo NM_encode_input($user_bod_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_user_bod_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_user_bod_input_2_mes" name="user_bod_input_2_mes" value="<?php echo NM_encode_input($user_bod_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_user_bod_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_user_bod_input_2_ano" name="user_bod_input_2_ano" value="<?php echo NM_encode_input($user_bod_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
      ...
      <TD id='SC_user_id_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['user_id'])) ? $this->New_label['user_id'] : "Usuario"; ?></TD>
     <TD class="scFilterFieldEven"> 
...
?>
<INPUT  type="text" id="SC_user_id" name="user_id" value="<?php echo NM_encode_input($user_id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_user_name_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['user_name'])) ? $this->New_label['user_name'] : "Nombre"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_user_name_cond" name="user_name_cond" onChange="nm_campos_between(document.getElementById('id_vis_user_name'), this, 'user_name')">
       <OPTION value="qp" <?php if ("qp" == $user_name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $user_name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $user_name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $user_name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_user_name" <?php echo $str_hide_user_name?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['user_name'])) ? $this->New_label['user_name'] : "Nombre";
 $nmgp_tab_label .= "user_name?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $user_name;
      }
?>
<INPUT  type="text" id="SC_user_name" name="user_name" value="<?php echo NM_encode_input($user_name) ?>"  size=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_user_name" name="user_name_autocomp" size="45"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_user_docnum_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['user_docnum'])) ? $this->New_label['user_docnum'] : "Nro. Documento"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_user_docnum_cond" name="user_docnum_cond" onChange="nm_campos_between(document.getElementById('id_vis_user_docnum'), this, 'user_docnum')">
       <OPTION value="gt" <?php if ("gt" == $user_docnum_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $user_docnum_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $user_docnum_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_user_docnum" <?php echo $str_hide_user_docnum?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['user_docnum'])) ? $this->New_label['user_docnum'] : "Nro. Documento";
 $nmgp_tab_label .= "user_docnum?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_user_docnum" name="user_docnum" value="<?php echo NM_encode_input($user_docnum) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if (!$_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.user_bod_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_user_bod'), document.F1.user_bod_cond, 'user_bod');
   document.F1.user_bod_dia.value = "";
   document.F1.user_bod_mes.value = "";
   document.F1.user_bod_ano.value = "";
   document.F1.user_bod_input_2_dia.value = "";
   document.F1.user_bod_input_2_mes.value = "";
   document.F1.user_bod_input_2_ano.value = "";
   ...
   document.F1.user_name_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_user_name'), document.F1.user_name_cond, 'user_name');
   document.F1.user_name.value = "";
   document.F1.user_name_autocomp.value = "";
   document.F1.user_docnum_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_user_docnum'), document.F1.user_docnum_cond, 'user_docnum');
   document.F1.user_docnum.value = "";
 }
 function SC_carga_evt_jquery()
 {
    $('#SC_user_bod_dia').bind('change', function() {sc_grid_Users_1_valida_dia(this)});
    $('#SC_user_bod_input_2_dia').bind('change', function() {sc_grid_Users_1_valida_dia(this)});
    $('#SC_user_bod_input_2_mes').bind('change', function() {sc_grid_Users_1_valida_mes(this)});
    $('#SC_user_bod_mes').bind('change', function() {sc_grid_Users_1_valida_mes(this)});
 }
 function sc_grid_Users_1_valida_dia(obj)
 {
 ...
 function sc_grid_Users_1_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_user_bod_cond'] = 'cond';
      $tp_fields['SC_user_bod_dia'] = 'text';
      $tp_fields['SC_user_bod_mes'] = 'text';
      $tp_fields['SC_user_bod_ano'] = 'text';
      $tp_fields['SC_user_bod_input_2_dia'] = 'text';
      $tp_fields['SC_user_bod_input_2_mes'] = 'text';
      $tp_fields['SC_user_bod_input_2_ano'] = 'text';
      $tp_fields['SC_user_id_cond'] = 'cond';
      $tp_fields['SC_user_id'] = 'text';
      $tp_fields['SC_user_name_cond'] = 'cond';
      $tp_fields['SC_user_name'] = 'text_aut';
      $tp_fields['id_ac_user_name'] = 'text_aut';
      $tp_fields['SC_user_docnum_cond'] = 'cond';
      $tp_fields['SC_user_docnum'] = 'text';
   ...
   {
      global $user_bod_cond, $user_bod, $user_bod_dia, $user_bod_mes, $user_bod_ano, $user_bod_input_2_dia, $user_bod_input_2_mes, $user_bod_input_2_ano,
             $user_id_cond, $user_id,
             $user_name_cond, $user_name, $user_name_autocomp,
             $user_docnum_cond, $user_docnum, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($user_name_autocomp) && empty($user_name))
      {
          $user_name = $user_name_autocomp;
      }
      $user_bod_cond_salva = $user_bod_cond; 
      if (!isset($user_bod_input_2_dia) || $user_bod_input_2_dia == "")
      {
          $user_bod_input_2_dia = $user_bod_dia;
      }
      if (!isset($user_bod_input_2_mes) || $user_bod_input_2_mes == "")
      {
          $user_bod_input_2_mes = $user_bod_mes;
      }
      if (!isset($user_bod_input_2_ano) || $user_bod_input_2_ano == "")
      {
          $user_bod_input_2_ano = $user_bod_ano;
      }
      ...
      $user_name_cond_salva = $user_name_cond; 
      if (!isset($user_name_input_2) || $user_name_input_2 == "")
      {
          $user_name_input_2 = $user_name;
      }
      $user_docnum_cond_salva = $user_docnum_cond; 
      if (!isset($user_docnum_input_2) || $user_docnum_input_2 == "")
      {
          $user_docnum_input_2 = $user_docnum;
      }
      if ($user_id_cond != "in")
      {
          nm_limpa_numero($user_id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($user_docnum_cond != "in")
      {
          nm_limpa_numero($user_docnum, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['user_bod_dia'] = $user_bod_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['user_bod_mes'] = $user_bod_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['user_bod_ano'] = $user_bod_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['user_bod_input_2_dia'] = $user_bod_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['user_bod_input_2_mes'] = $user_bod_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['user_bod_input_2_ano'] = $user_bod_input_2_ano; 
      if (!empty($user_bod_dia) || !empty($user_bod_mes) || !empty($user_bod_ano) || $user_bod_cond_salva == "nu" || $user_bod_cond_salva == "nn" || $user_bod_cond_salva == "ep" || $user_bod_cond_salva == "ne")
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $user_bod_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $user_bod_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $user_bod_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $user_bod_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $user_bod_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $user_bod_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['user_bod_cond'] = $user_bod_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['Grid_search'][$I_Grid]['cmp'] = "user_bod"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['Grid_search'][$I_Grid]['opc'] = $user_bod_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq']['user_bod'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['user_id'] = $user_id; 
      if (is_array($user_id) && !empty($user_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['Grid_search'][$I_Grid]['val'][0] = $user_id;
      }
      elseif ($user_id_cond_salva == "nu" || $user_id_cond_salva == "nn" || $user_id_cond_salva == "ep" || $user_id_cond_salva == "ne" || !empty($user_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['Grid_search'][$I_Grid]['val'][0][0] = $user_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['user_id_cond'] = $user_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['Grid_search'][$I_Grid]['cmp'] = "user_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['Grid_search'][$I_Grid]['opc'] = $user_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq']['user_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['user_name'] = $user_name; 
      if (is_array($user_name) && !empty($user_name))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['Grid_search'][$I_Grid]['val'][0] = $user_name;
      }
      elseif ($user_name_cond_salva == "nu" || $user_name_cond_salva == "nn" || $user_name_cond_salva == "ep" || $user_name_cond_salva == "ne" || !empty($user_name))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['Grid_search'][$I_Grid]['val'][0][0] = $user_name;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['user_name_cond'] = $user_name_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['Grid_search'][$I_Grid]['cmp'] = "user_name"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['Grid_search'][$I_Grid]['opc'] = $user_name_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq']['user_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['user_docnum'] = $user_docnum; 
      if (is_array($user_docnum) && !empty($user_docnum))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['Grid_search'][$I_Grid]['val'][0] = $user_docnum;
      }
      elseif ($user_docnum_cond_salva == "nu" || $user_docnum_cond_salva == "nn" || $user_docnum_cond_salva == "ep" || $user_docnum_cond_salva == "ne" || !empty($user_docnum))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['Grid_search'][$I_Grid]['val'][0][0] = $user_docnum;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['user_docnum_cond'] = $user_docnum_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['Grid_search'][$I_Grid]['cmp'] = "user_docnum"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['Grid_search'][$I_Grid]['opc'] = $user_docnum_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq']['user_docnum'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($user_name != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['user_name'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['user_name'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['user_name'] = $user_name;
      }
      $Conteudo = $user_docnum;
      if (strtoupper($user_docnum_cond) != "II" && strtoupper($user_docnum_cond) != "QP" && strtoupper($user_docnum_cond) != "NP" && strtoupper($user_docnum_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['user_docnum'] = $Conteudo;

      //----- $user_bod
      $this->Date_part = false;
      if ($user_bod_cond != "bi_TP")
      {
          $user_bod_cond = strtoupper($user_bod_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $user_bod_ano;
          $Dtxt .= $user_bod_mes;
          $Dtxt .= $user_bod_dia;
          $val[0]['ano'] = $user_bod_ano;
          $val[0]['mes'] = $user_bod_mes;
          $val[0]['dia'] = $user_bod_dia;
          if ($user_bod_cond == "BW")
          {
              $val[1]['ano'] = $user_bod_input_2_ano;
              $val[1]['mes'] = $user_bod_input_2_mes;
              $val[1]['dia'] = $user_bod_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DT", "DATE", $user_bod_cond, "", "data");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $user_bod = $val[0];
          $this->cmp_formatado['user_bod'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['user_bod'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['user_bod'], "YYYY-MM-DD");
          $this->cmp_formatado['user_bod'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($user_bod_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $user_bod_input_2     = $val[1];
              $this->cmp_formatado['user_bod_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']['user_bod_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['user_bod_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['user_bod_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $user_bod_cond == "NU" || $user_bod_cond == "NN"|| $user_bod_cond == "EP"|| $user_bod_cond == "NE")
          {
              $this->monta_condicao("user_bod", $user_bod_cond, $user_bod, $user_bod_input_2, 'user_bod', 'DATE');
          }
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq']['user_bod']['label'] = $nmgp_tab_label['user_bod'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq']['user_bod']['descr'] = $nmgp_tab_label['user_bod'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['grid_pesq']['user_bod']['hint']  = $nmgp_tab_label['user_bod'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
      ...
      //----- $user_name
      $this->Date_part = false;
      if (isset($user_name) || $user_name_cond == "nu" || $user_name_cond == "nn" || $user_name_cond == "ep" || $user_name_cond == "ne")
      {
         $this->monta_condicao("user_name", $user_name_cond, $user_name, "", "user_name", "VARCHAR", false);
      }

      //----- $user_docnum
      $this->Date_part = false;
      if (isset($user_docnum) || $user_docnum_cond == "nu" || $user_docnum_cond == "nn" || $user_docnum_cond == "ep" || $user_docnum_cond == "ne")
      {
         $this->monta_condicao("user_docnum", $user_docnum_cond, $user_docnum, "", "user_docnum", "INT", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Users_1']['cond_pesq'] .= $this->NM_operador;
