<?php
@session_start() ;
$_SESSION['scriptcase']['grid_Users_1']['sc_process_barr'] = true;
require_once('../grid_Users_1/index.php');
unset($_SESSION['scriptcase']['grid_Users_1']['sc_process_barr']);
$ExportCtrl = new grid_Users_1_export_control;
$ExportCtrl->Export_barr();

class grid_Users_1_export_control
{
