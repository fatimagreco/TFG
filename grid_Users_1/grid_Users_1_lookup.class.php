<?php
class grid_Users_1_lookup
{
//  
   function lookup_pos_id(&$conteudo , $pos_id) 
   {   
      ...
      $nm_comando = "select pos_name from positions where pos_id = $pos_id order by pos_name" ; 
      $conteudo = "" ; 
