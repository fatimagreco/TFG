...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "user_bod";$Nm_numeric[] = "user_id";$Nm_numeric[] = "user_docnum";$Nm_numeric[] = "user_phone";$Nm_numeric[] = "btyp_id";$Nm_numeric[] = "pos_id";$Nm_numeric[] = "gerens_id";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_user_bod_cond" name="user_bod_cond" onChange="nm_campos_between(document.getElementById('id_vis_user_bod'), this, 'user_bod')">
      ...
      <br><span id="id_hide_user_bod"  <?php echo $str_hide_user_bod?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
 ...
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_user_bod"  <?php echo $str_display_user_bod; ?> class="scFilterFieldFontOdd">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_user_name_cond" name="user_name_cond" onChange="nm_campos_between(document.getElementById('id_vis_user_name'), this, 'user_name')">
      ...
      <br><span id="id_hide_user_name"  <?php echo $str_hide_user_name?>><?php
      if ($user_name != "")
      {
      $user_name_look = (is_string($user_name) ? substr($this->Db->qstr($user_name), 1, -1) : $user_name); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_user_docnum_cond" name="user_docnum_cond" onChange="nm_campos_between(document.getElementById('id_vis_user_docnum'), this, 'user_docnum')">
      ...
      <br><span id="id_hide_user_docnum"  <?php echo $str_hide_user_docnum?>><INPUT  type="text" id="SC_user_docnum" name="user_docnum" value="<?php echo NM_encode_input($user_docnum) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
