  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_calendario_consultas_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_calendario_consultas_mob_form();
	}
...
?>
  ...
  // ---------- Validate pati_id
  function do_ajax_calendario_consultas_mob_validate_pati_id()
  {
    var nomeCampo_pati_id = "pati_id";
    var var_pati_id = scAjaxGetFieldSelect(nomeCampo_pati_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendario_consultas_mob_validate_pati_id(var_pati_id, var_script_case_init, do_ajax_calendario_consultas_mob_validate_pati_id_cb);
  } // do_ajax_calendario_consultas_mob_validate_pati_id

  function do_ajax_calendario_consultas_mob_validate_pati_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendario_consultas_mob_validate_pati_id_cb

  // ---------- Validate pat_phone
  function do_ajax_calendario_consultas_mob_validate_pat_phone()
  {
    var nomeCampo_pat_phone = "pat_phone";
    var var_pat_phone = scAjaxGetFieldText(nomeCampo_pat_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendario_consultas_mob_validate_pat_phone(var_pat_phone, var_script_case_init, do_ajax_calendario_consultas_mob_validate_pat_phone_cb);
  } // do_ajax_calendario_consultas_mob_validate_pat_phone

  function do_ajax_calendario_consultas_mob_validate_pat_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendario_consultas_mob_validate_pat_phone_cb

  // ---------- Validate pat_lname
  function do_ajax_calendario_consultas_mob_validate_pat_lname()
  {
    var nomeCampo_pat_lname = "pat_lname";
    var var_pat_lname = scAjaxGetFieldText(nomeCampo_pat_lname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendario_consultas_mob_validate_pat_lname(var_pat_lname, var_script_case_init, do_ajax_calendario_consultas_mob_validate_pat_lname_cb);
  } // do_ajax_calendario_consultas_mob_validate_pat_lname

  function do_ajax_calendario_consultas_mob_validate_pat_lname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendario_consultas_mob_validate_pat_lname_cb

  // ---------- Validate pat_name
  function do_ajax_calendario_consultas_mob_validate_pat_name()
  {
    var nomeCampo_pat_name = "pat_name";
    var var_pat_name = scAjaxGetFieldText(nomeCampo_pat_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendario_consultas_mob_validate_pat_name(var_pat_name, var_script_case_init, do_ajax_calendario_consultas_mob_validate_pat_name_cb);
  } // do_ajax_calendario_consultas_mob_validate_pat_name

  function do_ajax_calendario_consultas_mob_validate_pat_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendario_consultas_mob_validate_pat_name_cb

  // ---------- Validate pat_bod
  function do_ajax_calendario_consultas_mob_validate_pat_bod()
  {
    var nomeCampo_pat_bod = "pat_bod";
    var var_pat_bod = scAjaxGetFieldText(nomeCampo_pat_bod);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendario_consultas_mob_validate_pat_bod(var_pat_bod, var_script_case_init, do_ajax_calendario_consultas_mob_validate_pat_bod_cb);
  } // do_ajax_calendario_consultas_mob_validate_pat_bod

  function do_ajax_calendario_consultas_mob_validate_pat_bod_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pat_bod";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendario_consultas_mob_validate_pat_bod_cb

  // ---------- Validate pat_gerens
  function do_ajax_calendario_consultas_mob_validate_pat_gerens()
  {
    var nomeCampo_pat_gerens = "pat_gerens";
    var var_pat_gerens = scAjaxGetFieldRadio(nomeCampo_pat_gerens);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendario_consultas_mob_validate_pat_gerens(var_pat_gerens, var_script_case_init, do_ajax_calendario_consultas_mob_validate_pat_gerens_cb);
  } // do_ajax_calendario_consultas_mob_validate_pat_gerens

  function do_ajax_calendario_consultas_mob_validate_pat_gerens_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendario_consultas_mob_validate_pat_gerens_cb

  // ---------- Validate anam_career
  function do_ajax_calendario_consultas_mob_validate_anam_career()
  {
    var nomeCampo_anam_career = "anam_career";
    var var_anam_career = scAjaxGetFieldText(nomeCampo_anam_career);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendario_consultas_mob_validate_anam_career(var_anam_career, var_script_case_init, do_ajax_calendario_consultas_mob_validate_anam_career_cb);
  } // do_ajax_calendario_consultas_mob_validate_anam_career

  function do_ajax_calendario_consultas_mob_validate_anam_career_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendario_consultas_mob_validate_anam_career_cb

  // ---------- Validate anam_carsem
  function do_ajax_calendario_consultas_mob_validate_anam_carsem()
  {
    var nomeCampo_anam_carsem = "anam_carsem";
    var var_anam_carsem = scAjaxGetFieldText(nomeCampo_anam_carsem);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendario_consultas_mob_validate_anam_carsem(var_anam_carsem, var_script_case_init, do_ajax_calendario_consultas_mob_validate_anam_carsem_cb);
  } // do_ajax_calendario_consultas_mob_validate_anam_carsem

  function do_ajax_calendario_consultas_mob_validate_anam_carsem_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendario_consultas_mob_validate_anam_carsem_cb

  // ---------- Validate btyp_id
  function do_ajax_calendario_consultas_mob_validate_btyp_id()
  {
    var nomeCampo_btyp_id = "btyp_id";
    var var_btyp_id = scAjaxGetFieldSelect(nomeCampo_btyp_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendario_consultas_mob_validate_btyp_id(var_btyp_id, var_script_case_init, do_ajax_calendario_consultas_mob_validate_btyp_id_cb);
  } // do_ajax_calendario_consultas_mob_validate_btyp_id

  function do_ajax_calendario_consultas_mob_validate_btyp_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "btyp_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendario_consultas_mob_validate_btyp_id_cb

  // ---------- Validate pati_famphone
  function do_ajax_calendario_consultas_mob_validate_pati_famphone()
  {
    var nomeCampo_pati_famphone = "pati_famphone";
    var var_pati_famphone = scAjaxGetFieldText(nomeCampo_pati_famphone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendario_consultas_mob_validate_pati_famphone(var_pati_famphone, var_script_case_init, do_ajax_calendario_consultas_mob_validate_pati_famphone_cb);
  } // do_ajax_calendario_consultas_mob_validate_pati_famphone

  function do_ajax_calendario_consultas_mob_validate_pati_famphone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pati_famphone";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendario_consultas_mob_validate_pati_famphone_cb

  // ---------- Validate pati_famname
  function do_ajax_calendario_consultas_mob_validate_pati_famname()
  {
    var nomeCampo_pati_famname = "pati_famname";
    var var_pati_famname = scAjaxGetFieldText(nomeCampo_pati_famname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendario_consultas_mob_validate_pati_famname(var_pati_famname, var_script_case_init, do_ajax_calendario_consultas_mob_validate_pati_famname_cb);
  } // do_ajax_calendario_consultas_mob_validate_pati_famname

  function do_ajax_calendario_consultas_mob_validate_pati_famname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pati_famname";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendario_consultas_mob_validate_pati_famname_cb

  // ---------- Validate consul_date
  function do_ajax_calendario_consultas_mob_validate_consul_date()
  {
    var nomeCampo_consul_date = "consul_date";
    var var_consul_date = scAjaxGetFieldText(nomeCampo_consul_date);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_consul_date = scAjaxGetFieldText(nomeCampo_consul_date);
      x_ajax_calendario_consultas_mob_validate_consul_date(var_consul_date, var_script_case_init, do_ajax_calendario_consultas_mob_validate_consul_date_cb);
    }, 200);
  } // do_ajax_calendario_consultas_mob_validate_consul_date

  function do_ajax_calendario_consultas_mob_validate_consul_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "consul_date";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendario_consultas_mob_validate_consul_date_cb

  // ---------- Validate consul_strtime
  function do_ajax_calendario_consultas_mob_validate_consul_strtime()
  {
    var nomeCampo_consul_strtime = "consul_strtime";
    var var_consul_strtime = scAjaxGetFieldText(nomeCampo_consul_strtime);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendario_consultas_mob_validate_consul_strtime(var_consul_strtime, var_script_case_init, do_ajax_calendario_consultas_mob_validate_consul_strtime_cb);
  } // do_ajax_calendario_consultas_mob_validate_consul_strtime

  function do_ajax_calendario_consultas_mob_validate_consul_strtime_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "consul_strtime";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendario_consultas_mob_validate_consul_strtime_cb

  // ---------- Validate consul_endtime
  function do_ajax_calendario_consultas_mob_validate_consul_endtime()
  {
    var nomeCampo_consul_endtime = "consul_endtime";
    var var_consul_endtime = scAjaxGetFieldText(nomeCampo_consul_endtime);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendario_consultas_mob_validate_consul_endtime(var_consul_endtime, var_script_case_init, do_ajax_calendario_consultas_mob_validate_consul_endtime_cb);
  } // do_ajax_calendario_consultas_mob_validate_consul_endtime

  function do_ajax_calendario_consultas_mob_validate_consul_endtime_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "consul_endtime";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendario_consultas_mob_validate_consul_endtime_cb

  // ---------- Validate user_id
  function do_ajax_calendario_consultas_mob_validate_user_id()
  {
    var nomeCampo_user_id = "user_id";
    var var_user_id = scAjaxGetFieldSelect(nomeCampo_user_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendario_consultas_mob_validate_user_id(var_user_id, var_script_case_init, do_ajax_calendario_consultas_mob_validate_user_id_cb);
  } // do_ajax_calendario_consultas_mob_validate_user_id

  function do_ajax_calendario_consultas_mob_validate_user_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendario_consultas_mob_validate_user_id_cb

  // ---------- Validate consul_reason
  function do_ajax_calendario_consultas_mob_validate_consul_reason()
  {
    var nomeCampo_consul_reason = "consul_reason";
    var var_consul_reason = scAjaxGetFieldText(nomeCampo_consul_reason);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendario_consultas_mob_validate_consul_reason(var_consul_reason, var_script_case_init, do_ajax_calendario_consultas_mob_validate_consul_reason_cb);
  } // do_ajax_calendario_consultas_mob_validate_consul_reason

  function do_ajax_calendario_consultas_mob_validate_consul_reason_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "consul_reason";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendario_consultas_mob_validate_consul_reason_cb

  // ---------- Validate consul_anot
  function do_ajax_calendario_consultas_mob_validate_consul_anot()
  {
    var nomeCampo_consul_anot = "consul_anot";
    var var_consul_anot = scAjaxGetFieldText(nomeCampo_consul_anot);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendario_consultas_mob_validate_consul_anot(var_consul_anot, var_script_case_init, do_ajax_calendario_consultas_mob_validate_consul_anot_cb);
  } // do_ajax_calendario_consultas_mob_validate_consul_anot

  function do_ajax_calendario_consultas_mob_validate_consul_anot_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "consul_anot";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendario_consultas_mob_validate_consul_anot_cb

  // ---------- Event onchange pati_id
  function do_ajax_calendario_consultas_mob_event_pati_id_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_calendario_consultas_mob_event_pati_id_onchange(var_pati_id, var_anam_career, var_anam_carsem, var_pat_bod, var_pat_name, var_pat_lname, var_pat_gerens, var_pat_phone, var_script_case_init, do_ajax_calendario_consultas_mob_event_pati_id_onchange_cb);
  } // do_ajax_calendario_consultas_mob_event_pati_id_onchange

  function do_ajax_calendario_consultas_mob_event_pati_id_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pati_id";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_calendario_consultas_mob_event_pati_id_onchange_cb_after_alert);
  } // do_ajax_calendario_consultas_mob_event_pati_id_onchange_cb
  function do_ajax_calendario_consultas_mob_event_pati_id_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_calendario_consultas_mob_event_pati_id_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_calendario_consultas_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_calendario_consultas_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_pati_id = scAjaxGetFieldSelect("pati_id");
    ...
    var var_anam_career = scAjaxGetFieldText("anam_career");
    var var_anam_carsem = scAjaxGetFieldText("anam_carsem");
    var var_btyp_id = scAjaxGetFieldSelect("btyp_id");
    var var_pati_famphone = scAjaxGetFieldText("pati_famphone");
    var var_pati_famname = scAjaxGetFieldText("pati_famname");
    var var_consul_date = scAjaxGetFieldText("consul_date");
    var var_consul_strtime = scAjaxGetFieldText("consul_strtime");
    var var_consul_endtime = scAjaxGetFieldText("consul_endtime");
    var var_user_id = scAjaxGetFieldSelect("user_id");
    var var_consul_reason = scAjaxGetFieldText("consul_reason");
    var var_consul_anot = scAjaxGetFieldText("consul_anot");
    var var_consul_id = scAjaxGetFieldText("consul_id");
    ...
    scAjaxProcOn();
    x_ajax_calendario_consultas_mob_submit_form(var_pati_id, var_pat_phone, var_pat_lname, var_pat_name, var_pat_bod, var_pat_gerens, var_anam_career, var_anam_carsem, var_btyp_id, var_pati_famphone, var_pati_famname, var_consul_date, var_consul_strtime, var_consul_endtime, var_user_id, var_consul_reason, var_consul_anot, var_consul_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_calendario_consultas_mob_submit_form_cb);
  } // do_ajax_calendario_consultas_mob_submit_form

  function do_ajax_calendario_consultas_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_calendario_consultas_mob_submit_form_cb_after_alert);
  } // do_ajax_calendario_consultas_mob_submit_form_cb
  function do_ajax_calendario_consultas_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_calendario_consultas_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_calendario_consultas_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_calendario_consultas_mob_navigate_form, function() {});
    } else {
      perform_ajax_calendario_consultas_mob_navigate_form();
    }
  }

  function perform_ajax_calendario_consultas_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    var var_consul_id = document.F2.consul_id.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_calendario_consultas_mob_navigate_form(var_consul_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_calendario_consultas_mob_navigate_form_cb);
  } // do_ajax_calendario_consultas_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_calendario_consultas_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.consul_id.value = scAjaxGetKeyValue("consul_id");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_calendario_consultas_mob_navigate_form_cb_after_alert);
  } // do_ajax_calendario_consultas_mob_navigate_form_cb
  function do_ajax_calendario_consultas_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_calendario_consultas_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_calendario_consultas_mob_navigate_form_cb_after_alert

  function sc_hide_calendario_consultas_mob_form()
  {
  ...
  ajax_field_list[0] = "pati_id";
  ajax_field_list[1] = "pat_phone";
  ajax_field_list[2] = "pat_lname";
  ajax_field_list[3] = "pat_name";
  ajax_field_list[4] = "pat_bod";
  ajax_field_list[5] = "pat_gerens";
  ajax_field_list[6] = "anam_career";
  ajax_field_list[7] = "anam_carsem";
  ajax_field_list[8] = "btyp_id";
  ajax_field_list[9] = "pati_famphone";
  ajax_field_list[10] = "pati_famname";
  ajax_field_list[11] = "consul_date";
  ajax_field_list[12] = "consul_strtime";
  ajax_field_list[13] = "consul_endtime";
  ajax_field_list[14] = "user_id";
  ajax_field_list[15] = "consul_reason";
  ajax_field_list[16] = "consul_anot";
  ...
  var ajax_error_list = {
    "pati_id": {"label": "Paciente", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "pat_phone": {"label": "Celular", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "pat_lname": {"label": "Apellido", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "pat_name": {"label": "Nombre", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "pat_bod": {"label": "Fecha de Nacimiento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "pat_gerens": {"label": "Genero", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "anam_career": {"label": "Carrera", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "anam_carsem": {"label": "Semestre", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "btyp_id": {"label": "Grupo Sanguíneo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "pati_famphone": {"label": "Nombre Familiar", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "pati_famname": {"label": "Numero  Familiar", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "consul_date": {"label": "Fecha", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "consul_strtime": {"label": "Hora Inicio", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "consul_endtime": {"label": "Hora Final", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "user_id": {"label": "Tratante", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "consul_reason": {"label": "Motivo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "consul_anot": {"label": "Anotaciones", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    ...
    "btyp_id": new Array(),
    "pati_famphone": new Array(),
    "pati_famname": new Array(),
    "consul_date": new Array(),
    "consul_strtime": new Array(),
    "consul_endtime": new Array(),
    "user_id": new Array(),
    "consul_reason": new Array(),
    "consul_anot": new Array()
  };
  ...
  ajax_field_mult["btyp_id"][1] = "btyp_id";
  ajax_field_mult["pati_famphone"][1] = "pati_famphone";
  ajax_field_mult["pati_famname"][1] = "pati_famname";
  ajax_field_mult["consul_date"][1] = "consul_date";
  ajax_field_mult["consul_strtime"][1] = "consul_strtime";
  ajax_field_mult["consul_endtime"][1] = "consul_endtime";
  ajax_field_mult["user_id"][1] = "user_id";
  ajax_field_mult["consul_reason"][1] = "consul_reason";
  ajax_field_mult["consul_anot"][1] = "consul_anot";
  ...
  var ajax_field_id = {
    ...
    "btyp_id": new Array("hidden_field_label_btyp_id", "hidden_field_data_btyp_id"),
    "pati_famphone": new Array("hidden_field_label_pati_famphone", "hidden_field_data_pati_famphone"),
    "pati_famname": new Array("hidden_field_label_pati_famname", "hidden_field_data_pati_famname"),
    "consul_date": new Array("hidden_field_label_consul_date", "hidden_field_data_consul_date"),
    "consul_strtime": new Array("hidden_field_label_consul_strtime", "hidden_field_data_consul_strtime"),
    "consul_endtime": new Array("hidden_field_label_consul_endtime", "hidden_field_data_consul_endtime"),
    "user_id": new Array("hidden_field_label_user_id", "hidden_field_data_user_id"),
    "consul_reason": new Array("hidden_field_label_consul_reason", "hidden_field_data_consul_reason"),
    "consul_anot": new Array("hidden_field_label_consul_anot", "hidden_field_data_consul_anot")
  };
