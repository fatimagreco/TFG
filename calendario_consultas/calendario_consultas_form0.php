...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2-4.0.6/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>calendario_consultas/calendario_consultas_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("calendario_consultas_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('calendario_consultas_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['link_info']['remove_border']) {
...
<?php
 include_once("calendario_consultas_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['calendario_consultas'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['calendario_consultas'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-3';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pati_id_label" id="hidden_field_label_pati_id" style="<?php echo $sStyleHidden_pati_id; ?>"><span id="id_label_pati_id"><?php echo $this->nm_new_label['pati_id']; ?></span></TD>
    <TD class="scFormDataOdd css_pati_id_line" id="hidden_field_data_pati_id" style="<?php echo $sStyleHidden_pati_id; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pat_phone_line" id="hidden_field_data_pat_phone" style="<?php echo $sStyleHidden_pat_phone; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pat_lname_line" id="hidden_field_data_pat_lname" style="<?php echo $sStyleHidden_pat_lname; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pat_name_line" id="hidden_field_data_pat_name" style="<?php echo $sStyleHidden_pat_name; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pat_bod_line" id="hidden_field_data_pat_bod" style="<?php echo $sStyleHidden_pat_bod; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pat_gerens_line" id="hidden_field_data_pat_gerens" style="<?php echo $sStyleHidden_pat_gerens; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_anam_career_line" id="hidden_field_data_anam_career" style="<?php echo $sStyleHidden_anam_career; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_btyp_id_line" id="hidden_field_data_btyp_id" style="<?php echo $sStyleHidden_btyp_id; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pati_famphone_label" id="hidden_field_label_pati_famphone" style="<?php echo $sStyleHidden_pati_famphone; ?>"><span id="id_label_pati_famphone"><?php echo $this->nm_new_label['pati_famphone']; ?></span></TD>
    <TD class="scFormDataOdd css_pati_famphone_line" id="hidden_field_data_pati_famphone" style="<?php echo $sStyleHidden_pati_famphone; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pati_famname_label" id="hidden_field_label_pati_famname" style="<?php echo $sStyleHidden_pati_famname; ?>"><span id="id_label_pati_famname"><?php echo $this->nm_new_label['pati_famname']; ?></span></TD>
    <TD class="scFormDataOdd css_pati_famname_line" id="hidden_field_data_pati_famname" style="<?php echo $sStyleHidden_pati_famname; ?>">
...
<?php } 
?> 
<?php $sStyleHidden_consul_date_dumb = ('' == $sStyleHidden_consul_date) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_consul_date_dumb" style="<?php echo $sStyleHidden_consul_date_dumb; ?>"></TD>
<?php $sStyleHidden_consul_strtime_dumb = ('' == $sStyleHidden_consul_strtime) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_consul_strtime_dumb" style="<?php echo $sStyleHidden_consul_strtime_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_user_id_line" id="hidden_field_data_user_id" style="<?php echo $sStyleHidden_user_id; ?>"> <span class="scFormLabelOddFormat css_user_id_label" style=""><span id="id_label_user_id"><?php echo $this->nm_new_label['user_id']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['php_cmp_required']['user_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['php_cmp_required']['user_id'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_consul_endtime_dumb = ('' == $sStyleHidden_consul_endtime) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_consul_endtime_dumb" style="<?php echo $sStyleHidden_consul_endtime_dumb; ?>"></TD>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['btn_label'][''];
        }
?>
<?php
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("calendario_consultas");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("calendario_consultas");
 parent.scAjaxDetailHeight("calendario_consultas", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['calendario_consultas']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
