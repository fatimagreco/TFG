...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>sec_Login/sec_Login_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['btn_disabled']['last'] : 'off'); ?>";
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
else
{
    ...
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['link_info']['remove_border']) {
...
if (isset($_SESSION['scriptcase']['sec_Login']['error_buffer']) && '' != $_SESSION['scriptcase']['sec_Login']['error_buffer'])
{
    echo $_SESSION['scriptcase']['sec_Login']['error_buffer'];
}
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['where_filter']))
       {
...
<span id="id_read_on_login" class="sc-ui-readonly-login css_login_line" style="<?php echo $sStyleReadLab_login; ?>"><?php echo $this->form_format_readonly("login", $this->form_encode_input($this->login)); ?></span><span id="id_read_off_login" class="css_read_off_login<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_login; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=35"; } ?> maxlength=255 alt="{datatype: 'text', maxLength: 255, allowedChars: '<?php echo $this->allowedCharsCharset("0123456789") ?>', lettersCase: '', enterTab: false, enterSubmit: true, autoTab: false, selectOnFocus: false, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
 </TD>
   <?php }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['Lookup_remember_me'][] = '1'; ?>
...
<input type="hidden" name="new_user_sc_target_name" value = "">
 ...
 <a href="javascript:nm_menu_link_new_user('sec_form_add_users', '_self')" class="scFormLinkOdd"><?php echo $this->Ini->Nm_lang['lang_new_user'] ?></a>
<?php  } ?>
 </TD>
   <?php }?>
...
<input type="hidden" name="retrieve_pswd_sc_target_name" value = "">
 ...
 <a href="javascript:nm_menu_link_retrieve_pswd('sec_retrieve_pswd', '_self')" class="scFormLinkOdd"><?php echo $this->Ini->Nm_lang['lang_subject_mail'] ?></a>
<?php  } ?>
 </TD>
   <?php }?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['btn_disabled']['ok']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['btn_disabled']['ok']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['btn_label']['ok']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['btn_label']['ok']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['btn_label']['ok'];
        }
?>
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("sec_Login_mob");
</script>
<?php
    }
    else {
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
