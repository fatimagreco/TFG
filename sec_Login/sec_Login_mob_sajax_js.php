...
?>
  ...
  function do_ajax_sec_Login_mob_validate_remember_me()
  {
    var nomeCampo_remember_me = "remember_me";
    var var_remember_me = scAjaxGetFieldCheckbox(nomeCampo_remember_me, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_Login_mob_validate_remember_me(var_remember_me, var_script_case_init, do_ajax_sec_Login_mob_validate_remember_me_cb);
  } // do_ajax_sec_Login_mob_validate_remember_me

  function do_ajax_sec_Login_mob_validate_remember_me_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_Login_mob_validate_remember_me_cb

  // ---------- Validate new_user
  function do_ajax_sec_Login_mob_validate_new_user()
  {
    var nomeCampo_new_user = "new_user";
    var var_new_user = scAjaxGetFieldText(nomeCampo_new_user);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_Login_mob_validate_new_user(var_new_user, var_script_case_init, do_ajax_sec_Login_mob_validate_new_user_cb);
  } // do_ajax_sec_Login_mob_validate_new_user

  function do_ajax_sec_Login_mob_validate_new_user_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_Login_mob_validate_new_user_cb

  // ---------- Validate retrieve_pswd
  function do_ajax_sec_Login_mob_validate_retrieve_pswd()
  {
    var nomeCampo_retrieve_pswd = "retrieve_pswd";
    var var_retrieve_pswd = scAjaxGetFieldText(nomeCampo_retrieve_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_Login_mob_validate_retrieve_pswd(var_retrieve_pswd, var_script_case_init, do_ajax_sec_Login_mob_validate_retrieve_pswd_cb);
  } // do_ajax_sec_Login_mob_validate_retrieve_pswd

  function do_ajax_sec_Login_mob_validate_retrieve_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_Login_mob_validate_retrieve_pswd_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_sec_Login_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_sec_Login_mob_submit_form(var_login, var_pswd, var_remember_me, var_new_user, var_retrieve_pswd, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_sec_Login_mob_submit_form_cb);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_sec_Login_mob_submit_form_cb_after_alert);
  } // do_ajax_sec_Login_mob_submit_form_cb
  function do_ajax_sec_Login_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_sec_Login_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_sec_Login_mob_navigate_form()
  {
    perform_ajax_sec_Login_mob_navigate_form();
  }

  function perform_ajax_sec_Login_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
  ...
  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_sec_Login_mob_navigate_form_cb(sResp)
  {
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_sec_Login_mob_navigate_form_cb_after_alert);
  } // do_ajax_sec_Login_mob_navigate_form_cb
  function do_ajax_sec_Login_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('login');
...
?>
  ...
  } // do_ajax_sec_Login_mob_navigate_form_cb_after_alert
