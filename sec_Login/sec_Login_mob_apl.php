...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['sec_Login_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['sec_Login_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['sec_Login_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['sec_Login_mob']['embutida_parms'];
...
$_SESSION['scriptcase']['sec_Login_mob']['contr_erro'] = 'off';
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sec_Login_mob']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sec_Login_mob']['label'] = "Login";
      ...
      $_SESSION['scriptcase']['error_icon']['sec_Login_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      ...
      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['buttonStatus'];
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['sec_Login_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['sec_Login_mob'];
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['opc_ant'] : "";
      } 
...
$_SESSION['scriptcase']['sec_Login_mob']['contr_erro'] = 'off'; 
            ...
            $out1_img_cache = $_SESSION['scriptcase']['sec_Login_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['sec_Login_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
...
//
      if (!isset($nm_form_submit) && $this->nmgp_opcao != "nada")
      {
          ...
          $this->new_user = "" ;  
          $this->retrieve_pswd = "" ;  
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['dados_form']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['dados_form']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['dados_form'] as $NM_campo => $NM_valor)
              {
                  $$NM_campo = $NM_valor;
              }
          }
      ...
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          ...
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['campos']))
              { 
                  $login = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['campos'][0]; 
                  $pswd = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['campos'][1]; 
                  $remember_me = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['campos'][2]; 
                  $new_user = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['campos'][3]; 
                  $retrieve_pswd = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['campos'][4]; 
              } 
          }
          $this->nm_gera_html();
          $this->NM_close_db(); 
      ...
      elseif (isset($this->bok) && $this->bok == "OK")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['campos'][2] = $this->remember_me; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['campos'][3] = $this->new_user; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['campos'][4] = $this->retrieve_pswd; 
          ...
          else
          {
              ...
              {
                  $this->nm_gera_html();
                  if (!$_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['embutida_proc'])
                  { 
                      $this->NM_close_db(); 
                  } 
              }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "sec_Login_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="sec_Login_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="sec_Login_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="sec_Login_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO audit (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'sec_Login_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO audit (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'sec_Login_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO audit (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'sec_Login_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
$aLookup[] = array(sec_Login_mob_pack_protect_string('1') => str_replace('<', '&lt;',sec_Login_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_remember_me'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['Lookup_remember_me'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['remember_me']['valList'][$i] = sec_Login_mob_pack_protect_string($v);
          }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['where_filter']);
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['where_detal'];
          }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['where_filter'] = $comando;
...
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['dashboard_info']['parent_widget']; ?>']");
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['opc_ant'] = "";
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['ordem_ord'] == " desc") {
