  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_Users_1" == sTestField)
        {
...
?>
  ...
  // ---------- Validate user_id
  function do_ajax_form_Users_1_validate_user_id()
  {
    var nomeCampo_user_id = "user_id";
    var var_user_id = scAjaxGetFieldHidden(nomeCampo_user_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Users_1_validate_user_id(var_user_id, var_script_case_init, do_ajax_form_Users_1_validate_user_id_cb);
  } // do_ajax_form_Users_1_validate_user_id

  function do_ajax_form_Users_1_validate_user_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Users_1_validate_user_id_cb

  // ---------- Validate user_name
  function do_ajax_form_Users_1_validate_user_name()
  {
    var nomeCampo_user_name = "user_name";
    var var_user_name = scAjaxGetFieldText(nomeCampo_user_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Users_1_validate_user_name(var_user_name, var_script_case_init, do_ajax_form_Users_1_validate_user_name_cb);
  } // do_ajax_form_Users_1_validate_user_name

  function do_ajax_form_Users_1_validate_user_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Users_1_validate_user_name_cb

  // ---------- Validate user_docnum
  function do_ajax_form_Users_1_validate_user_docnum()
  {
    var nomeCampo_user_docnum = "user_docnum";
    var var_user_docnum = scAjaxGetFieldText(nomeCampo_user_docnum);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Users_1_validate_user_docnum(var_user_docnum, var_script_case_init, do_ajax_form_Users_1_validate_user_docnum_cb);
  } // do_ajax_form_Users_1_validate_user_docnum

  function do_ajax_form_Users_1_validate_user_docnum_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Users_1_validate_user_docnum_cb

  // ---------- Validate user_bod
  function do_ajax_form_Users_1_validate_user_bod()
  {
    var nomeCampo_user_bod = "user_bod";
    var var_user_bod = scAjaxGetFieldText(nomeCampo_user_bod);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Users_1_validate_user_bod(var_user_bod, var_script_case_init, do_ajax_form_Users_1_validate_user_bod_cb);
  } // do_ajax_form_Users_1_validate_user_bod

  function do_ajax_form_Users_1_validate_user_bod_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Users_1_validate_user_bod_cb

  // ---------- Validate user_phone
  function do_ajax_form_Users_1_validate_user_phone()
  {
    var nomeCampo_user_phone = "user_phone";
    var var_user_phone = scAjaxGetFieldText(nomeCampo_user_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Users_1_validate_user_phone(var_user_phone, var_script_case_init, do_ajax_form_Users_1_validate_user_phone_cb);
  } // do_ajax_form_Users_1_validate_user_phone

  function do_ajax_form_Users_1_validate_user_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Users_1_validate_user_phone_cb

  // ---------- Validate user_addreess
  function do_ajax_form_Users_1_validate_user_addreess()
  {
    var nomeCampo_user_addreess = "user_addreess";
    var var_user_addreess = scAjaxGetFieldText(nomeCampo_user_addreess);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Users_1_validate_user_addreess(var_user_addreess, var_script_case_init, do_ajax_form_Users_1_validate_user_addreess_cb);
  } // do_ajax_form_Users_1_validate_user_addreess

  function do_ajax_form_Users_1_validate_user_addreess_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Users_1_validate_user_addreess_cb

  // ---------- Validate user_email
  function do_ajax_form_Users_1_validate_user_email()
  {
    var nomeCampo_user_email = "user_email";
    var var_user_email = scAjaxGetFieldText(nomeCampo_user_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Users_1_validate_user_email(var_user_email, var_script_case_init, do_ajax_form_Users_1_validate_user_email_cb);
  } // do_ajax_form_Users_1_validate_user_email

  function do_ajax_form_Users_1_validate_user_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Users_1_validate_user_email_cb

  // ---------- Validate btyp_id
  function do_ajax_form_Users_1_validate_btyp_id()
  {
    var nomeCampo_btyp_id = "btyp_id";
    var var_btyp_id = scAjaxGetFieldSelect(nomeCampo_btyp_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Users_1_validate_btyp_id(var_btyp_id, var_script_case_init, do_ajax_form_Users_1_validate_btyp_id_cb);
  } // do_ajax_form_Users_1_validate_btyp_id

  function do_ajax_form_Users_1_validate_btyp_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "btyp_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Users_1_validate_btyp_id_cb

  // ---------- Validate pos_id
  function do_ajax_form_Users_1_validate_pos_id()
  {
    var nomeCampo_pos_id = "pos_id";
    var var_pos_id = scAjaxGetFieldSelect(nomeCampo_pos_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Users_1_validate_pos_id(var_pos_id, var_script_case_init, do_ajax_form_Users_1_validate_pos_id_cb);
  } // do_ajax_form_Users_1_validate_pos_id

  function do_ajax_form_Users_1_validate_pos_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pos_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Users_1_validate_pos_id_cb

  // ---------- Validate gerens_id
  function do_ajax_form_Users_1_validate_gerens_id()
  {
    var nomeCampo_gerens_id = "gerens_id";
    var var_gerens_id = scAjaxGetFieldRadio(nomeCampo_gerens_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Users_1_validate_gerens_id(var_gerens_id, var_script_case_init, do_ajax_form_Users_1_validate_gerens_id_cb);
  } // do_ajax_form_Users_1_validate_gerens_id

  function do_ajax_form_Users_1_validate_gerens_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Users_1_validate_gerens_id_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_Users_1_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_Users_1_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_Users_1_submit_form(var_user_id, var_user_name, var_user_docnum, var_user_bod, var_user_phone, var_user_addreess, var_user_email, var_btyp_id, var_pos_id, var_gerens_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_Users_1_submit_form_cb);
  } // do_ajax_form_Users_1_submit_form

  function do_ajax_form_Users_1_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_Users_1_submit_form_cb_after_alert);
  } // do_ajax_form_Users_1_submit_form_cb
  function do_ajax_form_Users_1_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_Users_1_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_Users_1_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_Users_1_navigate_form, function() {});
    } else {
      perform_ajax_form_Users_1_navigate_form();
    }
  }

  function perform_ajax_form_Users_1_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_Users_1_navigate_form(var_user_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_Users_1_navigate_form_cb);
  } // do_ajax_form_Users_1_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_Users_1_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_Users_1_navigate_form_cb_after_alert);
  } // do_ajax_form_Users_1_navigate_form_cb
  function do_ajax_form_Users_1_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_Users_1_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_Users_1_navigate_form_cb_after_alert

  function sc_hide_form_Users_1_form()
  {
