...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2-4.0.6/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_Users_1/form_Users_1_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_Users_1_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_Users_1_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['link_info']['remove_border']) {
...
<?php
 include_once("form_Users_1_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_Users_1'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_Users_1'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['run_iframe'] != "R")
{
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['fast_search'][2] : "";
...
<?php 
          ...
          $SC_Label_atu['user_name'] = (isset($this->nm_new_label['user_name'])) ? $this->nm_new_label['user_name'] : 'Nombre'; 
          $SC_Label_atu['user_docnum'] = (isset($this->nm_new_label['user_docnum'])) ? $this->nm_new_label['user_docnum'] : 'Nro. Documento'; 
          $SC_Label_atu['user_bod'] = (isset($this->nm_new_label['user_bod'])) ? $this->nm_new_label['user_bod'] : 'Fecha de Nacimiento'; 
          $SC_Label_atu['user_phone'] = (isset($this->nm_new_label['user_phone'])) ? $this->nm_new_label['user_phone'] : 'Telefono'; 
          $SC_Label_atu['user_addreess'] = (isset($this->nm_new_label['user_addreess'])) ? $this->nm_new_label['user_addreess'] : 'Dirección'; 
          $SC_Label_atu['user_email'] = (isset($this->nm_new_label['user_email'])) ? $this->nm_new_label['user_email'] : 'Correo Electronico'; 
          $SC_Label_atu['btyp_id'] = (isset($this->nm_new_label['btyp_id'])) ? $this->nm_new_label['btyp_id'] : 'Sangre'; 
          $SC_Label_atu['pos_id'] = (isset($this->nm_new_label['pos_id'])) ? $this->nm_new_label['pos_id'] : 'Ocupación'; 
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['breload']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['breload']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['breload']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['breload']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['breload'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<input type="hidden" name="user_id" value="<?php echo $this->form_encode_input($user_id) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_user_id_label" id="hidden_field_label_user_id" style="<?php echo $sStyleHidden_user_id; ?>"><span id="id_label_user_id"><?php echo $this->nm_new_label['user_id']; ?></span></TD>
    <TD class="scFormDataOdd css_user_id_line" id="hidden_field_data_user_id" style="<?php echo $sStyleHidden_user_id; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_user_id_line" style="vertical-align: top;padding: 0px"><span id="id_read_on_user_id" class="css_user_id_line" style="<?php echo $sStyleReadLab_user_id; ?>"><?php echo $this->form_format_readonly("user_id", $this->form_encode_input($this->user_id)); ?></span><span id="id_read_off_user_id" class="css_read_off_user_id" style="<?php echo $sStyleReadInp_user_id; ?>"><input type="hidden" name="user_id" value="<?php echo $this->form_encode_input($user_id) . "\">"?><span id="id_ajax_label_user_id"><?php echo nl2br($user_id); ?></span>
</span></span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_user_id_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_user_id_text"></span></td></tr></table></td></tr></table></TD>
   <?php }
      else
      {
         $sc_hidden_no--;
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_user_name_label" id="hidden_field_label_user_name" style="<?php echo $sStyleHidden_user_name; ?>"><span id="id_label_user_name"><?php echo $this->nm_new_label['user_name']; ?></span></TD>
    <TD class="scFormDataOdd css_user_name_line" id="hidden_field_data_user_name" style="<?php echo $sStyleHidden_user_name; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_user_name_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_user_docnum_label" id="hidden_field_label_user_docnum" style="<?php echo $sStyleHidden_user_docnum; ?>"><span id="id_label_user_docnum"><?php echo $this->nm_new_label['user_docnum']; ?></span></TD>
    <TD class="scFormDataOdd css_user_docnum_line" id="hidden_field_data_user_docnum" style="<?php echo $sStyleHidden_user_docnum; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_user_docnum_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_user_bod_label" id="hidden_field_label_user_bod" style="<?php echo $sStyleHidden_user_bod; ?>"><span id="id_label_user_bod"><?php echo $this->nm_new_label['user_bod']; ?></span></TD>
    <TD class="scFormDataOdd css_user_bod_line" id="hidden_field_data_user_bod" style="<?php echo $sStyleHidden_user_bod; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_user_bod_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_user_phone_label" id="hidden_field_label_user_phone" style="<?php echo $sStyleHidden_user_phone; ?>"><span id="id_label_user_phone"><?php echo $this->nm_new_label['user_phone']; ?></span></TD>
    <TD class="scFormDataOdd css_user_phone_line" id="hidden_field_data_user_phone" style="<?php echo $sStyleHidden_user_phone; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_user_phone_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_user_addreess_label" id="hidden_field_label_user_addreess" style="<?php echo $sStyleHidden_user_addreess; ?>"><span id="id_label_user_addreess"><?php echo $this->nm_new_label['user_addreess']; ?></span></TD>
    <TD class="scFormDataOdd css_user_addreess_line" id="hidden_field_data_user_addreess" style="<?php echo $sStyleHidden_user_addreess; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_user_addreess_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_user_email_label" id="hidden_field_label_user_email" style="<?php echo $sStyleHidden_user_email; ?>"><span id="id_label_user_email"><?php echo $this->nm_new_label['user_email']; ?></span></TD>
    <TD class="scFormDataOdd css_user_email_line" id="hidden_field_data_user_email" style="<?php echo $sStyleHidden_user_email; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_user_email_line" style="vertical-align: top;padding: 0px">
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   {
       $this->nm_new_label['btyp_id'] = "Sangre";
   }
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = (isset($nm_img_fun_cel) && $nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   {
       $this->nm_new_label['pos_id'] = "Ocupación";
   }
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = (isset($nm_img_fun_cel) && $nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $pos_id = $this->pos_id;
...
<input type=hidden name="pos_id" value="<?php echo $this->form_encode_input($this->pos_id) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_pos_id_label" id="hidden_field_label_pos_id" style="<?php echo $sStyleHidden_pos_id; ?>"><span id="id_label_pos_id"><?php echo $this->nm_new_label['pos_id']; ?></span></TD>
    <TD class="scFormDataOdd css_pos_id_line" id="hidden_field_data_pos_id" style="<?php echo $sStyleHidden_pos_id; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pos_id_line" style="vertical-align: top;padding: 0px">
...
<?php
   ...
   while (!empty($todo[$x])) 
   {
          ...
          if (empty($pos_id_look))
          {
              $pos_id_look = $this->pos_id;
          }
   $x = 0; 
   echo "<span id=\"id_read_on_pos_id\" class=\"css_pos_id_line\" style=\"" .  $sStyleReadLab_pos_id . "\">" . $this->form_format_readonly("pos_id", $this->form_encode_input($pos_id_look)) . "</span><span id=\"id_read_off_pos_id\" class=\"css_read_off_pos_id" . $this->classes_100perc_fields['span_input'] . "\" style=\"white-space: nowrap; " . $sStyleReadInp_pos_id . "\">";
   echo " <span id=\"idAjaxSelect_pos_id\" class=\"" . $this->classes_100perc_fields['span_select'] . "\"><select class=\"sc-js-input scFormObjectOdd css_pos_id_obj" . $this->classes_100perc_fields['input'] . "\" style=\"\" id=\"id_sc_field_pos_id\" name=\"pos_id\" size=\"1\" alt=\"{type: 'select', enterTab: false}\">" ; 
   echo "\r" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
          if ($cadaselect[1] == "@ ") {$cadaselect[1]= trim($cadaselect[1]); } ; 
          echo "  <option value=\"$cadaselect[1]\"" ; 
          if (trim($this->pos_id) === trim($cadaselect[1])) 
          {
              echo " selected" ; 
          }
          if (strtoupper($cadaselect[2]) == "S") 
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_Users_1");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_Users_1");
 parent.scAjaxDetailHeight("form_Users_1", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_1']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
