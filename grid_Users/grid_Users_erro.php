...
function scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="")
{
    ...
    if (isset($_SESSION['scriptcase']['grid_Users']['contr_erro']) && $_SESSION['scriptcase']['grid_Users']['contr_erro'] == 'on')
    {
...
<BODY>
<TABLE class="scErrorTable" cellspacing="0" cellpadding="0" align="left">
 <TR>
