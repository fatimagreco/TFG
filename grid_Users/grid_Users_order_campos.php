...
<?php
   ...
   $Ord_Cmp = new grid_Users_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_Users_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_Users']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_Users']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["user_docnum"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_Users']['labels']["user_docnum"])) ? $_SESSION['sc_session'][$sc_init]['grid_Users']['labels']["user_docnum"] : "Nro. Documento";
   $tab_ger_campos['user_name'] = "on";
   $tab_def_campos['user_name'] = "user_name";
   $tab_labels["user_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_Users']['labels']["user_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_Users']['labels']["user_name"] : "Nombre";
   $tab_ger_campos['user_bod'] = "on";
   $tab_def_campos['user_bod'] = "user_bod";
   $tab_labels["user_bod"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_Users']['labels']["user_bod"])) ? $_SESSION['sc_session'][$sc_init]['grid_Users']['labels']["user_bod"] : "Fecha de Nacimiento";
   $tab_ger_campos['user_phone'] = "on";
   $tab_def_campos['user_phone'] = "user_phone";
   $tab_labels["user_phone"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_Users']['labels']["user_phone"])) ? $_SESSION['sc_session'][$sc_init]['grid_Users']['labels']["user_phone"] : "Telefono";
   $tab_ger_campos['user_email'] = "on";
   $tab_def_campos['user_email'] = "user_email";
   $tab_labels["user_email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_Users']['labels']["user_email"])) ? $_SESSION['sc_session'][$sc_init]['grid_Users']['labels']["user_email"] : "Correo Electronico";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_Users']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_Users']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_Users']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_Users']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_Users']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_Users']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_Users']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_Users']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_Users']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_Users']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_Users']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_Users']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_Users_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_Users']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_Users']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_Users']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_Users']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_Users']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
