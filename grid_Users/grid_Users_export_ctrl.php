<?php
@session_start() ;
$_SESSION['scriptcase']['grid_Users']['sc_process_barr'] = true;
require_once('../grid_Users/index.php');
unset($_SESSION['scriptcase']['grid_Users']['sc_process_barr']);
$ExportCtrl = new grid_Users_export_control;
$ExportCtrl->Export_barr();

class grid_Users_export_control
{
