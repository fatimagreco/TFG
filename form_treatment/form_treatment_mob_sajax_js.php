  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_treatment_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_treatment_mob_form();
	}
...
?>
  ...
  // ---------- Validate treat_instruc
  function do_ajax_form_treatment_mob_validate_treat_instruc()
  {
    var nomeCampo_treat_instruc = "treat_instruc";
    var var_treat_instruc = scAjaxGetFieldText(nomeCampo_treat_instruc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_treatment_mob_validate_treat_instruc(var_treat_instruc, var_script_case_init, do_ajax_form_treatment_mob_validate_treat_instruc_cb);
  } // do_ajax_form_treatment_mob_validate_treat_instruc

  function do_ajax_form_treatment_mob_validate_treat_instruc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "treat_instruc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_treatment_mob_validate_treat_instruc_cb

  // ---------- Validate treat_restdays
  function do_ajax_form_treatment_mob_validate_treat_restdays()
  {
    var nomeCampo_treat_restdays = "treat_restdays";
    var var_treat_restdays = scAjaxGetFieldText(nomeCampo_treat_restdays);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_treatment_mob_validate_treat_restdays(var_treat_restdays, var_script_case_init, do_ajax_form_treatment_mob_validate_treat_restdays_cb);
  } // do_ajax_form_treatment_mob_validate_treat_restdays

  function do_ajax_form_treatment_mob_validate_treat_restdays_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "treat_restdays";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_treatment_mob_validate_treat_restdays_cb

  // ---------- Validate admtratamiento
  function do_ajax_form_treatment_mob_validate_admtratamiento()
  {
    var nomeCampo_admtratamiento = "admtratamiento";
    var var_admtratamiento = scAjaxGetFieldText(nomeCampo_admtratamiento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_treatment_mob_validate_admtratamiento(var_admtratamiento, var_script_case_init, do_ajax_form_treatment_mob_validate_admtratamiento_cb);
  } // do_ajax_form_treatment_mob_validate_admtratamiento

  function do_ajax_form_treatment_mob_validate_admtratamiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "admtratamiento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_treatment_mob_validate_admtratamiento_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_treatment_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_treatment_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_treat_instruc = scAjaxGetFieldText("treat_instruc");
    var var_treat_restdays = scAjaxGetFieldText("treat_restdays");
    var var_treat_id = scAjaxGetFieldText("treat_id");
    ...
    scAjaxProcOn();
    x_ajax_form_treatment_mob_submit_form(var_treat_instruc, var_treat_restdays, var_treat_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_treatment_mob_submit_form_cb);
  } // do_ajax_form_treatment_mob_submit_form

  function do_ajax_form_treatment_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("treat_instruc");
      scAjaxHideErrorDisplay("treat_restdays");
      scAjaxHideErrorDisplay("admtratamiento");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_treatment_mob_submit_form_cb_after_alert);
  } // do_ajax_form_treatment_mob_submit_form_cb
  function do_ajax_form_treatment_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_treatment_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_treat_details_mob"] = "off";

  function do_ajax_form_treatment_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_treatment_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_treatment_mob_navigate_form();
    }
  }

  function perform_ajax_form_treatment_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("treat_restdays");
    scAjaxHideErrorDisplay("admtratamiento");
    var var_treat_id = document.F2.treat_id.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_treat_details_mob"] = "on";
    x_ajax_form_treatment_mob_navigate_form(var_treat_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_treatment_mob_navigate_form_cb);
  } // do_ajax_form_treatment_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_treatment_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_treatment_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.treat_id.value = scAjaxGetKeyValue("treat_id");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_treat_details_mob"] && "nmsc_iframe_liga_form_treat_details_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_treat_details_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_treat_details_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_treat_details_mob').contentWindow.nm_move('apl_detalhe', true, '500px');
        document.getElementById('nmsc_iframe_liga_form_treat_details_mob').style.height = "500px";
        document.getElementById('nmsc_iframe_liga_form_treat_details_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_treatment_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_treatment_mob_navigate_form_cb
  function do_ajax_form_treatment_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_treatment_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_treatment_mob_navigate_form_cb_after_alert

  function sc_hide_form_treatment_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_treat_details_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "treat_instruc";
  ajax_field_list[1] = "treat_restdays";
  ajax_field_list[2] = "admtratamiento";
  ...
  var ajax_error_list = {
    "treat_instruc": {"label": "Indicaciones", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "treat_restdays": {"label": "Días de Reposo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "admtratamiento": {"label": "Tratamiento Administrado", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "treat_instruc": new Array(),
    "treat_restdays": new Array(),
    "admtratamiento": new Array()
  };
  ajax_field_mult["treat_instruc"][1] = "treat_instruc";
  ajax_field_mult["treat_restdays"][1] = "treat_restdays";
  ajax_field_mult["admtratamiento"][1] = "admtratamiento";

  var ajax_field_id = {
    "treat_instruc": new Array("hidden_field_label_treat_instruc", "hidden_field_data_treat_instruc"),
    "treat_restdays": new Array("hidden_field_label_treat_restdays", "hidden_field_data_treat_restdays"),
    "admtratamiento": new Array("hidden_field_label_admtratamiento", "hidden_field_data_admtratamiento")
  };
