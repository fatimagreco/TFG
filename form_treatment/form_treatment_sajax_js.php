  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_treatment" == sTestField)
        {
...
?>
  ...
  function do_ajax_form_treatment_validate_treat_instruc()
  {
    var nomeCampo_treat_instruc = "treat_instruc";
    var var_treat_instruc = scAjaxGetFieldText(nomeCampo_treat_instruc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_treatment_validate_treat_instruc(var_treat_instruc, var_script_case_init, do_ajax_form_treatment_validate_treat_instruc_cb);
  } // do_ajax_form_treatment_validate_treat_instruc

  function do_ajax_form_treatment_validate_treat_instruc_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_treatment_validate_treat_instruc_cb

  // ---------- Validate treat_restdays
  function do_ajax_form_treatment_validate_treat_restdays()
  {
    var nomeCampo_treat_restdays = "treat_restdays";
    var var_treat_restdays = scAjaxGetFieldText(nomeCampo_treat_restdays);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_treatment_validate_treat_restdays(var_treat_restdays, var_script_case_init, do_ajax_form_treatment_validate_treat_restdays_cb);
  } // do_ajax_form_treatment_validate_treat_restdays

  function do_ajax_form_treatment_validate_treat_restdays_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_treatment_validate_treat_restdays_cb

  // ---------- Validate admtratamiento
  function do_ajax_form_treatment_validate_admtratamiento()
  {
    var nomeCampo_admtratamiento = "admtratamiento";
    var var_admtratamiento = scAjaxGetFieldText(nomeCampo_admtratamiento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_treatment_validate_admtratamiento(var_admtratamiento, var_script_case_init, do_ajax_form_treatment_validate_admtratamiento_cb);
  } // do_ajax_form_treatment_validate_admtratamiento

  function do_ajax_form_treatment_validate_admtratamiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_treatment_validate_admtratamiento_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_treatment_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_treatment_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_treatment_submit_form(var_treat_instruc, var_treat_restdays, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_treatment_submit_form_cb);
  } // do_ajax_form_treatment_submit_form

  function do_ajax_form_treatment_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_treatment_submit_form_cb_after_alert);
  } // do_ajax_form_treatment_submit_form_cb
  function do_ajax_form_treatment_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_treatment_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_treat_details"] = "off";

  function do_ajax_form_treatment_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_treatment_navigate_form, function() {});
    } else {
      perform_ajax_form_treatment_navigate_form();
    }
  }

  function perform_ajax_form_treatment_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_treat_details"] = "on";
    x_ajax_form_treatment_navigate_form(var_treat_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_treatment_navigate_form_cb);
  } // do_ajax_form_treatment_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_treatment']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_treatment_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_treat_details"] && "nmsc_iframe_liga_form_treat_details" != scMasterDetailIframe["nmsc_iframe_liga_form_treat_details"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_treat_details"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_treat_details').contentWindow.nm_move('apl_detalhe', true, '500px');
        document.getElementById('nmsc_iframe_liga_form_treat_details').style.height = "500px";
        document.getElementById('nmsc_iframe_liga_form_treat_details').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_treatment_navigate_form_cb_after_alert);
  } // do_ajax_form_treatment_navigate_form_cb
  function do_ajax_form_treatment_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_treatment_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_treatment_navigate_form_cb_after_alert

  function sc_hide_form_treatment_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_treat_details"])
    {
      return true;
    }
    return false;
