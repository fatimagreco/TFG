...
<?php
   ...
   $Ord_Cmp = new app_grid_log_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class app_grid_log_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['app_grid_log']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['app_grid_log']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['app_grid_log']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['app_grid_log']['labels']["id"] : "" . $this->Nm_lang['lang_log_id'] . "";
   $tab_ger_campos['inserted_date'] = "on";
   $tab_def_campos['inserted_date'] = "inserted_date";
   $tab_labels["inserted_date"]   = (isset($_SESSION['sc_session'][$sc_init]['app_grid_log']['labels']["inserted_date"])) ? $_SESSION['sc_session'][$sc_init]['app_grid_log']['labels']["inserted_date"] : "" . $this->Nm_lang['lang_log_date_insert'] . "";
   $tab_ger_campos['username'] = "on";
   $tab_def_campos['username'] = "username";
   $tab_labels["username"]   = (isset($_SESSION['sc_session'][$sc_init]['app_grid_log']['labels']["username"])) ? $_SESSION['sc_session'][$sc_init]['app_grid_log']['labels']["username"] : "" . $this->Nm_lang['lang_log_user'] . "";
   $tab_ger_campos['usr_name'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['usr_name'] = "usr_name";
   }
   else
   {
       $tab_def_campos['usr_name'] = "SELECT sc_concat(user_name," " , user_lname) 
FROM Users 
WHERE user_docnum = '{username}' 
ORDER BY user_name, user_lname";
   }
   $tab_labels["usr_name"]   = (isset($_SESSION['sc_session'][$sc_init]['app_grid_log']['labels']["usr_name"])) ? $_SESSION['sc_session'][$sc_init]['app_grid_log']['labels']["usr_name"] : "Nombre";
   $tab_ger_campos['application'] = "on";
   $tab_def_campos['application'] = "application";
   $tab_labels["application"]   = (isset($_SESSION['sc_session'][$sc_init]['app_grid_log']['labels']["application"])) ? $_SESSION['sc_session'][$sc_init]['app_grid_log']['labels']["application"] : "" . $this->Nm_lang['lang_log_app'] . "";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['app_grid_log']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['app_grid_log']['labels']["sc_field_0"] : "" . $this->Nm_lang['lang_log_action'] . "";
   $tab_ger_campos['ip_user'] = "on";
   $tab_def_campos['ip_user'] = "ip_user";
   $tab_labels["ip_user"]   = (isset($_SESSION['sc_session'][$sc_init]['app_grid_log']['labels']["ip_user"])) ? $_SESSION['sc_session'][$sc_init]['app_grid_log']['labels']["ip_user"] : "" . $this->Nm_lang['lang_log_ip'] . "";
   $tab_ger_campos['usr_name'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['app_grid_log']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['app_grid_log']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['app_grid_log']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['app_grid_log']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['app_grid_log']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['app_grid_log']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['app_grid_log']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['app_grid_log']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['app_grid_log']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['app_grid_log']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['app_grid_log']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['app_grid_log']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "app_grid_log_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['app_grid_log']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['app_grid_log']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['app_grid_log']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['app_grid_log']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['app_grid_log']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
