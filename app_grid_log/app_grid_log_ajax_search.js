...
Table_sv_fil[0] = "inserted_date";
Table_sv_fil[1] = "application";
Table_sv_fil[2] = "username";
Table_sv_fil[3] = "ip_user";
...
function ajax_select_filter(parm)
{
    ...
    $.ajax({
     ...
     .done(function(json_sel_fil) {
        ...
        if ($("#SC_inserted_date_cond") && search_get_sel_txt("SC_inserted_date_cond").substring(0, 3) == "bi_") {
            formata_bi_inserted_date(search_get_sel_txt("SC_inserted_date_cond"), SC_inserted_date_bi_opc, SC_inserted_date_bi_dt);
        }
