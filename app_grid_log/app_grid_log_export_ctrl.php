<?php
@session_start() ;
$_SESSION['scriptcase']['app_grid_log']['sc_process_barr'] = true;
require_once('../app_grid_log/index.php');
unset($_SESSION['scriptcase']['app_grid_log']['sc_process_barr']);
$ExportCtrl = new app_grid_log_export_control;
$ExportCtrl->Export_barr();

class app_grid_log_export_control
{
