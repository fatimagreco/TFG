...
function actionBar_getStateHide($buttonName)
{
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['rtf_name']);
      }
...
$_SESSION['scriptcase']['app_grid_log']['contr_erro'] = 'off'; 
   ...
   function NM_export_usr_name()
   {
         ...
         $this->usr_name = str_replace('<', '&lt;', $this->usr_name);
         $this->usr_name = str_replace('>', '&gt;', $this->usr_name);
         $this->Texto_tag .= "<td>" . $this->usr_name . "</td>\r\n";
   }
   //----- application
   ...
   function NM_export_log_ok()
   {
         ...
         $this->log_ok = str_replace('<', '&lt;', $this->log_ok);
         $this->log_ok = str_replace('>', '&gt;', $this->log_ok);
         $this->Texto_tag .= "<td>" . $this->log_ok . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_log_title'] ?> :: RTF</TITLE>
