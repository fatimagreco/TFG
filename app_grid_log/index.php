<?php
   include_once('app_grid_log_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['app_grid_log']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['app_grid_log']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['app_grid_log']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['app_grid_log']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['app_grid_log']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['app_grid_log']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['app_grid_log']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['app_grid_log']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['app_grid_log']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['app_grid_log']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['app_grid_log']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['app_grid_log']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['app_grid_log']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['app_grid_log']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['app_grid_log']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['app_grid_log']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['app_grid_log']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class app_grid_log_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "app_grid_log"; 
      $this->nm_nome_apl     = "Application created by Scriptcase, to check the log: audit"; 
      $this->nm_seguranca    = ""; 
      ...
      $this->nm_dt_criacao   = "20221207"; 
      $this->nm_hr_criacao   = "203228"; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['app_grid_log']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['app_grid_log']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['app_grid_log']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['app_grid_log']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['app_grid_log']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['app_grid_log']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['app_grid_log']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['app_grid_log']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['app_grid_log']['save_session']['data'] = '';
      } 
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['app_grid_log']['sub_cons_schema_all']))
      { 
         $this->str_schema_all    = $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['sub_cons_schema_all'];
         $this->str_schema_filter = $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['sub_cons_schema_filter'];
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/app_grid_log';
      ...
      $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['app_grid_log']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['app_grid_log']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['app_grid_log']['actual_lang']) || $_SESSION['scriptcase']['app_grid_log']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['app_grid_log']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("app_grid_log_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['app_grid_log']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['app_grid_log']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['app_grid_log']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['app_grid_log']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["app_grid_log"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["app_grid_log"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['app_grid_log']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['app_grid_log']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['app_grid_log']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['link_info']['remove_border'] = true;
        }

      if (!isset($_SESSION['sc_session'][$this->sc_page]['app_grid_log']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['responsive_chart'] = array(
              'enabled' => false,
              'active'  => false,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['app_grid_log']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['app_grid_log']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['app_grid_log']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['app_grid_log']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['app_grid_log']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "app_grid_log_erro.class.php"); 
      $this->Erro = new app_grid_log_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('app_grid_log'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['app_grid_log']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['app_grid_log']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['app_grid_log']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['app_grid_log']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['app_grid_log']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['app_grid_log']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      if (isset($_SESSION['sc_session'][$this->sc_page]['app_grid_log']['initialize']) && $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['initialize'])  
      { 
          $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['Gera_log_access'] = true;
          $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['initialize']      = false;
      } 
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['app_grid_log']['glo_nm_conexao']) && $_SESSION['scriptcase']['app_grid_log']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['app_grid_log']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['app_grid_log']['glo_nm_perfil']) && $_SESSION['scriptcase']['app_grid_log']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['app_grid_log']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['app_grid_log']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['app_grid_log']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['app_grid_log']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['app_grid_log']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['app_grid_log']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_grid_log']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['app_grid_log']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['app_grid_log']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['app_grid_log']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['app_grid_log']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['app_grid_log']['embutida_init']) 
      {
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_grid_log']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_grid_log']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_grid_log']['glo_nm_conexao'], $this->root . $this->path_prod, 'EnfermeriaUNAE', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['app_grid_log']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['app_grid_log']['embutida'])
      {
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['app_grid_log']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['app_grid_log']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['SC_sep_date1'];
           }
...
//
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_access))
       { 
           $comando = "INSERT INTO audit (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'app_grid_log', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO audit (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'app_grid_log', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO audit (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'app_grid_log', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
   ...
   function NM_log_split($log_str)
   {
       if (substr($log_str, 0, 12) != "--> keys <--")
       {
           return $log_str;
       }
       $log_output = array();
       $tp_proc    = "";
       $arr_trab   = explode("||", $log_str);
       foreach ($arr_trab as $cada_log)
       {
           if (substr($cada_log, 0, 12) == "--> keys <--")
           {
               $tp_proc = "keys";
               $cada_log = substr($cada_log, 12);
           }
           elseif (substr($cada_log, 0, 14) == "--> fields <--")
           {
               $tp_proc = "fields";
               $cada_log = substr($cada_log, 14);
           }
           $cmp = explode(":", $cada_log);
           if (count($cmp) > 1)
           {
               for ($x = 2; $x < count($cmp); $x++)
               {
                   $cmp[1] .= ":" . $cmp[$x];
               }
           }
           if ($tp_proc == "keys")
           {
               $log_output[$tp_proc][trim($cmp[0])] = trim($cmp[1]);
           }
           elseif ($tp_proc == "fields")
           {
               if (strpos($cmp[0], "(old)"))
               {
                   $cmp[0] = str_replace("(old)", "", $cmp[0]);
                   $log_output[$tp_proc]['old'][trim($cmp[0])] = trim($cmp[1]);
               }
               if (strpos($cmp[0], "(new)"))
               {
                   $cmp[0] = str_replace("(new)", "", $cmp[0]);
                   $log_output[$tp_proc]['new'][trim($cmp[0])] = trim($cmp[1]);
               }
               if (strpos($cmp[0], "(label)"))
               {
                   $cmp[0] = str_replace("(label)", "", $cmp[0]);
                   $log_output[$tp_proc]['label'][trim($cmp[0])] = trim($cmp[1]);
               }
           }
       }
       return $log_output;
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['app_grid_log']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['app_grid_log']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
class app_grid_log_sub_css
{
   function __construct()
   {
      ...
      if ($_SESSION['sc_session'][$script_case_init]['app_grid_log']['SC_herda_css'] == "N")
      {
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css']['app_grid_log']    = $str_schema_all . "_grid.css";
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css_bw']['app_grid_log'] = $str_schema_all . "_grid_bw.css";
      }
   }
}
//
class app_grid_log_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['app_grid_log']))
      { 
          $GLOBALS['nmgp_parms'] = $_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['app_grid_log'];
          $Parms_form_pdf = true;
      } 
      if ($_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida'] || $Parms_form_pdf)
      { 
      ...
      if ($Parms_form_pdf)
      { 
          $_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida_pdf'] = true;
          $_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida_form'] = true;
          $_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida_form_full'] = false;
          $_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida_pai'] = "";
      } 
      $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida_ibase'])) 
      { 
          $this->Ini = new app_grid_log_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida_ibase'] = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['emb_lig_aba'] = array();
      $this->Change_Menu = false;
      if (!isset($nmgp_opcao)) {
         $nmgp_opcao = "";
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'])) {
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] = "";
      }
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['sc_modal']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['app_grid_log']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['app_grid_log'];
          }
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_grid_log']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_grid_log']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('app_grid_log') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_grid_log']['label'] = "" . $this->Ini->Nm_lang['lang_log_title'] . "";
      ...
      $this->Db = $this->Ini->Db; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['nm_tpbanco'] = $this->Ini->nm_tpbanco;
      $this->nm_data = new nm_data("es");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida'])
      { 
          include_once($this->Ini->path_embutida . "app_grid_log/app_grid_log_erro.class.php"); 
      } 
      else 
      { 
          include_once($this->Ini->path_aplicacao . "app_grid_log_erro.class.php"); 
      } 
      $this->Erro      = new app_grid_log_erro();
      $this->Erro->Ini = $this->Ini;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida'])
      { 
          require_once($this->Ini->path_embutida . "app_grid_log/app_grid_log_lookup.class.php"); 
      } 
      else 
      { 
          require_once($this->Ini->path_aplicacao . "app_grid_log_lookup.class.php"); 
      } 
      $this->Lookup       = new app_grid_log_lookup();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_export")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] = $nmgp_opcao;
              if ($nmgp_opcao == "print" || $nmgp_opcao == "res_print" || $nmgp_opcao == "det_print")
              {
                  $ajax_opc_print   = true;
                  $nm_arquivo_print = "/sc_app_grid_log_" . session_id();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida'])
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['ajax_nav'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['scroll_navigate'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['scroll_navigate_reload'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['scroll_navigate_app'] = false;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['scroll_navigate_header_row']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['scroll_navigate_header_row'] = 1;
          }
          if (isset($_POST['nmgp_opcao']) && ($_POST['nmgp_opcao'] == "ajax_navigate" || $_POST['nmgp_opcao'] == "ajax_detalhe"))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['ajax_nav'] = true;
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['save_grid'] = true;
              }
              ...
              {
                  $_SESSION['sc_session'][$script_case_init]['app_grid_log']['contr_total_geral'] = "NAO";
                  $_SESSION['sc_session'][$script_case_init]['app_grid_log']['contr_array_resumo'] = "NAO";
                  unset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['tot_geral']);
                  unset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['arr_total']);
                  unset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['pivot_group_by']);
                  unset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['pivot_x_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['pivot_y_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['pivot_fill']);
                  unset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['pivot_order']);
                  unset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['pivot_order_col']);
                  unset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['pivot_order_level']);
                  unset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['pivot_order_sort']);
                  unset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['pivot_tabular']);
              }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['SC_Gb_date_format'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['SC_Gb_date_format'] = array();
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['SC_All_Groupby'] = array('sc_free_total' => 'grid');
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['SC_Groupby_hide'])) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['SC_Groupby_hide'] = array();
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['SC_Ind_Groupby'])) 
      { 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['SC_All_Groupby'] as $Ind => $Tp)
          {
              if (!in_array($Ind, $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['SC_Groupby_hide'])) 
              { 
                  break;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['SC_Ind_Groupby'] = $Ind;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['Labels_GB'] = array();
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['SC_Ind_Groupby'] == "sc_free_total")
      {
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['dados_orig_gb']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['dados_orig_gb'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['dados_orig_gb']['all']['SC_Ind_Groupby'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['SC_Ind_Groupby']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['dados_orig_gb']['all']['SC_Ind_Groupby'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['SC_Ind_Groupby'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['SC_Gb_Free_cmp']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['SC_Gb_Free_cmp'];
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['dados_orig_gb']['res']['summarizing_fields_display'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['dados_orig_gb']['res']['summarizing_fields_order']   = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['dados_orig_gb']['res']['summarizing_fields_control'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['dados_orig_gb']['res']['pivot_x_axys']               = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['summarizing_fields_display']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['dados_orig_gb']['res']['summarizing_fields_display'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['summarizing_fields_display'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['summarizing_fields_order']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['dados_orig_gb']['res']['summarizing_fields_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['summarizing_fields_order'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['summarizing_fields_control']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['dados_orig_gb']['res']['summarizing_fields_control'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['summarizing_fields_control'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['pivot_x_axys']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['dados_orig_gb']['res']['pivot_x_axys'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['pivot_x_axys'];
          }
      }
      $this->Ini->Apl_resumo  = "app_grid_log_resumo_" . $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['SC_Ind_Groupby'] . ".class.php"; 
      $this->Ini->Apl_grafico = "app_grid_log_grafico_" . $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['SC_Ind_Groupby'] . ".class.php"; 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['Gera_log_access'])
      {
          $this->Ini->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['Gera_log_access'] = false;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['xls_return']  = ($nmgp_opcao == "xls")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['csv_return']  = ($nmgp_opcao == "csv")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['xml_return']  = ($nmgp_opcao == "xml")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['json_return'] = ($nmgp_opcao == "json") ? "volta_grid" : "resumo"; 
      ...
      if ($nmgp_opcao == 'print' || $nmgp_opcao == 'res_print') {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['print_return'] = $this->ret_print;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida'])
      {
          if ($this->Ini->Export_html_zip)
          {
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['html_name']))
              {
                  $nm_arquivo_html = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['html_name'];
              }
              elseif ($nmgp_opcao == 'print' && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
              {
                  $nm_arquivo_html = "/sc_app_grid_log_" . session_id() . ".html";
              }
              else
              {
                  $nm_arquivo_html = "/sc_app_grid_log_res_" . session_id() . ".html";
              }
      ...
      if ($nmgp_opcao == "doc_word") {  
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['word_return'] = $this->ret_word;
          $_SESSION['scriptcase']['proc_mobile'] = false;
      }
      ...
      { 
          $nmgp_opcao = "doc_word"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] = "doc_word"; 
      }
      elseif ($nmgp_opcao == "doc_word" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "doc_word_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] = "doc_word_res"; 
      }
      if ($nmgp_opcao == "xls_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xls"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] = "xls"; 
      }
      elseif ($nmgp_opcao == "xls" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xls_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] = "xls_res"; 
      }
      if ($nmgp_opcao == "csv_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "csv"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] = "csv"; 
      }
      elseif ($nmgp_opcao == "csv" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "csv_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] = "csv_res"; 
      }
      if ($nmgp_opcao == "xml_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xml"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] = "xml"; 
      }
      elseif ($nmgp_opcao == "xml" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xml_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] = "xml_res"; 
      }
      if ($nmgp_opcao == "json_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "json"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] = "json"; 
      }
      elseif ($nmgp_opcao == "json" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "json_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] = "json_res"; 
      }
      $_SESSION['sc_session'][$script_case_init]['app_grid_log']['skip_charts'] = (strpos(" " . $this->Ini->SC_module_export, "chart") !== false) ? false : true;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['pdf_det'] = false;
      if ($nmgp_opcao == 'pdf_det')
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['pdf_det'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] = 'pdf';
          $_SESSION['sc_session'][$script_case_init]['app_grid_log']['opc_pdf']['pdf_zip'] = (isset($Det_pdf_zip) && !empty($Det_pdf_zip)) ? $Det_pdf_zip : "N";
          if ($Det_use_pass_pdf != "__APL__")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['use_pass_pdf'] = $Det_use_pass_pdf;
          } 
          $nmgp_opcao = 'pdf';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['conf_chart_level'] = "S";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida']      = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida_grid']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida_grid'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida_init']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida_init'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida_label']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida_label'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['cab_embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['cab_embutida'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida_pdf']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida_pdf'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida_treeview']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida_treeview'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida_opcao']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida_opcao'] = "";
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['proc_pdf'] = (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida'] && ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] == "pdf_res")) ? true : false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['proc_pdf']) {
          $_SESSION['scriptcase']['proc_mobile'] = false;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['proc_pdf_vert'] = false;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida'])
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['field_order']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['field_order'][] = "id";
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['field_order'][] = "inserted_date";
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['field_order'][] = "username";
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['field_order'][] = "usr_name";
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['field_order'][] = "application";
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['field_order'][] = "sc_field_0";
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['field_order'][] = "ip_user";
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['field_order'][] = "creator";
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['field_order'][] = "description";
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['field_order'][] = "log_ok";
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['field_order_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['field_order'];
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['usr_cmp_sel']))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['usr_cmp_sel'] = array();
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['usr_cmp_sel']['creator'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['usr_cmp_sel']['description'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['usr_cmp_sel']['log_ok'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['usr_cmp_sel_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['usr_cmp_sel'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app_grid_log']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['app_grid_log']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['app_grid_log']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }

      $this->Ini->sc_Include($this->Ini->path_libs . "/nm_gc.php", "F", "nm_gc") ; 
      nm_gc($this->Ini->path_libs);
      if (!$_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida'])
      { 
      ...
      if (!$_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida'])
      { 
          $this->pdf_zip = (isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['opc_pdf']['pdf_zip'])) ? $_SESSION['sc_session'][$script_case_init]['app_grid_log']['opc_pdf']['pdf_zip'] : "N";
          $_SESSION['sc_session'][$script_case_init]['app_grid_log']['use_pass_pdf'] = "";
      ...
      if (strpos($NM_orig, "/app_grid_log") === false)
      {
          $nmgp_opcao = "busca";
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] = "busca";  
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['SC_Ind_Groupby'] == "sc_free_total") 
      {
      ...
      if ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_orig'])) && !isset($_POST['reload_comb_chart']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] = "busca";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opc_liga'] = array();  
          if (isset($NMSC_conf_apl) && !empty($NMSC_conf_apl))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opc_liga'] = $NMSC_conf_apl;  
          }   
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opc_liga']['inicial']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opc_liga']['inicial'];
          }
      }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opc_liga']['paginacao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opc_liga']['paginacao']))
          { 
              $this->Ini->Apl_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opc_liga']['paginacao'];
          } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] == "busca")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] = "grid" ;  
      }   
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao_print']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao_print']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao_print'] = "inicio" ;  
      }   
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['print_all'] = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] == "print")  
      { 
          if (strpos(" " . $this->Ini->SC_module_export, "grid") === false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] = "res_print";
          }
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] == "res_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao']     = "resumo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['print_all'] = true;
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] = "print";
              $nmgp_tipo_print = "RC";
          }
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['det_print'] = "";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] == "det_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao']     = "detalhe";
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['det_print'] = "print";
          if (!empty($nmgp_password)) {
          ...
          {
              $this->Ini->Export_img_zip = true;
              $nm_arquivo_html = "/sc_app_grid_log_det_" . session_id() . ".html";
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_html);
          }
      } 
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'], 0, 7) == "grafico")  
      { 
          $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] == "fast_search")  
      { 
          $this->SC_fast_search($GLOBALS["nmgp_fast_search"], $GLOBALS["nmgp_cond_fast_search"], $GLOBALS["nmgp_arg_fast_search"]);
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_pesq_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_pesq'])
          { 
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['interativ_refresh'] = true;
          } 
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] == "interativ_search")
      { 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opc_int_search'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['interativ_refresh'] = true;
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] == 'pesq' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['orig_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['orig_pesq']))  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['orig_pesq'] == "res")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] = 'resumo';
          } 
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['orig_pesq'] == "grid") 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] = 'inicio';
          } 
      } 
//
      ...
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))  
      { 
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['use_pass_pdf']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['prim_cons'] = true;  
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_pesq_grid']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_pesq_lookup'] = "";
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['Grid_search']       = array();
      ...
      $nm_flag_pdf   = true;
      $nm_vendo_pdf  = ("pdf" == $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['graf_pdf'] = "S";
      if (isset($nmgp_graf_pdf) && !empty($nmgp_graf_pdf))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['graf_pdf'] = $nmgp_graf_pdf;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            $nm_arquivo_htm_temp = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_app_grid_log_html_" . session_id() . "_2.html";
            $nm_arquivo_pdf_base = "/sc_pdf_" . md5(date("Ymd") . "_" . session_id()) . "_app_grid_log.pdf";
            $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . $nm_arquivo_pdf_base;
            $nm_arquivo_pdf_serv = $this->Ini->root . $nm_arquivo_pdf_url;
            $nm_arquivo_de_saida = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_app_grid_log_html_" . session_id() . ".html";
            $nm_url_de_saida = $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_app_grid_log_html_" . session_id() . ".html";
...
//----------------------------------->
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] == "doc_word_res")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['print_navigator'] = "Microsoft Internet Explorer";
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['print_all'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['doc_word']  = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao']     = "resumo";
          $_SESSION['scriptcase']['saida_word'] = true;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['word_name']))
          {
              $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['word_name'], ".");
              if ($Pos === false) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['word_name'] .= ".doc";
              }
              $nm_arquivo_doc_word = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['word_name'];
          }
          else
          {
              $nm_arquivo_doc_word = "/sc_app_grid_log_res_" . session_id() . ".doc";
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] == "xls")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "app_grid_log/app_grid_log_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "app_grid_log_xls.class.php"); 
          } 
          $this->xls  = new app_grid_log_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] == "xml")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "app_grid_log/app_grid_log_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "app_grid_log_xml.class.php"); 
          } 
          $this->xml  = new app_grid_log_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] == "json")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "app_grid_log/app_grid_log_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "app_grid_log_json.class.php"); 
          } 
          $this->json  = new app_grid_log_json();
          $this->prep_modulos("json");
          $this->json->monta_json();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] == "csv")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "app_grid_log/app_grid_log_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "app_grid_log_csv.class.php"); 
          } 
          $this->csv  = new app_grid_log_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] == "rtf")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "app_grid_log/app_grid_log_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "app_grid_log_rtf.class.php"); 
          } 
          $this->rtf  = new app_grid_log_rtf();
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida'])
          { 
              require_once($this->Ini->path_embutida . " . app_grid_log . /" . $this->Ini->Apl_grafico); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
          } 
          $this->Graf  = new app_grid_log_grafico();
          $this->prep_modulos("Graf");
          if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'], 7, 1) == "_")  
          { 
              $this->Graf->grafico_col(substr($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'], 8));
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] = "grid";
          }
          else
          { 
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['dashboard_refresh_after_chart'])) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['dashboard_refresh_after_chart'];
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['dashboard_refresh_after_chart']);
              }
              else {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] = "grid";
              }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] == "busca")  
      { 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "app_grid_log_pesq.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "app_grid_log_mobile_pesq.class.php"); 
          } 
          $this->pesq  = new app_grid_log_pesq();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] == "resumo")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "app_grid_log/" . $this->Ini->Apl_resumo); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
          } 
          $this->Res = new app_grid_log_resumo("out");
          $this->prep_modulos("Res");
          $this->Res->monta_resumo();
      }
      else 
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] == "print" && $nmgp_tipo_print == "RC")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['print_navigator'] = $nmgp_navegator_print;
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao']     = "pdf";
              $GLOBALS['nmgp_tipo_pdf'] = strtolower($nmgp_cor_print);
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] == "doc_word")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['print_navigator'] = "Microsoft Internet Explorer";
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['doc_word']  = true;
              ...
              {
                  $nm_arquivo_doc_word = "/sc_app_grid_log_" . session_id() . ".doc";
              }
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word);
              $this->Ini->nm_limite_lin_prt = 0;
              $GLOBALS['nmgp_tipo_pdf'] = $nmgp_cor_word;
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] == "detalhe" || $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['pdf_det'])  
          { 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida'])
              { 
                  require_once($this->Ini->path_embutida . "app_grid_log/app_grid_log_det.class.php"); 
              } 
              else 
              { 
                  require_once($this->Ini->path_aplicacao . "app_grid_log_det.class.php"); 
              } 
              $this->det  = new app_grid_log_det();
          ...
          { 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida'])
              { 
                  require_once($this->Ini->path_embutida . "app_grid_log/app_grid_log_grid.class.php"); 
              } 
              else 
              { 
                  require_once($this->Ini->path_aplicacao . "app_grid_log_grid.class.php"); 
              } 
              $this->grid  = new app_grid_log_grid();
...
<?php
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida'])
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['ajax_nav'])
         {
             ...
             if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] != "ajax_detalhe")  
             {
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['word_file'] = $this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            {
                $str_pd4ml    = " --page-size Folio --orientation Portrait";
            }
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['pdf_res'])
            { 
                $str_pd4ml .= " --outline-depth 0";
            }
            if (!$this->Ini->sc_export_ajax && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    app_grid_log_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . $this->grid->progress_tot . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                    fwrite($this->grid->progress_fp, ($this->grid->progress_tot) . "_#NM#_" . $lang_protect . "...\n");
                    fclose($this->grid->progress_fp);
                }
            }
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['pdf_name']))
            {
                $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['pdf_name'], ".");
                if ($Pos === false) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['pdf_name'] .= ".pdf";
                }
                if ('/' == substr($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['pdf_name'], 0, 1)) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['pdf_name'] = substr($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['pdf_name'], 1);
                }
                $nm_arquivo_pdf_serv = $this->Ini->root .  $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['pdf_name'];
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['pdf_name'];
                $nm_arquivo_pdf_base = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['pdf_name'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['pdf_name']);
            }
            ...
            elseif (is_dir($this->Ini->path_third . $dir_qpdf) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['use_pass_pdf']))
            {
            ...
            if ($this->pdf_zip == "S")
            {
                $pdf_pass = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['use_pass_pdf'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['use_pass_pdf'] : "";
            ...
            elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['use_pass_pdf']))
            {
                if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                {
                    $dir_qpdf = "/qpdf/win/bin";
                ...
                if (is_dir($this->Ini->path_third . $dir_qpdf)) 
                {
                    ...
                    $pdf_pass  = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['use_pass_pdf'];
            ...
            $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['contr_array_resumo'] = '';
            $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['contr_total_geral']  = '';
            // ----- PDF log
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    if ($this->grid->progress_fp)
                    {
                        ...
                        app_grid_log_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . ($this->grid->progress_now + 1 + $this->grid->progress_pdf) . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                        app_grid_log_pdf_progress_call("off\n", $this->Ini->Nm_lang);
...
unset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['pdf_file']);
if (is_file($nm_arquivo_pdf_serv))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['pdf_file'] = $nm_arquivo_pdf_serv;
}
if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['pdf_det'])
{
    if ($this->pdf_zip == "S")
...
$NM_volta  = "volta_grid";
$NM_target = "_parent";
$downloadFileName = "app_grid_log.pdf";
if ($this->pdf_zip == 'S') {
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log'][md5("newpdf_" . $downloadFileName)][0] = $nm_arquivo_pdf_url;
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log'][md5("newpdf_" . $downloadFileName)][1] = $downloadFileName;
}
...
<?php
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      if (empty($data_search)) 
      {
          $tmp_cmd = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_pesq_fast'] = "";
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_orig'])) 
          {
              $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_orig']; 
          }
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_pesq_filtro'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_pesq_filtro'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_pesq_filtro'] . ")"; 
              }
          }
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_pesq_interativ'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_pesq_interativ'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_pesq_interativ'] . ")"; 
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_pesq'] = $tmp_cmd;
      ...
      foreach ($fields as $field) {
          ...
          if ($field == "SC_all_Cmp" || $field == "inserted_date") 
          {
              $this->SC_monta_condicao($comando, "inserted_date", $arg_search, $data_search, "DATETIME", false);
          }
          if ($field == "SC_all_Cmp" || $field == "username") 
          {
              $this->SC_monta_condicao($comando, "username", $arg_search, $data_search, "VARCHAR", false);
          }
          if ($field == "SC_all_Cmp" || $field == "application") 
          {
              $this->SC_monta_condicao($comando, "application", $arg_search, $data_search, "VARCHAR", false);
          }
          if ($field == "SC_all_Cmp" || $field == "creator") 
          {
              $this->SC_monta_condicao($comando, "creator", $arg_search, $data_search, "VARCHAR", false);
          }
          if ($field == "SC_all_Cmp" || $field == "ip_user") 
          {
              $this->SC_monta_condicao($comando, "ip_user", $arg_search, $data_search, "VARCHAR", false);
          }
          ...
          {
              $this->SC_monta_condicao($comando, "description", $arg_search, $data_search, "TEXT", false);
          }
      }
      if (empty($comando)) 
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_pesq_fast'] = $comando;
      $tmp_cmd = "";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_orig'])) 
      {
          $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_orig']; 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_pesq_interativ'])) 
      {
          $comando .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_pesq_interativ'] . ")";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_pesq'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['fast_search'][0] = $in_fields;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['fast_search'][2] = $sv_data;
   }
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (isset($Nm_datas[$campo_join]) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['SC_sep_date']))
      {
   ...
   function SC_proc_interativ_search($Parms)
   {
       ...
       $cmd_sql = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['int_search_sql'][$tmp[0]];
       $vls     = "";
       $bol_numeric = false;
       if ($tmp[3] == "clear_interativ_all") {
           ...
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['interativ_search'][$tmp[0]]);
           if ($tmp[3] != "clear_interativ")
           {
               ...
               if ($tmp[2] == "dt" || $tmp[2] == "dh" || $tmp[2] == "hh")
               {
                   ...
                   {
                       $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['SC_sep_date'];
                       $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['SC_sep_date1'];
                   }
               }
           }
       }
       if (!empty($vls))
       {
           $prep = "";
           $bol_has_empty = false;
           $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['interativ_search'][$tmp[0]]['tp_obj'] = $tmp[2];
           foreach ($vls as $cada_val)
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['interativ_search'][$tmp[0]]['lab'][$tmp[1]][] = $descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['interativ_search'][$tmp[0]]['val_sel'][] = $cada_val;
               if ($cada_val == "")
               {
                   $bol_has_empty = true;
               }
           ...
           if ($prep == "" && $bol_numeric)
           {
               ...
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " is null";
               }
               else
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " = '' or " . $cmd_sql . " is null";
               }
           }
           elseif ($prep == "" && $delim != "")
           {
           ...
           elseif ( $tmp[2] == "bw")
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " between " . $delim . $range_bw[0] .  $delim1 . " and " . $delim . $range_bw[1] .  $delim1 . $str_add_null_or;
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " IN (" . $prep . ")" . $str_add_null_or;
           }
       }
      $tmp_cmd = "";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_orig'])) 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_pesq_fast'])) 
      {
          if (!empty($tmp_cmd)) 
          {
              $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_pesq_fast'] . ")";
          }
          else 
          {
              $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_pesq_fast'] . ")";
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_pesq_interativ'] = "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_sem_interativ']  = $tmp_cmd;
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['interativ_search'])) 
      {
          $prim = true;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['interativ_search'] as $cmp => $val) 
          {
              if (!$prim)
              {
                 $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_pesq_interativ'] .= " AND ";
              }
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_pesq_interativ'] .= "(" . $val['val'] . ")";
              $prim = false;
          }
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_pesq_interativ'])) 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_pesq'] = $tmp_cmd;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['refresh_interativ'] = (isset($tmp[5])) ? $tmp[5] : "S";
  ...
  function html_doc_word($nm_arquivo_doc_word, $nmgp_password)
  {
      ...
      { 
          ...
          $Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['word_file'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['word_file'], ".");
          if ($Pos !== false) {
              $Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['word_file'], 0, $Pos);
          }
          $Arq_zip .= ".zip";
          ...
          $Arq_input = (FALSE !== strpos($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['word_file'], ' ')) ? " \"" . $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['word_file'] . "\"" :  $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['word_file'];
           if (is_file($Arq_zip)) {
               unlink($Arq_zip);
           }
           $str_zip = "";
           ...
           if (is_file($Arq_zip)) {
               unlink($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['word_file']);
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['word_file'] = $Arq_zip;
               $nm_arquivo_doc_word = $Arq_doc;
          } 
      } 
      if ($this->Ini->sc_export_ajax)
      {
          $this->Arr_result['file_export']  = NM_charset_to_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['word_file']);
      ...
      if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false || strpos(" " . $this->Ini->SC_module_export, "resume") !== false)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log'][$path_doc_md5][1] = substr($nm_arquivo_doc_word, 1);
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_log_title'] ?> :: Doc</TITLE>
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      ...
      $Html_password = "";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_html;
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log'][$path_doc_md5][1] = substr($nm_arquivo_html, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['app_grid_log']['glo_nm_path_imag_temp'] . "/");
...
<?php
 ...
 $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log'][$path_doc_md5][0] = $nm_arquivo_pdf_det;
 $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log'][$path_doc_md5][1] = "app_grid_log_det.pdf";
?>
 <link rel="shortcut icon" href="../_lib/img/grp__NM__bg__NM__enfermeria_unae2.png">
  <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_all ?>_export.css" /> 
  <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_all ?>_export<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
...
// 
//======= =========================
   if (isset($_SESSION['scriptcase']['app_grid_log']['sc_process_barr'])) {
       return;
   }
   ...
   if (!empty($_POST))
   {
       ...
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_app_grid_log($nmgp_val);
            $nmgp_val = NM_decode_input($nmgp_val);
            nm_protect_num_app_grid_log($nmgp_var, $nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['app_grid_log']['glo_nm_path_imag_temp'] . "/sc_apl_default_EnfermeriaUNAE.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_grid_log']['glo_nm_path_imag_temp'] . "/sc_apl_default_EnfermeriaUNAE.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "app_grid_log") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['app_grid_log']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['app_grid_log']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['app_grid_log']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_EnfermeriaUNAE'])) {
               $_SESSION['scriptcase']['app_grid_log']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_EnfermeriaUNAE'];
           }
       }
   }
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida_pai']))
   {
       $apl_pai = $_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida_pai'];
       if (isset($_SESSION['sc_session'][$script_case_init][$apl_pai]['embutida_filho']))
       {
           ...
           {
               if (isset($_SESSION['sc_session'][$init_filho]['app_grid_log']['master_pai']) && $_SESSION['sc_session'][$init_filho]['app_grid_log']['master_pai'] == $script_case_init)
               {
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida_form'] && !isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['master_pai']))
   {
       $SC_init_ant = $script_case_init;
       $script_case_init = rand(2, 10000);
       if (isset($_SESSION['sc_session'][$SC_init_ant]['app_grid_log']['embutida_pai']))
       {
           $_SESSION['sc_session'][$SC_init_ant][$_SESSION['sc_session'][$SC_init_ant]['app_grid_log']['embutida_pai']]['embutida_filho'][] = $script_case_init;
       }
       $_SESSION['sc_session'][$script_case_init]['app_grid_log']['master_pai'] = $SC_init_ant;
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['master_pai']))
   {
       $SC_init_ant = $_SESSION['sc_session'][$script_case_init]['app_grid_log']['master_pai'];
       if (!isset($_SESSION['sc_session'][$SC_init_ant]['app_grid_log']['embutida_form_parms']))
       {
           $_SESSION['sc_session'][$SC_init_ant]['app_grid_log']['embutida_form_parms'] = "";
       }
       $_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida_form_parms'] = $_SESSION['sc_session'][$SC_init_ant]['app_grid_log']['embutida_form_parms'];
       $_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida_form'] = true;
       $_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida_form_full'] = (isset($_SESSION['sc_session'][$SC_init_ant]['app_grid_log']['embutida_form_full'])) ? $_SESSION['sc_session'][$SC_init_ant]['app_grid_log']['embutida_form_full'] : false;
       $_SESSION['sc_session'][$script_case_init]['app_grid_log']['reg_start'] = "";
       $_SESSION['sc_session'][$script_case_init]['app_grid_log']['opcao'] = "inicio";
       unset($_SESSION['sc_session'][$SC_init_ant]['app_grid_log']['embutida_form']);
       unset($_SESSION['sc_session'][$SC_init_ant]['app_grid_log']['embutida_form_parms']);
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida_form_parms'])) 
   {
       if (!empty($_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida_form_parms'])) 
       {
           $nmgp_parms = $_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida_form_parms'];
           $_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida_form_parms'] = "";
       }
   }
   elseif (isset($script_case_init))
   {
       unset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida_form']);
       unset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida_form_full']);
       unset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida_form_parms']);
   }
   if (!isset($nmgp_opcao) || !isset($script_case_init) || ((!isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida']) || !$_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida']) && $nmgp_opcao != "formphp"))
   { 
       if (!empty($nmgp_parms)) 
       { 
           ...
           { 
               unset($_SESSION['sc_session'][$script_case_init]['app_grid_log']);
               $_SESSION['sc_session'][$script_case_init]['app_grid_log']['b_sair'] = false;
           }   
       } 
   } 
   if (!isset($nmgp_opcao)) {
   ...
   $ini_embutida = "";
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida']) && $_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida'])
   {
       $nmgp_outra_jan = "";
   }
   ...
   if (isset($GLOBALS["script_case_init"]) && !empty($GLOBALS["script_case_init"]))
   {
       $ini_embutida = $GLOBALS["script_case_init"];
        if (!isset($_SESSION['sc_session'][$ini_embutida]['app_grid_log']['embutida']))
        { 
           $_SESSION['sc_session'][$ini_embutida]['app_grid_log']['embutida'] = false;
        }
        if (!$_SESSION['sc_session'][$ini_embutida]['app_grid_log']['embutida'])
        { 
           $script_case_init = $ini_embutida;
        }
   }
   if (isset($_SESSION['scriptcase']['app_grid_log']['protect_modal']) && !empty($_SESSION['scriptcase']['app_grid_log']['protect_modal']))
   {
       $script_case_init = $_SESSION['scriptcase']['app_grid_log']['protect_modal'];
   }
   ...
   $salva_emb    = false;
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['app_grid_log']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['iframe_menu']);
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida']))
   {
       $salva_emb = $_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida'];
       unset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1 && !$salva_emb)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "app_grid_log";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'app_grid_log' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['app_grid_log']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['app_grid_log']['iframe_menu'] = $salva_iframe;
   }
   $_SESSION['sc_session'][$script_case_init]['app_grid_log']['doc_word'] = false;
   $_SESSION['scriptcase']['saida_word'] = false;
   if (!isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['skip_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['app_grid_log']['skip_charts'] = false;
   }
   if (isset($_REQUEST['sc_create_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['app_grid_log']['skip_charts'] = 'N' == $_REQUEST['sc_create_charts'];
   }
   $_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida'] = $salva_emb;

   if (!isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['app_grid_log']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['app_grid_log']['initialize'] = false;
   }
   elseif (false === strpos($_SERVER['HTTP_REFERER'], '/app_grid_log/'))
   {
       $_SESSION['sc_session'][$script_case_init]['app_grid_log']['initialize'] = true;
   }
   else
   ...
   if ($_SESSION['sc_session'][$script_case_init]['app_grid_log']['initialize'])
   {
       unset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['tot_geral']);
       $_SESSION['sc_session'][$script_case_init]['app_grid_log']['contr_total_geral'] = "NAO";
   }
   ...
   if (!isset($nmgp_opcao) || empty($nmgp_opcao) || $nmgp_opcao == "grid" && (!isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['b_sair'])))
   {
       $_SESSION['sc_session'][$script_case_init]['app_grid_log']['b_sair'] = true;
   }
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'app_grid_log')
   {
       $_SESSION['sc_session'][$script_case_init]['app_grid_log']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['app_grid_log']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/app_grid_log_erro.php");
   }
   ...
   if (!$_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida'] && $nmgp_opcao != "formphp")
   { 
       if (empty($nmgp_opcao) && !isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['opcao']))
       { 
           $nmgp_opcao = "busca";
       } 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['app_grid_log']['sc_change_lang'] = true;
           unset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['tot_geral']);
           $_SESSION['sc_session'][$script_case_init]['app_grid_log']['contr_total_geral'] = "NAO";
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['app_grid_log']['num_css'] = rand(0, 1000);
       } 
       ...
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['app_grid_log']['opcao'] = $nmgp_opcao ;  
       }   
       if ($_SESSION['sc_session'][$script_case_init]['app_grid_log']['opcao'] == "detalhe" && isset($nmgp_chave_det))  
       { 
           $_SESSION['sc_session'][$script_case_init]['app_grid_log']['chave_det'] = $nmgp_chave_det;
           $_SESSION['sc_session'][$script_case_init]['app_grid_log']['cmp_acum']  = $nmgp_parm_acum;
       }   
       if (isset($Sc_seq_det))  
       { 
           $_SESSION['sc_session'][$script_case_init]['app_grid_log']['Sc_seq_det'] = $Sc_seq_det;
       } 
       if (!isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['mostra_edit'])) 
       {
           $_SESSION['sc_session'][$script_case_init]['app_grid_log']['mostra_edit'] = "S";
       }
       if (isset($nmgp_lig_edit_lapis)) 
       {
          $_SESSION['sc_session'][$script_case_init]['app_grid_log']['mostra_edit'] = $nmgp_lig_edit_lapis;
       ...
       $nm_saida = "";
      if (!isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['opcao']) || empty($_SESSION['sc_session'][$script_case_init]['app_grid_log']['opcao']) || !isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['where_orig']))  
      { 
          $nmgp_opcao = "busca" ;  
      }   
       if (!isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['sc_modal']))
       {
           $_SESSION['sc_session'][$script_case_init]['app_grid_log']['sc_modal'] = false;
       }
       if (isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['app_grid_log']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['app_grid_log']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['app_grid_log']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['app_grid_log']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['app_grid_log']['volta_redirect_tp'] = "";
           $nm_url_saida = "app_grid_log_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['app_grid_log']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['app_grid_log']['opcao'] != "pdf"  && $nmgp_opcao == "busca") 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['app_grid_log']['sc_outra_jan'])
           {
               if ($nmgp_url_saida == "modal")
               {
                   $_SESSION['sc_session'][$script_case_init]['app_grid_log']['sc_modal'] = true;
               }
               $nm_url_saida = "app_grid_log_fim.php"; 
           }
           else
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['app_grid_log']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['app_grid_log']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['app_grid_log']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['app_grid_log']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['app_grid_log']['opcao'] != "pdf"  && $nmgp_opcao == "busca") 
       { 
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['scriptcase']['nm_sc_retorno']; 
            $_SESSION['sc_session'][$script_case_init]['app_grid_log']['menu_desenv'] = true;   
       } 
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['app_grid_log']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['app_grid_log']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['app_grid_log']['dado_psq_ret']  = $todo[2];
           $_SESSION['sc_session'][$script_case_init]['app_grid_log']['js_apos_busca'] = $nm_evt_ret_busca;
           $_SESSION['sc_session'][$script_case_init]['app_grid_log']['opc_psq'] = true;   
           if (isset($nmgp_iframe_ret)) {
               $_SESSION['sc_session'][$script_case_init]['app_grid_log']['iframe_ret_cap'] = $nmgp_iframe_ret;
           }
           $_SESSION['sc_session'][$script_case_init]['app_grid_log']['psq_edit'] = 'N';   
           if (isset($nmgp_perm_edit)) {
               $_SESSION['sc_session'][$script_case_init]['app_grid_log']['psq_edit'] = $nmgp_perm_edit;
           }
       } 
       elseif (!isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['opc_psq']))
       {
           $_SESSION['sc_session'][$script_case_init]['app_grid_log']['opc_psq']  = false;   
           $_SESSION['sc_session'][$script_case_init]['app_grid_log']['psq_edit'] = 'N';   
       } 
       if (isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida_form'])
       {
           if (!isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida_form_full']) || !$_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida_form_full'])
           {
               $_SESSION['sc_session'][$script_case_init]['app_grid_log']['mostra_edit'] = "N";   
           } 
       ...
       $contr_app_grid_log = new app_grid_log_apl();

      if ('ajax_autocomp' == $nmgp_opcao)
      {
          $nmgp_opcao = 'busca';
          $_SESSION['sc_session'][$script_case_init]['app_grid_log']['opcao'] = "busca";
          $contr_app_grid_log->NM_ajax_flag = true;
          $contr_app_grid_log->NM_ajax_opcao = $NM_ajax_opcao;
      }
      if ('ajax_ch_bi_search' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['app_grid_log']['opcao'] = "busca";
          $contr_app_grid_log->NM_ajax_flag = true;
          $contr_app_grid_log->NM_ajax_opcao = "ajax_ch_bi_search";
      }
      if ('ajax_filter_save' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['app_grid_log']['opcao'] = "busca";
          $contr_app_grid_log->NM_ajax_flag = true;
          $contr_app_grid_log->NM_ajax_opcao = "ajax_filter_save";
      }
      if ('ajax_filter_delete' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['app_grid_log']['opcao'] = "busca";
          $contr_app_grid_log->NM_ajax_flag = true;
          $contr_app_grid_log->NM_ajax_opcao = "ajax_filter_delete";
      }
      if ('ajax_filter_select' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['app_grid_log']['opcao'] = "busca";
          $contr_app_grid_log->NM_ajax_flag = true;
          $contr_app_grid_log->NM_ajax_opcao = "ajax_filter_select";
      }
       $contr_app_grid_log->controle();
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida'] && $nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_app_grid_log(&$str)
   {
   }
   function nm_protect_num_app_grid_log($name, &$val)
   {
       if (empty($val))
       {
          return;
   ...
   function app_grid_log_pack_protect_string($sString)
   {
    ...
    function app_grid_log_pdf_progress_call($message, $Nm_lang, $flushBuffer = false) {
...
<?php
        global $script_case_init;
        if ($flushBuffer && $_SESSION['sc_session'][$script_case_init]['app_grid_log']['opcao'] != 'print') {
            $bufferSize = @ini_get('output_buffering');
            if ('' != $bufferSize) {
