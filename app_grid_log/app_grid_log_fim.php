...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["EnfermeriaUNAE_____app_grid_log"]))
   {
      unset($_SESSION['session_sec_aplicacao']["EnfermeriaUNAE_____app_grid_log"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['app_grid_log']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['app_grid_log']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida_filho'] as $ind => $sc_init)
          {
