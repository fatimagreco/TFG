...
if (parent.document.getElementById('nmsc_iframe_app_grid_log').contentWindow.nm_gp_submit_ajax)
{
   parent.document.getElementById('nmsc_iframe_app_grid_log').contentWindow.nm_gp_submit_ajax('inicio', 'save_grid');
}
else
{
   parent.document.getElementById('nmsc_iframe_app_grid_log').src = 'index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>';
}
</SCRIPT>
</BODY>
</HTML>
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Log de Auditoría</span></td>
...
?>
    ...
    <TR>
     <TD colspan="3" height="20" class="scFilterBlockBack">
      ...
      <TD id='SC_inserted_date_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['inserted_date'])) ? $this->New_label['inserted_date'] : "" . $this->Ini->Nm_lang['lang_log_date_insert'] . ""; ?></TD>
     ...
     <TD  class="scFilterFieldOdd"><SPAN id="Nm_bi_dados_inserted_date" style="display:none"></SPAN>
      <TABLE  id="opc_bi_TP_inserted_date"  style=display:  border="0" cellpadding="0" cellspacing="0">
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
      ...
      <TD id='SC_application_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['application'])) ? $this->New_label['application'] : "" . $this->Ini->Nm_lang['lang_log_app'] . ""; ?></TD>
...
?>
      ...
      <TD id='SC_username_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['username'])) ? $this->New_label['username'] : "" . $this->Ini->Nm_lang['lang_log_user'] . ""; ?></TD>
...
?>
      ...
      <TD id='SC_ip_user_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['ip_user'])) ? $this->New_label['ip_user'] : "" . $this->Ini->Nm_lang['lang_log_ip'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_ip_user_cond" name="ip_user_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ip_user" <?php echo $str_hide_ip_user?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
?>
<INPUT  type="text" id="SC_ip_user" name="ip_user" value="<?php echo NM_encode_input($ip_user) ?>"  size=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_sc_field_0_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['sc_field_0'])) ? $this->New_label['sc_field_0'] : "" . $this->Ini->Nm_lang['lang_log_action'] . ""; ?></TD>
...
{
?>
<iframe id="nmsc_iframe_app_grid_log" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_app_grid_log" scrolling="auto" src="index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>" width="100%"></iframe>
<?php
}
else
{
...
?>
<iframe id="nmsc_iframe_app_grid_log_pesq"  name="nm_iframe_app_grid_log_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
...
?>
 ...
 {
    document.F1.target = "nm_iframe_app_grid_log_pesq";
    document.F1.submit();
 }
 function nm_move()
 {
     document.getElementById('nmsc_iframe_app_grid_log').contentWindow.nm_move('igual');
 }
 function limpa_form()
 {
   document.F1.reset();
