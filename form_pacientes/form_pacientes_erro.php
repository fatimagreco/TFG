...
$old_error_handler = set_error_handler("form_pacientes_scriptcase_error_handler");

function form_pacientes_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['form_pacientes']['contr_erro']) && $_SESSION['scriptcase']['form_pacientes']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_pacientes->contr_form_pacientes->Apl_com_erro = true;
            if ($inicial_form_pacientes->contr_form_pacientes->NM_ajax_flag)
            {
                $inicial_form_pacientes->contr_form_pacientes->NM_ajax_info['errList']['geral_form_pacientes'][] = $msg;
                return;
            }
            form_pacientes_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_pacientes_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_pacientes'])  && '' != $_SESSION['scriptcase']['error_icon']['form_pacientes'])  ? $_SESSION['scriptcase']['error_icon']['form_pacientes']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_pacientes']) && '' != $_SESSION['scriptcase']['error_span_title']['form_pacientes']) ? $_SESSION['scriptcase']['error_span_title']['form_pacientes'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_pacientes']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_pacientes']) ? $_SESSION['scriptcase']['error_icon_title']['form_pacientes'] : '';
?>
