  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_medicines_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_medicines_mob_form();
	}
...
?>
  ...
  // ---------- Validate mtype_id
  function do_ajax_form_medicines_mob_validate_mtype_id()
  {
    var nomeCampo_mtype_id = "mtype_id";
    var var_mtype_id = scAjaxGetFieldSelect(nomeCampo_mtype_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medicines_mob_validate_mtype_id(var_mtype_id, var_script_case_init, do_ajax_form_medicines_mob_validate_mtype_id_cb);
  } // do_ajax_form_medicines_mob_validate_mtype_id

  function do_ajax_form_medicines_mob_validate_mtype_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mtype_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medicines_mob_validate_mtype_id_cb

  // ---------- Validate meds_desc
  function do_ajax_form_medicines_mob_validate_meds_desc()
  {
    var nomeCampo_meds_desc = "meds_desc";
    var var_meds_desc = scAjaxGetFieldText(nomeCampo_meds_desc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medicines_mob_validate_meds_desc(var_meds_desc, var_script_case_init, do_ajax_form_medicines_mob_validate_meds_desc_cb);
  } // do_ajax_form_medicines_mob_validate_meds_desc

  function do_ajax_form_medicines_mob_validate_meds_desc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "meds_desc";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medicines_mob_validate_meds_desc_cb

  // ---------- Validate presentaciones
  function do_ajax_form_medicines_mob_validate_presentaciones()
  {
    var nomeCampo_presentaciones = "presentaciones";
    var var_presentaciones = scAjaxGetFieldText(nomeCampo_presentaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medicines_mob_validate_presentaciones(var_presentaciones, var_script_case_init, do_ajax_form_medicines_mob_validate_presentaciones_cb);
  } // do_ajax_form_medicines_mob_validate_presentaciones

  function do_ajax_form_medicines_mob_validate_presentaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "presentaciones";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medicines_mob_validate_presentaciones_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_medicines_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_medicines_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_mtype_id = scAjaxGetFieldSelect("mtype_id");
    var var_meds_desc = scAjaxGetFieldText("meds_desc");
    var var_meds_id = scAjaxGetFieldText("meds_id");
    ...
    scAjaxProcOn();
    x_ajax_form_medicines_mob_submit_form(var_mtype_id, var_meds_desc, var_meds_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_medicines_mob_submit_form_cb);
  } // do_ajax_form_medicines_mob_submit_form

  function do_ajax_form_medicines_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("mtype_id");
      scAjaxHideErrorDisplay("meds_desc");
      scAjaxHideErrorDisplay("presentaciones");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_medicines_mob_submit_form_cb_after_alert);
  } // do_ajax_form_medicines_mob_submit_form_cb
  function do_ajax_form_medicines_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_medicines_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_med_presentation_mob"] = "off";

  function do_ajax_form_medicines_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_medicines_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_medicines_mob_navigate_form();
    }
  }

  function perform_ajax_form_medicines_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("meds_desc");
    scAjaxHideErrorDisplay("presentaciones");
    var var_meds_id = document.F2.meds_id.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_med_presentation_mob"] = "on";
    x_ajax_form_medicines_mob_navigate_form(var_meds_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_medicines_mob_navigate_form_cb);
  } // do_ajax_form_medicines_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_medicines_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_medicines_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.meds_id.value = scAjaxGetKeyValue("meds_id");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_med_presentation_mob"] && "nmsc_iframe_liga_form_med_presentation_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_med_presentation_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_med_presentation_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_med_presentation_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_med_presentation_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_med_presentation_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_medicines_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_medicines_mob_navigate_form_cb
  function do_ajax_form_medicines_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_medicines_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_medicines_mob_navigate_form_cb_after_alert

  function sc_hide_form_medicines_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_med_presentation_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "mtype_id";
  ajax_field_list[1] = "meds_desc";
  ajax_field_list[2] = "presentaciones";
  ...
  var ajax_error_list = {
    "mtype_id": {"label": "Tipo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "meds_desc": {"label": "Medicamento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "presentaciones": {"label": "Presentaciones", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "mtype_id": new Array(),
    "meds_desc": new Array(),
    "presentaciones": new Array()
  };
  ajax_field_mult["mtype_id"][1] = "mtype_id";
  ajax_field_mult["meds_desc"][1] = "meds_desc";
  ajax_field_mult["presentaciones"][1] = "presentaciones";

  var ajax_field_id = {
    "mtype_id": new Array("hidden_field_label_mtype_id", "hidden_field_data_mtype_id"),
    "meds_desc": new Array("hidden_field_label_meds_desc", "hidden_field_data_meds_desc"),
    "presentaciones": new Array("hidden_field_label_presentaciones", "hidden_field_data_presentaciones")
  };
