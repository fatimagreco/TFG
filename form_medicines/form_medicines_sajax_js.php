  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_medicines" == sTestField)
        {
...
?>
  ...
  // ---------- Validate mtype_id
  function do_ajax_form_medicines_validate_mtype_id()
  {
    var nomeCampo_mtype_id = "mtype_id";
    var var_mtype_id = scAjaxGetFieldSelect(nomeCampo_mtype_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medicines_validate_mtype_id(var_mtype_id, var_script_case_init, do_ajax_form_medicines_validate_mtype_id_cb);
  } // do_ajax_form_medicines_validate_mtype_id

  function do_ajax_form_medicines_validate_mtype_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medicines_validate_mtype_id_cb

  // ---------- Validate meds_desc
  function do_ajax_form_medicines_validate_meds_desc()
  {
    var nomeCampo_meds_desc = "meds_desc";
    var var_meds_desc = scAjaxGetFieldText(nomeCampo_meds_desc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medicines_validate_meds_desc(var_meds_desc, var_script_case_init, do_ajax_form_medicines_validate_meds_desc_cb);
  } // do_ajax_form_medicines_validate_meds_desc

  function do_ajax_form_medicines_validate_meds_desc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medicines_validate_meds_desc_cb

  // ---------- Validate presentaciones
  function do_ajax_form_medicines_validate_presentaciones()
  {
    var nomeCampo_presentaciones = "presentaciones";
    var var_presentaciones = scAjaxGetFieldText(nomeCampo_presentaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medicines_validate_presentaciones(var_presentaciones, var_script_case_init, do_ajax_form_medicines_validate_presentaciones_cb);
  } // do_ajax_form_medicines_validate_presentaciones

  function do_ajax_form_medicines_validate_presentaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medicines_validate_presentaciones_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_medicines_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_medicines_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_medicines_submit_form(var_mtype_id, var_meds_desc, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_medicines_submit_form_cb);
  } // do_ajax_form_medicines_submit_form

  function do_ajax_form_medicines_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_medicines_submit_form_cb_after_alert);
  } // do_ajax_form_medicines_submit_form_cb
  function do_ajax_form_medicines_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_medicines_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_med_presentation"] = "off";

  function do_ajax_form_medicines_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_medicines_navigate_form, function() {});
    } else {
      perform_ajax_form_medicines_navigate_form();
    }
  }

  function perform_ajax_form_medicines_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_med_presentation"] = "on";
    x_ajax_form_medicines_navigate_form(var_meds_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_medicines_navigate_form_cb);
  } // do_ajax_form_medicines_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_medicines']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_medicines_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_med_presentation"] && "nmsc_iframe_liga_form_med_presentation" != scMasterDetailIframe["nmsc_iframe_liga_form_med_presentation"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_med_presentation"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_med_presentation').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_med_presentation').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_med_presentation').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_medicines_navigate_form_cb_after_alert);
  } // do_ajax_form_medicines_navigate_form_cb
  function do_ajax_form_medicines_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_medicines_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_medicines_navigate_form_cb_after_alert

  function sc_hide_form_medicines_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_med_presentation"])
    {
      return true;
    }
    return false;
