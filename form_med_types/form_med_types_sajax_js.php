  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_med_types" == sTestField)
        {
...
?>
  ...
  // ---------- Validate mtype_name
  function do_ajax_form_med_types_validate_mtype_name()
  {
    var nomeCampo_mtype_name = "mtype_name";
    var var_mtype_name = scAjaxGetFieldText(nomeCampo_mtype_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_med_types_validate_mtype_name(var_mtype_name, var_script_case_init, do_ajax_form_med_types_validate_mtype_name_cb);
  } // do_ajax_form_med_types_validate_mtype_name

  function do_ajax_form_med_types_validate_mtype_name_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_med_types_validate_mtype_name_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_med_types_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_med_types_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_med_types_submit_form(var_mtype_name, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_med_types_submit_form_cb);
  } // do_ajax_form_med_types_submit_form

  function do_ajax_form_med_types_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_med_types_submit_form_cb_after_alert);
  } // do_ajax_form_med_types_submit_form_cb
  function do_ajax_form_med_types_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_med_types_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_med_types_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_med_types_navigate_form, function() {});
    } else {
      perform_ajax_form_med_types_navigate_form();
    }
  }

  function perform_ajax_form_med_types_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_med_types_navigate_form(var_mtype_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_med_types_navigate_form_cb);
  } // do_ajax_form_med_types_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_med_types']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_med_types_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_med_types_navigate_form_cb_after_alert);
  } // do_ajax_form_med_types_navigate_form_cb
  function do_ajax_form_med_types_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_med_types_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_med_types_navigate_form_cb_after_alert

  function sc_hide_form_med_types_form()
  {
