  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_suppliers" == sTestField)
        {
...
?>
  ...
  // ---------- Validate sup_name
  function do_ajax_form_suppliers_validate_sup_name()
  {
    var nomeCampo_sup_name = "sup_name";
    var var_sup_name = scAjaxGetFieldText(nomeCampo_sup_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_suppliers_validate_sup_name(var_sup_name, var_script_case_init, do_ajax_form_suppliers_validate_sup_name_cb);
  } // do_ajax_form_suppliers_validate_sup_name

  function do_ajax_form_suppliers_validate_sup_name_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_suppliers_validate_sup_name_cb

  // ---------- Validate sup_address
  function do_ajax_form_suppliers_validate_sup_address()
  {
    var nomeCampo_sup_address = "sup_address";
    var var_sup_address = scAjaxGetFieldText(nomeCampo_sup_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_suppliers_validate_sup_address(var_sup_address, var_script_case_init, do_ajax_form_suppliers_validate_sup_address_cb);
  } // do_ajax_form_suppliers_validate_sup_address

  function do_ajax_form_suppliers_validate_sup_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_suppliers_validate_sup_address_cb

  // ---------- Validate sup_phone
  function do_ajax_form_suppliers_validate_sup_phone()
  {
    var nomeCampo_sup_phone = "sup_phone";
    var var_sup_phone = scAjaxGetFieldText(nomeCampo_sup_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_suppliers_validate_sup_phone(var_sup_phone, var_script_case_init, do_ajax_form_suppliers_validate_sup_phone_cb);
  } // do_ajax_form_suppliers_validate_sup_phone

  function do_ajax_form_suppliers_validate_sup_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_suppliers_validate_sup_phone_cb

  // ---------- Validate sup_email
  function do_ajax_form_suppliers_validate_sup_email()
  {
    var nomeCampo_sup_email = "sup_email";
    var var_sup_email = scAjaxGetFieldText(nomeCampo_sup_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_suppliers_validate_sup_email(var_sup_email, var_script_case_init, do_ajax_form_suppliers_validate_sup_email_cb);
  } // do_ajax_form_suppliers_validate_sup_email

  function do_ajax_form_suppliers_validate_sup_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_suppliers_validate_sup_email_cb

  // ---------- Validate sup_ruc
  function do_ajax_form_suppliers_validate_sup_ruc()
  {
    var nomeCampo_sup_ruc = "sup_ruc";
    var var_sup_ruc = scAjaxGetFieldText(nomeCampo_sup_ruc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_suppliers_validate_sup_ruc(var_sup_ruc, var_script_case_init, do_ajax_form_suppliers_validate_sup_ruc_cb);
  } // do_ajax_form_suppliers_validate_sup_ruc

  function do_ajax_form_suppliers_validate_sup_ruc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sup_ruc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_suppliers_validate_sup_ruc_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_suppliers_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_suppliers_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_suppliers_submit_form(var_sup_name, var_sup_address, var_sup_phone, var_sup_email, var_sup_ruc, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_suppliers_submit_form_cb);
  } // do_ajax_form_suppliers_submit_form

  function do_ajax_form_suppliers_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_suppliers_submit_form_cb_after_alert);
  } // do_ajax_form_suppliers_submit_form_cb
  function do_ajax_form_suppliers_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_suppliers_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_suppliers_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_suppliers_navigate_form, function() {});
    } else {
      perform_ajax_form_suppliers_navigate_form();
    }
  }

  function perform_ajax_form_suppliers_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_suppliers_navigate_form(var_sup_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_suppliers_navigate_form_cb);
  } // do_ajax_form_suppliers_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_suppliers']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_suppliers_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_suppliers_navigate_form_cb_after_alert);
  } // do_ajax_form_suppliers_navigate_form_cb
  function do_ajax_form_suppliers_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_suppliers_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_suppliers_navigate_form_cb_after_alert

  function sc_hide_form_suppliers_form()
  {
