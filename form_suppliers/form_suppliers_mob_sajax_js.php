  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_suppliers_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_suppliers_mob_form();
	}
...
?>
  ...
  // ---------- Validate sup_name
  function do_ajax_form_suppliers_mob_validate_sup_name()
  {
    var nomeCampo_sup_name = "sup_name";
    var var_sup_name = scAjaxGetFieldText(nomeCampo_sup_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_suppliers_mob_validate_sup_name(var_sup_name, var_script_case_init, do_ajax_form_suppliers_mob_validate_sup_name_cb);
  } // do_ajax_form_suppliers_mob_validate_sup_name

  function do_ajax_form_suppliers_mob_validate_sup_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sup_name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_suppliers_mob_validate_sup_name_cb

  // ---------- Validate sup_address
  function do_ajax_form_suppliers_mob_validate_sup_address()
  {
    var nomeCampo_sup_address = "sup_address";
    var var_sup_address = scAjaxGetFieldText(nomeCampo_sup_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_suppliers_mob_validate_sup_address(var_sup_address, var_script_case_init, do_ajax_form_suppliers_mob_validate_sup_address_cb);
  } // do_ajax_form_suppliers_mob_validate_sup_address

  function do_ajax_form_suppliers_mob_validate_sup_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sup_address";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_suppliers_mob_validate_sup_address_cb

  // ---------- Validate sup_phone
  function do_ajax_form_suppliers_mob_validate_sup_phone()
  {
    var nomeCampo_sup_phone = "sup_phone";
    var var_sup_phone = scAjaxGetFieldText(nomeCampo_sup_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_suppliers_mob_validate_sup_phone(var_sup_phone, var_script_case_init, do_ajax_form_suppliers_mob_validate_sup_phone_cb);
  } // do_ajax_form_suppliers_mob_validate_sup_phone

  function do_ajax_form_suppliers_mob_validate_sup_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sup_phone";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_suppliers_mob_validate_sup_phone_cb

  // ---------- Validate sup_email
  function do_ajax_form_suppliers_mob_validate_sup_email()
  {
    var nomeCampo_sup_email = "sup_email";
    var var_sup_email = scAjaxGetFieldText(nomeCampo_sup_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_suppliers_mob_validate_sup_email(var_sup_email, var_script_case_init, do_ajax_form_suppliers_mob_validate_sup_email_cb);
  } // do_ajax_form_suppliers_mob_validate_sup_email

  function do_ajax_form_suppliers_mob_validate_sup_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sup_email";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_suppliers_mob_validate_sup_email_cb

  // ---------- Validate sup_ruc
  function do_ajax_form_suppliers_mob_validate_sup_ruc()
  {
    var nomeCampo_sup_ruc = "sup_ruc";
    var var_sup_ruc = scAjaxGetFieldText(nomeCampo_sup_ruc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_suppliers_mob_validate_sup_ruc(var_sup_ruc, var_script_case_init, do_ajax_form_suppliers_mob_validate_sup_ruc_cb);
  } // do_ajax_form_suppliers_mob_validate_sup_ruc

  function do_ajax_form_suppliers_mob_validate_sup_ruc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sup_ruc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_suppliers_mob_validate_sup_ruc_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_suppliers_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_suppliers_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_sup_name = scAjaxGetFieldText("sup_name");
    var var_sup_address = scAjaxGetFieldText("sup_address");
    var var_sup_phone = scAjaxGetFieldText("sup_phone");
    var var_sup_email = scAjaxGetFieldText("sup_email");
    var var_sup_ruc = scAjaxGetFieldText("sup_ruc");
    var var_sup_id = scAjaxGetFieldText("sup_id");
    ...
    scAjaxProcOn();
    x_ajax_form_suppliers_mob_submit_form(var_sup_name, var_sup_address, var_sup_phone, var_sup_email, var_sup_ruc, var_sup_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_suppliers_mob_submit_form_cb);
  } // do_ajax_form_suppliers_mob_submit_form

  function do_ajax_form_suppliers_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("sup_name");
      scAjaxHideErrorDisplay("sup_address");
      scAjaxHideErrorDisplay("sup_phone");
      scAjaxHideErrorDisplay("sup_email");
      scAjaxHideErrorDisplay("sup_ruc");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_suppliers_mob_submit_form_cb_after_alert);
  } // do_ajax_form_suppliers_mob_submit_form_cb
  function do_ajax_form_suppliers_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_suppliers_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_suppliers_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_suppliers_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_suppliers_mob_navigate_form();
    }
  }

  function perform_ajax_form_suppliers_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("sup_email");
    scAjaxHideErrorDisplay("sup_ruc");
    var var_sup_id = document.F2.sup_id.value;
    ...
    scAjaxProcOn();
    x_ajax_form_suppliers_mob_navigate_form(var_sup_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_suppliers_mob_navigate_form_cb);
  } // do_ajax_form_suppliers_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_suppliers_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_suppliers_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.sup_id.value = scAjaxGetKeyValue("sup_id");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_suppliers_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_suppliers_mob_navigate_form_cb
  function do_ajax_form_suppliers_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_suppliers_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_suppliers_mob_navigate_form_cb_after_alert

  function sc_hide_form_suppliers_mob_form()
  {
  ...
  ajax_field_list[0] = "sup_name";
  ajax_field_list[1] = "sup_address";
  ajax_field_list[2] = "sup_phone";
  ajax_field_list[3] = "sup_email";
  ajax_field_list[4] = "sup_ruc";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "sup_name": {"label": "Proveedor", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sup_address": {"label": "Dirección", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sup_phone": {"label": "Teléfono", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sup_email": {"label": "Correo Electrónico", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sup_ruc": {"label": "RUC", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "sup_name": new Array(),
    "sup_address": new Array(),
    "sup_phone": new Array(),
    "sup_email": new Array(),
    "sup_ruc": new Array()
  };
  ajax_field_mult["sup_name"][1] = "sup_name";
  ajax_field_mult["sup_address"][1] = "sup_address";
  ajax_field_mult["sup_phone"][1] = "sup_phone";
  ajax_field_mult["sup_email"][1] = "sup_email";
  ajax_field_mult["sup_ruc"][1] = "sup_ruc";

  var ajax_field_id = {
    "sup_name": new Array("hidden_field_label_sup_name", "hidden_field_data_sup_name"),
    "sup_address": new Array("hidden_field_label_sup_address", "hidden_field_data_sup_address"),
    "sup_phone": new Array("hidden_field_label_sup_phone", "hidden_field_data_sup_phone"),
    "sup_email": new Array("hidden_field_label_sup_email", "hidden_field_data_sup_email"),
    "sup_ruc": new Array("hidden_field_label_sup_ruc", "hidden_field_data_sup_ruc")
  };
