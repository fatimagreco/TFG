...
$old_error_handler = set_error_handler("form_suppliers_scriptcase_error_handler");

function form_suppliers_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['form_suppliers']['contr_erro']) && $_SESSION['scriptcase']['form_suppliers']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_suppliers->contr_form_suppliers->Apl_com_erro = true;
            if ($inicial_form_suppliers->contr_form_suppliers->NM_ajax_flag)
            {
                $inicial_form_suppliers->contr_form_suppliers->NM_ajax_info['errList']['geral_form_suppliers'][] = $msg;
                return;
            }
            form_suppliers_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_suppliers_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_suppliers'])  && '' != $_SESSION['scriptcase']['error_icon']['form_suppliers'])  ? $_SESSION['scriptcase']['error_icon']['form_suppliers']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_suppliers']) && '' != $_SESSION['scriptcase']['error_span_title']['form_suppliers']) ? $_SESSION['scriptcase']['error_span_title']['form_suppliers'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_suppliers']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_suppliers']) ? $_SESSION['scriptcase']['error_icon_title']['form_suppliers'] : '';
?>
