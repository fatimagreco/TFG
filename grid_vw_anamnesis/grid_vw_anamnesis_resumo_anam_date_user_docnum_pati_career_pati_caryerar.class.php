...
class grid_vw_anamnesis_resumo
{
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_anam_date = array();
...
SCEOT;
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_anam_date = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['arr_total']['anam_date'];
      }
      else
      {
          $this->array_total_anam_date = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['arr_total']['anam_date'] = $this->array_total_anam_date;
   ...
   function completeMatrix()
   {
       ...
       {
          $Lab_anam_date = "anam_date";
       }
       else
       {
       $Lab_anam_date = "Fecha";
       $Lab_anam_date =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "", $Lab_anam_date);
       }
       $this->comp_field = array(
           $Lab_anam_date,
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_order']['anam_date_user_docnum_pati_career_pati_caryerar']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_order']['anam_date_user_docnum_pati_career_pati_caryerar'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_order']['anam_date_user_docnum_pati_career_pati_caryerar'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_display']['anam_date_user_docnum_pati_career_pati_caryerar'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_display']['anam_date_user_docnum_pati_career_pati_caryerar'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_display']['anam_date_user_docnum_pati_career_pati_caryerar'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_display']['anam_date_user_docnum_pati_career_pati_caryerar'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_display']['anam_date_user_docnum_pati_career_pati_caryerar'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_display']['anam_date_user_docnum_pati_career_pati_caryerar'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_display']['anam_date_user_docnum_pati_career_pati_caryerar'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_anam_date as $i_anam_date => $d_anam_date) {
           if (!isset($i_anam_date, $this->comp_label[0]) || !in_array($i_anam_date, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_anam_date[3] ] = $d_anam_date[2];
               $this->comp_label[0][ $d_anam_date[3] ] = $d_anam_date[2];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'anam_date', 'prot' => '@aspass@'),
       );
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_anam_date => $l_anam_date) {
           if (isset($this->array_total_anam_date[$i_anam_date])) {
               $this->comp_group[$i_anam_date] = array();
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_anam_date;
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_anam_date_user_docnum_pati_career_pati_caryerar("res", $this->NM_export);
      ...
      if (is_array($this->array_total_anam_date)) {
          ksort($this->array_total_anam_date);
      }
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['SC_Ind_Groupby'];
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_anam_id, $quebra_anam_date, $quebra_anam_date_orig)
   {
      //----- " . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "
      if (!isset($this->array_total_anam_date[$quebra_anam_date_orig]))
      {
         $this->array_total_anam_date[$quebra_anam_date_orig][0] = 1;
         $this->array_total_anam_date[$quebra_anam_date_orig][1] = $sum_anam_id;
         $this->array_total_anam_date[$quebra_anam_date_orig][2] = $quebra_anam_date;
         $this->array_total_anam_date[$quebra_anam_date_orig][3] = $quebra_anam_date_orig;
      }
      else
      {
         $this->array_total_anam_date[$quebra_anam_date_orig][0]++;
         $this->array_total_anam_date[$quebra_anam_date_orig][1] = bcadd($this->array_total_anam_date[$quebra_anam_date_orig][1], $sum_anam_id, 10);
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('anam_date_user_docnum_pati_career_pati_caryerar', 'anam_date');
     $campos_order = $this->Ini->Get_date_order_groupby("anam_date", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->anam_date_orig = $this->Ini->Get_arg_groupby($TP_Time . $this->anam_date, $Format_tst);
            $this->anam_date = $this->Ini->GB_date_format($TP_Time . $this->anam_date, $Format_tst, $Prefix_dat);
            $this->user_id = $this->look_user_id ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->anam_id, $this->anam_date, $this->anam_date_orig);
            }
   }
//
