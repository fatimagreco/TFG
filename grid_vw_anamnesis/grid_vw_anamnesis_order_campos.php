...
<?php
   ...
   $Ord_Cmp = new grid_vw_anamnesis_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_vw_anamnesis_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['anam_date'] = "on";
   $tab_def_campos['anam_date'] = "anam_date";
   $tab_labels["anam_date"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['labels']["anam_date"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['labels']["anam_date"] : "Fecha";
   $tab_ger_campos['anam_strtime'] = "on";
   $tab_def_campos['anam_strtime'] = "anam_strtime";
   $tab_labels["anam_strtime"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['labels']["anam_strtime"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['labels']["anam_strtime"] : "Hora ";
   $tab_ger_campos['pati_name'] = "on";
   $tab_def_campos['pati_name'] = "pati_name";
   $tab_labels["pati_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['labels']["pati_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['labels']["pati_name"] : "Nombre";
   $tab_ger_campos['pati_lname'] = "on";
   $tab_def_campos['pati_lname'] = "pati_lname";
   $tab_labels["pati_lname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['labels']["pati_lname"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['labels']["pati_lname"] : "Apellido";
   $tab_ger_campos['pati_bod'] = "on";
   $tab_def_campos['pati_bod'] = "pati_bod";
   $tab_labels["pati_bod"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['labels']["pati_bod"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['labels']["pati_bod"] : "Edad";
   $tab_ger_campos['anam_bpsys'] = "on";
   $tab_def_campos['anam_bpsys'] = "anam_bpsys";
   $tab_labels["anam_bpsys"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['labels']["anam_bpsys"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['labels']["anam_bpsys"] : "PA SIS";
   $tab_ger_campos['anam_bpdia'] = "on";
   $tab_def_campos['anam_bpdia'] = "anam_bpdia";
   $tab_labels["anam_bpdia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['labels']["anam_bpdia"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['labels']["anam_bpdia"] : "PA DIA";
   $tab_ger_campos['anam_career'] = "on";
   $tab_def_campos['anam_career'] = "anam_career";
   $tab_labels["anam_career"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['labels']["anam_career"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['labels']["anam_career"] : "Carrera";
   $tab_ger_campos['anam_caryear'] = "on";
   $tab_def_campos['anam_caryear'] = "anam_caryear";
   $tab_labels["anam_caryear"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['labels']["anam_caryear"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['labels']["anam_caryear"] : "Año";
   $tab_ger_campos['anam_reason'] = "on";
   $tab_def_campos['anam_reason'] = "anam_reason";
   $tab_labels["anam_reason"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['labels']["anam_reason"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['labels']["anam_reason"] : "Motivo de Consulta";
   $tab_ger_campos['treat_instruc'] = "on";
   $tab_def_campos['treat_instruc'] = "treat_instruc";
   $tab_labels["treat_instruc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['labels']["treat_instruc"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['labels']["treat_instruc"] : "Tratamiento Administrado";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_vw_anamnesis_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_vw_anamnesis']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
