...
class grid_vw_anamnesis_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_vw_anamnesis_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_vw_anamnesis_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_vw_anamnesis_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "anam_date";$Nm_datas[] = "anam_strtime";$Nm_datas[] = "anam_endtime";$Nm_datas[] = "pati_bod";
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_vw_anamnesis/grid_vw_anamnesis_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_vw_anamnesis_ajax_search.js"></script>
 <script type="text/javascript" src="grid_vw_anamnesis_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_vw_anamnesis_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_vw_anamnesis']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_vw_anamnesis']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
  $("#sc_anam_date_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_anam_date_dia').value + '/';
          var_dt_ini += document.getElementById('SC_anam_date_mes').value + '/';
          var_dt_ini += document.getElementById('SC_anam_date_ano').value;
          document.getElementById('sc_anam_date_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_anam_date_dia').value = aParts[0];
          document.getElementById('SC_anam_date_mes').value = aParts[1];
          document.getElementById('SC_anam_date_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_anam_date_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_anam_date_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_anam_date_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_anam_date_input_2_ano').value;
          document.getElementById('sc_anam_date_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_anam_date_input_2_dia').value = aParts[0];
          document.getElementById('SC_anam_date_input_2_mes').value = aParts[1];
          document.getElementById('SC_anam_date_input_2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_anam_date_cond#NMF#' + search_get_sel_txt('SC_anam_date_cond') + '@NMF@';
  opc = search_get_sel_txt('SC_anam_date_cond');
  if (opc.substring(0, 3) != "bi_")
  {
      str_out += 'SC_anam_date_dia#NMF#' + search_get_sel_txt('SC_anam_date_dia') + '@NMF@';
      str_out += 'SC_anam_date_mes#NMF#' + search_get_sel_txt('SC_anam_date_mes') + '@NMF@';
      str_out += 'SC_anam_date_ano#NMF#' + search_get_sel_txt('SC_anam_date_ano') + '@NMF@';
      str_out += 'SC_anam_date_input_2_dia#NMF#' + search_get_sel_txt('SC_anam_date_input_2_dia') + '@NMF@';
      str_out += 'SC_anam_date_input_2_mes#NMF#' + search_get_sel_txt('SC_anam_date_input_2_mes') + '@NMF@';
      str_out += 'SC_anam_date_input_2_ano#NMF#' + search_get_sel_txt('SC_anam_date_input_2_ano') + '@NMF@';
  }
  str_out += 'SC_user_id_cond#NMF#' + search_get_sel_txt('SC_user_id_cond') + '@NMF@';
  str_out += 'SC_user_id#NMF#' + search_get_selmult('SC_user_id') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"> Reporte Atenciones</div>
...
<?php
   ...
   {
      global 
             $anam_date_cond, $anam_date, $anam_date_dia, $anam_date_mes, $anam_date_ano, $anam_date_input_2_dia, $anam_date_input_2_mes, $anam_date_input_2_ano,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $anam_date_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca']['anam_date_dia']; 
          $anam_date_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca']['anam_date_mes']; 
          $anam_date_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca']['anam_date_ano']; 
          $anam_date_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca']['anam_date_input_2_dia']; 
          $anam_date_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca']['anam_date_input_2_mes']; 
          $anam_date_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca']['anam_date_input_2_ano']; 
          $anam_date_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca']['anam_date_cond']; 
          $user_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca']['user_id']; 
          $user_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca']['user_id_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca']['NM_operador']; 
      } 
      if (!isset($user_id_cond) || empty($user_id_cond))
      {
         $user_id_cond = "eq";
      }
      if (!isset($anam_date_cond) || empty($anam_date_cond))
      {
         $anam_date_cond = "bi_current_year";
      }
      if (isset($anam_date_cond) && substr($anam_date_cond, 0, 3) == "bi_")
      {
         $Temp_cond = $anam_date_cond;
         $this->Ini->process_cond_bi($Temp_cond, $BI_data1, $BI_data2);
         $anam_date_dia = substr($BI_data1, 0, 2);
         $anam_date_mes = substr($BI_data1, 2, 2);
         $anam_date_ano = substr($BI_data1, 4, 4);
         if (strlen($BI_data1) > 8)
         {
             $anam_date_hor = substr($BI_data1, 8, 2);
             $anam_date_min = substr($BI_data1, 10, 2);
             $anam_date_seg = substr($BI_data1, 12, 2);
         }
         $anam_date_input_2_dia = substr($BI_data2, 0, 2);
         $anam_date_input_2_mes = substr($BI_data2, 2, 2);
         $anam_date_input_2_ano = substr($BI_data2, 4, 4);
         if (strlen($BI_data2) > 8)
         {
             $anam_date_input_2_hor = substr($BI_data2, 8, 2);
             $anam_date_input_2_min = substr($BI_data2, 10, 2);
             $anam_date_input_2_seg = substr($BI_data2, 12, 2);
         }
         $Script_BI .= "  formata_bi_anam_date('" . $anam_date_cond . "', '" . $Temp_cond . "', '" . $BI_data1 . "');\r\n";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_anam_date = (in_array($anam_date_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_user_id = (in_array($user_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_anam_date = ('bw' == $anam_date_cond || 'bi_' == substr($anam_date_cond, 0, 3)) ? $display_aberto : $display_fechado;
      ...
      if (is_array($user_id) && !empty($user_id))
      {
         $tmp_array = array();
         $user_id_val_str = "";
         foreach ($user_id as $tmp_val_cmp)
         {
            if ("" != $user_id_val_str)
            {
               $user_id_val_str .= ",";
      ...
      if (!isset($anam_date) || $anam_date == "")
      {
          $anam_date = "";
      }
      if (isset($anam_date) && !empty($anam_date))
      {
...
?>
<?php
   if (is_file("grid_vw_anamnesis_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_vw_anamnesis']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_vw_anamnesis']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_anam_date_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['anam_date'])) ? $this->New_label['anam_date'] : "Fecha"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_anam_date_cond" name="anam_date_cond" onChange="nm_campos_between(document.getElementById('id_vis_anam_date'), this, 'anam_date')">
       <optgroup label="<?php echo $this->Ini->Nm_lang['lang_srch_spec'] ?>">
       <OPTION value="bi_current_year" <?php if ("bi_current_year" == $anam_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_search_summary_current_year'] ?></OPTION>
       <OPTION value="bi_LY" <?php if ("bi_LY" == $anam_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_year'] ?></OPTION>
       <OPTION value="bi_este_mes_full" <?php if ("bi_este_mes_full" == $anam_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_search_este_mes_full'] ?></OPTION>
       <OPTION value="bi_UM" <?php if ("bi_UM" == $anam_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_mnth'] ?></OPTION>
       <OPTION value="bi_M3" <?php if ("bi_M3" == $anam_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_03mo'] ?></OPTION>
       <OPTION value="bi_current_week" <?php if ("bi_current_week" == $anam_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_search_summary_current_week'] ?></OPTION>
       <OPTION value="bi_last_week" <?php if ("bi_last_week" == $anam_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_search_summary_last_week'] ?></OPTION>
       <OPTION value="bi_current_week_today" <?php if ("bi_current_week_today" == $anam_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_search_summary_current_week_today'] ?></OPTION>
       <OPTION value="bi_HJ" <?php if ("bi_HJ" == $anam_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_tday'] ?></OPTION>
       <OPTION value="bi_OT" <?php if ("bi_OT" == $anam_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_yest'] ?></OPTION>
       <OPTION value="bi_U7" <?php if ("bi_U7" == $anam_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_lst7'] ?></OPTION>
       <OPTION value="bi_last_30_dias" <?php if ("bi_last_30_dias" == $anam_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_search_last_30_dias'] ?></OPTION>
       <optgroup label="<?php echo $this->Ini->Nm_lang['lang_srch_nrml'] ?>">
       <OPTION value="eq" <?php if ("eq" == $anam_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $anam_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd"><SPAN id="Nm_bi_dados_anam_date" style="display:none"></SPAN>
      <TABLE  id="opc_bi_TP_anam_date"  style=display:  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_anam_date" <?php echo $str_hide_anam_date?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['anam_date'])) ? $this->New_label['anam_date'] : "Fecha";
 $nmgp_tab_label .= "anam_date?#?" . $SC_Label . "?@?";
...
<?php
  ...
  {
?>
<span id='id_date_part_anam_date_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_anam_date_dia" name="anam_date_dia" value="<?php echo NM_encode_input($anam_date_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_anam_date_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_anam_date_mes" name="anam_date_mes" value="<?php echo NM_encode_input($anam_date_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_anam_date_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_anam_date_ano" name="anam_date_ano" value="<?php echo NM_encode_input($anam_date_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_anam_date_jq">
</span>
...
?>
        <SPAN id="id_css_anam_date"  class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_anam_date"  <?php echo $str_display_anam_date; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<span id='id_date_part_anam_date_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_anam_date_input_2_dia" name="anam_date_input_2_dia" value="<?php echo NM_encode_input($anam_date_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_anam_date_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_anam_date_input_2_mes" name="anam_date_input_2_mes" value="<?php echo NM_encode_input($anam_date_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_anam_date_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_anam_date_input_2_ano" name="anam_date_input_2_ano" value="<?php echo NM_encode_input($anam_date_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_anam_date_jq2">
</span>
...
?>
      ...
      <INPUT type="hidden" id="SC_user_id_cond" name="user_id_cond" value="eq">
...
?>
   <span id="idAjaxSelect_user_id">
      <SELECT class="scFilterObjectEven" id="SC_user_id" name="user_id[]"  size="1" multiple>
<?php
...
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $user_id_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if (!$_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.anam_date_cond.value = 'bi_current_year';
   nm_campos_between(document.getElementById('id_vis_anam_date'), document.F1.anam_date_cond, 'anam_date');
   document.F1.anam_date_dia.value = "";
   document.F1.anam_date_mes.value = "";
   document.F1.anam_date_ano.value = "";
   document.F1.anam_date_input_2_dia.value = "";
   document.F1.anam_date_input_2_mes.value = "";
   document.F1.anam_date_input_2_ano.value = "";
   document.F1.user_id_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_user_id'), document.F1.user_id_cond, 'user_id');
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'user_id[]')
      {
 ...
 {
    if (Field == 'all' || Field == 'user_id') {
       Sc_carga_select2_user_id();
    }
 }
 function Sc_carga_select2_user_id()
 {
  $("#SC_user_id").select2(
    {
 ...
 {
    $('#SC_anam_date_dia').bind('change', function() {sc_grid_vw_anamnesis_valida_dia(this)});
    $('#SC_anam_date_input_2_dia').bind('change', function() {sc_grid_vw_anamnesis_valida_dia(this)});
    $('#SC_anam_date_input_2_mes').bind('change', function() {sc_grid_vw_anamnesis_valida_mes(this)});
    $('#SC_anam_date_mes').bind('change', function() {sc_grid_vw_anamnesis_valida_mes(this)});
 }
 function sc_grid_vw_anamnesis_valida_dia(obj)
 {
 ...
 function sc_grid_vw_anamnesis_valida_mes(obj)
 {
...
function formata_bi_anam_date(opc, opc_bi, dt_fmt)
{
   if (opc.substring(0,3) != "bi_")
   {
       document.getElementById('Nm_bi_dados_anam_date').style.display = 'none';
       document.getElementById('opc_bi_TP_anam_date').style.display = '';
       return;
   }
   if (opc == "bi_TP")
   {
       document.getElementById('Nm_bi_dados_anam_date').style.display = 'none';
       document.getElementById('opc_bi_TP_anam_date').style.display = 'none';
       return;
   }
<?php
   $date_format_show = "";
   ...
   {
       $date_format_show .= (!$Prim) ? " + '" . $_SESSION['scriptcase']['reg_conf']['date_sep'] . "' + ": "";
       $date_format_show .= ($Cada_d == "d") ? "document.F1.anam_date_dia.value" : "";
       $date_format_show .= ($Cada_d == "m") ? "document.F1.anam_date_mes.value" : "";
       $date_format_show .= ($Cada_d == "Y") ? "document.F1.anam_date_ano.value" : "";
       $Prim = false;
   }
?> 
...
<?php
   ...
   {
       $date_format_show .= (!$Prim) ? " + '" . $_SESSION['scriptcase']['reg_conf']['date_sep'] . "' + ": "";
       $date_format_show .= ($Cada_d == "d") ? "document.F1.anam_date_input_2_dia.value" : "";
       $date_format_show .= ($Cada_d == "m") ? "document.F1.anam_date_input_2_mes.value" : "";
       $date_format_show .= ($Cada_d == "Y") ? "document.F1.anam_date_input_2_ano.value" : "";
       $Prim = false;
   }
?> 
       saida += <?php echo $date_format_show ?>;
   }
   document.getElementById('Nm_bi_dados_anam_date').innerHTML = saida;
   document.getElementById('opc_bi_TP_anam_date').style.display = 'none';
   document.getElementById('Nm_bi_dados_anam_date').style.display = '';
}
<?php
  echo $Script_BI;
?>
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_anam_date_cond'] = 'cond';
      $tp_fields['SC_anam_date_dia'] = 'text';
      $tp_fields['SC_anam_date_mes'] = 'text';
      $tp_fields['SC_anam_date_ano'] = 'text';
      $tp_fields['SC_anam_date_input_2_dia'] = 'text';
      $tp_fields['SC_anam_date_input_2_mes'] = 'text';
      $tp_fields['SC_anam_date_input_2_ano'] = 'text';
      $tp_fields['SC_user_id_cond'] = 'cond';
      $tp_fields['SC_user_id'] = 'selmult';
      ...
      if (is_file($NM_patch))
      {
          ...
          foreach ($NMcmp_filter as $Cada_cmp)
          {
              ...
              else
              {
                  ...
                  if ($Cada_cmp[0] == 'SC_anam_date_cond')
                  {
                      $opc = $Cada_cmp[1];
   ...
   {
      global $anam_date_cond, $anam_date, $anam_date_dia, $anam_date_mes, $anam_date_ano, $anam_date_input_2_dia, $anam_date_input_2_mes, $anam_date_input_2_ano,
             $user_id_cond, $user_id, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $anam_date_cond_salva = $anam_date_cond; 
      if (!isset($anam_date_input_2_dia) || $anam_date_input_2_dia == "")
      {
          $anam_date_input_2_dia = $anam_date_dia;
      }
      if (!isset($anam_date_input_2_mes) || $anam_date_input_2_mes == "")
      {
          $anam_date_input_2_mes = $anam_date_mes;
      }
      if (!isset($anam_date_input_2_ano) || $anam_date_input_2_ano == "")
      {
          $anam_date_input_2_ano = $anam_date_ano;
      }
      ...
      if (is_array($user_id)) {
          foreach ($user_id as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['psq_check_ret']['user_id'])) {
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca']['anam_date_dia'] = $anam_date_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca']['anam_date_mes'] = $anam_date_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca']['anam_date_ano'] = $anam_date_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca']['anam_date_input_2_dia'] = $anam_date_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca']['anam_date_input_2_mes'] = $anam_date_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca']['anam_date_input_2_ano'] = $anam_date_input_2_ano; 
      if (!empty($anam_date_dia) || !empty($anam_date_mes) || !empty($anam_date_ano) || $anam_date_cond_salva == "nu" || $anam_date_cond_salva == "nn" || $anam_date_cond_salva == "ep" || $anam_date_cond_salva == "ne")
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $anam_date_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $anam_date_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $anam_date_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $anam_date_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $anam_date_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $anam_date_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca']['anam_date_cond'] = $anam_date_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['Grid_search'][$I_Grid]['cmp'] = "anam_date"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['Grid_search'][$I_Grid]['opc'] = $anam_date_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq']['anam_date'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca']['user_id'] = $user_id; 
      if (is_array($user_id) && !empty($user_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['Grid_search'][$I_Grid]['val'][0] = $user_id;
      }
      elseif ($user_id_cond_salva == "nu" || $user_id_cond_salva == "nn" || $user_id_cond_salva == "ep" || $user_id_cond_salva == "ne" || !empty($user_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['Grid_search'][$I_Grid]['val'][0][0] = $user_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca']['user_id_cond'] = $user_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['Grid_search'][$I_Grid]['cmp'] = "user_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['Grid_search'][$I_Grid]['opc'] = $user_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq']['user_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $this->cmp_formatado['user_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca']['user_id'];
      $this->cmp_formatado['user_id_input_2'] = $user_id_input_2;

      //----- $anam_date
      $this->Date_part = false;
      if ($anam_date_cond != "bi_TP")
      {
          $anam_date_cond = strtoupper($anam_date_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $anam_date_ano;
          $Dtxt .= $anam_date_mes;
          $Dtxt .= $anam_date_dia;
          $val[0]['ano'] = $anam_date_ano;
          $val[0]['mes'] = $anam_date_mes;
          $val[0]['dia'] = $anam_date_dia;
          if ($anam_date_cond == "BW")
          {
              $val[1]['ano'] = $anam_date_input_2_ano;
              $val[1]['mes'] = $anam_date_input_2_mes;
              $val[1]['dia'] = $anam_date_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DT", "DATE", $anam_date_cond, "", "data");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $anam_date = $val[0];
          $this->cmp_formatado['anam_date'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca']['anam_date'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['anam_date'], "YYYY-MM-DD");
          $this->cmp_formatado['anam_date'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($anam_date_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $anam_date_input_2     = $val[1];
              $this->cmp_formatado['anam_date_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca']['anam_date_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['anam_date_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['anam_date_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $anam_date_cond == "NU" || $anam_date_cond == "NN"|| $anam_date_cond == "EP"|| $anam_date_cond == "NE")
          {
              $this->monta_condicao("anam_date", $anam_date_cond, $anam_date, $anam_date_input_2, 'anam_date', 'DATE');
          }
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq']['anam_date']['label'] = $nmgp_tab_label['anam_date'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq']['anam_date']['descr'] = $nmgp_tab_label['anam_date'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq']['anam_date']['hint']  = $nmgp_tab_label['anam_date'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }

      //----- $user_id
      $this->Date_part = false;
      $nm_aspas = "";
      if ($user_id_cond == "nu" || $user_id_cond == "nn" || $user_id_cond == "ep" || $user_id_cond == "ne")
      {
          $user_id = array();
      }
      if (is_array($user_id) && count($user_id) != 0)
      {
         foreach ($user_id as $i => $dados)
         {
      ...
      if (is_array($user_id) && count($user_id) != 0)
      {
         ...
         $lim_descr   = 15;
         $lang_descr  = strlen($this->Ini->Nm_lang['lang_srch_orr_cond']);
         if ($user_id_cond == "df" || $user_id_cond == "np")
         {
             $this->comando        .= " user_id not in (";
             $this->comando_sum    .= " vw_anamnesis.user_id not in (";
             $this->comando_filtro .= " user_id not in (";
         }
         else
         {
             $this->comando        .= " user_id in (";
             $this->comando_sum    .= " vw_anamnesis.user_id in (";
             $this->comando_filtro .= " user_id in (";
         }
         $x                     = count($user_id);
         $xx                    = 0;
         $nm_cond               = "";
         foreach ($user_id as $i => $dados)
         {
            ...
            elseif (!$end_descr)
            {
                 $cond_descr .= " +" . (count($user_id) - $count_descr);
                 $end_descr = true;
            };
            if ($xx != ($x - 1))
            {
         ...
         $Lang_descr_final = isset($Lang_descr[$user_id_cond]) ? $Lang_descr[$user_id_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['cond_pesq'] .= $nmgp_tab_label['user_id'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq']['user_id']['label'] = $nmgp_tab_label['user_id'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq']['user_id']['descr'] = $nmgp_tab_label['user_id'] . ": " . $Lang_descr_final . " " . $cond_descr;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq']['user_id']['hint'] = $nmgp_tab_label['user_id'] . ": " . $Lang_descr_final . " " . $nm_cond;
      }
      elseif (isset($user_id) && ($user_id_cond == "nu" || $user_id_cond == "nn" || $user_id_cond == "ep" || $user_id_cond == "ne"))
      {
         $this->monta_condicao("user_id", $user_id_cond, "", "", "user_id", "INT", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['where_pesq_fast'])) 
       {
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['where_pesq_fast'] . ")";
           }
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['where_pesq_interativ'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['where_pesq_interativ'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['where_pesq'] = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['where_pesq_interativ'];
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "user_id" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
