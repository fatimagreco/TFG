...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_anam_date_cond" name="anam_date_cond" onChange="nm_campos_between(document.getElementById('id_vis_anam_date'), this, 'anam_date')">
      ...
      <br><span id="id_hide_anam_date"  <?php echo $str_hide_anam_date?>>
<SPAN id="Nm_bi_dados_anam_date" style="display:none"></SPAN>
<SPAN id="opc_bi_TP_anam_date"  style="display:''">
...
?>
 ...
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_anam_date"  <?php echo $str_display_anam_date; ?> class="scFilterFieldFontOdd">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_user_id"  <?php echo $str_hide_user_id?>>
<?php
