...
class grid_vw_anamnesis_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_anam_career;
   var $array_total_anam_carsem;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_anam_career = array();
      $this->array_total_anam_carsem = array();
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_vw_anamnesis']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_vw_anamnesis']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['orig_pesq'] = "resumo";
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['contr_total_geral'] == "OK")
      {
          $this->array_total_anam_career = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['arr_total']['anam_career'];
          $this->array_total_anam_carsem = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['arr_total']['anam_carsem'];
      }
      else
      {
          $this->array_total_anam_career = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['tot_geral'][1];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['arr_total']['anam_career'] = $this->array_total_anam_career;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['arr_total']['anam_carsem'] = $this->array_total_anam_carsem;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['json_use_label'])
       {
          $Lab_anam_career = "anam_career";
          $Lab_anam_carsem = "anam_carsem";
       }
       else
       {
       $Lab_anam_career = "Carrera";
       $Lab_anam_carsem = "Semestre";
       }
       $this->comp_field = array(
           $Lab_anam_career,
           $Lab_anam_carsem,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_date']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_date'] = "Fecha"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_strtime']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_strtime'] = "Hora "; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['pati_name']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['pati_name'] = "Nombre"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['pati_lname']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['pati_lname'] = "Apellido"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['pati_bod']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['pati_bod'] = "Edad"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_bpsys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_bpsys'] = "PA SIS"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_bpdia']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_bpdia'] = "PA DIA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_career']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_career'] = "Carrera"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_caryear']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_caryear'] = "Año"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_reason']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_reason'] = "Motivo de Consulta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['treat_instruc']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['treat_instruc'] = "Tratamiento Administrado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_id'] = "Atención"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['pati_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['pati_id'] = "Pacientes"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['user_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['user_id'] = "Usuario"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_endtime']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_endtime'] = "Hora Fin"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_carsem']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_carsem'] = "Semestre"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_aller']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_aller'] = "Alergias"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_temp']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_temp'] = "T"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_hbeat']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_hbeat'] = "FC"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_oxy']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_oxy'] = "SO2"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_gluco']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_gluco'] = "HGT"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_diag']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['anam_diag'] = "Tratamiento Administrado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['pati_docnum']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['pati_docnum'] = "N° Cedula"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['pati_phone']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['pati_phone'] = "Celular"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['pati_career']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['pati_career'] = "Carrera"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['pati_caryerar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['pati_caryerar'] = "Curso"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['pati_carsem']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['pati_carsem'] = "Semestre"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['pati_famphone']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['pati_famphone'] = "Contacto Familiar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['pati_famname']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['pati_famname'] = "Familiar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['user_name']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['user_name'] = "Usuario Nombre"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['user_lname']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['user_lname'] = "Usuario Apellido"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['user_docnum']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['user_docnum'] = "Usuario N° CI"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['btyp_name']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['btyp_name'] = "Grupo Sanguíneo "; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['gerens_name']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['gerens_name'] = "Género"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['treat_restdays']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['treat_restdays'] = "Reposo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['treat_rest']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['labels']['treat_rest'] = "Reposo"; 
       }
       //-----
       $this->comp_field_nm = array(
           'anam_career' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_order']['anam_caryear_anam_carsem']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_order']['anam_caryear_anam_carsem'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_order']['anam_caryear_anam_carsem'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_display']['anam_caryear_anam_carsem'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_display']['anam_caryear_anam_carsem'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_display']['anam_caryear_anam_carsem'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_display']['anam_caryear_anam_carsem'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_display']['anam_caryear_anam_carsem'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_display']['anam_caryear_anam_carsem'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_display']['anam_caryear_anam_carsem'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_anam_career as $i_anam_career => $d_anam_career) {
           if (!isset($i_anam_career, $this->comp_label[0]) || !in_array($i_anam_career, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_anam_career[3] ] = $d_anam_career[2];
               $this->comp_label[0][ $d_anam_career[3] ] = $d_anam_career[2];
           }
           foreach ($this->array_total_anam_carsem[$i_anam_career] as $i_anam_carsem => $d_anam_carsem) {
               if (!isset($i_anam_carsem, $this->comp_label[1][ $d_anam_career[3] ]) || !in_array($i_anam_carsem, $this->comp_label[1][ $d_anam_career[3] ], true)) {
                   $this->comp_index[1][ $d_anam_carsem[3] ] = $d_anam_carsem[2];
                   $this->comp_label[1][ $d_anam_career[3] ][ $d_anam_carsem[3] ] = $d_anam_carsem[2];
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'anam_career', 'prot' => '@aspass@'),
           array('name' => 'anam_carsem', 'prot' => ''),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_tabular_label'];
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_anam_career => $l_anam_career) {
           if (isset($this->array_total_anam_career[$i_anam_career])) {
               $this->comp_group[$i_anam_career] = array();
           }
           foreach ($this->comp_label[1][$i_anam_career] as $i_anam_carsem => $l_anam_carsem) {
               if (isset($this->array_total_anam_carsem[$i_anam_career][$i_anam_carsem])) {
                   $this->comp_group[$i_anam_career][$i_anam_carsem] = array();
               }
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_anam_career;
       }
       elseif (1 == $level) {
           $return = $this->array_total_anam_carsem;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_vw_anamnesis@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_anam_career)),
           ...
           '1|1' => array(
               ...
               'field_x'  => 'anam_carsem',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_anam_carsem)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           'T|1' => array(
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_vw_anamnesis_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_vw_anamnesis_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_vw_anamnesis_total.class.php"); 
      }
      ...
      $this->Total   = new grid_vw_anamnesis_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_anam_caryear_anam_carsem("res", $this->NM_export);
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['arr_total'][$cmp_gb];
      }
      if (is_array($this->array_total_anam_career)) {
          ksort($this->array_total_anam_career);
      }
      if (is_array($this->array_total_anam_carsem)) {
          ksort($this->array_total_anam_carsem);
      }
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['SC_Ind_Groupby'];
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['ajax_nav']) {  
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_vw_anamnesis_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_vw_anamnesis_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_vw_anamnesis_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_vw_anamnesis/grid_vw_anamnesis_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_vw_anamnesis/grid_vw_anamnesis_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_vw_anamnesis/grid_vw_anamnesis_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_vw_anamnesis&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_vw_anamnesis/grid_vw_anamnesis_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['json'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bjson", "", "", "Rjson_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_vw_anamnesis/grid_vw_anamnesis_config_json.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_json_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_json_format=N&nm_json_label=S&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_vw_anamnesis/grid_vw_anamnesis_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_conf'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_vw_anamnesis/grid_vw_anamnesis_config_graf_flash.php?nome_apl=grid_vw_anamnesis&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
      ...
      if ($this->nmgp_botoes['reload'] == 'on' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['opc_psq'] && !$this->grid_emb_form)
      {
         ...
         if (is_file("grid_vw_anamnesis_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rword_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['word'][] = "Rword_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_vw_anamnesis/grid_vw_anamnesis_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rxml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['xml'][] = "Rxml_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_vw_anamnesis/grid_vw_anamnesis_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['json'] == "on" && !$this->NM_res_sem_reg)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rcsv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['csv'][] = "Rcsv_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_vw_anamnesis/grid_vw_anamnesis_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['rtf'] == "on" && !$this->NM_res_sem_reg)
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_vw_anamnesis']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_vw_anamnesis']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_vw_anamnesis_config_pivot.php?nome_apl=grid_vw_anamnesis&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_vw_anamnesis_iframe.php\";\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_vw_anamnesis_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_vw_anamnesis/grid_vw_anamnesis_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
           $tp_quebra .= "<div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">Resumen</H1></div>";
       }
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $anam_date = (isset($Busca_temp['anam_date'])) ? $Busca_temp['anam_date'] : ""; 
          $tmp_pos = (is_string($anam_date)) ? strpos($anam_date, "##@@") : false;
          if ($tmp_pos !== false && !is_array($anam_date))
          {
              $anam_date = substr($anam_date, 0, $tmp_pos);
          }
          $anam_date_2 = (isset($Busca_temp['anam_date_input_2'])) ? $Busca_temp['anam_date_input_2'] : ""; 
          $user_id = (isset($Busca_temp['user_id'])) ? $Busca_temp['user_id'] : ""; 
          $tmp_pos = (is_string($user_id)) ? strpos($user_id, "##@@") : false;
          if ($tmp_pos !== false && !is_array($user_id))
          {
   ...
   //---- 
   function adiciona_registro($quebra_anam_career, $quebra_anam_carsem, $quebra_anam_career_orig, $quebra_anam_carsem_orig)
   {
      //----- Carrera
      if (!isset($this->array_total_anam_career[$quebra_anam_career_orig]))
      {
         $this->array_total_anam_career[$quebra_anam_career_orig][0] = 1;
         $this->array_total_anam_career[$quebra_anam_career_orig][1] = 1;
         $this->array_total_anam_career[$quebra_anam_career_orig][2] = $quebra_anam_career;
         $this->array_total_anam_career[$quebra_anam_career_orig][3] = $quebra_anam_career_orig;
      }
      else
      {
         $this->array_total_anam_career[$quebra_anam_career_orig][0]++;
         $this->array_total_anam_career[$quebra_anam_career_orig][2]++;
      }
      //----- Semestre
      if (!isset($this->array_total_anam_carsem[$quebra_anam_career_orig][$quebra_anam_carsem_orig]))
      {
         $this->array_total_anam_carsem[$quebra_anam_career_orig][$quebra_anam_carsem_orig][0] = 1;
         $this->array_total_anam_carsem[$quebra_anam_career_orig][$quebra_anam_carsem_orig][1] = 1;
         $this->array_total_anam_carsem[$quebra_anam_career_orig][$quebra_anam_carsem_orig][2] = $quebra_anam_carsem;
         $this->array_total_anam_carsem[$quebra_anam_career_orig][$quebra_anam_carsem_orig][3] = $quebra_anam_carsem_orig;
      }
      else
      {
         $this->array_total_anam_carsem[$quebra_anam_career_orig][$quebra_anam_carsem_orig][0]++;
         $this->array_total_anam_carsem[$quebra_anam_career_orig][$quebra_anam_carsem_orig][2]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->anam_date = $Busca_temp['anam_date']; 
       $this->anam_date = (isset($Busca_temp['anam_date'])) ? $Busca_temp['anam_date'] : ""; 
       $tmp_pos = (is_string($this->anam_date)) ? strpos($this->anam_date, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->anam_date))
       {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('anam_caryear_anam_carsem', 'anam_career');
     $campos_order = $this->Ini->Get_date_order_groupby("anam_career", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('anam_caryear_anam_carsem', 'anam_carsem');
     $campos_order = $this->Ini->Get_date_order_groupby("anam_carsem", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->anam_date = $rs_res->fields[0] ;  
            $this->anam_strtime = $rs_res->fields[1] ;  
            $this->pati_name = $rs_res->fields[2] ;  
            $this->pati_lname = $rs_res->fields[3] ;  
            $this->pati_bod = $rs_res->fields[4] ;  
            $this->anam_bpsys = $rs_res->fields[5] ;  
            $this->anam_bpdia = $rs_res->fields[6] ;  
            $this->anam_career = $rs_res->fields[7] ;  
            $this->anam_caryear = $rs_res->fields[8] ;  
            $this->anam_reason = $rs_res->fields[9] ;  
            $this->treat_instruc = $rs_res->fields[10] ;  
            $this->anam_id = $rs_res->fields[11] ;  
            $this->pati_id = $rs_res->fields[12] ;  
            $this->user_id = $rs_res->fields[13] ;  
            $this->anam_endtime = $rs_res->fields[14] ;  
            $this->anam_carsem = $rs_res->fields[15] ;  
            $this->look_user_id = $this->user_id; 
            $this->Lookup->lookup_user_id($this->look_user_id, $this->user_id) ; 
            $this->anam_career_orig = $this->anam_career;
            $this->anam_carsem_orig = $this->anam_carsem;
            $this->user_id = $this->look_user_id ;
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->anam_career, $this->anam_carsem, $this->anam_career_orig,  $this->anam_carsem_orig);
            }
   }
//
