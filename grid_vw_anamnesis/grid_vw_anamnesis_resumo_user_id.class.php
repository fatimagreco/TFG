...
class grid_vw_anamnesis_resumo
{
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_user_id = array();
...
SCEOT;
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_user_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['arr_total']['user_id'];
      }
      else
      {
          $this->array_total_user_id = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['arr_total']['user_id'] = $this->array_total_user_id;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_order']['user_id']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_order']['user_id'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_order']['user_id'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_display']['user_id'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_display']['user_id'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_display']['user_id'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_display']['user_id'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_display']['user_id'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_display']['user_id'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['summarizing_fields_display']['user_id'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_user_id as $i_user_id => $d_user_id) {
           if (!isset($i_user_id, $this->comp_label[0]) || !in_array($i_user_id, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_user_id[3] ] = $d_user_id[2];
               $this->comp_label[0][ $d_user_id[3] ] = $d_user_id[2];
           }
       }
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_user_id => $l_user_id) {
           if (isset($this->array_total_user_id[$i_user_id])) {
               $this->comp_group[$i_user_id] = array();
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_user_id;
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_user_id)),
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_user_id("res", $this->NM_export);
      ...
      if (is_array($this->array_total_user_id)) {
          ksort($this->array_total_user_id);
      }
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['SC_Ind_Groupby'];
...
//--- 
   ...
   //---- 
   function adiciona_registro($quebra_user_id, $quebra_user_id_orig)
   {
      //----- Usuario
      if (!isset($this->array_total_user_id[$quebra_user_id_orig]))
      {
         $this->array_total_user_id[$quebra_user_id_orig][0] = 1;
         $this->array_total_user_id[$quebra_user_id_orig][1] = 1;
         $this->array_total_user_id[$quebra_user_id_orig][2] = $quebra_user_id;
         $this->array_total_user_id[$quebra_user_id_orig][3] = $quebra_user_id_orig;
      }
      else
      {
         $this->array_total_user_id[$quebra_user_id_orig][0]++;
         $this->array_total_user_id[$quebra_user_id_orig][2]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('user_id', 'user_id');
     $campos_order = $this->Ini->Get_date_order_groupby("user_id", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->user_id_orig = $this->user_id;
            $this->user_id = $this->look_user_id ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->user_id, $this->user_id_orig);
            }
   }
//
