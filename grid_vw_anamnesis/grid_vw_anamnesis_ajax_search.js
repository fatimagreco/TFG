...
function ajax_select_filter(parm)
{
    ...
    $.ajax({
     ...
     .done(function(json_sel_fil) {
        ...
        if ($("#SC_anam_date_cond") && search_get_sel_txt("SC_anam_date_cond").substring(0, 3) == "bi_") {
            formata_bi_anam_date(search_get_sel_txt("SC_anam_date_cond"), SC_anam_date_bi_opc, SC_anam_date_bi_dt);
        }
