...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['contr_label_graf']['anam_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['contr_label_graf']['anam_date']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_anamnesis']['contr_label_graf']['anam_date'];
      }
   }
