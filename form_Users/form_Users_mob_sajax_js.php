  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_Users_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate user_name
  function do_ajax_form_Users_mob_validate_user_name()
  {
    var nomeCampo_user_name = "user_name";
    var var_user_name = scAjaxGetFieldText(nomeCampo_user_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Users_mob_validate_user_name(var_user_name, var_script_case_init, do_ajax_form_Users_mob_validate_user_name_cb);
  } // do_ajax_form_Users_mob_validate_user_name

  function do_ajax_form_Users_mob_validate_user_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user_name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Users_mob_validate_user_name_cb

  // ---------- Validate user_lname
  function do_ajax_form_Users_mob_validate_user_lname()
  {
    var nomeCampo_user_lname = "user_lname";
    var var_user_lname = scAjaxGetFieldText(nomeCampo_user_lname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Users_mob_validate_user_lname(var_user_lname, var_script_case_init, do_ajax_form_Users_mob_validate_user_lname_cb);
  } // do_ajax_form_Users_mob_validate_user_lname

  function do_ajax_form_Users_mob_validate_user_lname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user_lname";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Users_mob_validate_user_lname_cb

  // ---------- Validate user_docnum
  function do_ajax_form_Users_mob_validate_user_docnum()
  {
    var nomeCampo_user_docnum = "user_docnum";
    var var_user_docnum = scAjaxGetFieldText(nomeCampo_user_docnum);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Users_mob_validate_user_docnum(var_user_docnum, var_script_case_init, do_ajax_form_Users_mob_validate_user_docnum_cb);
  } // do_ajax_form_Users_mob_validate_user_docnum

  function do_ajax_form_Users_mob_validate_user_docnum_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user_docnum";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Users_mob_validate_user_docnum_cb

  // ---------- Validate user_bod
  function do_ajax_form_Users_mob_validate_user_bod()
  {
    var nomeCampo_user_bod = "user_bod";
    var var_user_bod = scAjaxGetFieldText(nomeCampo_user_bod);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Users_mob_validate_user_bod(var_user_bod, var_script_case_init, do_ajax_form_Users_mob_validate_user_bod_cb);
  } // do_ajax_form_Users_mob_validate_user_bod

  function do_ajax_form_Users_mob_validate_user_bod_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user_bod";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Users_mob_validate_user_bod_cb

  // ---------- Validate user_phone
  function do_ajax_form_Users_mob_validate_user_phone()
  {
    var nomeCampo_user_phone = "user_phone";
    var var_user_phone = scAjaxGetFieldText(nomeCampo_user_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Users_mob_validate_user_phone(var_user_phone, var_script_case_init, do_ajax_form_Users_mob_validate_user_phone_cb);
  } // do_ajax_form_Users_mob_validate_user_phone

  function do_ajax_form_Users_mob_validate_user_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user_phone";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Users_mob_validate_user_phone_cb

  // ---------- Validate user_addreess
  function do_ajax_form_Users_mob_validate_user_addreess()
  {
    var nomeCampo_user_addreess = "user_addreess";
    var var_user_addreess = scAjaxGetFieldText(nomeCampo_user_addreess);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Users_mob_validate_user_addreess(var_user_addreess, var_script_case_init, do_ajax_form_Users_mob_validate_user_addreess_cb);
  } // do_ajax_form_Users_mob_validate_user_addreess

  function do_ajax_form_Users_mob_validate_user_addreess_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user_addreess";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Users_mob_validate_user_addreess_cb

  // ---------- Validate user_email
  function do_ajax_form_Users_mob_validate_user_email()
  {
    var nomeCampo_user_email = "user_email";
    var var_user_email = scAjaxGetFieldText(nomeCampo_user_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Users_mob_validate_user_email(var_user_email, var_script_case_init, do_ajax_form_Users_mob_validate_user_email_cb);
  } // do_ajax_form_Users_mob_validate_user_email

  function do_ajax_form_Users_mob_validate_user_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user_email";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Users_mob_validate_user_email_cb

  // ---------- Validate btyp_id
  function do_ajax_form_Users_mob_validate_btyp_id()
  {
    var nomeCampo_btyp_id = "btyp_id";
    var var_btyp_id = scAjaxGetFieldRadio(nomeCampo_btyp_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Users_mob_validate_btyp_id(var_btyp_id, var_script_case_init, do_ajax_form_Users_mob_validate_btyp_id_cb);
  } // do_ajax_form_Users_mob_validate_btyp_id

  function do_ajax_form_Users_mob_validate_btyp_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "btyp_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Users_mob_validate_btyp_id_cb

  // ---------- Validate pos_id
  function do_ajax_form_Users_mob_validate_pos_id()
  {
    var nomeCampo_pos_id = "pos_id";
    var var_pos_id = scAjaxGetFieldRadio(nomeCampo_pos_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Users_mob_validate_pos_id(var_pos_id, var_script_case_init, do_ajax_form_Users_mob_validate_pos_id_cb);
  } // do_ajax_form_Users_mob_validate_pos_id

  function do_ajax_form_Users_mob_validate_pos_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pos_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Users_mob_validate_pos_id_cb

  // ---------- Validate gerens_id
  function do_ajax_form_Users_mob_validate_gerens_id()
  {
    var nomeCampo_gerens_id = "gerens_id";
    var var_gerens_id = scAjaxGetFieldRadio(nomeCampo_gerens_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Users_mob_validate_gerens_id(var_gerens_id, var_script_case_init, do_ajax_form_Users_mob_validate_gerens_id_cb);
  } // do_ajax_form_Users_mob_validate_gerens_id

  function do_ajax_form_Users_mob_validate_gerens_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "gerens_id";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Users_mob_validate_gerens_id_cb

  // ---------- Validate f_useres
  function do_ajax_form_Users_mob_validate_f_useres()
  {
    var nomeCampo_f_useres = "f_useres";
    var var_f_useres = scAjaxGetFieldText(nomeCampo_f_useres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Users_mob_validate_f_useres(var_f_useres, var_script_case_init, do_ajax_form_Users_mob_validate_f_useres_cb);
  } // do_ajax_form_Users_mob_validate_f_useres

  function do_ajax_form_Users_mob_validate_f_useres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "f_useres";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Users_mob_validate_f_useres_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_Users_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_Users_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_user_name = scAjaxGetFieldText("user_name");
    var var_user_lname = scAjaxGetFieldText("user_lname");
    var var_user_docnum = scAjaxGetFieldText("user_docnum");
    var var_user_bod = scAjaxGetFieldText("user_bod");
    var var_user_phone = scAjaxGetFieldText("user_phone");
    var var_user_addreess = scAjaxGetFieldText("user_addreess");
    var var_user_email = scAjaxGetFieldText("user_email");
    var var_btyp_id = scAjaxGetFieldRadio("btyp_id");
    var var_pos_id = scAjaxGetFieldRadio("pos_id");
    var var_gerens_id = scAjaxGetFieldRadio("gerens_id");
    ...
    scAjaxProcOn();
    x_ajax_form_Users_mob_submit_form(var_user_name, var_user_lname, var_user_docnum, var_user_bod, var_user_phone, var_user_addreess, var_user_email, var_btyp_id, var_pos_id, var_gerens_id, var_user_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_Users_mob_submit_form_cb);
  } // do_ajax_form_Users_mob_submit_form

  function do_ajax_form_Users_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("user_name");
      scAjaxHideErrorDisplay("user_lname");
      scAjaxHideErrorDisplay("user_docnum");
      scAjaxHideErrorDisplay("user_bod");
      scAjaxHideErrorDisplay("user_phone");
      scAjaxHideErrorDisplay("user_addreess");
      scAjaxHideErrorDisplay("user_email");
      scAjaxHideErrorDisplay("btyp_id");
      scAjaxHideErrorDisplay("pos_id");
      scAjaxHideErrorDisplay("gerens_id");
      scAjaxHideErrorDisplay("f_useres");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_Users_mob_submit_form_cb_after_alert);
  } // do_ajax_form_Users_mob_submit_form_cb
  function do_ajax_form_Users_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_Users_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["sec_form_edit_users_mob"] = "off";

  function do_ajax_form_Users_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_Users_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_Users_mob_navigate_form();
    }
  }

  function perform_ajax_form_Users_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["sec_form_edit_users_mob"] = "on";
    x_ajax_form_Users_mob_navigate_form(var_user_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_Users_mob_navigate_form_cb);
  } // do_ajax_form_Users_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_Users_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_Users_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_sec_form_edit_users_mob"] && "nmsc_iframe_liga_sec_form_edit_users_mob" != scMasterDetailIframe["nmsc_iframe_liga_sec_form_edit_users_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_sec_form_edit_users_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_sec_form_edit_users_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_sec_form_edit_users_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_sec_form_edit_users_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_Users_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_Users_mob_navigate_form_cb
  function do_ajax_form_Users_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_Users_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_Users_mob_navigate_form_cb_after_alert

  function sc_hide_form_Users_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["sec_form_edit_users_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "user_name";
  ajax_field_list[1] = "user_lname";
  ajax_field_list[2] = "user_docnum";
  ajax_field_list[3] = "user_bod";
  ajax_field_list[4] = "user_phone";
  ajax_field_list[5] = "user_addreess";
  ajax_field_list[6] = "user_email";
  ajax_field_list[7] = "btyp_id";
  ajax_field_list[8] = "pos_id";
  ajax_field_list[9] = "gerens_id";
  ajax_field_list[10] = "f_useres";
  ...
  var ajax_error_list = {
    "user_name": {"label": "Nombre", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "user_lname": {"label": "Apellido", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "user_docnum": {"label": "Nro. Documento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "user_bod": {"label": "Fecha de Nacimiento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "user_phone": {"label": "Telefono", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "user_addreess": {"label": "Dirección", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "user_email": {"label": "Correo Electronico", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "btyp_id": {"label": "Tipo de Sangre", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pos_id": {"label": "Cargo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "gerens_id": {"label": "Genero", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "f_useres": {"label": "Sistemas", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "user_name": new Array(),
    "user_lname": new Array(),
    "user_docnum": new Array(),
    "user_bod": new Array(),
    "user_phone": new Array(),
    "user_addreess": new Array(),
  ...
  ajax_field_mult["user_name"][1] = "user_name";
  ajax_field_mult["user_lname"][1] = "user_lname";
  ajax_field_mult["user_docnum"][1] = "user_docnum";
  ajax_field_mult["user_bod"][1] = "user_bod";
  ajax_field_mult["user_phone"][1] = "user_phone";
  ajax_field_mult["user_addreess"][1] = "user_addreess";
  ajax_field_mult["user_email"][1] = "user_email";
  ajax_field_mult["btyp_id"][1] = "btyp_id";
  ajax_field_mult["pos_id"][1] = "pos_id";
  ajax_field_mult["gerens_id"][1] = "gerens_id";
  ajax_field_mult["f_useres"][1] = "f_useres";

  var ajax_field_id = {
    "user_name": new Array("hidden_field_label_user_name", "hidden_field_data_user_name"),
    "user_lname": new Array("hidden_field_label_user_lname", "hidden_field_data_user_lname"),
    "user_docnum": new Array("hidden_field_label_user_docnum", "hidden_field_data_user_docnum"),
    "user_bod": new Array("hidden_field_label_user_bod", "hidden_field_data_user_bod"),
    "user_phone": new Array("hidden_field_label_user_phone", "hidden_field_data_user_phone"),
    "user_addreess": new Array("hidden_field_label_user_addreess", "hidden_field_data_user_addreess"),
    "user_email": new Array("hidden_field_label_user_email", "hidden_field_data_user_email"),
    "btyp_id": new Array("hidden_field_label_btyp_id", "hidden_field_data_btyp_id"),
    "pos_id": new Array("hidden_field_label_pos_id", "hidden_field_data_pos_id"),
    "gerens_id": new Array("hidden_field_label_gerens_id", "hidden_field_data_gerens_id"),
    "f_useres": new Array("hidden_field_label_f_useres", "hidden_field_data_f_useres")
  };
