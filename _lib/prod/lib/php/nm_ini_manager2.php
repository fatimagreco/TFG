...
function nm_prod_display_login($v_str_pass, $v_tp_win = "login")
{
    ...
    <table cellpadding=0 cellspacing=0 border=0 id="loginContainer" align='center'>
        <tr>
            <td style='height: 89%'>
                <!-- logo -->
                <div id="loginPartsLogo"><img src="<?php echo $scBaseUrl; ?>img/scriptcase.png" width="300" alt="Scriptcase"
             ...
             <tr class="nmTableTd">
              ...
              &nbsp;&nbsp;<a href="javascript: nm_set_option('profile_test', '', 'nm_iframe')" title="<?php echo $nm_lang['hint_profile_test']; ?>" class="nmText"><?php echo $nm_lang['main_profile_test']; ?></a>
                ...
                <table class="nmTable" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr class="nmTableTd">
                        <td class="nmLineV3">
                            &nbsp;&nbsp;<a href="javascript: nm_set_option('diagnosis', '', 'nm_iframe')"
                                           title="<?php echo $nm_lang['hint_diagnosis']; ?>"
                                           class="nmText"><?php echo $nm_lang['main_diagnosis']; ?></a>
                        </td>
                    </tr>
                    <tr class="nmTableTd">
                        <td class="nmLineV3">
