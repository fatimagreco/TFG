...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["EnfermeriaUNAE_____grid_vwmedicamentos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["EnfermeriaUNAE_____grid_vwmedicamentos"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_vwmedicamentos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_vwmedicamentos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_vwmedicamentos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_vwmedicamentos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_vwmedicamentos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_vwmedicamentos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_vwmedicamentos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_vwmedicamentos']['embutida_filho'] as $ind => $sc_init)
          {
