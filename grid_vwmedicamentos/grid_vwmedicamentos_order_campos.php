<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_vwmedicamentos']['glo_nm_path_imag_temp'] . "/sc_apl_default_EnfermeriaUNAE.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_vwmedicamentos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_vwmedicamentos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['med_types_mtype_name'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['med_types_mtype_name'] = "med_types_mtype_name";
   }
   else
   {
       $tab_def_campos['med_types_mtype_name'] = "med_types.mtype_name";
   }
   $tab_labels["med_types_mtype_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['labels']["med_types_mtype_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['labels']["med_types_mtype_name"] : "Tipo";
   $tab_ger_campos['medicines_meds_desc'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['medicines_meds_desc'] = "medicines_meds_desc";
   }
   else
   {
       $tab_def_campos['medicines_meds_desc'] = "medicines.meds_desc";
   }
   $tab_labels["medicines_meds_desc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['labels']["medicines_meds_desc"])) ? $_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['labels']["medicines_meds_desc"] : "Medicamento";
   $tab_ger_campos['med_presentation_mpres_desc'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['med_presentation_mpres_desc'] = "med_presentation_mpres_desc";
   }
   else
   {
       $tab_def_campos['med_presentation_mpres_desc'] = "med_presentation.mpres_desc";
   }
   $tab_labels["med_presentation_mpres_desc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['labels']["med_presentation_mpres_desc"])) ? $_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['labels']["med_presentation_mpres_desc"] : "Presentación";
   $tab_ger_campos['med_stocks_mstk_exist'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['med_stocks_mstk_exist'] = "med_stocks_mstk_exist";
   }
   else
   {
       $tab_def_campos['med_stocks_mstk_exist'] = "med_stocks.mstk_exist";
   }
   $tab_labels["med_stocks_mstk_exist"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['labels']["med_stocks_mstk_exist"])) ? $_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['labels']["med_stocks_mstk_exist"] : "Existencia";
   $tab_ger_campos['med_stocks_mstk_stkmin'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['med_stocks_mstk_stkmin'] = "med_stocks_mstk_stkmin";
   }
   else
   {
       $tab_def_campos['med_stocks_mstk_stkmin'] = "med_stocks.mstk_stkmin";
   }
   $tab_labels["med_stocks_mstk_stkmin"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['labels']["med_stocks_mstk_stkmin"])) ? $_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['labels']["med_stocks_mstk_stkmin"] : "Exist. Minima";
   $tab_ger_campos['med_stocks_mstk_stkmax'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['med_stocks_mstk_stkmax'] = "med_stocks_mstk_stkmax";
   }
   else
   {
       $tab_def_campos['med_stocks_mstk_stkmax'] = "med_stocks.mstk_stkmax";
   }
   $tab_labels["med_stocks_mstk_stkmax"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['labels']["med_stocks_mstk_stkmax"])) ? $_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['labels']["med_stocks_mstk_stkmax"] : "Exist. Máxima";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_vwmedicamentos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_vwmedicamentos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
