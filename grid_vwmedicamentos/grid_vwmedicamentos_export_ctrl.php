<?php
@session_start() ;
$_SESSION['scriptcase']['grid_vwmedicamentos']['sc_process_barr'] = true;
require_once('../grid_vwmedicamentos/index.php');
unset($_SESSION['scriptcase']['grid_vwmedicamentos']['sc_process_barr']);
$ExportCtrl = new grid_vwmedicamentos_export_control;
$ExportCtrl->Export_barr();

class grid_vwmedicamentos_export_control
{
