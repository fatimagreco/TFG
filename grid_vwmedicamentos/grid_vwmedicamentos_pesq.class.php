...
class grid_vwmedicamentos_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_vwmedicamentos_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_vwmedicamentos_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_vwmedicamentos_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "med_stocks.mstk_exp";$Nm_datas[] = "med_stocks_mstk_exp";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_vwmedicamentos/grid_vwmedicamentos_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_vwmedicamentos_ajax_search.js"></script>
 <script type="text/javascript" src="grid_vwmedicamentos_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_vwmedicamentos_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_vwmedicamentos']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_vwmedicamentos']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_med_stocks_mstk_id_cond#NMF#' + search_get_sel_txt('SC_med_stocks_mstk_id_cond') + '@NMF@';
  str_out += 'SC_med_stocks_mstk_id#NMF#' + search_get_text('SC_med_stocks_mstk_id') + '@NMF@';
  str_out += 'SC_med_stocks_mpres_id_cond#NMF#' + search_get_sel_txt('SC_med_stocks_mpres_id_cond') + '@NMF@';
  str_out += 'SC_med_stocks_mpres_id#NMF#' + search_get_text('SC_med_stocks_mpres_id') + '@NMF@';
  str_out += 'SC_med_stocks_mstk_exist_cond#NMF#' + search_get_sel_txt('SC_med_stocks_mstk_exist_cond') + '@NMF@';
  str_out += 'SC_med_stocks_mstk_exist#NMF#' + search_get_text('SC_med_stocks_mstk_exist') + '@NMF@';
  str_out += 'SC_med_stocks_mstk_stkmin_cond#NMF#' + search_get_sel_txt('SC_med_stocks_mstk_stkmin_cond') + '@NMF@';
  str_out += 'SC_med_stocks_mstk_stkmin#NMF#' + search_get_text('SC_med_stocks_mstk_stkmin') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $med_stocks_mstk_id_cond, $med_stocks_mstk_id,
             $med_stocks_mpres_id_cond, $med_stocks_mpres_id,
             $med_stocks_mstk_exist_cond, $med_stocks_mstk_exist,
             $med_stocks_mstk_stkmin_cond, $med_stocks_mstk_stkmin,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $med_stocks_mstk_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca']['med_stocks_mstk_id']; 
          $med_stocks_mstk_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca']['med_stocks_mstk_id_cond']; 
          $med_stocks_mpres_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca']['med_stocks_mpres_id']; 
          $med_stocks_mpres_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca']['med_stocks_mpres_id_cond']; 
          $med_stocks_mstk_exist = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca']['med_stocks_mstk_exist']; 
          $med_stocks_mstk_exist_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca']['med_stocks_mstk_exist_cond']; 
          $med_stocks_mstk_stkmin = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca']['med_stocks_mstk_stkmin']; 
          $med_stocks_mstk_stkmin_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca']['med_stocks_mstk_stkmin_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca']['NM_operador']; 
          if (strtoupper($med_stocks_mstk_id_cond) != "II" && strtoupper($med_stocks_mstk_id_cond) != "QP" && strtoupper($med_stocks_mstk_id_cond) != "NP" && strtoupper($med_stocks_mstk_id_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($med_stocks_mstk_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($med_stocks_mpres_id_cond) != "II" && strtoupper($med_stocks_mpres_id_cond) != "QP" && strtoupper($med_stocks_mpres_id_cond) != "NP" && strtoupper($med_stocks_mpres_id_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($med_stocks_mpres_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($med_stocks_mstk_exist_cond) != "II" && strtoupper($med_stocks_mstk_exist_cond) != "QP" && strtoupper($med_stocks_mstk_exist_cond) != "NP" && strtoupper($med_stocks_mstk_exist_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($med_stocks_mstk_exist, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($med_stocks_mstk_stkmin_cond) != "II" && strtoupper($med_stocks_mstk_stkmin_cond) != "QP" && strtoupper($med_stocks_mstk_stkmin_cond) != "NP" && strtoupper($med_stocks_mstk_stkmin_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($med_stocks_mstk_stkmin, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($med_stocks_mstk_id_cond) || empty($med_stocks_mstk_id_cond))
      {
         $med_stocks_mstk_id_cond = "gt";
      }
      if (!isset($med_stocks_mpres_id_cond) || empty($med_stocks_mpres_id_cond))
      {
         $med_stocks_mpres_id_cond = "gt";
      }
      if (!isset($med_stocks_mstk_exist_cond) || empty($med_stocks_mstk_exist_cond))
      {
         $med_stocks_mstk_exist_cond = "gt";
      }
      if (!isset($med_stocks_mstk_stkmin_cond) || empty($med_stocks_mstk_stkmin_cond))
      {
         $med_stocks_mstk_stkmin_cond = "gt";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_med_stocks_mstk_id = (in_array($med_stocks_mstk_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_med_stocks_mpres_id = (in_array($med_stocks_mpres_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_med_stocks_mstk_exist = (in_array($med_stocks_mstk_exist_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_med_stocks_mstk_stkmin = (in_array($med_stocks_mstk_stkmin_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($med_stocks_mstk_id) || $med_stocks_mstk_id == "")
      {
          $med_stocks_mstk_id = "";
      }
      if (isset($med_stocks_mstk_id) && !empty($med_stocks_mstk_id))
      {
         $tmp_pos = (is_string($med_stocks_mstk_id)) ? strpos($med_stocks_mstk_id, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $med_stocks_mstk_id = substr($med_stocks_mstk_id, 0, $tmp_pos);
         }
      }
      if (!isset($med_stocks_mpres_id) || $med_stocks_mpres_id == "")
      {
          $med_stocks_mpres_id = "";
      }
      if (isset($med_stocks_mpres_id) && !empty($med_stocks_mpres_id))
      {
         $tmp_pos = (is_string($med_stocks_mpres_id)) ? strpos($med_stocks_mpres_id, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $med_stocks_mpres_id = substr($med_stocks_mpres_id, 0, $tmp_pos);
         }
      }
      if (!isset($med_stocks_mstk_exist) || $med_stocks_mstk_exist == "")
      {
          $med_stocks_mstk_exist = "";
      }
      if (isset($med_stocks_mstk_exist) && !empty($med_stocks_mstk_exist))
      {
         $tmp_pos = (is_string($med_stocks_mstk_exist)) ? strpos($med_stocks_mstk_exist, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $med_stocks_mstk_exist = substr($med_stocks_mstk_exist, 0, $tmp_pos);
         }
      }
      if (!isset($med_stocks_mstk_stkmin) || $med_stocks_mstk_stkmin == "")
      {
          $med_stocks_mstk_stkmin = "";
      }
      if (isset($med_stocks_mstk_stkmin) && !empty($med_stocks_mstk_stkmin))
      {
         $tmp_pos = (is_string($med_stocks_mstk_stkmin)) ? strpos($med_stocks_mstk_stkmin, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $med_stocks_mstk_stkmin = substr($med_stocks_mstk_stkmin, 0, $tmp_pos);
         }
      }
?>
 <?php
...
?>
<?php
   if (is_file("grid_vwmedicamentos_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_vwmedicamentos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_vwmedicamentos']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_med_stocks_mstk_id_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['med_stocks_mstk_id'])) ? $this->New_label['med_stocks_mstk_id'] : "" . $this->Ini->Nm_lang['lang_med_stocks_fld_mstk_id'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_med_stocks_mstk_id_cond" name="med_stocks_mstk_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_med_stocks_mstk_id'), this, 'med_stocks_mstk_id')">
       <OPTION value="gt" <?php if ("gt" == $med_stocks_mstk_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $med_stocks_mstk_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $med_stocks_mstk_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_med_stocks_mstk_id" <?php echo $str_hide_med_stocks_mstk_id?> valign="top">
 ...
 $nmgp_tab_label .= "med_stocks_mstk_id?#?" . $SC_Label . "?@?";
...
<INPUT  type="text" id="SC_med_stocks_mstk_id" name="med_stocks_mstk_id" value="<?php echo NM_encode_input($med_stocks_mstk_id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_med_stocks_mpres_id_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['med_stocks_mpres_id'])) ? $this->New_label['med_stocks_mpres_id'] : "Presentación"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_med_stocks_mpres_id_cond" name="med_stocks_mpres_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_med_stocks_mpres_id'), this, 'med_stocks_mpres_id')">
       <OPTION value="gt" <?php if ("gt" == $med_stocks_mpres_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $med_stocks_mpres_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $med_stocks_mpres_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_med_stocks_mpres_id" <?php echo $str_hide_med_stocks_mpres_id?> valign="top">
 ...
 $nmgp_tab_label .= "med_stocks_mpres_id?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_med_stocks_mpres_id" name="med_stocks_mpres_id" value="<?php echo NM_encode_input($med_stocks_mpres_id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_med_stocks_mstk_exist_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['med_stocks_mstk_exist'])) ? $this->New_label['med_stocks_mstk_exist'] : "Existencia"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_med_stocks_mstk_exist_cond" name="med_stocks_mstk_exist_cond" onChange="nm_campos_between(document.getElementById('id_vis_med_stocks_mstk_exist'), this, 'med_stocks_mstk_exist')">
       <OPTION value="gt" <?php if ("gt" == $med_stocks_mstk_exist_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $med_stocks_mstk_exist_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $med_stocks_mstk_exist_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_med_stocks_mstk_exist" <?php echo $str_hide_med_stocks_mstk_exist?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['med_stocks_mstk_exist'])) ? $this->New_label['med_stocks_mstk_exist'] : "Existencia";
 $nmgp_tab_label .= "med_stocks_mstk_exist?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_med_stocks_mstk_exist" name="med_stocks_mstk_exist" value="<?php echo NM_encode_input($med_stocks_mstk_exist) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_med_stocks_mstk_stkmin_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['med_stocks_mstk_stkmin'])) ? $this->New_label['med_stocks_mstk_stkmin'] : "Exist. Minima"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_med_stocks_mstk_stkmin_cond" name="med_stocks_mstk_stkmin_cond" onChange="nm_campos_between(document.getElementById('id_vis_med_stocks_mstk_stkmin'), this, 'med_stocks_mstk_stkmin')">
       <OPTION value="gt" <?php if ("gt" == $med_stocks_mstk_stkmin_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $med_stocks_mstk_stkmin_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $med_stocks_mstk_stkmin_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_med_stocks_mstk_stkmin" <?php echo $str_hide_med_stocks_mstk_stkmin?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['med_stocks_mstk_stkmin'])) ? $this->New_label['med_stocks_mstk_stkmin'] : "Exist. Minima";
 $nmgp_tab_label .= "med_stocks_mstk_stkmin?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if (!$_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.med_stocks_mstk_id_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_med_stocks_mstk_id'), document.F1.med_stocks_mstk_id_cond, 'med_stocks_mstk_id');
   document.F1.med_stocks_mstk_id.value = "";
   document.F1.med_stocks_mpres_id_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_med_stocks_mpres_id'), document.F1.med_stocks_mpres_id_cond, 'med_stocks_mpres_id');
   document.F1.med_stocks_mpres_id.value = "";
   document.F1.med_stocks_mstk_exist_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_med_stocks_mstk_exist'), document.F1.med_stocks_mstk_exist_cond, 'med_stocks_mstk_exist');
   document.F1.med_stocks_mstk_exist.value = "";
   document.F1.med_stocks_mstk_stkmin_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_med_stocks_mstk_stkmin'), document.F1.med_stocks_mstk_stkmin_cond, 'med_stocks_mstk_stkmin');
   document.F1.med_stocks_mstk_stkmin.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_med_stocks_mstk_id_cond'] = 'cond';
      $tp_fields['SC_med_stocks_mstk_id'] = 'text';
      $tp_fields['SC_med_stocks_mpres_id_cond'] = 'cond';
      $tp_fields['SC_med_stocks_mpres_id'] = 'text';
      $tp_fields['SC_med_stocks_mstk_exist_cond'] = 'cond';
      $tp_fields['SC_med_stocks_mstk_exist'] = 'text';
      $tp_fields['SC_med_stocks_mstk_stkmin_cond'] = 'cond';
      $tp_fields['SC_med_stocks_mstk_stkmin'] = 'text';
   ...
   {
      global $med_stocks_mstk_id_cond, $med_stocks_mstk_id,
             $med_stocks_mpres_id_cond, $med_stocks_mpres_id,
             $med_stocks_mstk_exist_cond, $med_stocks_mstk_exist,
             $med_stocks_mstk_stkmin_cond, $med_stocks_mstk_stkmin, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $med_stocks_mstk_id_cond_salva = $med_stocks_mstk_id_cond; 
      if (!isset($med_stocks_mstk_id_input_2) || $med_stocks_mstk_id_input_2 == "")
      {
          $med_stocks_mstk_id_input_2 = $med_stocks_mstk_id;
      }
      $med_stocks_mpres_id_cond_salva = $med_stocks_mpres_id_cond; 
      if (!isset($med_stocks_mpres_id_input_2) || $med_stocks_mpres_id_input_2 == "")
      {
          $med_stocks_mpres_id_input_2 = $med_stocks_mpres_id;
      }
      $med_stocks_mstk_exist_cond_salva = $med_stocks_mstk_exist_cond; 
      if (!isset($med_stocks_mstk_exist_input_2) || $med_stocks_mstk_exist_input_2 == "")
      {
          $med_stocks_mstk_exist_input_2 = $med_stocks_mstk_exist;
      }
      $med_stocks_mstk_stkmin_cond_salva = $med_stocks_mstk_stkmin_cond; 
      if (!isset($med_stocks_mstk_stkmin_input_2) || $med_stocks_mstk_stkmin_input_2 == "")
      {
          $med_stocks_mstk_stkmin_input_2 = $med_stocks_mstk_stkmin;
      }
      if ($med_stocks_mstk_id_cond != "in")
      {
          nm_limpa_numero($med_stocks_mstk_id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($med_stocks_mpres_id_cond != "in")
      {
          nm_limpa_numero($med_stocks_mpres_id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($med_stocks_mstk_exist_cond != "in")
      {
          nm_limpa_numero($med_stocks_mstk_exist, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($med_stocks_mstk_stkmin_cond != "in")
      {
          nm_limpa_numero($med_stocks_mstk_stkmin, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca']['med_stocks_mstk_id'] = $med_stocks_mstk_id; 
      if (is_array($med_stocks_mstk_id) && !empty($med_stocks_mstk_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['Grid_search'][$I_Grid]['val'][0] = $med_stocks_mstk_id;
      }
      elseif ($med_stocks_mstk_id_cond_salva == "nu" || $med_stocks_mstk_id_cond_salva == "nn" || $med_stocks_mstk_id_cond_salva == "ep" || $med_stocks_mstk_id_cond_salva == "ne" || !empty($med_stocks_mstk_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['Grid_search'][$I_Grid]['val'][0][0] = $med_stocks_mstk_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca']['med_stocks_mstk_id_cond'] = $med_stocks_mstk_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['Grid_search'][$I_Grid]['cmp'] = "med_stocks_mstk_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['Grid_search'][$I_Grid]['opc'] = $med_stocks_mstk_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq']['med_stocks_mstk_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca']['med_stocks_mpres_id'] = $med_stocks_mpres_id; 
      if (is_array($med_stocks_mpres_id) && !empty($med_stocks_mpres_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['Grid_search'][$I_Grid]['val'][0] = $med_stocks_mpres_id;
      }
      elseif ($med_stocks_mpres_id_cond_salva == "nu" || $med_stocks_mpres_id_cond_salva == "nn" || $med_stocks_mpres_id_cond_salva == "ep" || $med_stocks_mpres_id_cond_salva == "ne" || !empty($med_stocks_mpres_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['Grid_search'][$I_Grid]['val'][0][0] = $med_stocks_mpres_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca']['med_stocks_mpres_id_cond'] = $med_stocks_mpres_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['Grid_search'][$I_Grid]['cmp'] = "med_stocks_mpres_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['Grid_search'][$I_Grid]['opc'] = $med_stocks_mpres_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq']['med_stocks_mpres_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca']['med_stocks_mstk_exist'] = $med_stocks_mstk_exist; 
      if (is_array($med_stocks_mstk_exist) && !empty($med_stocks_mstk_exist))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['Grid_search'][$I_Grid]['val'][0] = $med_stocks_mstk_exist;
      }
      elseif ($med_stocks_mstk_exist_cond_salva == "nu" || $med_stocks_mstk_exist_cond_salva == "nn" || $med_stocks_mstk_exist_cond_salva == "ep" || $med_stocks_mstk_exist_cond_salva == "ne" || !empty($med_stocks_mstk_exist))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['Grid_search'][$I_Grid]['val'][0][0] = $med_stocks_mstk_exist;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca']['med_stocks_mstk_exist_cond'] = $med_stocks_mstk_exist_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['Grid_search'][$I_Grid]['cmp'] = "med_stocks_mstk_exist"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['Grid_search'][$I_Grid]['opc'] = $med_stocks_mstk_exist_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq']['med_stocks_mstk_exist'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca']['med_stocks_mstk_stkmin'] = $med_stocks_mstk_stkmin; 
      if (is_array($med_stocks_mstk_stkmin) && !empty($med_stocks_mstk_stkmin))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['Grid_search'][$I_Grid]['val'][0] = $med_stocks_mstk_stkmin;
      }
      elseif ($med_stocks_mstk_stkmin_cond_salva == "nu" || $med_stocks_mstk_stkmin_cond_salva == "nn" || $med_stocks_mstk_stkmin_cond_salva == "ep" || $med_stocks_mstk_stkmin_cond_salva == "ne" || !empty($med_stocks_mstk_stkmin))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['Grid_search'][$I_Grid]['val'][0][0] = $med_stocks_mstk_stkmin;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca']['med_stocks_mstk_stkmin_cond'] = $med_stocks_mstk_stkmin_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['Grid_search'][$I_Grid]['cmp'] = "med_stocks_mstk_stkmin"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['Grid_search'][$I_Grid]['opc'] = $med_stocks_mstk_stkmin_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['grid_pesq']['med_stocks_mstk_stkmin'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $med_stocks_mstk_id;
      if (strtoupper($med_stocks_mstk_id_cond) != "II" && strtoupper($med_stocks_mstk_id_cond) != "QP" && strtoupper($med_stocks_mstk_id_cond) != "NP" && strtoupper($med_stocks_mstk_id_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['med_stocks_mstk_id'] = $Conteudo;
      $Conteudo = $med_stocks_mpres_id;
      if (strtoupper($med_stocks_mpres_id_cond) != "II" && strtoupper($med_stocks_mpres_id_cond) != "QP" && strtoupper($med_stocks_mpres_id_cond) != "NP" && strtoupper($med_stocks_mpres_id_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['med_stocks_mpres_id'] = $Conteudo;
      $Conteudo = $med_stocks_mstk_exist;
      if (strtoupper($med_stocks_mstk_exist_cond) != "II" && strtoupper($med_stocks_mstk_exist_cond) != "QP" && strtoupper($med_stocks_mstk_exist_cond) != "NP" && strtoupper($med_stocks_mstk_exist_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['med_stocks_mstk_exist'] = $Conteudo;
      $Conteudo = $med_stocks_mstk_stkmin;
      if (strtoupper($med_stocks_mstk_stkmin_cond) != "II" && strtoupper($med_stocks_mstk_stkmin_cond) != "QP" && strtoupper($med_stocks_mstk_stkmin_cond) != "NP" && strtoupper($med_stocks_mstk_stkmin_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['med_stocks_mstk_stkmin'] = $Conteudo;

      //----- $med_stocks_mstk_id
      $this->Date_part = false;
      if (isset($med_stocks_mstk_id) || $med_stocks_mstk_id_cond == "nu" || $med_stocks_mstk_id_cond == "nn" || $med_stocks_mstk_id_cond == "ep" || $med_stocks_mstk_id_cond == "ne")
      {
         $this->monta_condicao("med_stocks.mstk_id", $med_stocks_mstk_id_cond, $med_stocks_mstk_id, "", "med_stocks_mstk_id", "INT", false);
      }

      //----- $med_stocks_mpres_id
      $this->Date_part = false;
      if (isset($med_stocks_mpres_id) || $med_stocks_mpres_id_cond == "nu" || $med_stocks_mpres_id_cond == "nn" || $med_stocks_mpres_id_cond == "ep" || $med_stocks_mpres_id_cond == "ne")
      {
         $this->monta_condicao("med_stocks.mpres_id", $med_stocks_mpres_id_cond, $med_stocks_mpres_id, "", "med_stocks_mpres_id", "INT", false);
      }

      //----- $med_stocks_mstk_exist
      $this->Date_part = false;
      if (isset($med_stocks_mstk_exist) || $med_stocks_mstk_exist_cond == "nu" || $med_stocks_mstk_exist_cond == "nn" || $med_stocks_mstk_exist_cond == "ep" || $med_stocks_mstk_exist_cond == "ne")
      {
         $this->monta_condicao("med_stocks.mstk_exist", $med_stocks_mstk_exist_cond, $med_stocks_mstk_exist, "", "med_stocks_mstk_exist", "INT", false);
      }

      //----- $med_stocks_mstk_stkmin
      $this->Date_part = false;
      if (isset($med_stocks_mstk_stkmin) || $med_stocks_mstk_stkmin_cond == "nu" || $med_stocks_mstk_stkmin_cond == "nn" || $med_stocks_mstk_stkmin_cond == "ep" || $med_stocks_mstk_stkmin_cond == "ne")
      {
         $this->monta_condicao("med_stocks.mstk_stkmin", $med_stocks_mstk_stkmin_cond, $med_stocks_mstk_stkmin, "", "med_stocks_mstk_stkmin", "INT", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vwmedicamentos']['cond_pesq'] .= $this->NM_operador;
