...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "med_stocks.mstk_exp";$Nm_datas[] = "med_stocks_mstk_exp";$Nm_numeric[] = "med_stocks_mstk_id";$Nm_numeric[] = "med_stocks_mpres_id";$Nm_numeric[] = "med_stocks_mstk_exist";$Nm_numeric[] = "med_stocks_mstk_stkmin";$Nm_numeric[] = "med_stocks_mstk_stkmax";$Nm_numeric[] = "medicines_meds_id";$Nm_numeric[] = "medicines_mtype_id";$Nm_numeric[] = "med_types_mtype_id";$Nm_numeric[] = "med_presentation_mpres_id";$Nm_numeric[] = "med_presentation_meds_id";$Nm_numeric[] = "med_presentation_mpres_doses";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_med_stocks_mstk_id_cond" name="med_stocks_mstk_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_med_stocks_mstk_id'), this, 'med_stocks_mstk_id')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_med_stocks_mpres_id_cond" name="med_stocks_mpres_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_med_stocks_mpres_id'), this, 'med_stocks_mpres_id')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_med_stocks_mstk_exist_cond" name="med_stocks_mstk_exist_cond" onChange="nm_campos_between(document.getElementById('id_vis_med_stocks_mstk_exist'), this, 'med_stocks_mstk_exist')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_med_stocks_mstk_stkmin_cond" name="med_stocks_mstk_stkmin_cond" onChange="nm_campos_between(document.getElementById('id_vis_med_stocks_mstk_stkmin'), this, 'med_stocks_mstk_stkmin')">
