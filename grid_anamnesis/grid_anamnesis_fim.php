...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["EnfermeriaUNAE_____grid_anamnesis"]))
   {
      unset($_SESSION['session_sec_aplicacao']["EnfermeriaUNAE_____grid_anamnesis"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_anamnesis'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_anamnesis']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_anamnesis']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_anamnesis']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_anamnesis']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_anamnesis']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_anamnesis']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_anamnesis']['embutida_filho'] as $ind => $sc_init)
          {
