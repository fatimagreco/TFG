...
<?php
   ...
   $Ord_Cmp = new grid_anamnesis_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_anamnesis_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_anamnesis']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_anamnesis']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["anam_date"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_anamnesis']['labels']["anam_date"])) ? $_SESSION['sc_session'][$sc_init]['grid_anamnesis']['labels']["anam_date"] : "Fecha";
   $tab_ger_campos['anam_strtime'] = "on";
   $tab_def_campos['anam_strtime'] = "anam_strtime";
   $tab_labels["anam_strtime"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_anamnesis']['labels']["anam_strtime"])) ? $_SESSION['sc_session'][$sc_init]['grid_anamnesis']['labels']["anam_strtime"] : "Hora Inicio";
   $tab_ger_campos['num_doc'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['num_doc'] = "num_doc";
   }
   else
   {
       $tab_def_campos['num_doc'] = "SELECT pati_docnum 
FROM patients 
WHERE pati_id = '{pati_id}' 
ORDER BY pati_docnum";
   }
   $tab_labels["num_doc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_anamnesis']['labels']["num_doc"])) ? $_SESSION['sc_session'][$sc_init]['grid_anamnesis']['labels']["num_doc"] : "N° CI";
   $tab_ger_campos['pati_id'] = "on";
   $tab_def_campos['pati_id'] = "pati_id";
   $tab_labels["pati_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_anamnesis']['labels']["pati_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_anamnesis']['labels']["pati_id"] : "Paciente";
   $tab_ger_campos['anam_reason'] = "on";
   $tab_def_campos['anam_reason'] = "anam_reason";
   $tab_labels["anam_reason"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_anamnesis']['labels']["anam_reason"])) ? $_SESSION['sc_session'][$sc_init]['grid_anamnesis']['labels']["anam_reason"] : "Motivo de Conslta";
   $tab_ger_campos['user_id'] = "on";
   $tab_def_campos['user_id'] = "user_id";
   $tab_labels["user_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_anamnesis']['labels']["user_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_anamnesis']['labels']["user_id"] : "Tratante";
   $tab_ger_campos['num_doc'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_anamnesis']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_anamnesis']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_anamnesis']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_anamnesis']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_anamnesis']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_anamnesis']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_anamnesis']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_anamnesis']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_anamnesis']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_anamnesis']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_anamnesis']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_anamnesis']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_anamnesis_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_anamnesis']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_anamnesis']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_anamnesis']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_anamnesis']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_anamnesis']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
