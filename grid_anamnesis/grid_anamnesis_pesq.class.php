...
class grid_anamnesis_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_anamnesis_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_anamnesis_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_anamnesis_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "anam_date";$Nm_datas[] = "anam_strtime";$Nm_datas[] = "anam_endtime";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Atenciones Enfermería</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_anamnesis/grid_anamnesis_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_anamnesis_ajax_search.js"></script>
 <script type="text/javascript" src="grid_anamnesis_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_anamnesis_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_anamnesis']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_anamnesis']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_anam_id_cond#NMF#' + search_get_sel_txt('SC_anam_id_cond') + '@NMF@';
  str_out += 'SC_anam_id#NMF#' + search_get_text('SC_anam_id') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">Atenciones Enfermería</div>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $anam_date_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['anam_date_dia']; 
          $anam_date_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['anam_date_mes']; 
          $anam_date_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['anam_date_ano']; 
          $anam_date_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['anam_date_input_2_dia']; 
          $anam_date_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['anam_date_input_2_mes']; 
          $anam_date_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['anam_date_input_2_ano']; 
          $anam_date_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['anam_date_cond']; 
          $anam_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['anam_id']; 
          $anam_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['anam_id_cond']; 
          $pati_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['pati_id']; 
          $pati_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['pati_id_cond']; 
          $user_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['user_id']; 
          $user_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['user_id_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['NM_operador']; 
          if (strtoupper($anam_id_cond) != "II" && strtoupper($anam_id_cond) != "QP" && strtoupper($anam_id_cond) != "NP" && strtoupper($anam_id_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($anam_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      ...
      if (!isset($anam_id_cond) || empty($anam_id_cond))
      {
         $anam_id_cond = "gt";
      }
      ...
      $str_hide_anam_id = (in_array($anam_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_anam_date = ('bw' == $anam_date_cond) ? $display_aberto : $display_fechado;
      $str_display_anam_id = ('bw' == $anam_id_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($anam_id) || $anam_id == "")
      {
          $anam_id = "";
      }
      if (isset($anam_id) && !empty($anam_id))
      {
         $tmp_pos = (is_string($anam_id)) ? strpos($anam_id, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $anam_id = substr($anam_id, 0, $tmp_pos);
         }
      }
...
?>
<?php
   if (is_file("grid_anamnesis_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_anamnesis']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_anamnesis']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
   ...
   <tr>
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_anam_date_cond" name="anam_date_cond" onChange="nm_campos_between(document.getElementById('id_vis_anam_date'), this, 'anam_date')">
       ...
       <OPTION value="gt" <?php if ("gt" == $anam_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $anam_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
...
?>
      ...
      <TD id='SC_anam_id_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['anam_id'])) ? $this->New_label['anam_id'] : "atencion"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_anam_id_cond" name="anam_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_anam_id'), this, 'anam_id')">
       <OPTION value="gt" <?php if ("gt" == $anam_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $anam_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $anam_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_anam_id" <?php echo $str_hide_anam_id?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['anam_id'])) ? $this->New_label['anam_id'] : "atencion";
 $nmgp_tab_label .= "anam_id?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_anam_id" name="anam_id" value="<?php echo NM_encode_input($anam_id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
<INPUT  type="text" id="SC_pati_id" name="pati_id" value="<?php echo NM_encode_input($pati_id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_user_id_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['user_id'])) ? $this->New_label['user_id'] : "Tratante"; ?></TD>
     <TD class="scFilterFieldEven"> 
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if (!$_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.anam_date_cond.value = 'eq';
   ...
   document.F1.anam_id_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_anam_id'), document.F1.anam_id_cond, 'anam_id');
   document.F1.anam_id.value = "";
 ...
 {
    $('#SC_anam_date_dia').bind('change', function() {sc_grid_anamnesis_valida_dia(this)});
    $('#SC_anam_date_input_2_dia').bind('change', function() {sc_grid_anamnesis_valida_dia(this)});
    $('#SC_anam_date_input_2_mes').bind('change', function() {sc_grid_anamnesis_valida_mes(this)});
    $('#SC_anam_date_mes').bind('change', function() {sc_grid_anamnesis_valida_mes(this)});
 }
 function sc_grid_anamnesis_valida_dia(obj)
 {
 ...
 function sc_grid_anamnesis_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_anam_id_cond'] = 'cond';
      $tp_fields['SC_anam_id'] = 'text';
   ...
   function trata_campos()
   {
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $anam_id_cond_salva = $anam_id_cond; 
      if (!isset($anam_id_input_2) || $anam_id_input_2 == "")
      {
          $anam_id_input_2 = $anam_id;
      }
      ...
      if ($anam_id_cond != "in")
      {
          nm_limpa_numero($anam_id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($pati_id_cond != "in")
      {
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['anam_date_dia'] = $anam_date_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['anam_date_mes'] = $anam_date_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['anam_date_ano'] = $anam_date_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['anam_date_input_2_dia'] = $anam_date_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['anam_date_input_2_mes'] = $anam_date_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['anam_date_input_2_ano'] = $anam_date_input_2_ano; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $anam_date_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $anam_date_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $anam_date_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $anam_date_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $anam_date_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $anam_date_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['anam_date_cond'] = $anam_date_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['Grid_search'][$I_Grid]['cmp'] = "anam_date"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['Grid_search'][$I_Grid]['opc'] = $anam_date_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq']['anam_date'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['anam_id'] = $anam_id; 
      if (is_array($anam_id) && !empty($anam_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['Grid_search'][$I_Grid]['val'][0] = $anam_id;
      }
      elseif ($anam_id_cond_salva == "nu" || $anam_id_cond_salva == "nn" || $anam_id_cond_salva == "ep" || $anam_id_cond_salva == "ne" || !empty($anam_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['Grid_search'][$I_Grid]['val'][0][0] = $anam_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['anam_id_cond'] = $anam_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['Grid_search'][$I_Grid]['cmp'] = "anam_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['Grid_search'][$I_Grid]['opc'] = $anam_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq']['anam_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['pati_id'] = $pati_id; 
      if (is_array($pati_id) && !empty($pati_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['Grid_search'][$I_Grid]['val'][0] = $pati_id;
      }
      elseif ($pati_id_cond_salva == "nu" || $pati_id_cond_salva == "nn" || $pati_id_cond_salva == "ep" || $pati_id_cond_salva == "ne" || !empty($pati_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['Grid_search'][$I_Grid]['val'][0][0] = $pati_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['pati_id_cond'] = $pati_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['Grid_search'][$I_Grid]['cmp'] = "pati_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['Grid_search'][$I_Grid]['opc'] = $pati_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq']['pati_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['user_id'] = $user_id; 
      if (is_array($user_id) && !empty($user_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['Grid_search'][$I_Grid]['val'][0] = $user_id;
      }
      elseif ($user_id_cond_salva == "nu" || $user_id_cond_salva == "nn" || $user_id_cond_salva == "ep" || $user_id_cond_salva == "ne" || !empty($user_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['Grid_search'][$I_Grid]['val'][0][0] = $user_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['user_id_cond'] = $user_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['Grid_search'][$I_Grid]['cmp'] = "user_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['Grid_search'][$I_Grid]['opc'] = $user_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq']['user_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['anam_id'] = $Conteudo;
      $Conteudo = $pati_id;
      if (strtoupper($pati_id_cond) != "II" && strtoupper($pati_id_cond) != "QP" && strtoupper($pati_id_cond) != "NP" && strtoupper($pati_id_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      ...
      if ($anam_date_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['anam_date'] = $val[0];
          ...
          if ($anam_date_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']['anam_date_input_2'] = $val[1];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq']['anam_date']['label'] = $nmgp_tab_label['anam_date'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq']['anam_date']['descr'] = $nmgp_tab_label['anam_date'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['grid_pesq']['anam_date']['hint']  = $nmgp_tab_label['anam_date'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }

      //----- $anam_id
      $this->Date_part = false;
      if (isset($anam_id) || $anam_id_cond == "nu" || $anam_id_cond == "nn" || $anam_id_cond == "ep" || $anam_id_cond == "ne")
      {
         $this->monta_condicao("anam_id", $anam_id_cond, $anam_id, "", "anam_id", "INT", false);
      }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_anamnesis']['cond_pesq'] .= $this->NM_operador;
