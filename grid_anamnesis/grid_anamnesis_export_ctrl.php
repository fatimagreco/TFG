<?php
@session_start() ;
$_SESSION['scriptcase']['grid_anamnesis']['sc_process_barr'] = true;
require_once('../grid_anamnesis/index.php');
unset($_SESSION['scriptcase']['grid_anamnesis']['sc_process_barr']);
$ExportCtrl = new grid_anamnesis_export_control;
$ExportCtrl->Export_barr();

class grid_anamnesis_export_control
{
