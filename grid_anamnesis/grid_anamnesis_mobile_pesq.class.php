...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "anam_date";$Nm_datas[] = "anam_strtime";$Nm_datas[] = "anam_endtime";$Nm_numeric[] = "anam_id";$Nm_numeric[] = "pati_id";$Nm_numeric[] = "user_id";$Nm_numeric[] = "anam_caryear";$Nm_numeric[] = "anam_carsem";$Nm_numeric[] = "anam_hbeat";$Nm_numeric[] = "anam_bpsys";$Nm_numeric[] = "anam_bpdia";$Nm_numeric[] = "anam_oxy";$Nm_numeric[] = "anam_gluco";$Nm_numeric[] = "";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_anam_id_cond" name="anam_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_anam_id'), this, 'anam_id')">
      ...
      <br><span id="id_hide_anam_id"  <?php echo $str_hide_anam_id?>><INPUT  type="text" id="SC_anam_id" name="anam_id" value="<?php echo NM_encode_input($anam_id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
