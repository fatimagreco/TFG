<?php
@session_start() ;
$_SESSION['scriptcase']['grid_suppliers']['sc_process_barr'] = true;
require_once('../grid_suppliers/index.php');
unset($_SESSION['scriptcase']['grid_suppliers']['sc_process_barr']);
$ExportCtrl = new grid_suppliers_export_control;
$ExportCtrl->Export_barr();

class grid_suppliers_export_control
{
