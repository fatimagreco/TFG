...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["EnfermeriaUNAE_____grid_suppliers"]))
   {
      unset($_SESSION['session_sec_aplicacao']["EnfermeriaUNAE_____grid_suppliers"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_suppliers'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_suppliers']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_suppliers']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_suppliers']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_suppliers']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_suppliers']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_suppliers']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_suppliers']['embutida_filho'] as $ind => $sc_init)
          {
