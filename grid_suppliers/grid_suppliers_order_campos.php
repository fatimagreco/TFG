...
<?php
   ...
   $Ord_Cmp = new grid_suppliers_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_suppliers_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_suppliers']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_suppliers']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['sup_name'] = "sup_name";
   $tab_labels["sup_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_suppliers']['labels']["sup_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_suppliers']['labels']["sup_name"] : "Proveedor";
   $tab_ger_campos['sup_address'] = "on";
   $tab_def_campos['sup_address'] = "sup_address";
   $tab_labels["sup_address"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_suppliers']['labels']["sup_address"])) ? $_SESSION['sc_session'][$sc_init]['grid_suppliers']['labels']["sup_address"] : "Dirección";
   $tab_ger_campos['sup_phone'] = "on";
   $tab_def_campos['sup_phone'] = "sup_phone";
   $tab_labels["sup_phone"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_suppliers']['labels']["sup_phone"])) ? $_SESSION['sc_session'][$sc_init]['grid_suppliers']['labels']["sup_phone"] : "Teléfono";
   $tab_ger_campos['sup_email'] = "on";
   $tab_def_campos['sup_email'] = "sup_email";
   $tab_labels["sup_email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_suppliers']['labels']["sup_email"])) ? $_SESSION['sc_session'][$sc_init]['grid_suppliers']['labels']["sup_email"] : "Correo Electrónico";
   $tab_ger_campos['sup_ruc'] = "on";
   $tab_def_campos['sup_ruc'] = "sup_ruc";
   $tab_labels["sup_ruc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_suppliers']['labels']["sup_ruc"])) ? $_SESSION['sc_session'][$sc_init]['grid_suppliers']['labels']["sup_ruc"] : "RUC";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_suppliers']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_suppliers']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_suppliers']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_suppliers']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_suppliers']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_suppliers']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_suppliers']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_suppliers']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_suppliers']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_suppliers']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_suppliers']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_suppliers']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_suppliers_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_suppliers']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_suppliers']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_suppliers']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_suppliers']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_suppliers']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
