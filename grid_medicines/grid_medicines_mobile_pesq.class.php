...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "meds_id";$Nm_numeric[] = "mtype_id";$Nm_numeric[] = "meds_id";$Nm_numeric[] = "mtype_id";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_meds_id_cond" name="meds_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_meds_id'), this, 'meds_id')">
      ...
      <br><span id="id_hide_meds_id"  <?php echo $str_hide_meds_id?>><INPUT  type="text" id="SC_meds_id" name="meds_id" value="<?php echo NM_encode_input($meds_id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_meds_desc_cond" name="meds_desc_cond" onChange="nm_campos_between(document.getElementById('id_vis_meds_desc'), this, 'meds_desc')">
      ...
      <br><span id="id_hide_meds_desc"  <?php echo $str_hide_meds_desc?>><?php
      if ($meds_desc != "")
      {
      $meds_desc_look = (is_string($meds_desc) ? substr($this->Db->qstr($meds_desc), 1, -1) : $meds_desc); 
      $nmgp_def_dados = array(); 
