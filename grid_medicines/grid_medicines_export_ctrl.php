<?php
@session_start() ;
$_SESSION['scriptcase']['grid_medicines']['sc_process_barr'] = true;
require_once('../grid_medicines/index.php');
unset($_SESSION['scriptcase']['grid_medicines']['sc_process_barr']);
$ExportCtrl = new grid_medicines_export_control;
$ExportCtrl->Export_barr();

class grid_medicines_export_control
{
