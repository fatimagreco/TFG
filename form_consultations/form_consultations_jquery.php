...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["consil_sesnum" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["consil_sesnum" + iSeqRow] && scEventControl_data["consil_sesnum" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["consil_sesnum" + iSeqRow] && scEventControl_data["consil_sesnum" + iSeqRow]["change"]) {
    return true;
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_consul_id' + iSeqRow).bind('change', function() { sc_form_consultations_consul_id_onchange(this, iSeqRow) });
  $('#id_sc_field_pati_id' + iSeqRow).bind('blur', function() { sc_form_consultations_pati_id_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_consultations_pati_id_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_consultations_pati_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_user_id' + iSeqRow).bind('blur', function() { sc_form_consultations_user_id_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_consultations_user_id_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_consultations_user_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_consul_date' + iSeqRow).bind('blur', function() { sc_form_consultations_consul_date_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_consultations_consul_date_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_consultations_consul_date_onfocus(this, iSeqRow) });
  $('#id_sc_field_consul_strtime' + iSeqRow).bind('blur', function() { sc_form_consultations_consul_strtime_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_consultations_consul_strtime_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_consultations_consul_strtime_onfocus(this, iSeqRow) });
  $('#id_sc_field_consul_endtime' + iSeqRow).bind('blur', function() { sc_form_consultations_consul_endtime_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_consultations_consul_endtime_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_consultations_consul_endtime_onfocus(this, iSeqRow) });
  $('#id_sc_field_consil_sesnum' + iSeqRow).bind('blur', function() { sc_form_consultations_consil_sesnum_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_consultations_consil_sesnum_onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_consultations_consil_sesnum_onfocus(this, iSeqRow) });
  $('#id_sc_field_consul_reason' + iSeqRow).bind('blur', function() { sc_form_consultations_consul_reason_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_consultations_consul_reason_onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_consultations_consul_reason_onfocus(this, iSeqRow) });
  $('#id_sc_field_consul_anot' + iSeqRow).bind('blur', function() { sc_form_consultations_consul_anot_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_consultations_consul_anot_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_consultations_consul_anot_onfocus(this, iSeqRow) });
  $('#id_sc_field_consul_state' + iSeqRow).bind('change', function() { sc_form_consultations_consul_state_onchange(this, iSeqRow) });
  $('#id_sc_field_anam_career' + iSeqRow).bind('blur', function() { sc_form_consultations_anam_career_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_consultations_anam_career_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_consultations_anam_career_onfocus(this, iSeqRow) });
  $('#id_sc_field_anam_carsem' + iSeqRow).bind('blur', function() { sc_form_consultations_anam_carsem_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_consultations_anam_carsem_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_consultations_anam_carsem_onfocus(this, iSeqRow) });
  $('#id_sc_field_pat_bod' + iSeqRow).bind('blur', function() { sc_form_consultations_pat_bod_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_consultations_pat_bod_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_consultations_pat_bod_onfocus(this, iSeqRow) });
  $('#id_sc_field_pat_name' + iSeqRow).bind('blur', function() { sc_form_consultations_pat_name_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_consultations_pat_name_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_consultations_pat_name_onfocus(this, iSeqRow) });
  $('#id_sc_field_pat_lname' + iSeqRow).bind('blur', function() { sc_form_consultations_pat_lname_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_consultations_pat_lname_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_consultations_pat_lname_onfocus(this, iSeqRow) });
  $('#id_sc_field_pat_gerens' + iSeqRow).bind('blur', function() { sc_form_consultations_pat_gerens_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_consultations_pat_gerens_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_consultations_pat_gerens_onfocus(this, iSeqRow) });
  $('#id_sc_field_pat_phone' + iSeqRow).bind('blur', function() { sc_form_consultations_pat_phone_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_consultations_pat_phone_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_consultations_pat_phone_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_consultations_consul_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_consultations_pati_id_onblur(oThis, iSeqRow) {
  do_ajax_form_consultations_validate_pati_id();
  scCssBlur(oThis);
}

function sc_form_consultations_pati_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_consultations_event_pati_id_onchange();
}

function sc_form_consultations_pati_id_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_consultations_user_id_onblur(oThis, iSeqRow) {
  do_ajax_form_consultations_validate_user_id();
  scCssBlur(oThis);
}

function sc_form_consultations_user_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_consultations_user_id_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_consultations_consul_date_onblur(oThis, iSeqRow) {
  do_ajax_form_consultations_validate_consul_date();
  scCssBlur(oThis);
}

function sc_form_consultations_consul_date_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_consultations_consul_date_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_consultations_consul_strtime_onblur(oThis, iSeqRow) {
  do_ajax_form_consultations_validate_consul_strtime();
  scCssBlur(oThis);
}

function sc_form_consultations_consul_strtime_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_consultations_consul_strtime_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_consultations_consul_endtime_onblur(oThis, iSeqRow) {
  do_ajax_form_consultations_validate_consul_endtime();
  scCssBlur(oThis);
}

function sc_form_consultations_consul_endtime_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_consultations_consul_endtime_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_consultations_consil_sesnum_onblur(oThis, iSeqRow) {
  do_ajax_form_consultations_validate_consil_sesnum();
  scCssBlur(oThis);
}

function sc_form_consultations_consil_sesnum_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_consultations_consil_sesnum_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_consultations_consul_reason_onblur(oThis, iSeqRow) {
  do_ajax_form_consultations_validate_consul_reason();
  scCssBlur(oThis);
}

function sc_form_consultations_consul_reason_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_consultations_consul_reason_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_consultations_consul_anot_onblur(oThis, iSeqRow) {
  do_ajax_form_consultations_validate_consul_anot();
  scCssBlur(oThis);
}

function sc_form_consultations_consul_anot_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_consultations_consul_anot_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_consultations_consul_state_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_consultations_anam_career_onblur(oThis, iSeqRow) {
  do_ajax_form_consultations_validate_anam_career();
  scCssBlur(oThis);
}

function sc_form_consultations_anam_career_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_consultations_anam_career_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_consultations_anam_carsem_onblur(oThis, iSeqRow) {
  do_ajax_form_consultations_validate_anam_carsem();
  scCssBlur(oThis);
}

function sc_form_consultations_anam_carsem_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_consultations_anam_carsem_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_consultations_pat_bod_onblur(oThis, iSeqRow) {
  do_ajax_form_consultations_validate_pat_bod();
  scCssBlur(oThis);
}

function sc_form_consultations_pat_bod_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_consultations_pat_bod_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_consultations_pat_name_onblur(oThis, iSeqRow) {
  do_ajax_form_consultations_validate_pat_name();
  scCssBlur(oThis);
}

function sc_form_consultations_pat_name_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_consultations_pat_name_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_consultations_pat_lname_onblur(oThis, iSeqRow) {
  do_ajax_form_consultations_validate_pat_lname();
  scCssBlur(oThis);
}

function sc_form_consultations_pat_lname_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_consultations_pat_lname_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_consultations_pat_gerens_onblur(oThis, iSeqRow) {
  do_ajax_form_consultations_validate_pat_gerens();
  scCssBlur(oThis);
}

function sc_form_consultations_pat_gerens_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_consultations_pat_gerens_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_consultations_pat_phone_onblur(oThis, iSeqRow) {
  do_ajax_form_consultations_validate_pat_phone();
  scCssBlur(oThis);
}

function sc_form_consultations_pat_phone_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_consultations_pat_phone_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_block_0(status) {
	...
	displayChange_field("consil_sesnum", "", status);
...
function displayChange_row(row, status) {
	...
	displayChange_field_consil_sesnum(row, status);
...
function displayChange_field_consil_sesnum(row, status) {
    var fieldId;
}
...
function displayChange_field_consul_anot(row, status) {
	...
	if ("on" == status) {
		if ("all" == row) {
			var fieldList = $(".css_consul_anot__obj");
			for (var i = 0; i < fieldList.length; i++) {
            ...
            scAjaxExecFieldEditorHtml('mceRemoveControl', false, "consul_anot");
            scAjaxExecFieldEditorHtml('mceAddControl', false, "consul_anot");
		}
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_consultations_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_consul_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_form_consultations_validate_consul_date(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
<?php
if ('novo' != $this->nmgp_opcao && isset($this->nmgp_cmp_readonly['consul_anot']) && $this->nmgp_cmp_readonly['consul_anot'] == 'on')
{
...
?>
  ...
  setup: function(ed) {
    ...
    ed.on("init", function (e) {
      if ($('textarea[name="consul_anot' + iSeqRow + '"]').prop('disabled') == true) {
        ed.setMode("readonly");
      }
    });
  }
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_consultations')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
