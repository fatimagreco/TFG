...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2-4.0.6/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_consultations/form_consultations_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_consultations_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_consultations_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['link_info']['remove_border']) {
...
<?php
 include_once("form_consultations_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_consultations'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_consultations'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['run_iframe'] != "R")
{
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['fast_search'][2] : "";
...
<?php 
          ...
          $SC_Label_atu['consul_date'] = (isset($this->nm_new_label['consul_date'])) ? $this->nm_new_label['consul_date'] : 'Fecha'; 
          $SC_Label_atu['consul_strtime'] = (isset($this->nm_new_label['consul_strtime'])) ? $this->nm_new_label['consul_strtime'] : 'Hora Inicio'; 
          $SC_Label_atu['consul_endtime'] = (isset($this->nm_new_label['consul_endtime'])) ? $this->nm_new_label['consul_endtime'] : 'Hora Final'; 
          $SC_Label_atu['consil_sesnum'] = (isset($this->nm_new_label['consil_sesnum'])) ? $this->nm_new_label['consil_sesnum'] : 'Nro Sessión'; 
          $SC_Label_atu['consul_reason'] = (isset($this->nm_new_label['consul_reason'])) ? $this->nm_new_label['consul_reason'] : 'Motivo'; 
          $SC_Label_atu['user_id'] = (isset($this->nm_new_label['user_id'])) ? $this->nm_new_label['user_id'] : 'Tratante'; 
          $SC_Label_atu['pati_id'] = (isset($this->nm_new_label['pati_id'])) ? $this->nm_new_label['pati_id'] : 'Paciente'; 
          $SC_Label_atu['consul_anot'] = (isset($this->nm_new_label['consul_anot'])) ? $this->nm_new_label['consul_anot'] : 'Anotaciones'; 
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['breload']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['breload']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['breload']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['breload']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['breload'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_consul_date_label" id="hidden_field_label_consul_date" style="<?php echo $sStyleHidden_consul_date; ?>"><span id="id_label_consul_date"><?php echo $this->nm_new_label['consul_date']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['php_cmp_required']['consul_date']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['php_cmp_required']['consul_date'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_consul_date_line" id="hidden_field_data_consul_date" style="<?php echo $sStyleHidden_consul_date; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_consul_date_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_consul_strtime_label" id="hidden_field_label_consul_strtime" style="<?php echo $sStyleHidden_consul_strtime; ?>"><span id="id_label_consul_strtime"><?php echo $this->nm_new_label['consul_strtime']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['php_cmp_required']['consul_strtime']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['php_cmp_required']['consul_strtime'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_consul_strtime_line" id="hidden_field_data_consul_strtime" style="<?php echo $sStyleHidden_consul_strtime; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_consul_strtime_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_consul_endtime_label" id="hidden_field_label_consul_endtime" style="<?php echo $sStyleHidden_consul_endtime; ?>"><span id="id_label_consul_endtime"><?php echo $this->nm_new_label['consul_endtime']; ?></span></TD>
    <TD class="scFormDataOdd css_consul_endtime_line" id="hidden_field_data_consul_endtime" style="<?php echo $sStyleHidden_consul_endtime; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_consul_endtime_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_consil_sesnum_label" id="hidden_field_label_consil_sesnum" style="<?php echo $sStyleHidden_consil_sesnum; ?>"><span id="id_label_consil_sesnum"><?php echo $this->nm_new_label['consil_sesnum']; ?></span></TD>
    <TD class="scFormDataOdd css_consil_sesnum_line" id="hidden_field_data_consil_sesnum" style="<?php echo $sStyleHidden_consil_sesnum; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_consil_sesnum_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_consul_reason_label" id="hidden_field_label_consul_reason" style="<?php echo $sStyleHidden_consul_reason; ?>"><span id="id_label_consul_reason"><?php echo $this->nm_new_label['consul_reason']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['php_cmp_required']['consul_reason']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['php_cmp_required']['consul_reason'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_consul_reason_line" id="hidden_field_data_consul_reason" style="<?php echo $sStyleHidden_consul_reason; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_consul_reason_line" style="vertical-align: top;padding: 0px">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_user_id_label" id="hidden_field_label_user_id" style="<?php echo $sStyleHidden_user_id; ?>"><span id="id_label_user_id"><?php echo $this->nm_new_label['user_id']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['php_cmp_required']['user_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['php_cmp_required']['user_id'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_user_id_line" id="hidden_field_data_user_id" style="<?php echo $sStyleHidden_user_id; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_user_id_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pati_id_label" id="hidden_field_label_pati_id" style="<?php echo $sStyleHidden_pati_id; ?>"><span id="id_label_pati_id"><?php echo $this->nm_new_label['pati_id']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['php_cmp_required']['pati_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['php_cmp_required']['pati_id'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_pati_id_line" id="hidden_field_data_pati_id" style="<?php echo $sStyleHidden_pati_id; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pati_id_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pat_phone_label" id="hidden_field_label_pat_phone" style="<?php echo $sStyleHidden_pat_phone; ?>"><span id="id_label_pat_phone"><?php echo $this->nm_new_label['pat_phone']; ?></span></TD>
    <TD class="scFormDataOdd css_pat_phone_line" id="hidden_field_data_pat_phone" style="<?php echo $sStyleHidden_pat_phone; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pat_phone_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pat_lname_label" id="hidden_field_label_pat_lname" style="<?php echo $sStyleHidden_pat_lname; ?>"><span id="id_label_pat_lname"><?php echo $this->nm_new_label['pat_lname']; ?></span></TD>
    <TD class="scFormDataOdd css_pat_lname_line" id="hidden_field_data_pat_lname" style="<?php echo $sStyleHidden_pat_lname; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pat_lname_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pat_name_label" id="hidden_field_label_pat_name" style="<?php echo $sStyleHidden_pat_name; ?>"><span id="id_label_pat_name"><?php echo $this->nm_new_label['pat_name']; ?></span></TD>
    <TD class="scFormDataOdd css_pat_name_line" id="hidden_field_data_pat_name" style="<?php echo $sStyleHidden_pat_name; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pat_name_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pat_gerens_label" id="hidden_field_label_pat_gerens" style="<?php echo $sStyleHidden_pat_gerens; ?>"><span id="id_label_pat_gerens"><?php echo $this->nm_new_label['pat_gerens']; ?></span></TD>
    <TD class="scFormDataOdd css_pat_gerens_line" id="hidden_field_data_pat_gerens" style="<?php echo $sStyleHidden_pat_gerens; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pat_gerens_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pat_bod_label" id="hidden_field_label_pat_bod" style="<?php echo $sStyleHidden_pat_bod; ?>"><span id="id_label_pat_bod"><?php echo $this->nm_new_label['pat_bod']; ?></span></TD>
    <TD class="scFormDataOdd css_pat_bod_line" id="hidden_field_data_pat_bod" style="<?php echo $sStyleHidden_pat_bod; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pat_bod_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_anam_career_label" id="hidden_field_label_anam_career" style="<?php echo $sStyleHidden_anam_career; ?>"><span id="id_label_anam_career"><?php echo $this->nm_new_label['anam_career']; ?></span></TD>
    <TD class="scFormDataOdd css_anam_career_line" id="hidden_field_data_anam_career" style="<?php echo $sStyleHidden_anam_career; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_anam_career_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_anam_carsem_label" id="hidden_field_label_anam_carsem" style="<?php echo $sStyleHidden_anam_carsem; ?>"><span id="id_label_anam_carsem"><?php echo $this->nm_new_label['anam_carsem']; ?></span></TD>
    <TD class="scFormDataOdd css_anam_carsem_line" id="hidden_field_data_anam_carsem" style="<?php echo $sStyleHidden_anam_carsem; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_anam_carsem_line" style="vertical-align: top;padding: 0px">
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_consultations");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_consultations");
 parent.scAjaxDetailHeight("form_consultations", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
