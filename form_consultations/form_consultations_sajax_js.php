  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_consultations" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_consultations_form();
	}
...
?>
  ...
  function do_ajax_form_consultations_validate_consul_date()
  {
    ...
    setTimeout(function() {
      var var_consul_date = scAjaxGetFieldText(nomeCampo_consul_date);
      x_ajax_form_consultations_validate_consul_date(var_consul_date, var_script_case_init, do_ajax_form_consultations_validate_consul_date_cb);
    }, 200);
  } // do_ajax_form_consultations_validate_consul_date

  function do_ajax_form_consultations_validate_consul_date_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_consultations_validate_consul_date_cb

  // ---------- Validate consul_strtime
  function do_ajax_form_consultations_validate_consul_strtime()
  {
    var nomeCampo_consul_strtime = "consul_strtime";
    var var_consul_strtime = scAjaxGetFieldText(nomeCampo_consul_strtime);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_consultations_validate_consul_strtime(var_consul_strtime, var_script_case_init, do_ajax_form_consultations_validate_consul_strtime_cb);
  } // do_ajax_form_consultations_validate_consul_strtime

  function do_ajax_form_consultations_validate_consul_strtime_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_consultations_validate_consul_strtime_cb

  // ---------- Validate consul_endtime
  function do_ajax_form_consultations_validate_consul_endtime()
  {
    var nomeCampo_consul_endtime = "consul_endtime";
    var var_consul_endtime = scAjaxGetFieldText(nomeCampo_consul_endtime);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_consultations_validate_consul_endtime(var_consul_endtime, var_script_case_init, do_ajax_form_consultations_validate_consul_endtime_cb);
  } // do_ajax_form_consultations_validate_consul_endtime

  function do_ajax_form_consultations_validate_consul_endtime_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_consultations_validate_consul_endtime_cb

  // ---------- Validate consil_sesnum
  function do_ajax_form_consultations_validate_consil_sesnum()
  {
    var nomeCampo_consil_sesnum = "consil_sesnum";
    var var_consil_sesnum = scAjaxGetFieldText(nomeCampo_consil_sesnum);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_consultations_validate_consil_sesnum(var_consil_sesnum, var_script_case_init, do_ajax_form_consultations_validate_consil_sesnum_cb);
  } // do_ajax_form_consultations_validate_consil_sesnum

  function do_ajax_form_consultations_validate_consil_sesnum_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_consultations_validate_consil_sesnum_cb

  // ---------- Validate consul_reason
  function do_ajax_form_consultations_validate_consul_reason()
  {
    var nomeCampo_consul_reason = "consul_reason";
    var var_consul_reason = scAjaxGetFieldText(nomeCampo_consul_reason);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_consultations_validate_consul_reason(var_consul_reason, var_script_case_init, do_ajax_form_consultations_validate_consul_reason_cb);
  } // do_ajax_form_consultations_validate_consul_reason

  function do_ajax_form_consultations_validate_consul_reason_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_consultations_validate_consul_reason_cb

  // ---------- Validate user_id
  function do_ajax_form_consultations_validate_user_id()
  {
    var nomeCampo_user_id = "user_id";
    var var_user_id = scAjaxGetFieldSelect(nomeCampo_user_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_consultations_validate_user_id(var_user_id, var_script_case_init, do_ajax_form_consultations_validate_user_id_cb);
  } // do_ajax_form_consultations_validate_user_id

  function do_ajax_form_consultations_validate_user_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_consultations_validate_user_id_cb

  // ---------- Validate pati_id
  function do_ajax_form_consultations_validate_pati_id()
  {
    var nomeCampo_pati_id = "pati_id";
    var var_pati_id = scAjaxGetFieldSelect(nomeCampo_pati_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_consultations_validate_pati_id(var_pati_id, var_script_case_init, do_ajax_form_consultations_validate_pati_id_cb);
  } // do_ajax_form_consultations_validate_pati_id

  function do_ajax_form_consultations_validate_pati_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pati_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_consultations_validate_pati_id_cb

  // ---------- Validate pat_phone
  function do_ajax_form_consultations_validate_pat_phone()
  {
    var nomeCampo_pat_phone = "pat_phone";
    var var_pat_phone = scAjaxGetFieldText(nomeCampo_pat_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_consultations_validate_pat_phone(var_pat_phone, var_script_case_init, do_ajax_form_consultations_validate_pat_phone_cb);
  } // do_ajax_form_consultations_validate_pat_phone

  function do_ajax_form_consultations_validate_pat_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_consultations_validate_pat_phone_cb

  // ---------- Validate pat_lname
  function do_ajax_form_consultations_validate_pat_lname()
  {
    var nomeCampo_pat_lname = "pat_lname";
    var var_pat_lname = scAjaxGetFieldText(nomeCampo_pat_lname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_consultations_validate_pat_lname(var_pat_lname, var_script_case_init, do_ajax_form_consultations_validate_pat_lname_cb);
  } // do_ajax_form_consultations_validate_pat_lname

  function do_ajax_form_consultations_validate_pat_lname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_consultations_validate_pat_lname_cb

  // ---------- Validate pat_name
  function do_ajax_form_consultations_validate_pat_name()
  {
    var nomeCampo_pat_name = "pat_name";
    var var_pat_name = scAjaxGetFieldText(nomeCampo_pat_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_consultations_validate_pat_name(var_pat_name, var_script_case_init, do_ajax_form_consultations_validate_pat_name_cb);
  } // do_ajax_form_consultations_validate_pat_name

  function do_ajax_form_consultations_validate_pat_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_consultations_validate_pat_name_cb

  // ---------- Validate pat_gerens
  function do_ajax_form_consultations_validate_pat_gerens()
  {
    var nomeCampo_pat_gerens = "pat_gerens";
    var var_pat_gerens = scAjaxGetFieldSelect(nomeCampo_pat_gerens);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_consultations_validate_pat_gerens(var_pat_gerens, var_script_case_init, do_ajax_form_consultations_validate_pat_gerens_cb);
  } // do_ajax_form_consultations_validate_pat_gerens

  function do_ajax_form_consultations_validate_pat_gerens_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_consultations_validate_pat_gerens_cb

  // ---------- Validate pat_bod
  function do_ajax_form_consultations_validate_pat_bod()
  {
    var nomeCampo_pat_bod = "pat_bod";
    var var_pat_bod = scAjaxGetFieldText(nomeCampo_pat_bod);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_consultations_validate_pat_bod(var_pat_bod, var_script_case_init, do_ajax_form_consultations_validate_pat_bod_cb);
  } // do_ajax_form_consultations_validate_pat_bod

  function do_ajax_form_consultations_validate_pat_bod_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pat_bod";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_consultations_validate_pat_bod_cb

  // ---------- Validate anam_career
  function do_ajax_form_consultations_validate_anam_career()
  {
    var nomeCampo_anam_career = "anam_career";
    var var_anam_career = scAjaxGetFieldText(nomeCampo_anam_career);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_consultations_validate_anam_career(var_anam_career, var_script_case_init, do_ajax_form_consultations_validate_anam_career_cb);
  } // do_ajax_form_consultations_validate_anam_career

  function do_ajax_form_consultations_validate_anam_career_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_consultations_validate_anam_career_cb

  // ---------- Validate anam_carsem
  function do_ajax_form_consultations_validate_anam_carsem()
  {
    var nomeCampo_anam_carsem = "anam_carsem";
    var var_anam_carsem = scAjaxGetFieldText(nomeCampo_anam_carsem);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_consultations_validate_anam_carsem(var_anam_carsem, var_script_case_init, do_ajax_form_consultations_validate_anam_carsem_cb);
  } // do_ajax_form_consultations_validate_anam_carsem

  function do_ajax_form_consultations_validate_anam_carsem_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_consultations_validate_anam_carsem_cb

  // ---------- Validate consul_anot
  function do_ajax_form_consultations_validate_consul_anot()
  {
    var nomeCampo_consul_anot = "consul_anot";
    var var_consul_anot = scAjaxGetFieldEditorHtml(nomeCampo_consul_anot);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_consultations_validate_consul_anot(var_consul_anot, var_script_case_init, do_ajax_form_consultations_validate_consul_anot_cb);
  } // do_ajax_form_consultations_validate_consul_anot

  function do_ajax_form_consultations_validate_consul_anot_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_consultations_validate_consul_anot_cb

  // ---------- Event onchange pati_id
  function do_ajax_form_consultations_event_pati_id_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_consultations_event_pati_id_onchange(var_pati_id, var_anam_career, var_anam_carsem, var_pat_bod, var_pat_name, var_pat_lname, var_pat_gerens, var_pat_phone, var_script_case_init, do_ajax_form_consultations_event_pati_id_onchange_cb);
  } // do_ajax_form_consultations_event_pati_id_onchange

  function do_ajax_form_consultations_event_pati_id_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pati_id";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_consultations_event_pati_id_onchange_cb_after_alert);
  } // do_ajax_form_consultations_event_pati_id_onchange_cb
  function do_ajax_form_consultations_event_pati_id_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_consultations_event_pati_id_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_consultations_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_consultations_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_consultations_submit_form(var_consul_date, var_consul_strtime, var_consul_endtime, var_consil_sesnum, var_consul_reason, var_user_id, var_pati_id, var_pat_phone, var_pat_lname, var_pat_name, var_pat_gerens, var_pat_bod, var_anam_career, var_anam_carsem, var_consul_anot, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_consultations_submit_form_cb);
  } // do_ajax_form_consultations_submit_form

  function do_ajax_form_consultations_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_consultations_submit_form_cb_after_alert);
  } // do_ajax_form_consultations_submit_form_cb
  function do_ajax_form_consultations_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_consultations_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_consultations_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_consultations_navigate_form, function() {});
    } else {
      perform_ajax_form_consultations_navigate_form();
    }
  }

  function perform_ajax_form_consultations_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_consultations_navigate_form(var_consul_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_consultations_navigate_form_cb);
  } // do_ajax_form_consultations_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_consultations']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_consultations_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_consultations_navigate_form_cb_after_alert);
  } // do_ajax_form_consultations_navigate_form_cb
  function do_ajax_form_consultations_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_consultations_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_consultations_navigate_form_cb_after_alert

  function sc_hide_form_consultations_form()
  {
