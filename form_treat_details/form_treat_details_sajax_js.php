  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_treat_details" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_treat_details_form();
	}
...
?>
  ...
  // ---------- Validate mstk_id_
  function do_ajax_form_treat_details_validate_mstk_id_(iNumLinha)
  {
    var nomeCampo_mstk_id_ = "mstk_id_" + iNumLinha;
    var var_mstk_id_ = scAjaxGetFieldSelect(nomeCampo_mstk_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_treat_details_validate_mstk_id_(var_mstk_id_, iNumLinha, var_script_case_init, do_ajax_form_treat_details_validate_mstk_id__cb);
  } // do_ajax_form_treat_details_validate_mstk_id_

  function do_ajax_form_treat_details_validate_mstk_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "mstk_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "mstk_id_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "mstk_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "mstk_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_treat_details_validate_mstk_id__cb

  // ---------- Validate treat_doses_
  function do_ajax_form_treat_details_validate_treat_doses_(iNumLinha)
  {
    var nomeCampo_treat_doses_ = "treat_doses_" + iNumLinha;
    var var_treat_doses_ = scAjaxGetFieldText(nomeCampo_treat_doses_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_treat_details_validate_treat_doses_(var_treat_doses_, iNumLinha, var_script_case_init, do_ajax_form_treat_details_validate_treat_doses__cb);
  } // do_ajax_form_treat_details_validate_treat_doses_

  function do_ajax_form_treat_details_validate_treat_doses__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "treat_doses_" + iLineNumber;
    }
    else
    {
      sFieldValid = "treat_doses_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "treat_doses_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "treat_doses_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_treat_details_validate_treat_doses__cb

  // ---------- Validate mstk_indic_
  function do_ajax_form_treat_details_validate_mstk_indic_(iNumLinha)
  {
    var nomeCampo_mstk_indic_ = "mstk_indic_" + iNumLinha;
    var var_mstk_indic_ = scAjaxGetFieldText(nomeCampo_mstk_indic_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_treat_details_validate_mstk_indic_(var_mstk_indic_, iNumLinha, var_script_case_init, do_ajax_form_treat_details_validate_mstk_indic__cb);
  } // do_ajax_form_treat_details_validate_mstk_indic_

  function do_ajax_form_treat_details_validate_mstk_indic__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "mstk_indic_" + iLineNumber;
    }
    else
    {
      sFieldValid = "mstk_indic_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "mstk_indic_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "mstk_indic_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_treat_details_validate_mstk_indic__cb

  // ---------- Validate tdet_id_
  function do_ajax_form_treat_details_validate_tdet_id_(iNumLinha)
  {
    var nomeCampo_tdet_id_ = "tdet_id_" + iNumLinha;
    var var_tdet_id_ = scAjaxGetFieldHidden(nomeCampo_tdet_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_treat_details_validate_tdet_id_(var_tdet_id_, iNumLinha, var_script_case_init, do_ajax_form_treat_details_validate_tdet_id__cb);
  } // do_ajax_form_treat_details_validate_tdet_id_

  function do_ajax_form_treat_details_validate_tdet_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tdet_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tdet_id_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tdet_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tdet_id_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_treat_details_validate_tdet_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_treat_details_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_treat_details_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_treat_details_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_treat_details_add_new_line_cb);
  } // do_ajax_form_treat_details_add_new_line

  function do_ajax_form_treat_details_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_treat_details_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_treat_details_backup_line(iNumLinha)
  {
    var var_tdet_id_ = scAjaxGetFieldHidden("tdet_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_treat_details_backup_line(var_tdet_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_treat_details_backup_line_cb);
  } // do_ajax_form_treat_details_backup_line

  function do_ajax_form_treat_details_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_treat_details_backup_line_cb

  function do_ajax_form_treat_details_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_treat_details_cancel_insert

  function do_ajax_form_treat_details_cancel_update(iSeqVert)
  {
    do_ajax_form_treat_details_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_treat_details_cancel_update

  function do_ajax_form_treat_details_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_treat_details_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_treat_details_table_refresh()
  {
    var var_tdet_id_ = document.F2.tdet_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_treat_details_table_refresh(var_tdet_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_treat_details_table_refresh_cb);
  } //  do_ajax_form_treat_details_table_refresh

  function do_ajax_form_treat_details_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.tdet_id_.value = scAjaxGetKeyValue("tdet_id_");
    ...
    scAjaxAlert(do_ajax_form_treat_details_table_refresh_cb_after_alert);
  } // do_ajax_form_treat_details_table_refresh_cb
  function do_ajax_form_treat_details_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_treat_details_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_treat_details_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_treat_details_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_mstk_id_ = scAjaxGetFieldSelect("mstk_id_" + iNumLinha);
    var var_treat_doses_ = scAjaxGetFieldText("treat_doses_" + iNumLinha);
    var var_mstk_indic_ = scAjaxGetFieldText("mstk_indic_" + iNumLinha);
    var var_tdet_id_ = scAjaxGetFieldHidden("tdet_id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_treat_details_submit_form(var_mstk_id_, var_treat_doses_, var_mstk_indic_, var_tdet_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_treat_details_submit_form_cb);
  } // do_ajax_form_treat_details_submit_form

  function do_ajax_form_treat_details_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("mstk_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("treat_doses_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("mstk_indic_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tdet_id_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_treat_details_submit_form_cb_after_alert);
  } // do_ajax_form_treat_details_submit_form_cb
  function do_ajax_form_treat_details_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_treat_details_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_treat_details_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_treat_details_navigate_form, function() {});
    } else {
      perform_ajax_form_treat_details_navigate_form();
    }
  }

  function perform_ajax_form_treat_details_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_treat_details_cancel_insert(sc_form_treat_details_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("mstk_id_" + iNavForm);
      scAjaxHideErrorDisplay("treat_doses_" + iNavForm);
      scAjaxHideErrorDisplay("mstk_indic_" + iNavForm);
      scAjaxHideErrorDisplay("tdet_id_" + iNavForm);
    }
    var var_tdet_id_ = document.F2.tdet_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_treat_details_navigate_form(var_tdet_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_treat_details_navigate_form_cb);
  } // do_ajax_form_treat_details_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_treat_details']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_treat_details_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.tdet_id_.value = scAjaxGetKeyValue("tdet_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_treat_details_navigate_form_cb_after_alert);
  } // do_ajax_form_treat_details_navigate_form_cb
  function do_ajax_form_treat_details_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_treat_details_navigate_form_cb_after_alert

    function sc_form_treat_details_get_last_line_number()
    {
    ...
    } //sc_form_treat_details_get_last_line_number

  function sc_hide_form_treat_details_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "mstk_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "treat_doses_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "mstk_indic_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tdet_id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["mstk_id_" + iNumLinha] = {"label": "Medicamento<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["treat_doses_" + iNumLinha] = {"label": "Cant administrada<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["mstk_indic_" + iNumLinha] = {"label": "Indicaciones<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["tdet_id_" + iNumLinha] = {"label": "Detalle<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_field_mult["mstk_id_"][iNumLinha] = "mstk_id_" + iNumLinha;
    ajax_field_mult["treat_doses_"][iNumLinha] = "treat_doses_" + iNumLinha;
    ajax_field_mult["mstk_indic_"][iNumLinha] = "mstk_indic_" + iNumLinha;
    ajax_field_mult["tdet_id_"][iNumLinha] = "tdet_id_" + iNumLinha;
    ajax_field_id["mstk_id_" + iNumLinha] = new Array("hidden_field_label_mstk_id_", "hidden_field_data_mstk_id_" + iNumLinha);
    ajax_field_id["treat_doses_" + iNumLinha] = new Array("hidden_field_label_treat_doses_", "hidden_field_data_treat_doses_" + iNumLinha);
    ajax_field_id["mstk_indic_" + iNumLinha] = new Array("hidden_field_label_mstk_indic_", "hidden_field_data_mstk_indic_" + iNumLinha);
    ajax_error_count["mstk_id_" + iNumLinha] = "off";
    ajax_error_count["treat_doses_" + iNumLinha] = "off";
    ajax_error_count["mstk_indic_" + iNumLinha] = "off";
    ajax_error_count["tdet_id_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["mstk_id_" + iNumLinha] = "off";
    ajax_read_only["treat_doses_" + iNumLinha] = "on";
    ajax_read_only["mstk_indic_" + iNumLinha] = "on";
    ajax_read_only["tdet_id_" + iNumLinha] = "on";
<?php
}
else
{
?>
    ajax_read_only["mstk_id_" + iNumLinha] = "on";
    ajax_read_only["treat_doses_" + iNumLinha] = "on";
    ajax_read_only["mstk_indic_" + iNumLinha] = "on";
    ajax_read_only["tdet_id_" + iNumLinha] = "on";
<?php
...
?>
  ...
  {
    ajax_error_list["mstk_id_" + iNumLinha] = null;
    ajax_error_list["treat_doses_" + iNumLinha] = null;
    ajax_error_list["mstk_indic_" + iNumLinha] = null;
    ajax_error_list["tdet_id_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "mstk_id_": new Array(),
    "treat_doses_": new Array(),
    "mstk_indic_": new Array(),
    "tdet_id_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["mstk_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["mstk_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["mstk_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["mstk_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["mstk_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["treat_doses_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["treat_doses_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["treat_doses_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["treat_doses_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["treat_doses_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["mstk_indic_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["mstk_indic_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["mstk_indic_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["mstk_indic_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["mstk_indic_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tdet_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tdet_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tdet_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tdet_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tdet_id_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['mstk_id_'])) ? $this->nmgp_cmp_readonly['mstk_id_'] : 'off';
?>
    scAjaxFieldRead("mstk_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['treat_doses_'])) ? $this->nmgp_cmp_readonly['treat_doses_'] : 'on';
?>
    scAjaxFieldRead("treat_doses_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['mstk_indic_'])) ? $this->nmgp_cmp_readonly['mstk_indic_'] : 'on';
?>
    scAjaxFieldRead("mstk_indic_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tdet_id_'])) ? $this->nmgp_cmp_readonly['tdet_id_'] : 'on';
?>
    scAjaxFieldRead("tdet_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("mstk_id_" + iSeq, "on");
    scAjaxFieldRead("treat_doses_" + iSeq, "on");
    scAjaxFieldRead("mstk_indic_" + iSeq, "on");
    scAjaxFieldRead("tdet_id_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["mstk_id_" + iRow] || "on" == ajax_error_count["treat_doses_" + iRow] || "on" == ajax_error_count["mstk_indic_" + iRow] || "on" == ajax_error_count["tdet_id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_mstk_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_treat_doses_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_mstk_indic_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tdet_id_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["mstk_id_" + iRow] && "off" == ajax_error_count["treat_doses_" + iRow] && "off" == ajax_error_count["mstk_indic_" + iRow] && "off" == ajax_error_count["tdet_id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["mstk_id_" + iRow] = "off";
        ajax_error_count["treat_doses_" + iRow] = "off";
        ajax_error_count["mstk_indic_" + iRow] = "off";
        ajax_error_count["tdet_id_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_mstk_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_treat_doses_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_mstk_indic_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tdet_id_" + iRow).removeClass("scFormErrorLine");
    }
  }
