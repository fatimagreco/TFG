...
class pdfreport_consultations_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "pdfreport_consultations.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_consultations']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_consultations']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_consultations']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_consultations']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_consultations']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_consultations']['rtf_name']);
      }
      ...
      { 
          ...
          if ($Cada_col == "con_consul_id" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
          ...
          if ($Cada_col == "con_pati_id" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $SC_Label = NM_charset_to_utf8($SC_Label);
              $SC_Label = str_replace('<', '&lt;', $SC_Label);
              $SC_Label = str_replace('>', '&gt;', $SC_Label);
          ...
          if ($Cada_col == "con_user_id" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $SC_Label = NM_charset_to_utf8($SC_Label);
              $SC_Label = str_replace('<', '&lt;', $SC_Label);
              $SC_Label = str_replace('>', '&gt;', $SC_Label);
          ...
          if ($Cada_col == "con_consul_date" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $SC_Label = NM_charset_to_utf8($SC_Label);
              $SC_Label = str_replace('<', '&lt;', $SC_Label);
              $SC_Label = str_replace('>', '&gt;', $SC_Label);
          ...
          if ($Cada_col == "con_consul_strtime" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $SC_Label = NM_charset_to_utf8($SC_Label);
              $SC_Label = str_replace('<', '&lt;', $SC_Label);
              $SC_Label = str_replace('>', '&gt;', $SC_Label);
          ...
          if ($Cada_col == "con_consul_endtime" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $SC_Label = NM_charset_to_utf8($SC_Label);
              $SC_Label = str_replace('<', '&lt;', $SC_Label);
              $SC_Label = str_replace('>', '&gt;', $SC_Label);
          ...
          if ($Cada_col == "con_consil_sesnum" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $SC_Label = NM_charset_to_utf8($SC_Label);
              $SC_Label = str_replace('<', '&lt;', $SC_Label);
              $SC_Label = str_replace('>', '&gt;', $SC_Label);
          ...
          if ($Cada_col == "con_consul_reason" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $SC_Label = NM_charset_to_utf8($SC_Label);
              $SC_Label = str_replace('<', '&lt;', $SC_Label);
              $SC_Label = str_replace('>', '&gt;', $SC_Label);
          ...
          if ($Cada_col == "con_consul_anot" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $SC_Label = NM_charset_to_utf8($SC_Label);
              $SC_Label = str_replace('<', '&lt;', $SC_Label);
              $SC_Label = str_replace('>', '&gt;', $SC_Label);
          ...
          if ($Cada_col == "con_consul_state" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $SC_Label = NM_charset_to_utf8($SC_Label);
              $SC_Label = str_replace('<', '&lt;', $SC_Label);
              $SC_Label = str_replace('>', '&gt;', $SC_Label);
          ...
          if ($Cada_col == "pa_pati_docnum" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $SC_Label = NM_charset_to_utf8($SC_Label);
              $SC_Label = str_replace('<', '&lt;', $SC_Label);
              $SC_Label = str_replace('>', '&gt;', $SC_Label);
          ...
          if ($Cada_col == "pa_pati_name" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $SC_Label = NM_charset_to_utf8($SC_Label);
              $SC_Label = str_replace('<', '&lt;', $SC_Label);
              $SC_Label = str_replace('>', '&gt;', $SC_Label);
          ...
          if ($Cada_col == "pa_pati_lname" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $SC_Label = NM_charset_to_utf8($SC_Label);
              $SC_Label = str_replace('<', '&lt;', $SC_Label);
              $SC_Label = str_replace('>', '&gt;', $SC_Label);
          ...
          if ($Cada_col == "pa_pati_phone" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $SC_Label = NM_charset_to_utf8($SC_Label);
              $SC_Label = str_replace('<', '&lt;', $SC_Label);
              $SC_Label = str_replace('>', '&gt;', $SC_Label);
          ...
          if ($Cada_col == "pa_pati_career" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $SC_Label = NM_charset_to_utf8($SC_Label);
              $SC_Label = str_replace('<', '&lt;', $SC_Label);
              $SC_Label = str_replace('>', '&gt;', $SC_Label);
          ...
          if ($Cada_col == "pa_pati_carsem" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $SC_Label = NM_charset_to_utf8($SC_Label);
              $SC_Label = str_replace('<', '&lt;', $SC_Label);
              $SC_Label = str_replace('>', '&gt;', $SC_Label);
          ...
          if ($Cada_col == "pa_pati_bod" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $SC_Label = NM_charset_to_utf8($SC_Label);
              $SC_Label = str_replace('<', '&lt;', $SC_Label);
              $SC_Label = str_replace('>', '&gt;', $SC_Label);
          ...
          if ($Cada_col == "pa_pati_famname" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $SC_Label = NM_charset_to_utf8($SC_Label);
              $SC_Label = str_replace('<', '&lt;', $SC_Label);
              $SC_Label = str_replace('>', '&gt;', $SC_Label);
          ...
          if ($Cada_col == "pa_pati_famphone" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $SC_Label = NM_charset_to_utf8($SC_Label);
              $SC_Label = str_replace('<', '&lt;', $SC_Label);
              $SC_Label = str_replace('>', '&gt;', $SC_Label);
          ...
          if ($Cada_col == "us_user_docnum" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $SC_Label = NM_charset_to_utf8($SC_Label);
              $SC_Label = str_replace('<', '&lt;', $SC_Label);
              $SC_Label = str_replace('>', '&gt;', $SC_Label);
          ...
          if ($Cada_col == "us_user_name" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $SC_Label = NM_charset_to_utf8($SC_Label);
              $SC_Label = str_replace('<', '&lt;', $SC_Label);
              $SC_Label = str_replace('>', '&gt;', $SC_Label);
          ...
          if ($Cada_col == "us_user_lname" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $SC_Label = NM_charset_to_utf8($SC_Label);
              $SC_Label = str_replace('<', '&lt;', $SC_Label);
              $SC_Label = str_replace('>', '&gt;', $SC_Label);
          ...
          if ($Cada_col == "pati_nombre" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $SC_Label = NM_charset_to_utf8($SC_Label);
              $SC_Label = str_replace('<', '&lt;', $SC_Label);
              $SC_Label = str_replace('>', '&gt;', $SC_Label);
...
$_SESSION['scriptcase']['pdfreport_consultations']['contr_erro'] = 'off'; 
   ...
   function NM_export_con_consul_id()
   {
         ...
         $this->con_consul_id = NM_charset_to_utf8($this->con_consul_id);
         $this->con_consul_id = str_replace('<', '&lt;', $this->con_consul_id);
         $this->con_consul_id = str_replace('>', '&gt;', $this->con_consul_id);
         $this->Texto_tag .= "<td>" . $this->con_consul_id . "</td>\r\n";
   }
   //----- con_pati_id
   function NM_export_con_pati_id()
   {
         ...
         $this->con_pati_id = NM_charset_to_utf8($this->con_pati_id);
         $this->con_pati_id = str_replace('<', '&lt;', $this->con_pati_id);
         $this->con_pati_id = str_replace('>', '&gt;', $this->con_pati_id);
         $this->Texto_tag .= "<td>" . $this->con_pati_id . "</td>\r\n";
   }
   //----- con_user_id
   function NM_export_con_user_id()
   {
         ...
         $this->con_user_id = NM_charset_to_utf8($this->con_user_id);
         $this->con_user_id = str_replace('<', '&lt;', $this->con_user_id);
         $this->con_user_id = str_replace('>', '&gt;', $this->con_user_id);
         $this->Texto_tag .= "<td>" . $this->con_user_id . "</td>\r\n";
   }
   //----- con_consul_date
   function NM_export_con_consul_date()
   {
         ...
         $this->con_consul_date = NM_charset_to_utf8($this->con_consul_date);
         $this->con_consul_date = str_replace('<', '&lt;', $this->con_consul_date);
         $this->con_consul_date = str_replace('>', '&gt;', $this->con_consul_date);
         $this->Texto_tag .= "<td>" . $this->con_consul_date . "</td>\r\n";
   }
   //----- con_consul_strtime
   function NM_export_con_consul_strtime()
   {
         ...
         $this->con_consul_strtime = NM_charset_to_utf8($this->con_consul_strtime);
         $this->con_consul_strtime = str_replace('<', '&lt;', $this->con_consul_strtime);
         $this->con_consul_strtime = str_replace('>', '&gt;', $this->con_consul_strtime);
         $this->Texto_tag .= "<td>" . $this->con_consul_strtime . "</td>\r\n";
   }
   //----- con_consul_endtime
   function NM_export_con_consul_endtime()
   {
         ...
         $this->con_consul_endtime = NM_charset_to_utf8($this->con_consul_endtime);
         $this->con_consul_endtime = str_replace('<', '&lt;', $this->con_consul_endtime);
         $this->con_consul_endtime = str_replace('>', '&gt;', $this->con_consul_endtime);
         $this->Texto_tag .= "<td>" . $this->con_consul_endtime . "</td>\r\n";
   }
   //----- con_consil_sesnum
   function NM_export_con_consil_sesnum()
   {
         ...
         $this->con_consil_sesnum = NM_charset_to_utf8($this->con_consil_sesnum);
         $this->con_consil_sesnum = str_replace('<', '&lt;', $this->con_consil_sesnum);
         $this->con_consil_sesnum = str_replace('>', '&gt;', $this->con_consil_sesnum);
         $this->Texto_tag .= "<td>" . $this->con_consil_sesnum . "</td>\r\n";
   }
   //----- con_consul_reason
   function NM_export_con_consul_reason()
   {
         $this->con_consul_reason = html_entity_decode($this->con_consul_reason, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->con_consul_reason = strip_tags($this->con_consul_reason);
         $this->con_consul_reason = NM_charset_to_utf8($this->con_consul_reason);
         $this->con_consul_reason = str_replace('<', '&lt;', $this->con_consul_reason);
         $this->con_consul_reason = str_replace('>', '&gt;', $this->con_consul_reason);
         $this->Texto_tag .= "<td>" . $this->con_consul_reason . "</td>\r\n";
   }
   //----- con_consul_anot
   function NM_export_con_consul_anot()
   {
         $this->con_consul_anot = html_entity_decode($this->con_consul_anot, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->con_consul_anot = strip_tags($this->con_consul_anot);
         $this->con_consul_anot = NM_charset_to_utf8($this->con_consul_anot);
         $this->con_consul_anot = str_replace('<', '&lt;', $this->con_consul_anot);
         $this->con_consul_anot = str_replace('>', '&gt;', $this->con_consul_anot);
         $this->Texto_tag .= "<td>" . $this->con_consul_anot . "</td>\r\n";
   }
   //----- con_consul_state
   function NM_export_con_consul_state()
   {
         ...
         $this->con_consul_state = NM_charset_to_utf8($this->con_consul_state);
         $this->con_consul_state = str_replace('<', '&lt;', $this->con_consul_state);
         $this->con_consul_state = str_replace('>', '&gt;', $this->con_consul_state);
         $this->Texto_tag .= "<td>" . $this->con_consul_state . "</td>\r\n";
   }
   //----- pa_pati_docnum
   function NM_export_pa_pati_docnum()
   {
         ...
         $this->pa_pati_docnum = NM_charset_to_utf8($this->pa_pati_docnum);
         $this->pa_pati_docnum = str_replace('<', '&lt;', $this->pa_pati_docnum);
         $this->pa_pati_docnum = str_replace('>', '&gt;', $this->pa_pati_docnum);
         $this->Texto_tag .= "<td>" . $this->pa_pati_docnum . "</td>\r\n";
   }
   //----- pa_pati_name
   function NM_export_pa_pati_name()
   {
         $this->pa_pati_name = html_entity_decode($this->pa_pati_name, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->pa_pati_name = strip_tags($this->pa_pati_name);
         $this->pa_pati_name = NM_charset_to_utf8($this->pa_pati_name);
         $this->pa_pati_name = str_replace('<', '&lt;', $this->pa_pati_name);
         $this->pa_pati_name = str_replace('>', '&gt;', $this->pa_pati_name);
         $this->Texto_tag .= "<td>" . $this->pa_pati_name . "</td>\r\n";
   }
   //----- pa_pati_lname
   function NM_export_pa_pati_lname()
   {
         $this->pa_pati_lname = html_entity_decode($this->pa_pati_lname, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->pa_pati_lname = strip_tags($this->pa_pati_lname);
         $this->pa_pati_lname = NM_charset_to_utf8($this->pa_pati_lname);
         $this->pa_pati_lname = str_replace('<', '&lt;', $this->pa_pati_lname);
         $this->pa_pati_lname = str_replace('>', '&gt;', $this->pa_pati_lname);
         $this->Texto_tag .= "<td>" . $this->pa_pati_lname . "</td>\r\n";
   }
   //----- pa_pati_phone
   function NM_export_pa_pati_phone()
   {
         $this->pa_pati_phone = html_entity_decode($this->pa_pati_phone, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->pa_pati_phone = strip_tags($this->pa_pati_phone);
         $this->pa_pati_phone = NM_charset_to_utf8($this->pa_pati_phone);
         $this->pa_pati_phone = str_replace('<', '&lt;', $this->pa_pati_phone);
         $this->pa_pati_phone = str_replace('>', '&gt;', $this->pa_pati_phone);
         $this->Texto_tag .= "<td>" . $this->pa_pati_phone . "</td>\r\n";
   }
   //----- pa_pati_career
   function NM_export_pa_pati_career()
   {
         $this->pa_pati_career = html_entity_decode($this->pa_pati_career, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->pa_pati_career = strip_tags($this->pa_pati_career);
         $this->pa_pati_career = NM_charset_to_utf8($this->pa_pati_career);
         $this->pa_pati_career = str_replace('<', '&lt;', $this->pa_pati_career);
         $this->pa_pati_career = str_replace('>', '&gt;', $this->pa_pati_career);
         $this->Texto_tag .= "<td>" . $this->pa_pati_career . "</td>\r\n";
   }
   //----- pa_pati_carsem
   function NM_export_pa_pati_carsem()
   {
         ...
         $this->pa_pati_carsem = NM_charset_to_utf8($this->pa_pati_carsem);
         $this->pa_pati_carsem = str_replace('<', '&lt;', $this->pa_pati_carsem);
         $this->pa_pati_carsem = str_replace('>', '&gt;', $this->pa_pati_carsem);
         $this->Texto_tag .= "<td>" . $this->pa_pati_carsem . "</td>\r\n";
   }
   //----- pa_pati_bod
   function NM_export_pa_pati_bod()
   {
         ...
         $this->pa_pati_bod = NM_charset_to_utf8($this->pa_pati_bod);
         $this->pa_pati_bod = str_replace('<', '&lt;', $this->pa_pati_bod);
         $this->pa_pati_bod = str_replace('>', '&gt;', $this->pa_pati_bod);
         $this->Texto_tag .= "<td>" . $this->pa_pati_bod . "</td>\r\n";
   }
   //----- pa_pati_famname
   function NM_export_pa_pati_famname()
   {
         $this->pa_pati_famname = html_entity_decode($this->pa_pati_famname, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->pa_pati_famname = strip_tags($this->pa_pati_famname);
         $this->pa_pati_famname = NM_charset_to_utf8($this->pa_pati_famname);
         $this->pa_pati_famname = str_replace('<', '&lt;', $this->pa_pati_famname);
         $this->pa_pati_famname = str_replace('>', '&gt;', $this->pa_pati_famname);
         $this->Texto_tag .= "<td>" . $this->pa_pati_famname . "</td>\r\n";
   }
   //----- pa_pati_famphone
   function NM_export_pa_pati_famphone()
   {
         $this->pa_pati_famphone = html_entity_decode($this->pa_pati_famphone, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->pa_pati_famphone = strip_tags($this->pa_pati_famphone);
         $this->pa_pati_famphone = NM_charset_to_utf8($this->pa_pati_famphone);
         $this->pa_pati_famphone = str_replace('<', '&lt;', $this->pa_pati_famphone);
         $this->pa_pati_famphone = str_replace('>', '&gt;', $this->pa_pati_famphone);
         $this->Texto_tag .= "<td>" . $this->pa_pati_famphone . "</td>\r\n";
   }
   //----- us_user_docnum
   function NM_export_us_user_docnum()
   {
         $this->us_user_docnum = html_entity_decode($this->us_user_docnum, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->us_user_docnum = strip_tags($this->us_user_docnum);
         $this->us_user_docnum = NM_charset_to_utf8($this->us_user_docnum);
         $this->us_user_docnum = str_replace('<', '&lt;', $this->us_user_docnum);
         $this->us_user_docnum = str_replace('>', '&gt;', $this->us_user_docnum);
         $this->Texto_tag .= "<td>" . $this->us_user_docnum . "</td>\r\n";
   }
   //----- us_user_name
   function NM_export_us_user_name()
   {
         $this->us_user_name = html_entity_decode($this->us_user_name, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->us_user_name = strip_tags($this->us_user_name);
         $this->us_user_name = NM_charset_to_utf8($this->us_user_name);
         $this->us_user_name = str_replace('<', '&lt;', $this->us_user_name);
         $this->us_user_name = str_replace('>', '&gt;', $this->us_user_name);
         $this->Texto_tag .= "<td>" . $this->us_user_name . "</td>\r\n";
   }
   //----- us_user_lname
   function NM_export_us_user_lname()
   {
         $this->us_user_lname = html_entity_decode($this->us_user_lname, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->us_user_lname = strip_tags($this->us_user_lname);
         $this->us_user_lname = NM_charset_to_utf8($this->us_user_lname);
         $this->us_user_lname = str_replace('<', '&lt;', $this->us_user_lname);
         $this->us_user_lname = str_replace('>', '&gt;', $this->us_user_lname);
         $this->Texto_tag .= "<td>" . $this->us_user_lname . "</td>\r\n";
   }
   //----- pati_edad
   ...
   {
         $this->pati_nombre = html_entity_decode($this->pati_nombre, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->pati_nombre = strip_tags($this->pati_nombre);
         $this->pati_nombre = NM_charset_to_utf8($this->pati_nombre);
         $this->pati_nombre = str_replace('<', '&lt;', $this->pati_nombre);
         $this->pati_nombre = str_replace('>', '&gt;', $this->pati_nombre);
         $this->Texto_tag .= "<td>" . $this->pati_nombre . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_consultations']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_consultations']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_chart_title'] ?> <?php echo $this->Ini->Nm_lang['lang_tbl_Consultas'] ?> :: RTF</TITLE>
