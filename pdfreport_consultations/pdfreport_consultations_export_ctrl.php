<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_consultations']['sc_process_barr'] = true;
require_once('../pdfreport_consultations/index.php');
unset($_SESSION['scriptcase']['pdfreport_consultations']['sc_process_barr']);
$ExportCtrl = new pdfreport_consultations_export_control;
$ExportCtrl->Export_barr();

class pdfreport_consultations_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_title'] ?> <?php echo $this->Nm_lang['lang_tbl_Consultas'] ?></TITLE>
