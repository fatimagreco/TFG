<?php
@session_start() ;
$_SESSION['scriptcase']['grid_gerens']['sc_process_barr'] = true;
require_once('../grid_gerens/index.php');
unset($_SESSION['scriptcase']['grid_gerens']['sc_process_barr']);
$ExportCtrl = new grid_gerens_export_control;
$ExportCtrl->Export_barr();

class grid_gerens_export_control
{
