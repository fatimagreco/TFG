...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "gerens_id";$Nm_numeric[] = "gerens_id";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_gerens_id_cond" name="gerens_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_gerens_id'), this, 'gerens_id')">
      ...
      <br><span id="id_hide_gerens_id"  <?php echo $str_hide_gerens_id?>><INPUT  type="text" id="SC_gerens_id" name="gerens_id" value="<?php echo NM_encode_input($gerens_id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_gerens_name_cond" name="gerens_name_cond" onChange="nm_campos_between(document.getElementById('id_vis_gerens_name'), this, 'gerens_name')">
      ...
      <br><span id="id_hide_gerens_name"  <?php echo $str_hide_gerens_name?>><?php
      if ($gerens_name != "")
      {
      $gerens_name_look = (is_string($gerens_name) ? substr($this->Db->qstr($gerens_name), 1, -1) : $gerens_name); 
      $nmgp_def_dados = array(); 
