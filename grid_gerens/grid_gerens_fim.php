...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["EnfermeriaUNAE_____grid_gerens"]))
   {
      unset($_SESSION['session_sec_aplicacao']["EnfermeriaUNAE_____grid_gerens"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_gerens'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_gerens']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_gerens']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_gerens']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_gerens']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_gerens']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_gerens']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_gerens']['embutida_filho'] as $ind => $sc_init)
          {
